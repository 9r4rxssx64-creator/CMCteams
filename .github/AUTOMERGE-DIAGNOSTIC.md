...
X Pull request 9r4rxssx64-creator/CMCteams#3694 is not mergeable: the merge commit cannot be cleanly created.
To have the pull request merged after all the requirements have been met, add the `--auto` flag.
Run the following to resolve the merge conflicts locally:
  gh pr checkout 3694 && git fetch origin main && git merge origin/main
```
