/* KDMC Shops — Service Worker CHEZ LOLO. Cache nommé par boutique + nettoyage scopé. */
var CACHE='kdmc-lolo-v1.2.3';
...
self.addEventListener('activate',function(e){e.waitUntil(caches.keys().then(function(ks){return Promise.all(ks.filter(function(k){return k!==CACHE&&(k.indexOf('kdmc-lolo-')===0||k==='kdmc-v1')}).map(function(k){return caches.delete(k)}))}));self.clients.claim()});
