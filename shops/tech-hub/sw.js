/* KDMC Shops — Service Worker Tech Hub. Cache nommé par boutique + nettoyage scopé. */
var CACHE='kdmc-tech-hub-v1.0.4';
...
self.addEventListener('activate',function(e){e.waitUntil(caches.keys().then(function(ks){return Promise.all(ks.filter(function(k){return k!==CACHE&&(k.indexOf('kdmc-tech-hub-')===0||k==='kdmc-v1')}).map(function(k){return caches.delete(k)}))}));self.clients.claim()});
