...
**État** : Phase 1 (boutique + Studio) ✅ · Studio emplacements + thèmes ✅ · Phase 2 (checkout taille+adresse + bon de production) ✅ · Phase 3 (handoff fournisseur : envoi + Export CSV) ✅ · Image hero ✅ · **12 designs maison** → **60 produits** ✅ · **Bibliothèque de designs** (`bibliotheque.html`, 18 motifs, PNG/SVG, deep-link Studio) ✅ · Studio 18 motifs ✅ · **Upgrade boutique pro** (promo bar, livraison offerte 60€, taille+quantité+guide sur fiche, favoris, badges Nouveau/Top, filtre couleur) ✅ · Doc fournisseurs (`FOURNISSEURS_LA_DETENTE.md`) ✅. **Reste** : créer 1 compte fournisseur (KYC Kevin). Cache PWA `kdmc-la-detente-v1.8.0`.
