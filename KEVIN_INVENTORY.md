...
| `tests/club-semaine.test.mjs` | 10 preuves hors ligne (porte de vérité, faux réseau, rien publié si refusé) | [voir](https://github.com/9r4rxssx64-creator/cmcteams/blob/main/tests/club-semaine.test.mjs) | — |
