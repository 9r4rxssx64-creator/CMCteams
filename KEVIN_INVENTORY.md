...
| `LESSONS.md` (leçon #220) | 0,2 pt d'écart dans un PDF = une personne qui disparaît ; et pourquoi un test « app == light » ne peut jamais le voir. | [voir](https://github.com/9r4rxssx64-creator/CMCteams/blob/claude/verify-cmcteams-light-data-rzlvau/LESSONS.md) |
