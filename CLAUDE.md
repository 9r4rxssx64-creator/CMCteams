...
> 📚 Les leçons détaillées (#1→#134) sont archivées dans **LESSONS.md** — lues à la demande, plus rechargées à chaque message (économie de conso). Règle inchangée : append-only, ne jamais les reproduire.
...
> 📚 Table complète des versions déplacée dans **CHANGELOG.md** (référence, lue à la demande).
...
> 📚 Suite des leçons (#64→#134) archivée dans **LESSONS.md**.
