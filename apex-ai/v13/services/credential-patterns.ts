...
export const CREDENTIAL_PATTERNS: ReadonlyArray<CredentialPattern> = [
  ...
  /* On ne stocke PAS les mots de passe bancaires plain — on stocke références/ids
     pour pouvoir lancer une tâche autonome (ex: ouvrir app native, lire compte
     via Open Banking PSD2 OAuth si dispo). */
  {
