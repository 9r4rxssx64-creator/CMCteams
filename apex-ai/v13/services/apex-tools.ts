...
const APEX_TOOLS: readonly ApexTool[] = [
  ...
  /* === v13 — MCP Memory Server (knowledge graph local — innovation gratuite issue #240) === */
  {
  ...
  /* === v13 — Sequential Thinking (raisonnement multi-étapes — innovation gratuite issue #240) === */
  {
    name: 'thinking_start',
    description:
