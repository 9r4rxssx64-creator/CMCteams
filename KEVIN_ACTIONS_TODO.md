...
| ~~E-mails du Kit / Club / boutiques (EmailJS)~~ ✅ fait le 17.09 : Kevin a collé la vraie clé publique (elle commence par `nUso3…`, l'ancienne en était une copie tronquée). Posée aux 8 endroits (caisse, machine du lundi, 6 boutiques). Preuve d'envoi : voir MEMO_RESUME 17.09 | Codes d'achat, point du lundi, rappels J-14 et newsletters des boutiques partent enfin par e-mail | fait |
