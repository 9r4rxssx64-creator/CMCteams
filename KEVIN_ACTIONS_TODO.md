...
| **Ton tableau de bord Commerce est en ligne** : [ouvre-le](https://kd-mc.com/admin/commerce.html) (Face ID, compte Kevin) — ventes réelles, file à valider en 1 clic, produits, vidéos, boutons de lancement. **Rien à faire.** Si un bouton « Lancer » répond « GitHub HTTP 403 », c'est que le jeton `APEX_GITHUB_PAT` n'a pas le droit `workflow` : dis-le-moi, je passe par le lien GitHub en attendant | Voir tout ce qui a été construit pour vendre, et commander depuis le téléphone | 0 min |
| **La pub se fait toute seule chaque lundi 08:00** (routine « Pub — vidéos de la semaine ») : nouveaux scripts écrits par l'IA (immo + Club), vidéos rendues, publiées, programmées dans Metricool, tableau de bord mis à jour. **Rien à faire.** Pour l'arrêter ou changer les niches : dis-le, je règle la routine | Kevin 17.09 « création auto régulière de contenus, mise en ligne, pub, tout automatique » | 0 min |
| **16 vidéos programmées** (14 le 17.09 à la main, + 2 écrites par l'IA et posées par la chaîne autonome pour lun 28.09) sur tes 4 réseaux, du jeu 18.09 au lun 28.09, 10h et 12h, publication automatique. **Rien à faire** — sauf si tu veux en retirer une : [ouvre le planning Metricool](https://app.metricool.com/planner/calendar?blogId=7000185) et supprime-la **avant jeudi 18.09 10h** | Première pub réelle pour les 4 niches + le Kit + le Club (vidéos sans visage, ta voix du domaine) | 0 min |
