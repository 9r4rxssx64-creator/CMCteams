...
**Execution:**
```bash
python .claude/skills/seo/scripts/drift_baseline.py <url>
python .claude/skills/seo/scripts/drift_baseline.py <url> --skip-cwv
```
...
**Execution:**
```bash
python .claude/skills/seo/scripts/drift_compare.py <url>
python .claude/skills/seo/scripts/drift_compare.py <url> --baseline-id 5
python .claude/skills/seo/scripts/drift_compare.py <url> --skip-cwv
```
...
```bash
python .claude/skills/seo/scripts/drift_report.py <comparison_json_file> --output drift-report.html
```
...
**Execution:**
```bash
python .claude/skills/seo/scripts/drift_history.py <url>
python .claude/skills/seo/scripts/drift_history.py <url> --limit 10
```
