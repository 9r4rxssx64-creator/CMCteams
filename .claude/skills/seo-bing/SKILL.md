...
|---|---|
| `/seo bing links <url>` | `python .claude/skills/seo/scripts/bing_webmaster.py links <url>` |
| `/seo bing compare <urlA> <urlB>` | `python .claude/skills/seo/scripts/bing_webmaster.py compare <urlA> <urlB>` |
| `/seo bing submit <url>` (single URL) | `python .claude/skills/seo/scripts/indexnow_submit.py --host ... --urls <url>` |
| `/seo bing submit-batch <file>` | `python .claude/skills/seo/scripts/indexnow_submit.py --urls-file <file>` |
| `/seo bing verify-indexnow` | `python .claude/skills/seo/scripts/indexnow_submit.py --verify-only` |
