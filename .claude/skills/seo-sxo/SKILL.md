...
1. Fetch the target URL via `.claude/skills/seo/scripts/fetch_page.py` (SSRF-safe)
...
- [ ] Target URL was fetched via `.claude/skills/seo/scripts/fetch_page.py` (not raw curl/fetch)
