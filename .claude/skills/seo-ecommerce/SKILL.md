...
```
1. python .claude/skills/seo/scripts/fetch_page.py <url>         → raw HTML
2. python .claude/skills/seo/scripts/parse_html.py --url <url>   → SEO elements
...
```bash
python .claude/skills/seo/scripts/dataforseo_costs.py check merchant_google_products_search
```
...
After each call:
```bash
python .claude/skills/seo/scripts/dataforseo_costs.py log merchant_google_products_search <cost>
```
...
python .claude/skills/seo/scripts/dataforseo_merchant.py search "<keyword>" --marketplace google

# Seller analysis: merchant ratings and dominance
python .claude/skills/seo/scripts/dataforseo_merchant.py sellers "<keyword>"

# Normalize results for analysis
python .claude/skills/seo/scripts/dataforseo_normalize.py results.json --module merchant
```
...
```bash
python .claude/skills/seo/scripts/dataforseo_costs.py check merchant_amazon_products_search
```
...
python .claude/skills/seo/scripts/dataforseo_merchant.py search "<keyword>" --marketplace amazon

# Cross-marketplace comparison
python .claude/skills/seo/scripts/dataforseo_merchant.py compare "<keyword>"
```
...
python .claude/skills/seo/scripts/ucp_check.py https://store.example.com --json

# With endpoint reachability probes (HEAD each declared capability)
python .claude/skills/seo/scripts/ucp_check.py https://store.example.com --probe-endpoints --json
```
