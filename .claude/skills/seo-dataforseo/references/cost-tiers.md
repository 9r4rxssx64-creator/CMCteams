...
Configure with: `python .claude/skills/seo/scripts/dataforseo_costs.py config --mode threshold --threshold 0.50 --daily-limit 10.00`
...
1. Run `python .claude/skills/seo/scripts/dataforseo_costs.py check <endpoint> [--count N]`
...
5. After call completes, log: `python .claude/skills/seo/scripts/dataforseo_costs.py log <endpoint> <cost>`
