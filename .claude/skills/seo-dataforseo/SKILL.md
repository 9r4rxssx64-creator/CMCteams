...
```
python .claude/skills/seo/scripts/dataforseo_costs.py check <endpoint> [--count N]
```
...
```
python .claude/skills/seo/scripts/dataforseo_costs.py log <endpoint> <actual_cost>
```
