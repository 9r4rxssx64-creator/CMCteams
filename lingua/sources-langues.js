...
(function (racine) {
  ...
  var LANG_SOURCES = {
    mc: [
      { nom: 'Comité National des Traditions Monégasques', url: 'https://www.traditionsmonegasques.mc/', quoi: 'la maison qui édite le dictionnaire et enseigne la langue', etat: 'mort' },
      { nom: 'Académie des Langues Dialectales', url: 'https://www.acaledi.mc/', quoi: 'académie officielle des langues de Monaco', etat: 'mort' },
    ...
    uk: [
      { nom: 'Словник української мови', url: 'https://sum.in.ua/', quoi: 'le dictionnaire de l\'ukrainien', etat: 'mort' },
    ...
    ar: [
      { nom: 'مجمع اللغة العربية بالقاهرة', url: 'https://www.arabicacademy.org.eg/', quoi: 'l\'académie de langue arabe du Caire', etat: 'mort' },
