...
var STORIES=[
 ...
 {id:"marche", ic:"🛒", titre:"Au marché", lignes:[
  ...
  {qui:"🧑‍🌾", fr:"Voilà ! Dix euros.", t:{en:"Here you are! Ten euros.", it:"Ecco! Dieci euro.", es:"¡Aquí está! Diez euros.", de:"Bitte schön! Zehn Euro.", pt:"Aqui está! Dez euros.", nl:"Alstublieft! Tien euro.", pl:"Proszę! To kosztuje dziesięć euro.", ru:"Вот! Это десять евро.", uk:"Ось! Це десять євро.", cs:"Tady! To stojí deset eur.", zh:"给你！十欧元。", ja:"どうぞ！１０ユーロです。", ko:"드세요! 10유로입니다.", ar:"هنا！عشرة يورو؟"}},
 ...
 {id:"temps", ic:"🌦️", titre:"Le temps", lignes:[
  ...
  {qui:"🐝", fr:"J'ai un parapluie.", t:{en:"I have an umbrella.", it:"Ho un ombrello.", es:"Tengo un paraguas.", de:"Ich habe einen Regenschirm.", pt:"Tenho um guarda-chuva.", nl:"Ik heb een paraplu.", pl:"Mam parasol.", ru:"У меня есть зонт.", uk:"У мене є парасолька.", cs:"Mám deštník.", zh:"我有雨伞。", ja:"私は傘を持っています。", ko:"나는 우산을 가지고 있습니다.", ar:"عندى مظلة؟"}},
 ...
 {id:"docteur", ic:"🩺", titre:"Chez le docteur", lignes:[
  ...
  {qui:"🐝", fr:"J'ai mal à la tête.", t:{en:"I have a headache.", it:"Ho mal di testa.", es:"Me duele la cabeza.", de:"Ich habe Kopfschmerzen.", pt:"Dói-me a cabeça.", nl:"Ik heb hoofdpijn.", pl:"Boli mnie głowa.", ru:"У меня болит голова.", uk:"У мене болить голова.", cs:"Mě bolí hlava.", zh:"我的头疼。", ja:"頭が痛いです。", ko:"머리가 아파요.", ar:"头ي يؤلمني؟"}},
  {qui:"🩺", fr:"Bois de l'eau et dors.", t:{en:"Drink water and sleep.", it:"Bevi acqua e dormi.", es:"Bebe agua y duerme.", de:"Trink Wasser und schlaf.", pt:"Bebe água e dorme.", nl:"Drink water en slaap.", pl:"Wypij wody i śpij.", ru:"Выпей воды и поспи.", uk:"Випий води й поспи.", cs:"Pij vodu a spěchej.", zh:"喝水然后睡觉。", ja:"水を飲んで寝てください。", ko:"물을 마시고 자요.", ar:"اشرب الماء ونم؟"}},
 ...
 {id:"surprise", ic:"😊", titre:"Une belle surprise", lignes:[
  ...
  {qui:"🧑", fr:"Ouvre les yeux : c'est un gâteau !", t:{en:"Open your eyes: it is a cake!", it:"Apri gli occhi: è una torta!", es:"Abre los ojos: ¡es un pastel!", de:"Mach die Augen auf: es ist ein Kuchen!", pt:"Abre os olhos: é um bolo!", nl:"Doe je ogen open: het is een taart!", pl:"Otwórz oczy: to jest tort!", ru:"Открой глаза: это торт!", uk:"Відкрий очі: це торт!", cs:"Otevři oči: je to dort!", zh:"睁开眼睛：这是蛋糕！", ja:"目を開けて：ケーキだ！", ko:"눈을 떠. 케이크야!", ar:"افتح عينيك: هذا كعكة!"}},
  {qui:"🐝", fr:"Oh ! Je suis surprise et très contente !", t:{en:"Oh! I am surprised and very happy!", it:"Oh! Sono sorpresa e molto contenta!", es:"¡Oh! ¡Estoy sorprendida y muy contenta!", de:"Oh! Ich bin überrascht und sehr glücklich!", pt:"Oh! Estou surpresa e muito contente!", nl:"Oh! Ik ben verrast en heel blij!", pl:"O! Jestem zaskoczona i bardzo szczęśliwa!", ru:"О! Я удивлена и очень счастлива!", uk:"О! Я здивована і дуже щаслива!", cs:"Ó! Jsem překvapená a velmi šťastná!", zh:"哦！我很惊讶，也很高兴！", ja:"お！驚いて、そしてとても幸せだ！", ko:"오! 놀랐어, 그리고 너무 행복해!", ar:"يا! أنا مستعجلة وممتنة جداً!"}},
