...
- [x] **7. Intégration matériel** — capture pilotée par la source (segmentation live), Aravis/micro branchés, systemd + réseau **autonome ou branché au club** (`deploy/network.sh`), code d'accès, entretien disque, reprise d'état après crash
