import{e as r}from"./monitoring-BhKOVk_R.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CjUjKvms.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DT0Pl3Vf.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BpUeje3j.js";import"./kevin-alerts-CI8CdV2J.js";import"./whatsapp-DGvaadug.js";import"./auth-gate-Cm7B78W0.js";import"./auth-By5J_n0B.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
