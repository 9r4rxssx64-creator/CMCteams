const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./memory-bridge-iGDbFwD1.js","../core/main-D4zwvifF.js","../assets/css/main-rhfGvOFL.css","./audit-log-B0KCn-Eo.js","./observability-BT73ufBP.js","./persistent-memory-store-CkEYfctX.js","./toast-64I4l5xU.js","./haptic-BUEqXK0N.js","./consumption-anomaly-detector-BwjJ2HHV.js","./consumption-monitor-vZGTgew_.js","./links-registry-Dr2XHkLb.js","./firebase-BY3GRVm2.js","./push-notifications-DbYrzBGj.js","./tokens-dashboard-C5ZzZyK6.js","./auth-BRAqrvFk.js"])))=>i.map(i=>d[i]);
import{s as p,_ as s,l}from"../core/main-D4zwvifF.js";function m(o){const u=p.get("user"),x=p.get("isAdmin")??!1;o.innerHTML=`
