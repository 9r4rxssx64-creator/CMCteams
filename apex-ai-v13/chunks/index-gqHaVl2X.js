const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-B17vNBOa.js","./apex-tools-registry-DloDnFZi.js","./toast-Dgg9rcIP.js","./haptic-BUEqXK0N.js","./memory-bridge-Djxfea_x.js","./apex-kb-DRMqNqjP.js","./credential-patterns-DqicUg9o.js","./persistent-memory-store-DiCiEzZO.js","./consumption-anomaly-detector-Ce9yEp8d.js","./consumption-monitor-vpyPwOdv.js","./links-registry-okNGuU2k.js","./push-notifications-Bl21xDtS.js","./tokens-dashboard-C5ZzZyK6.js","./auth-DfBiOs-y.js","../core/main-veBmmiZq.js","../assets/css/main-rhfGvOFL.css"])))=>i.map(i=>d[i]);
import{_ as d}from"./apex-kb-DRMqNqjP.js";import{l as A}from"./monitoring-B17vNBOa.js";import{c as V}from"./listener-cleanup-Y2rGGxxX.js";import{s as S}from"../core/main-veBmmiZq.js";import"./apex-tools-registry-DloDnFZi.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-DTtxruLf.js";let s=null;function C(){s?.cleanup(),s=null}function g(i){return i.replace(/[&<>"']/g,b=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[b]??b)}const T="apex_v13_chat_auto_read";function R(){try{return localStorage.getItem(T)==="1"}catch{return!1}}function I(i){try{localStorage.setItem(T,i?"1":"0")}catch{}}async function P(i){try{const b=await d(()=>import("./voice-Dr7NkkAT.js").then(t=>t.a),__vite__mapDeps([0,1]),import.meta.url),{listVoices:v,getActiveVoice:p,setActiveVoice:u,speak:x,stopAll:f}=b,m=i.querySelector("#ax-settings-auto-read"),w=i.querySelector("#ax-voice-current"),h=i.querySelector("#ax-voice-list"),o=i.querySelectorAll(".ax-voice-cat-btn");if(!h)return;m&&(m.checked=R(),s.bind(m,"change",()=>{I(m.checked),(async()=>{const{toast:t}=await d(async()=>{const{toast:a}=await import("./toast-Dgg9rcIP.js");return{toast:a}},__vite__mapDeps([2,3]),import.meta.url);t.success(m.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const r=()=>{if(!w)return;const t=p(),n=v().find(l=>l.id===t);w.textContent=n?`Voix active : ${n.emoji??"🔊"} ${n.name} (${n.category})`:`Voix active : ${t}`};r();const c=t=>{const a=v(),n=t==="all"?a:a.filter(e=>e.category===t),l=p();h.innerHTML=n.map(e=>{const y=e.id===l,_=e.emoji??(e.category==="pro"?"🎙️":e.category==="fun"?"🎉":"🎨"),$=e.description?g(e.description):"",k=y?"background:rgba(232,184,48,0.15);border-color:rgba(232,184,48,0.45)":"background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.06)";return`
