import{s as f,F as m,p as l}from"./monitoring-Cq_vIOf8.js";import{c as v}from"./listener-cleanup-Y2rGGxxX.js";import{r as h}from"../core/main-DXZxWfzm.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-CgbS5D-d.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DY2-6tey.js";let o=null,s=1;const g=5,a={name:"",permissionsRequested:!1,capabilities:new Set(["chat","voice","studios"]),mode:"both",done:!1},y=[{id:"chat",label:"💬 Chat IA",desc:"Conversation Claude"},{id:"voice",label:"🎙 Voix",desc:"Dictée + lecture"},{id:"studios",label:"🎨 Studios",desc:"Music/Video/Logo"},{id:"browser",label:"🌐 Browser",desc:"Navigation embed"},{id:"pro",label:"💼 Pro modules",desc:"Cuisine/Médical/Légal"},{id:"crypto",label:"🪙 Crypto",desc:"Wallets + tracking"},{id:"domotique",label:"🏠 Domotique",desc:"Maison connectée"},{id:"remote",label:"📺 Remote TV",desc:"Télécommande univ."}];function B(){o?.cleanup(),o=null}function L(e){if(!e||e==="kdmc_admin")return!1;try{return localStorage.getItem(`apex_v13_onboarding_done_${e}`)!=="true"}catch{return!1}}function S(e){try{localStorage.setItem(`apex_v13_onboarding_done_${e}`,"true"),a.done=!0,f.info("onboarding",`Marked done for uid=${e}`)}catch{}}async function F(e){o?.cleanup(),o=v("onboarding");const t=m.get("user");t?.name&&(a.name=t.name),c(e)}function c(e){const t=`
