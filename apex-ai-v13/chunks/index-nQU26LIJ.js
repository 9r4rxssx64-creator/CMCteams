import{e as r}from"./monitoring-B4Vd9d9H.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-ASNxrqCp.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-COanab3A.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DE9nLX8M.js";import"./kevin-alerts-C0uWgkLP.js";import"./whatsapp-C0oQsADg.js";import"./auth-gate-CNXft3ei.js";import"./auth-Cbh6RQWV.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
