const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./device-context-PbkT2HT_.js","./apex-kb-Cocxpy6E.js","./monitoring-B17vNBOa.js","./apex-tools-registry-Duck4KzY.js","./credential-patterns-BybElwOv.js","./auth-Zy_kfjO3.js","../core/main-CjIm8OHH.js","../assets/css/main-rhfGvOFL.css"])))=>i.map(i=>d[i]);
import{_ as m}from"./apex-kb-Cocxpy6E.js";import{r as v}from"../core/main-CjIm8OHH.js";import{auth as g}from"./auth-Zy_kfjO3.js";import{h as d}from"./haptic-BUEqXK0N.js";import{toast as p}from"./toast-Dgg9rcIP.js";import"./monitoring-B17vNBOa.js";import"./apex-tools-registry-Duck4KzY.js";import"./credential-patterns-BybElwOv.js";import"./apex-tools-dispatch-DkU4U7sA.js";function f(e){return e.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]??o)}function x(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const l=atob(e[1]??"").split(":")[0];if(l)return{uid:l}}catch{}return null}async function _(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),o=localStorage.getItem("apex_v13_last_known_name"),l=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!o||!l)return!1;const{deviceContext:n}=await m(async()=>{const{deviceContext:s}=await import("./device-context-PbkT2HT_.js");return{deviceContext:s}},__vite__mapDeps([0,1,2,3,4]),import.meta.url);if((await n.getFingerprint()).device_id!==l)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:a}=await m(async()=>{const{auth:s}=await import("./auth-Zy_kfjO3.js");return{auth:s}},__vite__mapDeps([5,1,2,3,4,6,7]),import.meta.url);if((await a.loginTrusted(e,o)).ok)return v.navigate("chat"),!0}catch{}return!1}function L(e){_().then(t=>{t&&p.success("🔐 Reconnu automatiquement (device trusted)")});const o=x();e.innerHTML=`
...
//# sourceMappingURL=index-D2r_bA7B.js.map
