import{e as w}from"./escape-html-BlQj2yEF.js";import{c as S}from"./listener-cleanup-Y2rGGxxX.js";import{l as k,s as A}from"./monitoring-wizczV_1.js";import{voicePrint as c}from"./voice-print-DC_luz_d.js";import{g as C}from"./apex-tools-dispatch-core-BjKL1PRJ.js";import{haptic as z}from"./haptic-CQFg2PXZ.js";import{toast as u}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-CeV_AU5U.js";import"./apex-kb-DffZdqkV.js";import"./credential-patterns-ClK5OHi0.js";import"./apex-tools-dispatch-skills-0u_03RSE.js";import"./apex-tools-dispatch-data-D_gl6Zf5.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-CK3dPov1.js";import"./apex-tools-misc-DZ1FH1L1.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";const M="kdmc_admin";let m=null;function X(){m?.cleanup(),m=null}function y(e){if(!e||e===0)return"—";const i=new Date(e),a=t=>t.toString().padStart(2,"0");return`${a(i.getDate())}/${a(i.getMonth()+1)}/${i.getFullYear()} ${a(i.getHours())}:${a(i.getMinutes())}`}function b(e){return Math.round(e*100)+"%"}function _(){const e=A.get("user");return!e||!e.id?null:{id:e.id,name:e.name??"",isAdmin:e.id===M}}function x(e,i,a,t){i&&e.bind(i,a,t)}function D(e){const i=Math.max(0,Math.min(1,e))*100,a=i>=85?"#22c55e":i>=50?"#ffa500":"#ff6666";return`
