import{e as r}from"./monitoring-DIcR3-vs.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-B6Aoerwy.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-CeW95B3d.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BYZgAGqg.js";import"./kevin-alerts-BIkZ-ViD.js";import"./whatsapp-CPLQ1w4q.js";import"./auth-gate-ZHzvAYvd.js";import"./auth-CHmyXHl5.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
