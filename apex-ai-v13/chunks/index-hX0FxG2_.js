import{l as d}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-BVow9fOV.js";import{broadlinkBridge as a}from"./broadlink-bridge-DpMlH3pR.js";import{toast as i}from"./toast-Dgg9rcIP.js";import"./apex-kb-Cc3uNflI.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-DHezvtlA.js";import"./haptic-BUEqXK0N.js";const x="kdmc_admin";function t(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
