const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./device-context-Hak7w-su.js","./auth-3QV_AXlZ.js","../core/main-DiEA0LYS.js","../assets/css/main-CYtYG7GU.css"])))=>i.map(i=>d[i]);
import{_ as f}from"./apex-kb-CLN2FaYC.js";import{A as x,r as v}from"../core/main-DiEA0LYS.js";import{c as b}from"./listener-cleanup-Y2rGGxxX.js";import{auth as _}from"./auth-3QV_AXlZ.js";import{h as d}from"./haptic-BUEqXK0N.js";import{toast as m}from"./toast-Dgg9rcIP.js";import"./monitoring-WiO5ZBU9.js";import"./apex-tools-registry-_6Box58P.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-D_rogPxx.js";let p=null;function H(){p?.cleanup(),p=null}function g(e){return e.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]??o)}function y(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const r=atob(e[1]??"").split(":")[0];if(r)return{uid:r}}catch{}return null}async function h(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),o=localStorage.getItem("apex_v13_last_known_name"),r=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!o||!r)return!1;const{deviceContext:n}=await f(async()=>{const{deviceContext:l}=await import("./device-context-Hak7w-su.js");return{deviceContext:l}},__vite__mapDeps([0]),import.meta.url);if((await n.getFingerprint()).device_id!==r)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:a}=await f(async()=>{const{auth:l}=await import("./auth-3QV_AXlZ.js");return{auth:l}},__vite__mapDeps([1,2,3]),import.meta.url);if((await a.loginTrusted(e,o)).ok)return v.navigate("chat"),!0}catch{}return!1}function M(e){p?.cleanup(),p=b("landing"),h().then(t=>{t&&m.success("🔐 Reconnu automatiquement (device trusted)")});const o=y();e.innerHTML=`
