const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./multi-source-analyze-mBanIfM_.js","./apex-kb-B_UxJsN3.js","./monitoring-3uBGKGRH.js","./credential-patterns-CLzI061R.js","../assets/css/main-DBQtIeVv.css"])))=>i.map(i=>d[i]);
import{b as f,_ as $}from"./apex-kb-B_UxJsN3.js";import{c as q}from"./listener-cleanup-Y2rGGxxX.js";import{l as y}from"./monitoring-3uBGKGRH.js";import{s as P,a as z}from"../core/main-L86-OAy2.js";import{apexExecute as v}from"./apex-execute-BAARcO5d.js";import{auth as T}from"./auth-Cnq3N1Rl.js";import{commerce as S}from"./commerce-CP4eHcIF.js";import{c as M}from"./csp-style-helper-BisGRi53.js";import{i as A,r as j}from"./voice-BeZzTzhG.js";import{kdmcProjectsRegistry as k}from"./kdmc-projects-registry-DdTqW2gy.js";import{w as C}from"./whatsapp-8BJj_0eI.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as u}from"./toast-ClsF1KRZ.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-mBanIfM_.js";import"./claude-bridge-CmKUZLSZ.js";let h="commerce";const L={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function n(t){return t.replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i]??i)}function H(){const t=S.isEnabled();return`
  ...
  `}function U(){return[["commerce","💳 Commerce"],["users","👥 Comptes"],["pending","📨 Attente"],["health","🩺 Santé"],["projects","📦 Projets"],["executions","⚙️ Exec"],["knowledge","📚 KB"],["bilan","📊 Bilan"],["consumption","💰 Conso"],["audit-log","🔒 Audit"]].filter(([c])=>{const s=L[c];return!s||A(s)}).map(([c,s])=>{const o=h===c;return`
  ...
  `}function N(){const t=L[h];if(t&&!A(t))return`<div class="ax-admin-section">${j(t)}</div>`;switch(h){case"commerce":return H();case"users":return I();case"pending":return R();case"health":return D();case"projects":return V();case"executions":return B();case"knowledge":return G();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>';case"audit-log":return'<div id="ax-admin-mount-audit-log" class="ax-admin-section"><p class="ax-muted">Chargement audit log immuable…</p></div>'}}async function _(t){const i=t.querySelector("#ax-admin-mount-bilan");if(i)try{(await $(()=>import("./financial-bilan-DsbJkK34.js"),__vite__mapDeps([0,1,2,3,4]),import.meta.url)).render(i)}catch(o){y.warn("admin","financial-bilan render failed",{err:o}),i.innerHTML='<p class="ax-muted">Bilan indisponible (module ko)</p>'}const c=t.querySelector("#ax-admin-mount-consumption");if(c)try{(await $(()=>import("./consumption-dashboard-C5uergGq.js"),__vite__mapDeps([1,2,3,0,4]),import.meta.url)).render(c)}catch(o){y.warn("admin","consumption-dashboard render failed",{err:o}),c.innerHTML='<p class="ax-muted">Consommation indisponible (module ko)</p>'}const s=t.querySelector("#ax-admin-mount-audit-log");if(s){if(!A("admin.audit-log")){s.innerHTML=j("admin.audit-log");return}try{const{auditLog:o}=await $(async()=>{const{auditLog:a}=await import("./apex-kb-B_UxJsN3.js").then(l=>l.d);return{auditLog:a}},__vite__mapDeps([1,2,3]),import.meta.url);o.init();const r=o.getEntries().slice(-100).reverse(),e=r.map(a=>`<li><code>${n(new Date(a.ts).toLocaleString())}</code> · <strong>${n(a.action)}</strong> · ${n(a.actor||"system")}</li>`).join("");s.innerHTML=`
      ...
      `}catch(o){y.warn("admin","audit-log render failed",{err:o}),s.innerHTML='<p class="ax-muted">Audit log indisponible (module ko)</p>'}}}function G(){const t=f.listRepos(),i=f.getStats(),c=t.map(s=>`
  ...
  `}function K(t){t.querySelectorAll("[data-nav-route]").forEach(e=>{p.bind(e,"click",()=>{d.tap();const a=e.dataset.navRoute??"chat";window.location.hash="#"+a})}),t.querySelectorAll('[data-action="select-all"]').forEach(e=>{p.bind(e,"click",()=>{e.select()})}),t.querySelectorAll("[data-tab]").forEach(e=>{p.bind(e,"click",()=>{d.selection(),h=e.dataset.tab,b(t)})});const i=t.querySelector("#commerce-toggle");i&&p.bind(i,"change",()=>{const e=i.checked;d.medium();const a=t.querySelector(".ax-toggle-label");a&&(a.innerHTML=`Commercialisation ${e?"<strong>ACTIVÉE</strong>":"<strong>désactivée</strong>"}`),S.setEnabled(e),u.success(`Commercialisation ${e?"activée":"désactivée"}`),b(t)});const c=t.querySelector("#create-user-form");c&&p.bind(c,"submit",e=>{e.preventDefault(),O(t)}),t.querySelectorAll("[data-user-plan]").forEach(e=>{p.bind(e,"change",()=>{const a=e.dataset.userPlan??"";a&&(S.setUserPlan(a,e.value),y.info("admin",`Plan ${e.value} → ${a}`))})}),t.querySelectorAll("[data-project-save]").forEach(e=>{p.bind(e,"click",()=>{d.tap();const a=e.dataset.projectSave??"";if(!a)return;const l=t.querySelector(`[data-project-version="${CSS.escape(a)}"]`),m=t.querySelector(`[data-project-status="${CSS.escape(a)}"]`),x=(l?.value??"").trim(),g=m?.value??"active";if(!x){u.warn("Version requise");return}k.update(a,{version:x,status:g})?(d.success(),u.success(`${a} → ${x} (${g})`),y.info("admin",`Project ${a} updated`,{version:x,status:g}),b(t)):(d.error(),u.error("Update échoué"))})}),t.querySelectorAll("[data-confirm-otp]").forEach(e=>{p.bind(e,"click",()=>{d.tap();const a=e.dataset.confirmOtp??"";if(!a)return;const l=C.confirm(a);l.ok?(d.success(),u.success("Compte activé"),y.info("admin",`Confirmed user ${l.uid}`),b(t)):(d.error(),u.error("Code OTP invalide ou expiré"))})}),t.querySelectorAll("[data-exec-cancel]").forEach(e=>{p.bind(e,"click",()=>{d.tap();const a=e.dataset.execCancel??"";if(!a)return;v.cancelExecution(a)?(d.success(),u.success("Exécution annulée"),b(t)):(d.warning(),u.warn("Annulation impossible"))})}),t.querySelectorAll("[data-exec-poll]").forEach(e=>{p.bind(e,"click",()=>{d.tap();const a=e.dataset.execPoll??"";a&&v.pollResult(a).then(l=>{l?(u.success(`Statut : ${l.status}`),b(t)):u.warn("Exécution introuvable")})})});const s=t.querySelector("#add-repo-form");s&&p.bind(s,"submit",e=>{e.preventDefault(),d.tap();const l=t.querySelector("#kb-add-repo")?.value.trim()??"";if(!l){u.warn("Indique un repo");return}const m=f.addRepo(l);m.ok?(d.success(),u.success(`Repo ajouté : ${l}`),b(t)):(d.error(),u.error(m.reason??"Erreur ajout repo"))}),t.querySelectorAll("[data-remove-repo]").forEach(e=>{p.bind(e,"click",()=>{d.tap();const a=e.dataset.removeRepo??"";a&&(f.removeRepo(a),u.success(`Repo retiré : ${a}`),b(t))})});const o=t.querySelector("#kb-search-form");o&&p.bind(o,"submit",e=>{e.preventDefault(),d.tap();const a=t.querySelector("#kb-search-query"),l=t.querySelector("#kb-search-results"),m=a?.value.trim()??"";!m||!l||(l.innerHTML='<p class="ax-muted">Recherche en cours...</p>',f.searchCode(m).then(x=>{if(x.length===0){l.innerHTML='<p class="ax-muted">Aucun résultat (configure ax_github_token pour augmenter la limite).</p>';return}const g=x.slice(0,20).map(w=>`
          ...
          `).join("");l.innerHTML=`<ul class="ax-kb-results-list">${g}</ul>`}))});const r=t.querySelector("#kb-clear-cache");r&&p.bind(r,"click",()=>{d.tap();const e=f.clearCache();u.success(`Cache vidé : ${e.cleared} entrées`),b(t)})}async function O(t){const i=t.querySelector("#cu-name")?.value.trim()??"",c=t.querySelector("#cu-tier")?.value??"family",s=t.querySelector("#cu-email")?.value.trim()??"",o=t.querySelector("#cu-whatsapp")?.value.trim()??"",r=t.querySelector("#cu-pin")?.value??"";if(!i||i.length<2){d.warning(),u.warn("Nom complet requis (min 2 caractères)");return}const e=await T.createUser({name:i,tier:c,...s&&{email:s},...o&&{whatsappPhone:o},...r&&{initialPin:r}}),a=t.querySelector("#create-user-result");if(!a)return;if(!e.ok||!e.uid){d.error();const m=e.reason??"Erreur création";a.innerHTML=`<div class="ax-error">${n(m)}</div>`,u.error(m);return}d.success(),u.success(`Compte ${i} créé`);let l="";if(o){const m=await C.requestConfirmation({uid:e.uid,name:i,whatsappPhone:o});m.ok&&m.inviteLink&&(l=`
  ...
  `,b(t)}let p=null;function ce(){p?.cleanup(),p=null}function b(t){if(p?.cleanup(),p=q("admin"),!P.get("isAdmin")){t.innerHTML=`
      <div class="ax-empty">
        <h2>Accès réservé</h2>
  ...
  `),K(t),h==="bilan"||h==="consumption"){const c=h==="bilan"?"ax-admin-mount-bilan":"ax-admin-mount-consumption",s=t.querySelector(`#${c}`);if(s){const o=s.querySelector("p.ax-muted"),r=o?z(o,"admin-table"):()=>{};_(t).finally(()=>{r()})}else _(t)}}export{ce as dispose,b as render};
