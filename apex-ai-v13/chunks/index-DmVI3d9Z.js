import{e as n}from"./escape-html-BlQj2yEF.js";import{c as k}from"./listener-cleanup-Y2rGGxxX.js";import{s as w,l as f}from"./monitoring-B15B7Ex7.js";import{apexAutonomousMode as d}from"./apex-autonomous-mode-BPE0IMFE.js";import{autonomousWatch as h}from"./autonomous-watch-DliKt1mm.js";import{haptic as A}from"./haptic-CQFg2PXZ.js";import{toast as i}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-9nvgkMCT.js";import"./apex-kb-ghUk2PNK.js";import"./credential-patterns-CLzI061R.js";import"./ai-router-J4cls3jp.js";import"../core/main-DKDAQDRj.js";import"./chat-fallback-BsoFL6Ng.js";import"./apex-tools-dispatch-core-Dv5grOJa.js";import"./apex-tools-dispatch-skills-reMHBMzr.js";import"./apex-tools-dispatch-data-DbZTITXG.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-B1r9w82v.js";import"./apex-tools-misc-BS7DJVJn.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./economy-mode-C3a8YJHf.js";import"./firebase-queue-Dx1HZRfY.js";let c=null,r=null;function Y(){r&&(clearInterval(r),r=null),c?.cleanup(),c=null}function v(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function z(t){if(!t)return`
