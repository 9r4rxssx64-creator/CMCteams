const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-Djd1AM_Y.js","../core/main-58GY0Lk-.js","../assets/css/main-GfJ7qlqs.css","./observability-KzgGviHT.js","./toast-BkOpdP-z.js","./haptic-BUEqXK0N.js"])))=>i.map(i=>d[i]);
import{_ as i,l as g}from"../core/main-58GY0Lk-.js";async function d(e){const{sentinels:s}=await i(async()=>{const{sentinels:t}=await import("./sentinels-Djd1AM_Y.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),n=s.list(),p=n.filter(t=>t.lastResult?.ok).length,x=n.filter(t=>t.lastResult&&!t.lastResult.ok).length,u=n.filter(t=>!t.lastResult).length;e.innerHTML=`
...
//# sourceMappingURL=index-C-B9L9c9.js.map
