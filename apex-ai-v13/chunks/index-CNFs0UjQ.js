import{e as d}from"./escape-html-BlQj2yEF.js";import{c as S}from"./listener-cleanup-Y2rGGxxX.js";import{l as k}from"./monitoring-3uBGKGRH.js";import{s as C}from"../core/main-BHBzMEgW.js";import{f as n}from"./voice-CKlB4PWs.js";import{haptic as c}from"./haptic-CQFg2PXZ.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./apex-kb-BUdkXo7X.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DfTeMbTC.js";const A={studio:"🎨 Studios",pro:"💼 Modules Pro",voice:"🎙 Voix",browser:"🌐 Browser",sentinel:"🛡 Sentinelles",tool:"🛠 Outils IA",auth:"🔐 Authentification",admin:"👑 Admin",module:"📦 Modules"};let b="",l=null;function J(){m?.cleanup(),m=null}function Q(){b="",l=null}function z(){try{const e=localStorage.getItem("ax_users_v13");if(e){const t=JSON.parse(e);if(Array.isArray(t))return t.filter(r=>typeof r?.id=="string"&&typeof r?.name=="string").map(r=>({id:r.id,name:r.name}))}}catch{}return[{id:"kdmc_admin",name:"Kevin DESARZENS (admin)"},{id:"laurence_sp",name:"Laurence SAINT-POLIT"}]}function U(e){const t=n.list();if(!e.trim())return t;const r=e.toLowerCase().trim();return t.filter(a=>a.id.toLowerCase().includes(r)||a.description.toLowerCase().includes(r)||a.category.toLowerCase().includes(r))}function F(e){const t=new Map;for(const r of e){const a=t.get(r.category)??[];a.push(r),t.set(r.category,a)}return t}function O(e){const t=l?n.isEnabledForUser(e.id,l):n.isEnabledGlobal(e.id),r=d(e.id),a=d(e.description);return`
