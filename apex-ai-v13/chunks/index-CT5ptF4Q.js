import{l as k,b as A,e as w}from"./monitoring-DE8tOht_.js";import{c as S}from"./listener-cleanup-Y2rGGxxX.js";import{voicePrint as c}from"./voice-print-BTT_1Kj-.js";import{g as C}from"./apex-tools-dispatch-core-D6rxfL3c.js";import{haptic as z}from"./haptic-CQFg2PXZ.js";import{toast as u}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-y_3vQuz1.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BHH7h7Vp.js";import"./apex-tools-dispatch-skills-DZginb9y.js";import"./apex-tools-dispatch-data-mQRnG16N.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-7oRLqSu5.js";import"./apex-tools-misc-C0BUnpd1.js";import"./apex-tools-registry-core-48oOK-KS.js";import"./apex-tools-registry-skills-x-mAWYry.js";const M="kdmc_admin";let m=null;function W(){m?.cleanup(),m=null}function y(e){if(!e||e===0)return"—";const i=new Date(e),a=t=>t.toString().padStart(2,"0");return`${a(i.getDate())}/${a(i.getMonth()+1)}/${i.getFullYear()} ${a(i.getHours())}:${a(i.getMinutes())}`}function b(e){return Math.round(e*100)+"%"}function _(){const e=A.get("user");return!e||!e.id?null:{id:e.id,name:e.name??"",isAdmin:e.id===M}}function x(e,i,a,t){i&&e.bind(i,a,t)}function D(e){const i=Math.max(0,Math.min(1,e))*100,a=i>=85?"#22c55e":i>=50?"#ffa500":"#ff6666";return`
