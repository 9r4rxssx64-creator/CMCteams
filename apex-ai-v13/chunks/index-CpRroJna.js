...
import{_ as b}from"./apex-kb-GVSoM0ek.js";import{e as p}from"./escape-html-BlQj2yEF.js";import{c as S}from"./listener-cleanup-Y2rGGxxX.js";import{l as A}from"./monitoring-CDiFHg4q.js";import{A as f,s as P}from"./auto-improvement-core-BPELCE_U.js";import"./credential-patterns-ClK5OHi0.js";import"./multi-source-analyze-KNqxsI4v.js";let g=null;function z(){g?.cleanup(),g=null}const T={critical:'<span class="ax-gs-13">🔥 CRITICAL</span>',high:'<span class="ax-gs-14">⭐ HIGH</span>',medium:'<span class="ax-gs-44">○ MEDIUM</span>',low:'<span class="ax-gs-25">— LOW</span>'},_={installed:'<span class="ax-gs-14">🟢 Installé</span>',available:'<span class="ax-gs-139">⚪ Disponible</span>',"unsupported-pwa":'<span class="ax-gs-13">🔴 Non-PWA</span>',planned:'<span style="color:#aa8">🟡 Planifié</span>'},F={"dev-tools":"🛠 Dev Tools",lsp:"📝 LSP (langage)",database:"🗄 Database",cloud:"☁ Cloud",deployment:"🚀 Deployment",monitoring:"📊 Monitoring",security:"🛡 Security",productivity:"✨ Productivity",design:"🎨 Design",api:"🔌 API",search:"🔍 Search","vector-rag":"🧠 Vector RAG",payment:"💳 Payment",messaging:"💬 Messaging",social:"📱 Social",auth:"🔐 Auth","ai-ml":"🤖 AI/ML",analytics:"📈 Analytics",mobile:"📱 Mobile",browser:"🌐 Browser",content:"📁 Content",data:"💾 Data",memory:"🧬 Memory",voice:"🎙 Voice",workflow:"⚙ Workflow",observability:"👁 Observability",testing:"🧪 Testing",location:"📍 Location",finance:"💰 Finance",creator:"🎬 Creator",learning:"📚 Learning"},a={search:"",categoryFilter:"all",statusFilter:"all",pwaOnly:!0,view:"marketplace",extendedTypeFilter:"all",extendedCompatFilter:"all",extendedValueFilter:"all",extendedSortBy:"value"},h={"mcp-server":"🧩 MCP Server","mcp-aggregator":"🌐 MCP Aggregator","claude-skill":"🎯 Claude Skill","claude-hook":"🪝 Claude Hook","claude-command":"⌨ Claude Command","claude-subagent-orchestrator":"🤖 Subagent Orchestrator","agent-framework":"🏗 Agent Framework","browser-api":"🌍 Browser API","web-tool":"🛠 Web Tool","github-action":"⚙ GitHub Action","tooling-cli":"⌨ CLI Tooling","status-line":"📊 Status Line","pwa-capability":"📱 PWA Capability"},$={"pwa-direct":"🟢 PWA Direct","cloudflare-worker":"🟡 CF Worker","node-required":"🔴 Node Only","native-only":"⛔ Native Only"},L={high:'<span class="ax-gs-14">⭐ HIGH</span>',medium:'<span class="ax-gs-44">○ MEDIUM</span>',low:'<span class="ax-gs-25">— LOW</span>'};async function r(e){if(g?.cleanup(),g=S("plugins"),a.view==="extended"){await I(e);return}const{apexPluginsMarketplace:o}=await b(async()=>{const{apexPluginsMarketplace:s}=await import("./apex-plugins-marketplace-cj6LQccR.js");return{apexPluginsMarketplace:s}},__vite__mapDeps([0,1,2,3]),import.meta.url),c=o.getStats(),m=o.getCategories();let n;a.search.trim()?n=o.search(a.search,100):n=o.list({...a.categoryFilter!=="all"&&{category:a.categoryFilter},...a.statusFilter!=="all"&&{status:a.statusFilter},pwaOnly:a.pwaOnly});const u=o.recommendForUser({minValue:"high",max:6});e.innerHTML=`
    <div class="ax-page ax-gs-268">
      ...
      <div class="ax-gs-67">
        ...
        <button id="ax-plg-tab-extended" class="ax-btn ax-gs-411">🌐 Extended Catalog (${f.length}+)</button>
      </div>
      <p class="ax-gs-385">
  ...
  `}export{z as dispose,r as render};
