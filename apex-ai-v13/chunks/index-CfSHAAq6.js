const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-W8GOXAde.js","./monitoring-BurevTV9.js","./multi-source-analyze-tqKS13-U.js","./credential-patterns-CLzI061R.js","./auth-KGSTPNiL.js"])))=>i.map(i=>d[i]);
import{_ as g}from"./apex-kb-W8GOXAde.js";import{b as _,r as f}from"../core/main-ePTB0HrP.js";import{a as x}from"./escape-html-DGIYNPKb.js";import{c as b}from"./listener-cleanup-Y2rGGxxX.js";import{auth as y}from"./auth-KGSTPNiL.js";import{i as h}from"./apex-tools-dispatch-core-BU1DMgwl.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import{toast as m}from"./toast-CRdbcLoc.js";import"./monitoring-BurevTV9.js";import"./multi-source-analyze-tqKS13-U.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-DDiE-KLE.js";import"./apex-tools-dispatch-data-lZib1boO.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-BpXPfFgq.js";import"./apex-tools-misc-rUAS_FQK.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let c=null;function O(){c?.cleanup(),c=null}function S(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}async function I(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),d=localStorage.getItem("apex_v13_last_known_name");let o=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!d)return!1;if(!o&&(localStorage.getItem("apex_v13_pin")!==null||localStorage.getItem(`apex_v13_pin_${e}`)!==null))try{const{deviceContext:p}=await g(async()=>{const{deviceContext:i}=await import("./device-context-DUl6foXW.js");return{deviceContext:i}},__vite__mapDeps([0,1,2,3]),import.meta.url),t=await p.getFingerprint();localStorage.setItem("apex_v13_device_trusted_v1",t.device_id),o=t.device_id}catch{}if(!o)return!1;const{deviceContext:n}=await g(async()=>{const{deviceContext:l}=await import("./device-context-DUl6foXW.js");return{deviceContext:l}},__vite__mapDeps([0,1,2,3]),import.meta.url);if((await n.getFingerprint()).device_id!==o)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:a}=await g(async()=>{const{auth:l}=await import("./auth-KGSTPNiL.js");return{auth:l}},__vite__mapDeps([4,0,1,2,3]),import.meta.url);if((await a.loginTrusted(e,d)).ok)return f.navigate("chat"),!0}catch{}return!1}function J(e){if(c?.cleanup(),c=b("landing"),!h("module.landing")){e.innerHTML=`
