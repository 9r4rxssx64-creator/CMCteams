const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-8ONkQICG.js","../core/main-afL8CEyE.js","../assets/css/main-Bng3LWQS.css","./observability-JSmwQ-6E.js"])))=>i.map(i=>d[i]);
import{_ as l,l as r}from"../core/main-afL8CEyE.js";async function n(a){const{sentinels:s}=await l(async()=>{const{sentinels:t}=await import("./sentinels-8ONkQICG.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),e=s.list();a.innerHTML=`
...
//# sourceMappingURL=index-dfptwiPL.js.map
