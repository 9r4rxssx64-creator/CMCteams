import{a as s}from"./escape-html-DGIYNPKb.js";import{C as x,q as m}from"./monitoring-BurevTV9.js";import{r as f}from"./apex-tools-dispatch-skills-DDiE-KLE.js";import{mcpRegistry as c}from"./mcp-registry-Cg9m5RIy.js";import{skillsWatch as g}from"./skills-watch-DwtrFJI6.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-tqKS13-U.js";import"./apex-kb-W8GOXAde.js";import"./credential-patterns-CLzI061R.js";import"./haptic-CQFg2PXZ.js";function b(t){const l={alive:{color:"#10b981",emoji:"🟢"},dead:{color:"#ef4444",emoji:"🔴"},unknown:{color:"#94a3b8",emoji:"⚪"}},a=l[t]??l.unknown;return`<span style="color:${a.color};font-weight:600">${a.emoji} ${s(t)}</span>`}function p(t){if(!(x.get("isAdmin")===!0)){t.innerHTML='<div class="ax-gs-37">🔒 Réservé admin Kevin</div>';return}c.init();const a=c.list(),d=g.getLastReport("mcp-health-watch"),u=a.map(e=>{const r=e.toolsExposed?.length??0,i=e.lastCheck?new Date(e.lastCheck).toLocaleString("fr-FR"):"jamais";return`
