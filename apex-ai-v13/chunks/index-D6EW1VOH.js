import{e as r}from"./monitoring-fMxsG2JS.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-yn2Ob13y.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-COMTKZql.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-o11DN4-n.js";import"./kevin-alerts-Q19k3cLQ.js";import"./whatsapp-B4CR9Qra.js";import"./auth-gate-DfXyyr5r.js";import"./auth-B2gwi2Uz.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
