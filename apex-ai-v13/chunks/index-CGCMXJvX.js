import{e as r}from"./monitoring-DeFE_M1W.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-Dz0CX0jy.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-CcNp-QOw.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-C2H3mA7V.js";import"./kevin-alerts-DlOniHyo.js";import"./whatsapp-C9b_gCUe.js";import"./auth-gate-DpitDXnX.js";import"./auth-BanGSOkS.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
