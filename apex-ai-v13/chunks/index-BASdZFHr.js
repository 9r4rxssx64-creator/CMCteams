import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-DNycjZCb.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-ClsF1KRZ.js";import"./monitoring-3uBGKGRH.js";import"./apex-kb-C9hRSKUD.js";import"./credential-patterns-guxfirLX.js";import"./auth-gate-8_5SG1TX.js";import"../core/main-ByHiWHkb.js";import"./multi-source-analyze-5mE27jG7.js";import"./commerce-mpB0VTfo.js";import"./kevin-alerts-CKPxgzTO.js";import"./whatsapp-R6vrDTuP.js";let r=null;function P(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function f(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function C(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
