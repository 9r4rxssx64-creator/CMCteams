import{e as l}from"./escape-html-BlQj2yEF.js";import{c as b}from"./listener-cleanup-Y2rGGxxX.js";import{l as v}from"./monitoring-3uBGKGRH.js";import{s as m,r as y}from"../core/main-BHBzMEgW.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as c}from"./toast-CRdbcLoc.js";import"./apex-kb-BUdkXo7X.js";import"./voice-CKlB4PWs.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DfTeMbTC.js";let r=null,i=1;const x=5,t={name:"",permissionsRequested:!1,capabilities:new Set(["chat","voice","studios"]),mode:"both",done:!1},h=[{id:"chat",label:"💬 Chat IA",desc:"Conversation Claude"},{id:"voice",label:"🎙 Voix",desc:"Dictée + lecture"},{id:"studios",label:"🎨 Studios",desc:"Music/Video/Logo"},{id:"browser",label:"🌐 Browser",desc:"Navigation embed"},{id:"pro",label:"💼 Pro modules",desc:"Cuisine/Médical/Légal"},{id:"crypto",label:"🪙 Crypto",desc:"Wallets + tracking"},{id:"domotique",label:"🏠 Domotique",desc:"Maison connectée"},{id:"remote",label:"📺 Remote TV",desc:"Télécommande univ."}];function N(){r?.cleanup(),r=null}function O(e){if(!e||e==="kdmc_admin")return!1;try{return localStorage.getItem(`apex_v13_onboarding_done_${e}`)!=="true"}catch{return!1}}function z(e){try{localStorage.setItem(`apex_v13_onboarding_done_${e}`,"true"),t.done=!0,v.info("onboarding",`Marked done for uid=${e}`)}catch{}}async function j(e){r?.cleanup(),r=b("onboarding");const a=m.get("user");a?.name&&(t.name=a.name),p(e)}function p(e){const a=`
