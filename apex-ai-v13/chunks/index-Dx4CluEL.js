const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-CtV4Dp-9.js","./apex-tools-dispatch-CXM2s4gu.js","./monitoring-B17vNBOa.js","./apex-tools-registry-BIPGSzE6.js","./sentinels-registry-Cy0nWO9q.js","./toast-Dgg9rcIP.js","./haptic-BUEqXK0N.js"])))=>i.map(i=>d[i]);
import{_ as l}from"./apex-tools-dispatch-CXM2s4gu.js";import{l as f}from"./monitoring-B17vNBOa.js";import"./apex-tools-registry-BIPGSzE6.js";async function c(a){const{sentinels:s}=await l(async()=>{const{sentinels:t}=await import("./sentinels-CtV4Dp-9.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),{sentinelsRegistry:u,bootstrapSentinelsRegistry:m}=await l(async()=>{const{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}=await import("./sentinels-registry-Cy0nWO9q.js");return{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}},__vite__mapDeps([4,1,2,3,0]),import.meta.url);m();const n=s.list(),y=u.getStatus(),r=u.getMetrics(),x=n.filter(t=>t.lastResult?.ok).length,g=n.filter(t=>t.lastResult&&!t.lastResult.ok).length,b=n.filter(t=>!t.lastResult).length;a.innerHTML=`
...
//# sourceMappingURL=index-Dx4CluEL.js.map
