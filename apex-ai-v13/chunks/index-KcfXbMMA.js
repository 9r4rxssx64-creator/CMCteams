const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-D5Xt67ca.js","./monitoring-COuO8_T4.js","./multi-source-analyze-DXDFY8kk.js","./credential-patterns-DUMYZEMu.js"])))=>i.map(i=>d[i]);
import{b as S,l as _,e as s,_ as y}from"./monitoring-COuO8_T4.js";import{c as T}from"./listener-cleanup-Y2rGGxxX.js";import{credentialsAudit as k}from"./credentials-audit-B9RaSKVF.js";import{haptic as f}from"./haptic-CQFg2PXZ.js";import{toast as p}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DXDFY8kk.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-D5Xt67ca.js";let u=null,m=null,v="all";function j(){u?.cleanup(),u=null}const h={ok:{color:"#22cc77",icon:"🟢",label:"OK"},missing:{color:"#888",icon:"⚪",label:"Non config"},corrupted:{color:"#ff6b6b",icon:"🔴",label:"Corrompu"},expired:{color:"#ffaa00",icon:"🟠",label:"Expiré"},unknown:{color:"#aaa",icon:"❓",label:"Inconnu"},decrypt_failed:{color:"#ff6b6b",icon:"🔒",label:"Illisible"}},$={all:"Tous",ai:"🤖 IA",banking:"🏦 Banque",payment:"💳 Paiement",social:"📱 Social",email:"📧 Email",crypto:"₿ Crypto",hosting:"☁️ Hosting",productivity:"📋 Productivité",forbidden:"⚠️ Forbidden"};async function A(e){if(!(S.get("isAdmin")===!0)){e.innerHTML=`
      <div class="ax-gs-21">
