import{e as r}from"./monitoring-BbdBi1b1.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-D7nyp5DR.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-B8u3EwnB.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DViLrCq9.js";import"./kevin-alerts-BQ0Qxlym.js";import"./whatsapp-BEBcMcun.js";import"./auth-gate-Dlek5I2O.js";import"./auth-CaqcsDbS.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
