const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-CVNa_bDy.js","./multi-source-analyze-DcE_fU1o.js","./apex-kb-D6HNcQyl.js","./credential-patterns-CLzI061R.js","./auth-DM-ilRVT.js"])))=>i.map(i=>d[i]);
import{_ as p}from"./apex-kb-D6HNcQyl.js";import{a as u}from"./escape-html-DGIYNPKb.js";import{c as E}from"./listener-cleanup-Y2rGGxxX.js";import{C as I,q as z}from"./monitoring-CVNa_bDy.js";import{c as O}from"./csp-style-helper-BisGRi53.js";import{r as D}from"./recharge-action-ZBY-wwbv.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DcE_fU1o.js";let o=null;function K(){o?.cleanup(),o=null}const P="apex_v13_chat_auto_read";function V(){try{return localStorage.getItem(P)==="1"}catch{return!1}}function q(i){try{localStorage.setItem(P,i?"1":"0")}catch{}}async function R(i){try{const k=await p(()=>import("./voice-CTADTwOB.js"),__vite__mapDeps([0,1,2,3]),import.meta.url),{listVoices:A,getActiveVoice:x,setActiveVoice:m,speak:v,stopAll:g}=k,_=i.querySelector("#ax-settings-auto-read"),S=i.querySelector("#ax-voice-current"),w=i.querySelector("#ax-voice-list"),L=i.querySelectorAll(".ax-voice-cat-btn");if(!w)return;_&&(_.checked=V(),o.bind(_,"change",()=>{q(_.checked),(async()=>{const{toast:l}=await p(async()=>{const{toast:d}=await import("./toast-CRdbcLoc.js");return{toast:d}},[],import.meta.url);l.success(_.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const T=()=>{if(!S)return;const l=x(),b=A().find(h=>h.id===l);S.textContent=b?`Voix active : ${b.emoji??"🔊"} ${b.name} (${b.category})`:`Voix active : ${l}`};T();const $=l=>{const d=A(),b=l==="all"?d:d.filter(t=>t.category===l),h=x();w.setAttribute("aria-busy","false"),w.innerHTML=b.map(t=>{const s=t.id===h,a=t.emoji??(t.category==="pro"?"🎙️":t.category==="fun"?"🎉":"🎨"),e=t.description?u(t.description):"";return`
