import{l as c}from"./monitoring-3uBGKGRH.js";import{x as u}from"./apex-tools-dispatch-BKpsVKwY.js";import{toast as o}from"./toast-ClsF1KRZ.js";import"./apex-kb-Doy2WCFb.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-7Bgz4LbE.js";import"./apex-tools-registry-sVFRrUrs.js";import"./voice-DorbG-wZ.js";import"./haptic-CQFg2PXZ.js";function s(r){return r.replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l]??l)}function v(r){r.innerHTML=`
...
`).map(e=>e.trim()).filter(Boolean).map(e=>e.split(",").map(t=>{const a=t.trim(),n=Number(a);return!isNaN(n)&&a!==""?n:a}));if(i.length===0){o.error("Aucune donnée à exporter");return}o.info("Génération en cours...");try{const e=await u.generate({filename:l,sheets:[{name:p,data:i,freezeHeader:x}]}),t=r.querySelector("#xlsx-result");if(!t)return;e.success?(t.innerHTML=`
          ...
          </div>`,o.success(`✅ ${e.filename}`)):(t.innerHTML=`<p style="color:#ef4444">❌ ${s(e.error??"Erreur")}</p>`,o.error(`❌ ${e.error??"Erreur"}`))}catch(e){c.warn("studio-xlsx","failed",{err:e}),o.error(`❌ ${e instanceof Error?e.message:"Erreur"}`)}})}export{v as render};
