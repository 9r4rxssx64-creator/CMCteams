import{a as n}from"./escape-html-DGIYNPKb.js";import{c as k}from"./listener-cleanup-Y2rGGxxX.js";import{C as w,q as f}from"./monitoring-BkJ_WZbY.js";import{apexAutonomousMode as d}from"./apex-autonomous-mode-D6vXLLnE.js";import{autonomousWatch as h}from"./autonomous-watch-DfvMVd-Y.js";import{haptic as A}from"./haptic-CQFg2PXZ.js";import{toast as i}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DCjiC-qU.js";import"./apex-kb-C132uqD8.js";import"./credential-patterns-CLzI061R.js";import"./ai-router-CgHPC8vx.js";import"../core/main-BxOBg3Le.js";import"./chat-fallback-Cf8SYo4c.js";import"./apex-tools-dispatch-core-BHo3mwX7.js";import"./apex-tools-dispatch-skills-sOPz5fsK.js";import"./apex-tools-dispatch-data-hMaZjSXL.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-DoPKpcyI.js";import"./apex-tools-misc-C4sFgDRb.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./economy-mode-kumrG-wW.js";import"./firebase-queue-Dc7mnuwH.js";let c=null,r=null;function Y(){r&&(clearInterval(r),r=null),c?.cleanup(),c=null}function v(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function z(t){if(!t)return`
