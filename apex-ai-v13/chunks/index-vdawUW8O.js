const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-DMtdadhB.js","./apex-kb-BkV0oRt_.js","./credential-patterns-CLzI061R.js","./multi-source-analyze-g7IW7swn.js","./auth-Co2YQc4d.js","../assets/css/main-BjtUc25U.css"])))=>i.map(i=>d[i]);
import{_ as p}from"./apex-kb-BkV0oRt_.js";import{a as u}from"./escape-html-DGIYNPKb.js";import{c as E}from"./listener-cleanup-Y2rGGxxX.js";import{l as T}from"./monitoring-DMtdadhB.js";import{i as I}from"../core/main-Dtvg1vb1.js";import{c as O}from"./csp-style-helper-BisGRi53.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-g7IW7swn.js";let i=null;function W(){i?.cleanup(),i=null}const P="apex_v13_chat_auto_read";function D(){try{return localStorage.getItem(P)==="1"}catch{return!1}}function V(n){try{localStorage.setItem(P,n?"1":"0")}catch{}}async function R(n){try{const k=await p(()=>import("./voice-C-fda8ME.js").then(l=>l.v),__vite__mapDeps([0,1,2]),import.meta.url),{listVoices:S,getActiveVoice:x,setActiveVoice:f,speak:m,stopAll:b}=k,w=n.querySelector("#ax-settings-auto-read"),z=n.querySelector("#ax-voice-current"),_=n.querySelector("#ax-voice-list"),L=n.querySelectorAll(".ax-voice-cat-btn");if(!_)return;w&&(w.checked=D(),i.bind(w,"change",()=>{V(w.checked),(async()=>{const{toast:l}=await p(async()=>{const{toast:d}=await import("./toast-CRdbcLoc.js");return{toast:d}},[],import.meta.url);l.success(w.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const A=()=>{if(!z)return;const l=x(),g=S().find(h=>h.id===l);z.textContent=g?`Voix active : ${g.emoji??"🔊"} ${g.name} (${g.category})`:`Voix active : ${l}`};A();const $=l=>{const d=S(),g=l==="all"?d:d.filter(e=>e.category===l),h=x();_.innerHTML=g.map(e=>{const a=e.id===h,o=e.emoji??(e.category==="pro"?"🎙️":e.category==="fun"?"🎉":"🎨"),t=e.description?u(e.description):"",r=a?"background:rgba(232,184,48,0.15);border-color:rgba(232,184,48,0.45)":"background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.06)";return`
