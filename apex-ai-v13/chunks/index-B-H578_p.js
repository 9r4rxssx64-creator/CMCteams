import{e as r}from"./monitoring-8ioY434g.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-D88uWeay.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DkniHD_x.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DGzz0lus.js";import"./kevin-alerts-CfJSSEOb.js";import"./whatsapp-Ci3hihWC.js";import"./auth-gate-CZJjmnzF.js";import"./auth-DEhlrH5G.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
