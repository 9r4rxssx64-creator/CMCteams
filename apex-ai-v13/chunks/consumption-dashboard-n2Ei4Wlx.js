import{consumptionMonitor as i}from"./consumption-monitor-BHna91Uh.js";import"./monitoring-675b-Ybt.js";import"./apex-tools-registry-oQuNaPP9.js";import"./links-registry-C0ncmn8i.js";import"./apex-tools-dispatch-B5F6KHQD.js";import"./push-notifications-D763BIep.js";import"./tokens-dashboard-C5ZzZyK6.js";function d(a){const t=a.severity==="critical"?"#ff4444":a.severity==="warn"?"#ffaa00":"#22cc77",n=Math.min(100,a.pct_used);return`
  ...
  `}function b(a){const t=i.formatForUI(),n=t.services.map(d).join(""),e=t.total_alerts>0?`<div class="ax-banner-alert">⚠️ ${t.total_alerts} service${t.total_alerts>1?"s":""} en alerte — recharger vite</div>`:'<div class="ax-banner-ok">✅ Tous services dans les budgets</div>';a.innerHTML=`
  ...
  `,a.addEventListener("click",r=>{const s=r.target,c=s.closest('[data-action="upgrade-plans"]')?.dataset.target;if(c){const o=a.querySelector("#ax-consumption-modal-mount");o&&(o.innerHTML=l(c))}if(s.closest('[data-action="close-modal"]')){const o=a.querySelector("#ax-consumption-modal-mount");o&&(o.innerHTML="")}})}export{b as render};
//# sourceMappingURL=consumption-dashboard-n2Ei4Wlx.js.map
