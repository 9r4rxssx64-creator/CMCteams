import{e as s}from"./escape-html-BlQj2yEF.js";import{c as p}from"./listener-cleanup-Y2rGGxxX.js";import{l as c}from"./monitoring-3uBGKGRH.js";import{s as x}from"../core/main-DfBAVUzk.js";import{g as u}from"./apex-tools-dispatch-core-CDO8VC2i.js";import{haptic as b}from"./haptic-CQFg2PXZ.js";import"./apex-kb-DNf_z_6Q.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-BhbXkTSb.js";import"./apex-tools-dispatch-skills-DXNQRXOS.js";import"./apex-tools-dispatch-data-CXmoy5wJ.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-DyMSQAy8.js";import"./apex-tools-misc-DvXoGjTJ.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./voice-Dkn5kX58.js";let l=null;function R(){l?.cleanup(),l=null}const f=[{num:"DTU 13.3",titre:"Dallages — conception, calcul, exécution",domaine:"Béton"},{num:"DTU 20.1",titre:"Ouvrages en maçonnerie de petits éléments",domaine:"Maçonnerie"},{num:"DTU 21",titre:"Exécution des ouvrages en béton",domaine:"Béton"},{num:"DTU 25.1",titre:"Enduits intérieurs en plâtre",domaine:"Plâtre"},{num:"DTU 25.41",titre:"Plaques de plâtre",domaine:"Plaque"},{num:"DTU 26.1",titre:"Enduits aux mortiers de ciments / chaux",domaine:"Enduit"},{num:"DTU 31.1",titre:"Charpentes et escaliers en bois",domaine:"Bois"},{num:"DTU 36.5",titre:"Mise en œuvre des fenêtres et portes extérieures",domaine:"Menuiserie"},{num:"DTU 39",titre:"Vitrerie / miroiterie",domaine:"Vitrage"},{num:"DTU 40.11",titre:"Couverture en ardoises",domaine:"Couverture"},{num:"DTU 43.1",titre:"Étanchéité des toitures-terrasses",domaine:"Étanchéité"},{num:"DTU 70.1",titre:"Installations électriques résidentielles",domaine:"Électricité"}],h=[{element:"Porte intérieure",dimensions:"L 73/83/93 × H 204 cm",norme:"NF P 23-501"},{element:"Porte d'entrée",dimensions:"L 90 × H 215 cm",norme:"NF P 23-501"},{element:"Fenêtre 1 vantail",dimensions:"L 60-100 × H 75-115 cm",norme:"NF P 24-101"},{element:"Fenêtre 2 vantaux",dimensions:"L 100-160 × H 95-145 cm",norme:"NF P 24-101"},{element:"Allège fenêtre",dimensions:"H ≥ 90 cm depuis sol",norme:"NF P 01-012"},{element:"Garde-corps balcon",dimensions:"H ≥ 100 cm",norme:"NF P 01-012"},{element:"Garde-corps escalier",dimensions:"H 90 cm",norme:"NF P 01-012"},{element:"Hauteur sous plafond",dimensions:"≥ 240 cm (FR), ≥ 230 cm (Monaco)",norme:"CCH R.111-1-1"},{element:"Marche escalier (giron)",dimensions:"24-32 cm",norme:"Échelle Blondel"},{element:"Marche escalier (hauteur)",dimensions:"16-20 cm",norme:"Échelle Blondel"},{element:"Largeur escalier",dimensions:"≥ 80 cm (résidentiel)",norme:"NF P 21-211"},{element:"Plinthe",dimensions:"H 5-10 cm",norme:"Standard"}];function g(e,t,n){return!isFinite(e)||e<=0||!isFinite(t)||t<=0||!isFinite(n)||n<=0?null:{surface_m2:Math.round(e*t*100)/100,perimetre_m:Math.round(2*(e+t)*100)/100,volume_m3:Math.round(e*t*n*100)/100,plinthe_ml:Math.round(2*(e+t)*100)/100}}function y(e,t,n){if(e<=0||t<=0)return"";const o=360,i=Math.min(o/e,o/t,60),d=Math.round(e*i),a=Math.round(t*i),r=30,m=30;return`
  ...
  `}function V(e){l?.cleanup(),l=p("studios-building");const t=x.get("user")?.id??"anon";if(!u("studio.building",e,t))return;const n=f.map(i=>`
  ...
  `,v(e)}function v(e){const t=e.querySelector("#ax-bld-go"),n=e.querySelector("#ax-bld-out");!t||!n||!l||(l.bind(t,"click",()=>{b.tap();const o=parseFloat(e.querySelector("#ax-bld-l")?.value??""),i=parseFloat(e.querySelector("#ax-bld-w")?.value??""),d=parseFloat(e.querySelector("#ax-bld-h")?.value??""),a=(e.querySelector("#ax-bld-name")?.value??"Pièce").slice(0,40),r=g(o,i,d);if(!r){n.innerHTML='<div style="color:#ff8866">Dimensions invalides.</div>';return}n.innerHTML=`
      ${y(o,i,a)}
...
Plinthes : ${r.plinthe_ml} mL</pre>
    `}),c.info("studios-building","rendered"))}export{f as DTU_REFS,h as STANDARD_DIMS,g as calcMetre,R as dispose,V as render,y as svgPlanView};
