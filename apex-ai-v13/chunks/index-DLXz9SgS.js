import{e as r}from"./monitoring-C7JL14z6.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-D2hwK2_l.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-Bgv04NSw.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DztbJA7B.js";import"./kevin-alerts-BUs1qOEf.js";import"./whatsapp-ghFGe1Dh.js";import"./auth-gate-DgKSrOKb.js";import"./auth-CieLnH97.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
