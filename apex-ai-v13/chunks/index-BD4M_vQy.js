import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-C98ifBWM.js";import{h as d}from"./haptic-BUEqXK0N.js";import{toast as s}from"./toast-Dgg9rcIP.js";import"./monitoring-BAiQJoxJ.js";import"./apex-tools-registry-DqA3gZXO.js";import"./apex-kb-BFHUv3jX.js";import"./credential-patterns-Dy6Wjk7e.js";import"./auth-gate-ja4Cg9PS.js";import"../core/main-7dJ72G_o.js";import"./multi-source-analyze-DAvdcAQw.js";import"./commerce-C5M8cU1x.js";import"./kevin-alerts-CDvGabxb.js";import"./whatsapp-BIW5kwXA.js";let r=null;function C(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function m(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function D(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
  ...
  `,f(e)}function c(e,t){const i=`${e.prenom} ${e.nom}`,a=new Date(e.createdAt).toLocaleString("fr-FR"),p=e.status==="approved"?{color:"#10b981",label:"✅ Approuvé"}:e.status==="rejected"?{color:"#ef4444",label:"❌ Refusé"}:e.status==="expired"?{color:"#888",label:"⏰ Expiré"}:{color:"#c9a227",label:"⏳ En attente"};return`
  ...
  `}function f(e){r&&(e.querySelectorAll(".signup-approve-client").forEach(t=>{r.bind(t,"click",()=>{const i=t.dataset.id;i&&(d.tap(),u(e,i,"client"))})}),e.querySelectorAll(".signup-approve-family").forEach(t=>{r.bind(t,"click",()=>{const i=t.dataset.id;i&&(d.tap(),u(e,i,"family"))})}),e.querySelectorAll(".signup-reject").forEach(t=>{r.bind(t,"click",()=>{const i=t.dataset.id;i&&(d.medium(),g(e,i))})}))}async function u(e,t,i){const a=await o.approveSignup({requestId:t,type:i,adminUid:"kdmc_admin"});a.ok?(s.success(`✅ Approuvé ${i==="family"?"(famille)":"(client)"} → uid ${a.uid?.slice(0,16)??"?"}`),l(e)):s.error(a.reason??"Erreur approval")}async function g(e,t){const i=prompt("Raison du refus (sera visible client) :");if(!i)return;const a=await o.rejectSignup({requestId:t,adminUid:"kdmc_admin",reason:i});a.ok?(s.success("Demande rejetée"),l(e)):s.error(a.reason??"Erreur reject")}export{C as dispose,D as render};
