import{e as s}from"./escape-html-BlQj2yEF.js";import{c as $}from"./listener-cleanup-Y2rGGxxX.js";import{l as f}from"./monitoring-3uBGKGRH.js";import{s as w}from"../core/main-1zxfPgC1.js";import{apexAutonomousMode as p}from"./apex-autonomous-mode-DWIIlsZQ.js";import{autonomousWatch as h}from"./autonomous-watch-ByC6kbV-.js";import{haptic as z}from"./haptic-CQFg2PXZ.js";import{toast as n}from"./toast-CRdbcLoc.js";import"./apex-kb-BL-mRJI7.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-CDRNXpkc.js";import"./ai-router-BqJuBJqs.js";import"./chat-fallback-CUBOhbWa.js";import"./voice-BQ1FH04d.js";import"./economy-mode-BkvrYZaX.js";import"./tokens-dashboard-C5ZzZyK6.js";import"./firebase-queue-CjWU0Wt3.js";let l=null,i=null;function _(){i&&(clearInterval(i),i=null),l?.cleanup(),l=null}function y(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function A(t){if(!t)return`
