import{e as r}from"./monitoring-BQbiUTkF.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DUSea-dN.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-JCoCFUdV.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-D6z-UVRr.js";import"./kevin-alerts-B6XQ4Xiq.js";import"./whatsapp-BxDcMLDZ.js";import"./auth-gate-C8KcLATK.js";import"./auth-CLu1Vj2k.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
