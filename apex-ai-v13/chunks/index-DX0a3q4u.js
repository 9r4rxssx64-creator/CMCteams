...
• Point 3`}];function q(t){function p(){return r.map((a,s)=>`<div style="background:#0f172a;border:1px solid #1e293b;border-radius:8px;padding:12px;margin-bottom:10px">
            ...
            <textarea data-slide-content="${s}" rows="3" placeholder="Contenu (bullets)" style="width:100%;padding:8px;background:#1e293b;border:1px solid #334155;border-radius:4px;color:#f1f5f9;font-size:16px;resize:vertical">${l(a.content)}</textarea>
