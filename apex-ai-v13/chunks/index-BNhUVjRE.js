import{l as f}from"./monitoring-3uBGKGRH.js";import{s as m}from"./apex-tools-dispatch-skills-BV9-W1kV.js";import{toast as i}from"./toast-ClsF1KRZ.js";import"./apex-kb-Dx00IPob.js";import"./credential-patterns-CLzI061R.js";import"./haptic-CQFg2PXZ.js";function a(t){return t.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]??o)}const u=[{id:"invoice",label:"Facture",emoji:"💰"},{id:"quote",label:"Devis",emoji:"📋"},{id:"contract-signed",label:"Contrat à signer",emoji:"✍️"},{id:"report-standard",label:"Rapport",emoji:"📊"},{id:"certificate",label:"Certificat",emoji:"🏆"},{id:"receipt",label:"Reçu",emoji:"🧾"},{id:"custom",label:"Texte libre",emoji:"📝"}];function w(t){t.innerHTML=`
...
`).map(e=>e.trim()).filter(Boolean).map(e=>{const r=e.split("|").map(b=>b.trim());return{description:r[0]??"",quantity:parseFloat(r[1]??"1")||1,unit_price:parseFloat(r[2]??"0")||0}});i.info("Génération en cours...");try{const e=await m.generate({template:o,data:{number:p,client_name:n,client_address:d,items:c,date:new Date().toLocaleDateString("fr-FR")},...l?{options:{watermark:l}}:{}}),r=t.querySelector("#pdf-result");if(!r)return;e.success?(r.innerHTML=`
          ...
          </div>`,i.success(`✅ ${e.filename}`)):(r.innerHTML=`<p style="color:#ef4444">❌ ${a(e.error??"Erreur")}</p>`,i.error(`❌ ${e.error??"Erreur"}`))}catch(e){f.warn("studio-pdf","failed",{err:e}),i.error(`❌ ${e instanceof Error?e.message:"Erreur"}`)}})}export{w as render};
