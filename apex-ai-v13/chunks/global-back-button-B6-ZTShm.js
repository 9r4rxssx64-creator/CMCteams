import{l as n}from"./monitoring-PpenZbuc.js";import"./multi-source-analyze-DFbZH82A.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CguRncsD.js";const a="apex-global-back-btn",i="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(i))return;const t=`
      #${a} {
        position: fixed;
