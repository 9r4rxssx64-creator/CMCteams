const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-tools-dispatch-DUnWld9P.js","../core/main-BacW9-1V.js","../assets/css/main-BEeSXdcc.css","./apex-tools-CFgUjEKG.js","./audit-log-ceQdg87q.js","./firebase-DBcPGse7.js","./orchestrator-B164sTor.js","./smart-tools-suggester-BlVoEvjj.js","./vault-DR8sd3t8.js","./credential-patterns-Ct__OCbr.js","./smart-camera-BueR4HlE.js","./admin-prompt-x6avcEAA.js","./toast-DbVEuO4x.js","./ai-router-BezLSo86.js","./chat-fallback-BhBa08g3.js","./pii-redaction-BenraFWG.js","./tokens-dashboard-C5ZzZyK6.js","./commerce-D5N3KYJ4.js","./auth-D6J-kc02.js"])))=>i.map(i=>d[i]);
import{s as f,_ as h,l as L,e as D,m as P}from"../core/main-BacW9-1V.js";import{aiRouter as S}from"./ai-router-BezLSo86.js";import{commerce as q}from"./commerce-D5N3KYJ4.js";import{vault as I}from"./vault-DR8sd3t8.js";import{h as x,t as p}from"./toast-DbVEuO4x.js";class M{idCounter=0;active=null;open(e){this.active&&this.active.close();const i=`ax-sheet-${++this.idCounter}-${Date.now()}`,t=document.createElement("div");t.className="ax-sheet-overlay",t.id=i,t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),e.title&&t.setAttribute("aria-label",e.title);const l=document.createElement("div");l.className="ax-sheet";const v=e.title?`<div class="ax-sheet-header">
