import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-YpLhgiQ2.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-ClsF1KRZ.js";import"./monitoring-3uBGKGRH.js";import"./apex-kb-C57_4Py8.js";import"./credential-patterns-D-srKehy.js";import"./auth-gate-CQIZpCTT.js";import"../core/main-COVVZXkx.js";import"./multi-source-analyze-DVXRcPw0.js";import"./commerce-bCinYVog.js";import"./kevin-alerts-C0x6_mBh.js";import"./whatsapp-DANXfNY7.js";let r=null;function P(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function f(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function C(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
