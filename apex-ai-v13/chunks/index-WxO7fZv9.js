import{a}from"./escape-html-DGIYNPKb.js";import{c as u}from"./listener-cleanup-Y2rGGxxX.js";import{C as x,q as p,a as m}from"./monitoring-BkJ_WZbY.js";import{rgpd as g}from"./rgpd-CkEuHzoG.js";import{haptic as o}from"./haptic-CQFg2PXZ.js";import{toast as l}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DCjiC-qU.js";import"./apex-kb-C132uqD8.js";import"./credential-patterns-CLzI061R.js";let s=null;function H(){s?.cleanup(),s=null}function f(i){if(!i)return"—";try{return new Date(i).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function v(i){const e=i.scopes.includes("*")?'<span style="color:#ff6b6b;font-weight:600">Globale (tous scopes)</span>':i.scopes.map(n=>`<code style="background:rgba(255,255,255,0.05);padding:2px 6px;border-radius:4px;font-size:11px;margin-right:4px">${a(n)}</code>`).join("");return`
