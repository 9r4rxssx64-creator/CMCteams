import{consumptionMonitor as i}from"./consumption-monitor-DhuWlS3i.js";import"./monitoring-BAiQJoxJ.js";import"./apex-tools-registry-DqA3gZXO.js";import"./apex-kb-BFHUv3jX.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-DAvdcAQw.js";import"./push-notifications-Con0RoNe.js";import"./tokens-dashboard-C5ZzZyK6.js";function d(a){const t=a.severity==="critical"?"#ff4444":a.severity==="warn"?"#ffaa00":"#22cc77",n=Math.min(100,a.pct_used);return`
  ...
  `}function $(a){const t=i.formatForUI(),n=t.services.map(d).join(""),e=t.total_alerts>0?`<div class="ax-banner-alert">⚠️ ${t.total_alerts} service${t.total_alerts>1?"s":""} en alerte — recharger vite</div>`:'<div class="ax-banner-ok">✅ Tous services dans les budgets</div>';a.innerHTML=`
  ...
  `,a.addEventListener("click",r=>{const s=r.target,c=s.closest('[data-action="upgrade-plans"]')?.dataset.target;if(c){const o=a.querySelector("#ax-consumption-modal-mount");o&&(o.innerHTML=l(c))}if(s.closest('[data-action="close-modal"]')){const o=a.querySelector("#ax-consumption-modal-mount");o&&(o.innerHTML="")}})}export{$ as render};
