import{l as b}from"./monitoring-3uBGKGRH.js";import{s as y}from"../core/main-B2dYl_oo.js";import{c as h}from"./csp-style-helper-BisGRi53.js";import{iotRegistry as d}from"./iot-providers-registry-B0fLiHgr.js";import{toast as r}from"./toast-Dgg9rcIP.js";import"./apex-kb-Cc3uNflI.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-DHezvtlA.js";import"./broadlink-bridge-DpMlH3pR.js";import"./haptic-BUEqXK0N.js";const v="kdmc_admin";function n(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function k(){return y.get("user")?.id===v}async function g(e){if(e){if(!k()){e.innerHTML=`
  ...
  `;try{const t=await d.statusAll(),o=await d.listAllDevices().catch(()=>[]);e.innerHTML=h.withNonce($(t,o)),q(e)}catch(t){b.warn("iot-providers-view","render fail",{err:String(t)}),e.innerHTML=`
      <div style="padding:40px;text-align:center;color:#c00">
        <h2>Erreur</h2>
        <p>Impossible de charger les providers IoT.</p>
        <button onclick="location.reload()">Recharger</button>
      </div>
    `}}}function $(e,t){const o=e.filter(i=>i.status.ok).length,a=e.length;return`
