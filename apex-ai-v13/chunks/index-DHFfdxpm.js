const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./toast-Dgg9rcIP.js","./haptic-BUEqXK0N.js","./persistent-memory-store-DfTthuQW.js","./consumption-anomaly-detector-Bp0BD4AG.js","./push-notifications-DrbO5gc0.js","./auth-Cerc1WZi.js","../core/main-k2hhEa6P.js","../assets/css/main-CYtYG7GU.css"])))=>i.map(i=>d[i]);
import{_ as l}from"./apex-kb-DEV0ns6l.js";import{l as S}from"./monitoring-BAiQJoxJ.js";import{c as R}from"./listener-cleanup-Y2rGGxxX.js";import{s as z}from"../core/main-k2hhEa6P.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-Cjv0lJFa.js";let n=null;function C(){n?.cleanup(),n=null}function b(r){return r.replace(/[&<>"']/g,m=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[m]??m)}const T="apex_v13_chat_auto_read";function P(){try{return localStorage.getItem(T)==="1"}catch{return!1}}function I(r){try{localStorage.setItem(T,r?"1":"0")}catch{}}async function O(r){try{const m=await l(()=>import("./voice-ZnV_PRYq.js").then(t=>t.b),[],import.meta.url),{listVoices:w,getActiveVoice:c,setActiveVoice:d,speak:p,stopAll:f}=m,y=r.querySelector("#ax-settings-auto-read"),_=r.querySelector("#ax-voice-current"),x=r.querySelector("#ax-voice-list"),h=r.querySelectorAll(".ax-voice-cat-btn");if(!x)return;y&&(y.checked=P(),n.bind(y,"change",()=>{I(y.checked),(async()=>{const{toast:t}=await l(async()=>{const{toast:a}=await import("./toast-Dgg9rcIP.js");return{toast:a}},__vite__mapDeps([0,1]),import.meta.url);t.success(y.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const k=()=>{if(!_)return;const t=c(),i=w().find(o=>o.id===t);_.textContent=i?`Voix active : ${i.emoji??"🔊"} ${i.name} (${i.category})`:`Voix active : ${t}`};k();const v=t=>{const a=w(),i=t==="all"?a:a.filter(e=>e.category===t),o=c();x.innerHTML=i.map(e=>{const s=e.id===o,u=e.emoji??(e.category==="pro"?"🎙️":e.category==="fun"?"🎉":"🎨"),g=e.description?b(e.description):"",$=s?"background:rgba(232,184,48,0.15);border-color:rgba(232,184,48,0.45)":"background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.06)";return`
