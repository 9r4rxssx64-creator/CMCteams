import{e as c}from"./escape-html-BlQj2yEF.js";import{c as h}from"./listener-cleanup-Y2rGGxxX.js";import{r as x}from"../core/main-B4DExc5S.js";import{s as k}from"./signup-1t4kI6FO.js";import{haptic as g}from"./haptic-CQFg2PXZ.js";import{toast as b}from"./toast-CRdbcLoc.js";import"./apex-kb-D1VtWFD9.js";import"./monitoring-D2lWYrYo.js";import"./multi-source-analyze-Bg1HHfSC.js";import"./credential-patterns-CLzI061R.js";import"./auth-gate-BlV1tKTL.js";import"./auth-B3RTUO4E.js";import"./kevin-alerts-Bw8KkWyP.js";import"./whatsapp-CVPbuW0O.js";let a=null;function I(){a?.cleanup(),a=null}const q=[{id:"free",label:"🆓 Découverte",price:"0 €",features:["Chat IA basique","50 messages/jour"]},{id:"basic",label:"✨ Basic",price:"9,90 €/mois",features:["Chat illimité","Studios","Voix"]},{id:"pro",label:"💎 Pro",price:"29,90 €/mois",features:["Tout Basic","Modules pro","Coffre, IoT"]},{id:"family",label:"👨‍👩‍👧 Famille (sur invitation)",price:"Gratuit",features:["Accès complet","Validation Kevin"]}];function R(e){a?.cleanup(),a=h("signup"),e.innerHTML=`
  ...
  `,S(e)}function S(e){if(!a)return;const i=e.querySelector("#signup-form");i&&a.bind(i,"submit",r=>{r.preventDefault(),g.tap(),w(e)});const n=e.querySelector("#signup-go-login");n&&a.bind(n,"click",()=>{g.tap(),x.navigate("landing")});const m=e.querySelector("#signup-link-cgu");m&&a.bind(m,"click",r=>{r.preventDefault(),x.navigate("legal")});const d=e.querySelector("#signup-link-privacy");d&&a.bind(d,"click",r=>{r.preventDefault(),x.navigate("legal")})}async function w(e){const i=(e.querySelector("#signup-prenom")?.value??"").trim(),n=(e.querySelector("#signup-nom")?.value??"").trim(),m=(e.querySelector("#signup-email")?.value??"").trim(),d=(e.querySelector("#signup-whatsapp")?.value??"").trim(),r=(e.querySelector("#signup-pin")?.value??"").trim(),f=e.querySelector('input[name="signup-plan"]:checked')?.value??"free",y=e.querySelector("#signup-cgu")?.checked??!1,v=e.querySelector("#signup-rgpd")?.checked??!1,t=e.querySelector("#signup-submit"),o=t?.querySelector(".ax-btn-label"),s=t?.querySelector(".ax-spinner"),l=e.querySelector("#signup-error");l&&(l.innerHTML=""),t&&(t.disabled=!0),o&&(o.textContent="Création de ton compte..."),s&&(s.style.display="inline-block");try{const u={prenom:i,nom:n,email:m,pin:r,plan:f,consent:{cgu:y,rgpd:v,ts:Date.now()}};d&&(u.whatsapp=d);const p=await k.selfSignupDirect(u);if(!p.ok){g.error(),l&&(l.innerHTML=`<div class="ax-alert ax-alert-warn">⚠️ ${c(p.reason??"Erreur")}</div>`),b.error(p.reason??"Erreur"),t&&(t.disabled=!1),o&&(o.textContent="🚀 Créer mon compte et me connecter"),s&&(s.style.display="none");return}g.success(),b.success("🎉 Bienvenue ! Tu es connecté."),setTimeout(()=>x.navigate("chat"),500)}catch(u){g.error();const p=u instanceof Error?u.message:"Erreur inattendue";l&&(l.innerHTML=`<div class="ax-alert ax-alert-error">${c(p)}</div>`),b.error(p),t&&(t.disabled=!1),o&&(o.textContent="🚀 Créer mon compte et me connecter"),s&&(s.style.display="none")}}export{I as dispose,R as render};
