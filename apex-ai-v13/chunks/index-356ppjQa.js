...
import{_ as u}from"./apex-kb-CAfWvMOn.js";import{e as o}from"./escape-html-BlQj2yEF.js";import{c as M}from"./listener-cleanup-Y2rGGxxX.js";import{l as D}from"./monitoring-Bl85iYvy.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DfuDcC7m.js";let i=null;function E(){i?.cleanup(),i=null}async function g(n){i?.cleanup(),i=M("sentinels");const{sentinels:x}=await u(async()=>{const{sentinels:t}=await import("./sentinels-CgNHwGBC.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),{sentinelsRegistry:m,bootstrapSentinelsRegistry:b}=await u(async()=>{const{sentinelsRegistry:t,bootstrapSentinelsRegistry:a}=await import("./sentinels-registry-o-v-dUJ_.js");return{sentinelsRegistry:t,bootstrapSentinelsRegistry:a}},__vite__mapDeps([0,1,2,3]),import.meta.url);b();const e=x.list(),y=m.getStatus(),p=m.getMetrics(),v=e.filter(t=>t.lastResult?.ok).length,$=e.filter(t=>t.lastResult&&!t.lastResult.ok).length,R=e.filter(t=>!t.lastResult).length;n.innerHTML=`
