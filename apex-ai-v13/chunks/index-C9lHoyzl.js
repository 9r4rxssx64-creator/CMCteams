import{e as o}from"./escape-html-BlQj2yEF.js";import{c as b}from"./listener-cleanup-Y2rGGxxX.js";import{r as l}from"../core/main-ReifuZ6f.js";import{haptic as x}from"./haptic-CQFg2PXZ.js";import{toast as g}from"./toast-CRdbcLoc.js";import"./apex-kb-8FXW6jDe.js";import"./monitoring-gJBPZdzr.js";import"./multi-source-analyze-CxbUoEQT.js";import"./credential-patterns-K-vGUK9F.js";let n=null,i=null;function j(){n?.cleanup(),n=null,i&&(clearInterval(i),i=null)}function p(){try{const t=localStorage.getItem("apex_v13_signup_pending_id");return t?JSON.parse(localStorage.getItem("apex_v13_signup_requests")??"[]").find(a=>a.id===t)??null:null}catch{return null}}function A(t){n?.cleanup(),n=b("waiting-approval"),s(t),i&&clearInterval(i),i=setInterval(()=>{const e=p();if(e)if(e.status==="approved"){g.success("🎉 Compte approuvé ! Tu peux te connecter.");try{localStorage.removeItem("apex_v13_signup_pending_id")}catch{}setTimeout(()=>l.navigate("landing"),1500)}else(e.status==="rejected"||e.status==="expired")&&s(t)},3e4)}function s(t){const e=p(),a=(()=>{try{return localStorage.getItem("apex_v13_signup_invite_link")??""}catch{return""}})();if(!e){t.innerHTML=`
