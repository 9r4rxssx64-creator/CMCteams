import{l as b}from"./monitoring-3uBGKGRH.js";import{s as y}from"../core/main-YY9kaSgt.js";import{c as h}from"./csp-style-helper-BisGRi53.js";import{iotRegistry as d}from"./iot-providers-registry-BzyRVLI4.js";import{toast as r}from"./toast-ClsF1KRZ.js";import"./apex-kb-DrljU7RU.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-CHJpD1wV.js";import"./broadlink-bridge-CkN81S_z.js";import"./haptic-CQFg2PXZ.js";const v="kdmc_admin";function n(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function $(){return y.get("user")?.id===v}async function g(e){if(e){if(!$()){e.innerHTML=`
