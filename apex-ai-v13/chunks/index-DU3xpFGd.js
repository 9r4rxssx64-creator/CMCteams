const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-B8UKH9BT.js","../core/main-BRv-GK0z.js","../assets/css/main-rhfGvOFL.css","./observability-hdFh-rB8.js","./sentinels-registry-C-pSL-pW.js","./toast-64I4l5xU.js","./haptic-BUEqXK0N.js"])))=>i.map(i=>d[i]);
import{_ as i,l as f}from"../core/main-BRv-GK0z.js";async function c(a){const{sentinels:s}=await i(async()=>{const{sentinels:t}=await import("./sentinels-B8UKH9BT.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),{sentinelsRegistry:u,bootstrapSentinelsRegistry:m}=await i(async()=>{const{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}=await import("./sentinels-registry-C-pSL-pW.js");return{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}},__vite__mapDeps([4,1,2,0,3]),import.meta.url);m();const n=s.list(),y=u.getStatus(),r=u.getMetrics(),x=n.filter(t=>t.lastResult?.ok).length,g=n.filter(t=>t.lastResult&&!t.lastResult.ok).length,b=n.filter(t=>!t.lastResult).length;a.innerHTML=`
...
//# sourceMappingURL=index-DU3xpFGd.js.map
