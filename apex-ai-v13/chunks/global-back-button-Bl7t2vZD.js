import{l as n}from"./monitoring-YU0NtzTv.js";import"./multi-source-analyze-sFGwN-C1.js";import"./apex-kb-LHp054Nn.js";import"./credential-patterns-K-vGUK9F.js";const i="apex-global-back-btn",a="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(a))return;const t=`
      #${i} {
        position: fixed;
