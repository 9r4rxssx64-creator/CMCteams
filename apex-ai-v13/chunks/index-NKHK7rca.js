import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-CUm3-Q03.js";import{broadlinkBridge as t}from"./broadlink-bridge-j77M_DsM.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-CjNuJy7Q.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-TER8_hce.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
