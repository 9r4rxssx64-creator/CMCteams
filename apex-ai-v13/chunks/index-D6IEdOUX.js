...
import{_ as m}from"./apex-kb-B9dYWkSj.js";import{s as h}from"../core/main-DyCXfNFi.js";import{a as i}from"./apex-tools-registry-DloDnFZi.js";import{permissions as x}from"./permissions-B50xK33D.js";import"./monitoring-B17vNBOa.js";import"./credential-patterns-BybElwOv.js";import"./apex-tools-dispatch-Cy6tIY28.js";const r=["linear-gradient(135deg, #ffd6e8 0%, #c9a4ff 50%, #a4c8ff 100%)","linear-gradient(135deg, #ffe4ec 0%, #ffb3d9 50%, #d4a5ff 100%)","linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%)","linear-gradient(135deg, #f6d365 0%, #fda085 100%)","linear-gradient(135deg, #d4fc79 0%, #96e6a1 100%)"];function b(){const e=new Date().getHours();return e<5?"Bonne nuit":e<12?"Bonjour":e<18?"Bon après-midi":e<22?"Bonsoir":"Bonne soirée"}function w(){const n=Math.floor(Date.now()/864e5)%r.length;return r[n]??r[0]??"#ffd6e8"}function t(e,n,o){return`
...
//# sourceMappingURL=index-D6IEdOUX.js.map
