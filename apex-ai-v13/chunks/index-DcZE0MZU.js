const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./multi-source-analyze-CaRx0igv.js","./apex-kb-BnhygcNh.js","./monitoring-3uBGKGRH.js","./credential-patterns-xogPPKNY.js","../assets/css/main-0--QXdhW.css"])))=>i.map(i=>d[i]);
import{b as h,_ as k}from"./apex-kb-BnhygcNh.js";import{l as $}from"./monitoring-3uBGKGRH.js";import{c as L}from"./listener-cleanup-Y2rGGxxX.js";import{s as P,a as H}from"../core/main-OxZeppzC.js";import{apexExecute as v}from"./apex-execute-NLV-6N3V.js";import{auth as T}from"./auth-D8FWD90S.js";import{commerce as S}from"./commerce-D-3BcfxA.js";import{c as I}from"./csp-style-helper-BisGRi53.js";import{i as A,r as j}from"./voice-COi9Aack.js";import{kdmcProjectsRegistry as w}from"./kdmc-projects-registry-DdTqW2gy.js";import{w as _}from"./whatsapp-LIa1oP1P.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as u}from"./toast-ClsF1KRZ.js";import"./credential-patterns-xogPPKNY.js";import"./multi-source-analyze-CaRx0igv.js";import"./claude-bridge-CgdGId0a.js";let f="commerce";const q={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function n(e){return e.replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i]??i)}function R(){const e=S.isEnabled();return`
