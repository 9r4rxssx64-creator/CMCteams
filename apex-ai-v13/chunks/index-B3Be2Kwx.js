import{e as r}from"./monitoring-BmdSES5_.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BgplTMSm.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-BUQNMe0E.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CHygrKq5.js";import"./kevin-alerts-BYR48R-m.js";import"./whatsapp-oF49CdlE.js";import"./auth-gate-CQ3qO91d.js";import"./auth-DRSl4-UZ.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
