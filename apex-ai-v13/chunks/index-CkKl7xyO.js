const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-3uBGKGRH.js","./apex-kb-CTQpjCp2.js","./credential-patterns-CLzI061R.js","./multi-source-analyze-BL6_rinE.js","./auth-1WiJasxs.js","../assets/css/main-BUIq5pfg.css"])))=>i.map(i=>d[i]);
import{_ as u}from"./apex-kb-CTQpjCp2.js";import{c as P}from"./listener-cleanup-Y2rGGxxX.js";import{l as A}from"./monitoring-3uBGKGRH.js";import{s as L}from"../core/main-BZ5opVNk.js";import{c as E}from"./csp-style-helper-BisGRi53.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-BL6_rinE.js";let n=null;function j(){n?.cleanup(),n=null}function v(i){return i.replace(/[&<>"']/g,h=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[h]??h)}const I="apex_v13_chat_auto_read";function O(){try{return localStorage.getItem(I)==="1"}catch{return!1}}function D(i){try{localStorage.setItem(I,i?"1":"0")}catch{}}async function V(i){try{const h=await u(()=>import("./voice-BQXW25wi.js").then(l=>l.c),__vite__mapDeps([0,1,2]),import.meta.url),{listVoices:k,getActiveVoice:x,setActiveVoice:f,speak:m,stopAll:b}=h,_=i.querySelector("#ax-settings-auto-read"),S=i.querySelector("#ax-voice-current"),w=i.querySelector("#ax-voice-list"),T=i.querySelectorAll(".ax-voice-cat-btn");if(!w)return;_&&(_.checked=O(),n.bind(_,"change",()=>{D(_.checked),(async()=>{const{toast:l}=await u(async()=>{const{toast:d}=await import("./toast-ClsF1KRZ.js");return{toast:d}},[],import.meta.url);l.success(_.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const z=()=>{if(!S)return;const l=x(),g=k().find(y=>y.id===l);S.textContent=g?`Voix active : ${g.emoji??"🔊"} ${g.name} (${g.category})`:`Voix active : ${l}`};z();const $=l=>{const d=k(),g=l==="all"?d:d.filter(e=>e.category===l),y=x();w.innerHTML=g.map(e=>{const a=e.id===y,o=e.emoji??(e.category==="pro"?"🎙️":e.category==="fun"?"🎉":"🎨"),t=e.description?v(e.description):"",r=a?"background:rgba(232,184,48,0.15);border-color:rgba(232,184,48,0.45)":"background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.06)";return`
