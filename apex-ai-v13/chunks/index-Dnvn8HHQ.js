import{e as r}from"./monitoring-BvBXOJnl.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-Xiu18F9J.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-CuKuxzu0.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BFpLYE2c.js";import"./kevin-alerts-CeIZPx-i.js";import"./whatsapp-BQdrBy-5.js";import"./auth-gate-C-J4i3YS.js";import"./auth-CeZYW_Kx.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
