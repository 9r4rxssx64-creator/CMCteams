import{e as r}from"./monitoring-Cuem9BYP.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-C-HbTnNB.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-iPmWybTv.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-d05guMDK.js";import"./kevin-alerts-DKn6lLI6.js";import"./whatsapp-uDpvYuq0.js";import"./auth-gate-sysMWStw.js";import"./auth-BpCDmzKt.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
