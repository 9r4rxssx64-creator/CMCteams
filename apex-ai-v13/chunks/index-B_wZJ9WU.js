import{a as l}from"./escape-html-DGIYNPKb.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{q as u,C as b}from"./monitoring-DkAyV1Za.js";import{g as S}from"./apex-tools-dispatch-core-CXz-VJ9W.js";import"./multi-source-analyze-Dix04g2u.js";import"./apex-kb-BsCl-NaA.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-B_3TjPaa.js";import"./apex-tools-dispatch-data-BOyvt-Pl.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-B7RbiriK.js";import"./apex-tools-misc-BaDzXGK8.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let c=null;function J(){c?.cleanup(),c=null}const w="ax_notes_";function x(o){return`${w}${o}`}class ${load(e){if(!e)return[];try{const t=localStorage.getItem(x(e));if(!t)return[];const a=JSON.parse(t);return Array.isArray(a)?a.filter(this.isValidNote):[]}catch(t){return u.warn("notes","load failed",{err:t}),[]}}isValidNote(e){if(!e||typeof e!="object")return!1;const t=e;return typeof t.id=="string"&&typeof t.title=="string"&&typeof t.content=="string"&&Array.isArray(t.tags)&&typeof t.favorite=="boolean"&&typeof t.ts_created=="number"&&typeof t.ts_updated=="number"}save(e,t){if(!e)return!1;try{return localStorage.setItem(x(e),JSON.stringify(t)),!0}catch(a){return u.warn("notes","save failed (quota?)",{err:a}),!1}}add(e,t){if(!e||!t.title.trim())return null;const a=this.load(e),r={id:`note_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,title:t.title.trim().slice(0,200),content:t.content.slice(0,5e4),tags:(t.tags??[]).slice(0,10).map(s=>s.toLowerCase().trim()).filter(Boolean),favorite:!1,ts_created:Date.now(),ts_updated:Date.now()};return a.unshift(r),a.length>500&&(a.length=500),this.save(e,a)?r:null}update(e,t,a){if(!e)return!1;const r=this.load(e),s=r.findIndex(f=>f.id===t);if(s===-1)return!1;const n=r[s];if(!n)return!1;const i={...n,...a.title!==void 0&&{title:a.title.trim().slice(0,200)},...a.content!==void 0&&{content:a.content.slice(0,5e4)},...a.tags!==void 0&&{tags:a.tags.slice(0,10)},...a.favorite!==void 0&&{favorite:a.favorite},ts_updated:Date.now()};return r[s]=i,this.save(e,r)}remove(e,t){if(!e)return!1;const a=this.load(e).filter(r=>r.id!==t);return this.save(e,a)}search(e,t){if(!e||!t.trim())return this.load(e);const a=t.toLowerCase().trim();return this.load(e).filter(r=>r.title.toLowerCase().includes(a)||r.content.toLowerCase().includes(a)||r.tags.some(s=>s.includes(a)))}toggleFavorite(e,t){const r=this.load(e).find(s=>s.id===t);return r?this.update(e,t,{favorite:!r.favorite}):!1}exportJson(e){return JSON.stringify(this.load(e),null,2)}count(e){return this.load(e).length}}const d=new $;function p(o){c?.cleanup(),c=y("notes");const t=b.get("user")?.id??"anon";if(!S("module.notes",o,t))return;const a=d.load(t),r=a.length>0?a.map(s=>`
  ...
  `,q(o,t)}function q(o,e){const t=o.querySelector("#ax-notes-form");t&&c.bind(t,"submit",r=>{r.preventDefault();const s=o.querySelector("#ax-notes-title"),n=o.querySelector("#ax-notes-content"),i=o.querySelector("#ax-notes-tags"),f=s?.value.trim()??"",m=n?.value??"",h=(i?.value??"").split(",").map(v=>v.trim()).filter(Boolean);if(!f)return;const g=d.add(e,{title:f,content:m,tags:h});g&&(u.info("notes","created",{id:g.id}),s&&(s.value=""),n&&(n.value=""),i&&(i.value=""),p(o))});const a=o.querySelector("#ax-notes-search");a&&c.bind(a,"input",()=>{const r=a.value.trim(),s=r?d.search(e,r):d.load(e),n=o.querySelector("#ax-notes-list");n&&(n.innerHTML=s.length>0?s.map(i=>`
          ...
          `).join(""):'<p class="ax-gs-213">Aucun résultat</p>')}),o.querySelectorAll('[data-action="delete"]').forEach(r=>{c.bind(r,"click",()=>{const s=r.dataset.noteId;s&&d.remove(e,s)&&p(o)})}),o.querySelectorAll('[data-action="favorite"]').forEach(r=>{c.bind(r,"click",()=>{const s=r.dataset.noteId;s&&d.toggleFavorite(e,s)&&p(o)})})}export{J as dispose,l as escapeHtml,d as notesStore,p as render};
