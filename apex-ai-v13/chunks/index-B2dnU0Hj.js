...
import{_ as g}from"./apex-kb-DYaZzirt.js";import{e as c}from"./escape-html-BlQj2yEF.js";import{l as M}from"./monitoring-3uBGKGRH.js";import{m as b}from"../core/main-Mpi1QagI.js";import{g as L}from"./apex-tools-dispatch-core-CJ3kGOGQ.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-CO8Xdi3o.js";import"./apex-tools-dispatch-skills-NfyaUh_3.js";import"./apex-tools-dispatch-data-CHoqA494.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-pFTAoMIv.js";import"./apex-tools-misc-BCiR3bNW.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./voice-DS8oNU6O.js";import"./haptic-CQFg2PXZ.js";const S="kdmc_admin";function T(){try{const s=localStorage.getItem("apex_v13_user");return s?JSON.parse(s):null}catch{return null}}function x(s){if(!s)return"—";try{return new Date(s).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function h(s){if(!s)return"jamais";const t=Date.now()-s,e=t/36e5;return e<1?`${Math.floor(t/6e4)}min`:e<24?`${Math.floor(e)}h`:`${Math.floor(e/24)}j`}function W(s){const t=T(),e=t?.id===S,o=t?.name??"Anonyme";L("admin.kb",s,t?.id)&&(s.innerHTML=`
