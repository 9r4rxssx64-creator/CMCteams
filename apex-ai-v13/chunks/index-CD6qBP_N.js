import{e as r}from"./monitoring-0om1TPnh.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CVr9G02a.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DkIR_hUc.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CxXqiCNR.js";import"./kevin-alerts-D71f49WA.js";import"./whatsapp-DIONblWm.js";import"./auth-gate-CiUG-A1K.js";import"./auth-Byj7uwgR.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
