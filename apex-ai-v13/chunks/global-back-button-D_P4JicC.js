import{l as n}from"./monitoring-FVZXdgCC.js";import"./multi-source-analyze-ORaraTFl.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-D6LOeL9m.js";const a="apex-global-back-btn",i="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(i))return;const t=`
      #${a} {
        position: fixed;
