import{r as f}from"../core/main-Z2cXS-NH.js";import{auth as g}from"./auth-DQOhGcuy.js";import{h as c,t as d}from"./toast-D1-s5Kao.js";function m(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function v(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const r=atob(e[1]??"").split(":")[0];if(r)return{uid:r}}catch{}return null}function q(e){const t=v();e.innerHTML=`
...
//# sourceMappingURL=index-BS1Wjzhh.js.map
