const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-tools-registry-DloDnFZi.js","./monitoring-B17vNBOa.js"])))=>i.map(i=>d[i]);
import{_ as f}from"./apex-kb-BtBDNOCA.js";import{l as b}from"./monitoring-B17vNBOa.js";import{s as y}from"../core/main-1B0Upg3F.js";import{capabilities as v}from"./capabilities-DZLmdL_7.js";import{h as m}from"./haptic-BUEqXK0N.js";import{toast as $}from"./toast-Dgg9rcIP.js";import"./apex-tools-registry-DloDnFZi.js";import"./credential-patterns-BybElwOv.js";import"./apex-tools-dispatch-B3xQ6s_d.js";function i(e){return e.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]??o)}function h(e,o){return e.filter(t=>{if(o.query){const r=o.query.toLowerCase();if(!(t.name.toLowerCase().includes(r)||t.description.toLowerCase().includes(r)))return!1}return!(o.tier&&o.tier!=="all"&&t.minTier!==o.tier||o.impactLevel&&o.impactLevel!=="all"&&t.impactLevel!==o.impactLevel)})}function T(e){const o={total:e.length,by_tier:{},by_impact:{}};for(const t of e)o.by_tier[t.minTier]=(o.by_tier[t.minTier]??0)+1,o.by_impact[t.impactLevel]=(o.by_impact[t.impactLevel]??0)+1;return o}const x={admin:{color:"#c9a227",label:"Admin"},laurence:{color:"#ff6b9d",label:"Laurence"},family:{color:"#a878ff",label:"Famille"},client_pro:{color:"#5aa8ff",label:"Pro"},client_free:{color:"#22cc77",label:"Free"}},_={A:{color:"#22cc77",label:"Auto",icon:"✅"},B:{color:"#ffaa00",label:"Notify",icon:"⚠️"},C:{color:"#ff5858",label:"Validate",icon:"🚨"}};let a={tier:"all",impactLevel:"all"},s="tools";function L(e){const o=x[e.minTier],t=_[e.impactLevel],r=e.inputSchema.properties??{},l=Object.keys(r).length;return`
...
//# sourceMappingURL=index-DDRC5B9V.js.map
