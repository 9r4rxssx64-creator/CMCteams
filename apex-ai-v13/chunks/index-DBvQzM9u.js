import{e as r}from"./monitoring-CltDqhA_.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CETxIGeC.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-CXWYETOU.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CCWQWarl.js";import"./kevin-alerts-zX2qJVeh.js";import"./whatsapp-DPa9hheu.js";import"./auth-gate-Cp030Lwp.js";import"./auth-QgoBdIES.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
