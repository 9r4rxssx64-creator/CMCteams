import{e as r}from"./monitoring-Cb-9ORjD.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CLKj2_Du.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-CstlM42o.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BJPad5Ln.js";import"./kevin-alerts-CNFCkCHg.js";import"./whatsapp-B9L5Vz_W.js";import"./auth-gate-CCYCvTuS.js";import"./auth-Daaec0F2.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
