import{e as r}from"./monitoring-Bbobua-m.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DSJ4J_WC.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-D3nCkIzq.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-B-lkJuA5.js";import"./kevin-alerts-0QLJdMJG.js";import"./whatsapp-DFjG8990.js";import"./auth-gate-BYwOap42.js";import"./auth-Db8Avdbg.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
