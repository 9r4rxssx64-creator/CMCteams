import{l as n}from"./monitoring-wizczV_1.js";import"./multi-source-analyze-CeV_AU5U.js";import"./apex-kb-DffZdqkV.js";import"./credential-patterns-ClK5OHi0.js";const i="apex-global-back-btn",a="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(a))return;const t=`
      #${i} {
        position: fixed;
