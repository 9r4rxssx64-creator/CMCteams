...
import{_ as g}from"./apex-kb-CUbBeDnn.js";import{a as c}from"./escape-html-DGIYNPKb.js";import{l as M}from"./monitoring-DMtdadhB.js";import{m as b}from"../core/main-EjEt3jVy.js";import{g as L}from"./apex-tools-dispatch-core-BiZ4Lzp7.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-B0ccPYTp.js";import"./apex-tools-dispatch-skills-CsJ_X8d6.js";import"./apex-tools-dispatch-data-DYK7myhx.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-CzhhuN3h.js";import"./apex-tools-misc-Di46bMFi.js";import"./apex-tools-registry-core-3xEquv0D.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./voice-CqFtdLQC.js";import"./haptic-CQFg2PXZ.js";const S="kdmc_admin";function T(){try{const s=localStorage.getItem("apex_v13_user");return s?JSON.parse(s):null}catch{return null}}function x(s){if(!s)return"—";try{return new Date(s).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function h(s){if(!s)return"jamais";const t=Date.now()-s,e=t/36e5;return e<1?`${Math.floor(t/6e4)}min`:e<24?`${Math.floor(e)}h`:`${Math.floor(e/24)}j`}function W(s){const t=T(),e=t?.id===S,o=t?.name??"Anonyme";L("admin.kb",s,t?.id)&&(s.innerHTML=`
