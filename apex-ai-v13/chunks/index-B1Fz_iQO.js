import{a as d}from"./escape-html-DGIYNPKb.js";import{c as v}from"./listener-cleanup-Y2rGGxxX.js";import{l as b}from"./monitoring-DMtdadhB.js";import{i as m}from"../core/main-BhQZ9nOc.js";import{autoBackup as s}from"./auto-backup-BULf_BhW.js";import{g as k}from"./apex-tools-dispatch-core-TB9LLNU9.js";import{haptic as c}from"./haptic-CQFg2PXZ.js";import{toast as n}from"./toast-CRdbcLoc.js";import"./apex-kb-Dod34vVG.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-Ojn_lZzH.js";import"./apex-tools-dispatch-skills-C72ZWg18.js";import"./apex-tools-dispatch-data-CaX0b9cB.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-DYvTaRmS.js";import"./apex-tools-misc-jzkXVXfA.js";import"./apex-tools-registry-core-3xEquv0D.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./voice-CZNFWa8w.js";let i=null;function Z(){i?.cleanup(),i=null}function f(t){return t<1024?t+" B":t<1024*1024?(t/1024).toFixed(1)+" KB":(t/(1024*1024)).toFixed(2)+" MB"}function y(t){const r=new Date(t),e=o=>o.toString().padStart(2,"0");return`${e(r.getDate())}/${e(r.getMonth()+1)}/${r.getFullYear()} ${e(r.getHours())}:${e(r.getMinutes())}`}const w={manual:"💾 Manuel",daily:"📅 Quotidien",weekly:"🌐 Hebdo","pre-rollback":"↩ Pre-rollback"};function _(t){const r=w[t]??t;return`<span style="padding:2px 6px;border-radius:4px;background:rgba(201,162,39,0.15);color:#c9a227;font-size:11px;font-weight:600">${d(r)}</span>`}function tt(){}function z(t){const r=t.last_backup_age_h<0?"Jamais":t.last_backup_age_h===0?"< 1h":`${t.last_backup_age_h}h`,e=t.last_backup_age_h<0||t.last_backup_age_h>48?"#ff6666":t.last_backup_age_h>26?"#ffa500":"#22c55e",o=t.integrity_ok?"#22c55e":"#ff6666",a=t.integrity_ok?"✓ OK":"⚠ Cassée",p=s.isQuotaCritical()?'<span style="margin-left:10px;padding:3px 8px;background:rgba(255,165,0,0.15);color:#ffa500;border-radius:4px;font-size:11px">⚠ Quota localStorage > 4 MB</span>':"";return`
