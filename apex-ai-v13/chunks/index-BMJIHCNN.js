import{l as b}from"./monitoring-3uBGKGRH.js";import{s as y}from"../core/main-BxMVCELi.js";import{c as h}from"./csp-style-helper-BisGRi53.js";import{iotRegistry as d}from"./iot-providers-registry-EEM8qi9u.js";import{toast as r}from"./toast-ClsF1KRZ.js";import"./apex-kb-DRP-rQ5c.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DFRy0PZC.js";import"./broadlink-bridge-DymMtr7V.js";import"./haptic-CQFg2PXZ.js";const v="kdmc_admin";function n(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function $(){return y.get("user")?.id===v}async function g(e){if(e){if(!$()){e.innerHTML=`
