import{e as r}from"./monitoring-BIhGYvG3.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup--bD1km4X.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DivxHzon.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-C9TmwGFA.js";import"./kevin-alerts-CjzOT81P.js";import"./whatsapp-B7WzsCoA.js";import"./auth-gate-DKFuU20G.js";import"./auth-BrWXCdPI.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
