const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-WiO5ZBU9.js","./apex-tools-registry-DPQHcZUW.js","./toast-Dgg9rcIP.js","./haptic-BUEqXK0N.js","./memory-bridge-C61XPacv.js","./apex-kb-xCpbmn6r.js","./credential-patterns-DqicUg9o.js","./persistent-memory-store-BLermAEh.js","./consumption-anomaly-detector-DDSm2eDU.js","./consumption-monitor-DV3c4mHv.js","./links-registry-AZynCxHp.js","./push-notifications-CjKSaU1u.js","./tokens-dashboard-C5ZzZyK6.js","./auth-B51ecXH9.js","../core/main-6OzRnTUP.js","../assets/css/main-CjlSpvBL.css"])))=>i.map(i=>d[i]);
import{_ as l}from"./apex-kb-xCpbmn6r.js";import{l as S}from"./monitoring-WiO5ZBU9.js";import{c as R}from"./listener-cleanup-Y2rGGxxX.js";import{s as z}from"../core/main-6OzRnTUP.js";import"./apex-tools-registry-DPQHcZUW.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-BI7GZhgU.js";let n=null;function M(){n?.cleanup(),n=null}function b(r){return r.replace(/[&<>"']/g,m=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[m]??m)}const T="apex_v13_chat_auto_read";function P(){try{return localStorage.getItem(T)==="1"}catch{return!1}}function I(r){try{localStorage.setItem(T,r?"1":"0")}catch{}}async function O(r){try{const m=await l(()=>import("./voice-BcOs5xoC.js").then(t=>t.a),__vite__mapDeps([0,1]),import.meta.url),{listVoices:w,getActiveVoice:c,setActiveVoice:d,speak:p,stopAll:f}=m,y=r.querySelector("#ax-settings-auto-read"),_=r.querySelector("#ax-voice-current"),x=r.querySelector("#ax-voice-list"),h=r.querySelectorAll(".ax-voice-cat-btn");if(!x)return;y&&(y.checked=P(),n.bind(y,"change",()=>{I(y.checked),(async()=>{const{toast:t}=await l(async()=>{const{toast:a}=await import("./toast-Dgg9rcIP.js");return{toast:a}},__vite__mapDeps([2,3]),import.meta.url);t.success(y.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const k=()=>{if(!_)return;const t=c(),i=w().find(o=>o.id===t);_.textContent=i?`Voix active : ${i.emoji??"🔊"} ${i.name} (${i.category})`:`Voix active : ${t}`};k();const v=t=>{const a=w(),i=t==="all"?a:a.filter(e=>e.category===t),o=c();x.innerHTML=i.map(e=>{const s=e.id===o,u=e.emoji??(e.category==="pro"?"🎙️":e.category==="fun"?"🎉":"🎨"),g=e.description?b(e.description):"",$=s?"background:rgba(232,184,48,0.15);border-color:rgba(232,184,48,0.45)":"background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.06)";return`
