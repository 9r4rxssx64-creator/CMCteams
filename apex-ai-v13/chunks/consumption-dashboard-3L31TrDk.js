import{s as l}from"../core/main-C6aPB2j8.js";import{consumptionMonitor as i}from"./consumption-monitor-Dobq1tqQ.js";import{g as p}from"./apex-tools-dispatch-CS2IntCy.js";import"./apex-kb-DqSepSVN.js";import"./monitoring-3uBGKGRH.js";import"./credential-patterns-qcw7Brjr.js";import"./multi-source-analyze-I74ZuE2q.js";import"./push-notifications-DT_oeCr7.js";import"./tokens-dashboard-C5ZzZyK6.js";import"./apex-tools-registry-DZDSBWuK.js";import"./voice-0SIyGyVY.js";function m(a){const s=a.severity==="critical"?"#ff4444":a.severity==="warn"?"#ffaa00":"#22cc77",t=Math.min(100,a.pct_used);return`
  ...
  `,a.addEventListener("click",n=>{const c=n.target,d=c.closest('[data-action="upgrade-plans"]')?.dataset.target;if(d){const o=a.querySelector("#ax-consumption-modal-mount");o&&(o.innerHTML=u(d))}if(c.closest('[data-action="close-modal"]')){const o=a.querySelector("#ax-consumption-modal-mount");o&&(o.innerHTML="")}})}export{M as render};
