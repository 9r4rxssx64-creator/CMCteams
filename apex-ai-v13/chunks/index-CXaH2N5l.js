import{a as g}from"./escape-html-DGIYNPKb.js";import{c as q}from"./listener-cleanup-Y2rGGxxX.js";import{q as l,a as $,C as H}from"./monitoring-BkJ_WZbY.js";import{r as j}from"../core/main-BxOBg3Le.js";import{aiRouter as k}from"./ai-router-CgHPC8vx.js";import{_ as z}from"./apex-kb-C132uqD8.js";import{haptic as C}from"./haptic-CQFg2PXZ.js";import{modalSheet as v}from"./modal-sheet-oR7SW-wv.js";import{toast as y}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DCjiC-qU.js";import"./credential-patterns-CLzI061R.js";import"./chat-fallback-Cf8SYo4c.js";import"./apex-tools-dispatch-core-BHo3mwX7.js";import"./apex-tools-dispatch-skills-sOPz5fsK.js";import"./apex-tools-dispatch-data-hMaZjSXL.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-DoPKpcyI.js";import"./apex-tools-misc-C4sFgDRb.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./economy-mode-kumrG-wW.js";const T="apex_v13_agent_browser_history",N=20;class J{async analyze(t,e){const r=(t||"").trim(),a=(e||"").trim();if(!r)throw new Error("URL vide");if(!a)throw new Error("Objectif vide");if(!/^https?:\/\//i.test(r))throw new Error("URL doit commencer par http(s)://");const c=Date.now(),o=`agent_${Date.now()}_${Math.random().toString(36).slice(2,6)}`;let n="",m=!1;try{const s=await fetch(r,{method:"GET",mode:"cors",credentials:"omit"});s.ok&&(n=await s.text(),m=!0)}catch(s){l.info("agent-browser","fetch CORS blocked, fallback skeleton",{err:s})}const h=this.extractRelevantDom(n).slice(0,3e4),d=`Tu es un agent pilote browser. L'utilisateur te donne une URL et un objectif.
...
Trigger Cialdini : ${a}`}],d,s=>{s.text&&(u+=s.text)},s=>{l.warn("marketing-psy","stream err",{err:s})})}catch(s){l.warn("marketing-psy","stream throw",{err:s})}let p;try{const s=u.match(/\{[\s\S]*"copy"[\s\S]*\}/);if(!s)throw new Error("JSON manquant");const b=JSON.parse(s[0]);if(p={copy:typeof b.copy=="string"?b.copy.slice(0,1e3):"",rationale:typeof b.rationale=="string"?b.rationale.slice(0,500):""},!p.copy)throw new Error("copy vide")}catch(s){l.warn("marketing-psy","parse failed, fallback",{err:s}),p=this.fallbackCopy(e,a)}const f={id:m,copy:p.copy,trigger:a,rationale:p.rationale||h,product:e,audience:r,format:c,tone:o,generatedAt:Date.now(),durationMs:Date.now()-n};return this.persist(f),$.record("marketing-psy.generate",{details:{id:m,trigger:a,product:e.slice(0,50),durationMs:f.durationMs}}),l.info("marketing-psy",`Generated copy (${a}, ${f.durationMs}ms)`),f}history(){try{const t=localStorage.getItem(R);if(!t)return[];const e=JSON.parse(t);return Array.isArray(e)?e:[]}catch{return[]}}listTriggers(){return Object.keys(S).map(t=>({id:t,description:S[t]}))}fallbackCopy(t,e){return{copy:{reciprocity:`Essaie ${t} gratuitement — sans engagement.`,scarcity:`${t} : seulement 100 places cette semaine.`,authority:`${t}, recommandé par les experts du domaine.`,consistency:`Tu cherches X depuis longtemps ? ${t} est l'étape logique.`,liking:`On a créé ${t} pour les gens comme toi.`,"social-proof":`Rejoins 10 000+ utilisateurs satisfaits de ${t}.`,unity:`Entre nous, ${t} change vraiment la donne.`}[e],rationale:S[e]}}persist(t){try{const e=this.history();e.unshift(t);const r=e.slice(0,Q);localStorage.setItem(R,JSON.stringify(r))}catch(e){l.warn("marketing-psy","persist failed",{err:e})}}}const L=new Z;let w=null;function _e(){w?.cleanup(),w=null}const ee=[{id:"hyperframes",emoji:"🎞",name:"HyperFrames",description:"Compose une animation HTML/CSS/JS multi-frames depuis un prompt. Preview dans iframe sandbox.",buttonLabel:"Composer"},{id:"agent-browser",emoji:"🌐",name:"Agent Browser",description:"Analyse une URL + objectif, retourne actions structurées (click/fill/extract).",buttonLabel:"Analyser URL"},{id:"marketing-psy",emoji:"🧠",name:"Marketing Psy",description:"Génère copies marketing avec triggers Cialdini (scarcity/social-proof/authority/...).",buttonLabel:"Générer copy"},{id:"impeccable-design",emoji:"✨",name:"Impeccable Design",description:"23 commandes design fluency (make-it-pop / tighten-spacing / improve-typography / ...).",buttonLabel:"Polir un design"},{id:"ios-simulator",emoji:"📱",name:"iOS Simulator",description:"Preview HTML/URL dans frame iPhone 15 Pro simulé (visuel only, pas runtime iOS).",buttonLabel:"Lancer preview"}];function te(i){return`
  ...
  `}async function ae(){const i=window.prompt("Décris l'animation à composer :","Logo APEX qui pulse en doré sur fond noir");if(i){y.info("🎞 Composition en cours...");try{const t=await M.compose(i),r=M.buildPreviewSrcdoc(t).replace(/"/g,"&quot;").replace(/</g,"&lt;");v.open({title:`🎞 HyperFrames — ${t.frames} frames`,content:`
        <div class="ax-gs-12">
          <p class="ax-gs-303">
