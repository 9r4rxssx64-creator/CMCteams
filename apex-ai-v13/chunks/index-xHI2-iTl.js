import{e as r}from"./monitoring-qYECZG6L.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-kCTFxnAX.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DI0tATGY.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-C1B0uCd_.js";import"./kevin-alerts-CjsMwlLb.js";import"./whatsapp-BeW4UAQs.js";import"./auth-gate-R_mIWgd2.js";import"./auth-xUPb5_0b.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
