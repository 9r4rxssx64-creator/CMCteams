...
import{_ as k,v as Y}from"./apex-kb-DRMqNqjP.js";import{s as P,e as J,m as Q}from"../core/main-veBmmiZq.js";import{l as j}from"./monitoring-B17vNBOa.js";import{aiRouter as O}from"./ai-router-Bi58gslR.js";import{commerce as X}from"./commerce-DM7FGug_.js";import{h as y}from"./haptic-BUEqXK0N.js";import{modalSheet as z}from"./modal-sheet-Pqfkse7W.js";import{toast as m}from"./toast-Dgg9rcIP.js";import"./apex-tools-registry-DloDnFZi.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-DTtxruLf.js";import"./chat-fallback-BTgk9lp3.js";import"./tokens-dashboard-C5ZzZyK6.js";const D=[],R=[];let q=!1;function _(t){return t.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e)}function Z(t){if(!Array.isArray(t)||t.length===0)return"";const e=t.length===1?1:t.length<=4?2:3,d=t.map((o,p)=>{const x=_(o.url),c=_(o.filename);return`<div class="ax-album-item" data-img-idx="${p}" style="aspect-ratio:1;background:#1a1a2e;border-radius:8px;overflow:hidden;position:relative;cursor:pointer;-webkit-tap-highlight-color:transparent"><img src="${x}" alt="${c}" loading="lazy" style="width:100%;height:100%;object-fit:cover;transition:transform 200ms cubic-bezier(0.16,1,0.3,1)"><div class="ax-album-overlay" style="position:absolute;bottom:0;left:0;right:0;padding:8px;background:linear-gradient(to top,rgba(0,0,0,0.85),transparent);color:#fff;font-size:11px;line-height:1.3;text-overflow:ellipsis;overflow:hidden;white-space:nowrap">${c}</div></div>`}).join("");return`<div class="ax-image-album" style="display:grid;grid-template-columns:repeat(${e},1fr);gap:8px;margin:12px 0;border-radius:12px">${d}</div>`}function tt(t,e){const d=_(e.url),o=_(e.filename),p=document.createElement("div");p.className="ax-lightbox",p.setAttribute("role","dialog"),p.setAttribute("aria-modal","true"),p.setAttribute("aria-label","Visualisation image"),p.style.cssText="position:fixed;inset:0;z-index:99999;background:rgba(0,0,0,0.95);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:env(safe-area-inset-top,20px) 16px env(safe-area-inset-bottom,20px) 16px";const x="min-height:44px;padding:10px 14px;border-radius:10px;border:1px solid rgba(255,255,255,0.15);background:rgba(20,20,35,0.7);color:#fff;font-size:13px;cursor:pointer;-webkit-tap-highlight-color:transparent;font-weight:600;";p.innerHTML=`<button class="ax-lb-close" aria-label="Fermer" style="position:absolute;top:env(safe-area-inset-top,20px);right:16px;width:44px;height:44px;border-radius:50%;background:rgba(255,255,255,0.1);border:none;color:#fff;font-size:20px;cursor:pointer;-webkit-tap-highlight-color:transparent;z-index:1">✕</button><img src="${d}" alt="${o}" style="max-width:100%;max-height:65vh;object-fit:contain;border-radius:12px;box-shadow:0 10px 40px rgba(0,0,0,0.5)"><div class="ax-lb-filename" style="color:rgba(255,255,255,0.7);font-size:13px;margin-top:12px;text-align:center">${o}</div><div class="ax-lb-actions" style="display:flex;gap:8px;margin-top:20px;flex-wrap:wrap;justify-content:center;max-width:680px"><button data-action="cartoon" style="${x}" title="Transformer en cartoon">🎨 Cartoon</button><button data-action="anime" style="${x}" title="Style anime">🤖 Anime</button><button data-action="video" style="${x}" title="Animer en vidéo">🎬 Animer vidéo</button><button data-action="remove-bg" style="${x}" title="Retirer le fond">✂️ Retirer fond</button><button data-action="stylize" style="${x}" title="Variation stylisée">🎭 Variations</button><button data-action="share" style="${x}" title="Partager">📤 Partager</button><button data-action="download" style="${x}" title="Télécharger">💾 Télécharger</button></div><div class="ax-lb-status" data-status style="margin-top:14px;color:#c9a227;font-size:12px;min-height:18px;text-align:center"></div>`,document.body.appendChild(p);const c=()=>{p.parentNode&&p.parentNode.removeChild(p)};p.querySelector(".ax-lb-close")?.addEventListener("click",c);const h=g=>{g.key==="Escape"&&(c(),document.removeEventListener("keydown",h))};document.addEventListener("keydown",h),p.addEventListener("click",g=>{g.target===p&&c()});const v=p.querySelector("[data-status]");return p.querySelectorAll("[data-action]").forEach(g=>{g.addEventListener("click",()=>{const w=g.dataset.action??"";et(t,e,w,v,c)})}),p}async function et(t,e,d,o,p){if(d==="share"){const c=navigator;if(c.share)try{await c.share({url:e.url,title:e.filename});return}catch{}try{await navigator.clipboard.writeText(e.url),m.success("Lien copié dans le presse-papiers")}catch{m.warn("Partage non supporté par ce navigateur")}return}if(d==="download"){try{const c=document.createElement("a");c.href=e.url,c.download=e.filename||"image",document.body.appendChild(c),c.click(),document.body.removeChild(c)}catch(c){m.error(c instanceof Error?c.message:"Téléchargement échoué")}return}if(["cartoon","anime","video","remove-bg","stylize"].includes(d)){o&&(o.textContent=`⏳ ${d} en cours… (Replicate)`);let c;if(d==="stylize"){const u=window.prompt('Style souhaité (ex: "huile sur toile renaissance") :');if(!u){o&&(o.textContent="");return}c=u}try{const{apexToolsDispatch:u}=await k(async()=>{const{apexToolsDispatch:w}=await import("./apex-tools-dispatch-DTtxruLf.js").then(C=>C.b);return{apexToolsDispatch:w}},__vite__mapDeps([0,1,2,3]),import.meta.url),h={url:e.url,type:d};c&&(h.prompt=c);const v=await u.execute("transform_image",h,"admin");if(!v.ok){const w=v.error??"transformation échouée";o&&(o.textContent=`❌ ${w}`),m.error(w);return}const g=v.result;if(!g.success||!g.outputUrl){const w=g.error??"aucun outputUrl";o&&(o.textContent=`❌ ${w}`);return}if(o){const w=g.cost_eur!==void 0&&g.cost_eur!==null?` (${g.cost_eur.toFixed(3)}€)`:"";o.textContent=`✅ Transformé${w}`}at(t,g.outputUrl,d,e.filename),setTimeout(p,1500)}catch(u){const h=u instanceof Error?u.message:"erreur";o&&(o.textContent=`❌ ${h}`)}return}}function at(t,e,d,o){const p=t.querySelector(".ax-chat-scroll");if(!p)return;const x=_(e),c=_(o),u=_(d),v=d==="video"||/\.(mp4|webm|mov)(\?|$)/i.test(e)?`<video src="${x}" controls autoplay loop playsinline style="max-width:100%;max-height:70vh;border-radius:12px;display:block">Ton navigateur ne supporte pas la vidéo HTML5.</video>`:`<img src="${x}" alt="${c} ${u}" style="max-width:100%;max-height:70vh;object-fit:contain;border-radius:12px;display:block">`,g=document.createElement("div");g.className="ax-msg ax-msg-assistant ax-slide-up-fade ax-transform-result",g.dataset.transformType=d,g.innerHTML=`<div class="ax-msg-body"><p style="margin:0 0 8px;color:#c9a227;font-size:12px;font-weight:600">${nt(d)} ${u} appliqué sur ${c}</p>`+v+`<div class="ax-transform-actions" style="display:flex;gap:6px;margin-top:10px;flex-wrap:wrap"><button data-tr-action="download" data-tr-url="${x}" style="min-height:36px;padding:6px 10px;border-radius:6px;border:1px solid rgba(255,255,255,0.15);background:rgba(20,20,35,0.7);color:#fff;font-size:12px;cursor:pointer">💾 Télécharger</button><button data-tr-action="share" data-tr-url="${x}" style="min-height:36px;padding:6px 10px;border-radius:6px;border:1px solid rgba(255,255,255,0.15);background:rgba(20,20,35,0.7);color:#fff;font-size:12px;cursor:pointer">📤 Partager</button></div></div>`,p.appendChild(g),p.scrollTo({top:p.scrollHeight,behavior:"smooth"}),g.querySelectorAll("[data-tr-action]").forEach(w=>{w.addEventListener("click",()=>{const C=w.dataset.trAction??"",L=w.dataset.trUrl??"";if(C==="download"){const A=document.createElement("a");A.href=L,A.download=`apex-${d}-${Date.now()}`,document.body.appendChild(A),A.click(),document.body.removeChild(A)}else if(C==="share"){const A=navigator;A.share?A.share({url:L}).catch(()=>{}):navigator.clipboard?.writeText(L)}})})}function nt(t){return{cartoon:"🎨",anime:"🤖",video:"🎬","remove-bg":"✂️",stylize:"🎭"}[t]??"🖼️"}function F(t){if(t.role!=="assistant"||t.streaming||!t.text||t.text.length===0)return"";const e="width:32px;height:32px;border-radius:50%;background:rgba(201,162,39,0.1);border:1px solid rgba(201,162,39,0.3);cursor:pointer;display:inline-flex;align-items:center;justify-content:center;font-size:14px;color:var(--ax-gold);transition:all 200ms;opacity:0.7;-webkit-tap-highlight-color:transparent;padding:0;";return`<div class="ax-msg-actions" style="display:flex;gap:6px;margin-top:8px;justify-content:flex-end;flex-wrap:wrap"><button class="ax-msg-action" data-action="speak" data-msg-id="${_(t.id)}" style="${e}" title="Lire la réponse à voix haute" aria-label="Lire la réponse">🔊</button><button class="ax-msg-action" data-action="copy" data-msg-id="${_(t.id)}" style="${e}" title="Copier dans presse-papiers" aria-label="Copier le texte">📋</button><button class="ax-msg-action" data-action="export-pdf" data-msg-id="${_(t.id)}" style="${e}" title="Exporter en PDF" aria-label="Exporter PDF">📄</button></div>`}function H(t){let e=_(t);return e=e.replace(/```([\s\S]*?)```/g,(d,o)=>`<pre class="ax-code"><code>${o}</code></pre>`),e=e.replace(/`([^`\n]+)`/g,'<code class="ax-code-inline">$1</code>'),e=e.replace(/\*\*([^*\n]+)\*\*/g,"<strong>$1</strong>"),e=e.replace(/\*([^*\n]+)\*/g,"<em>$1</em>"),e=e.replace(/\n/g,"<br>"),e}function rt(){const t=P.get("user");return Q.buildSystemPromptContext(t)}async function ot(t,e){try{const{apexToolsDispatch:d}=await k(async()=>{const{apexToolsDispatch:g}=await import("./apex-tools-dispatch-DTtxruLf.js").then(w=>w.b);return{apexToolsDispatch:g}},__vite__mapDeps([0,1,2,3]),import.meta.url),o=await d.execute("detect_intent",{text:t},"admin");if(!o.ok||!o.result)return;const p=o.result.intent,x=o.result.confidence??0;if(!p||p==="unknown"||x<.7)return;if(p==="open_url"||p==="open_browser"){const g=t.match(/(https?:\/\/[^\s]+)/i),w=t.match(/\b([a-z0-9-]+\.(com|fr|io|net|org|app|dev|ai|co))\b/i),C=g?.[1]??w?.[1]??"https://www.google.com";d.execute("open_url",{url:C},"admin");return}const{smartToolsSuggester:c}=await k(async()=>{const{smartToolsSuggester:g}=await import("./smart-tools-suggester-DStQAaaW.js");return{smartToolsSuggester:g}},__vite__mapDeps([4,1,2]),import.meta.url),u=c.suggestForIntent(p);if(!u)return;const{toast:h}=await k(async()=>{const{toast:g}=await import("./toast-Dgg9rcIP.js");return{toast:g}},__vite__mapDeps([5,6]),import.meta.url);h.info(`${u.emoji} ${u.name} disponible — tape pour ouvrir`,{duration:5e3});const v=P.get("user");v?.id&&c.recordUsage(u.id,v.id),it(e,u)}catch(d){j.warn("chat","detectAndSuggestTool failed",{err:d})}}function it(t,e){const d=t.querySelector(".ax-chat-scroll");if(!d)return;const o=document.createElement("div");o.className="ax-msg ax-msg-tool ax-slide-up-fade",o.innerHTML=`
  ...
  `;const x=t.querySelector("#ax-chat-form"),c=t.querySelector("#ax-chat-text");x&&c&&(x.addEventListener("submit",n=>{n.preventDefault();const s=c.value.trim();s&&(async()=>{const{detectAllCredentials:i}=await k(async()=>{const{detectAllCredentials:l}=await import("./credential-patterns-DqicUg9o.js");return{detectAllCredentials:l}},[],import.meta.url);if(i(s).length>0){c.value="",c.style.height="auto";const{vault:l}=await k(async()=>{const{vault:f}=await import("./apex-kb-DRMqNqjP.js").then(b=>b.b);return{vault:f}},__vite__mapDeps([0,1,2,3]),import.meta.url),a=await l.autoStoreBulk(s);if(a.stored.length>0){const f=a.stored.map(b=>b.pattern.name).join(", ");m.success(`🔑 ${a.stored.length} clé(s) chiffrée(s) AES-GCM-256 : ${f}`,{duration:6e3})}if(a.forbidden.length>0){const f=a.forbidden.map(b=>b.pattern.name).join(", ");m.error(`🚫 ${f} JAMAIS stocké (sécu Kevin)`,{duration:8e3})}a.failed>0&&a.stored.length===0&&m.warn(`⚠️ ${a.failed} format inconnu — ouvre 🔐 Coffre pour coller manuellement`,{duration:8e3});return}c.value="",c.style.height="auto",R.push(s),U(t)})()}),c.addEventListener("input",()=>{c.style.height="auto",c.style.height=`${Math.min(c.scrollHeight,200)}px`}),c.addEventListener("keydown",n=>{n.key==="Enter"&&!n.shiftKey&&(n.preventDefault(),x.requestSubmit())}),c.addEventListener("paste",n=>{const s=n.clipboardData?.getData("text")?.trim()??"";s&&(async()=>{const{detectAllCredentials:i}=await k(async()=>{const{detectAllCredentials:f}=await import("./credential-patterns-DqicUg9o.js");return{detectAllCredentials:f}},[],import.meta.url);if(i(s).length===0)return;c.value="";const{vault:l}=await k(async()=>{const{vault:f}=await import("./apex-kb-DRMqNqjP.js").then(b=>b.b);return{vault:f}},__vite__mapDeps([0,1,2,3]),import.meta.url),a=await l.autoStoreBulk(s);if(a.stored.length>0){const f=a.stored.map(b=>b.pattern.name).join(", ");m.success(`🔑 ${a.stored.length} clé(s) chiffrée(s) auto AES-GCM-256 : ${f}`,{duration:6e3})}if(a.forbidden.length>0){const f=a.forbidden.map(b=>b.pattern.name).join(", ");m.error(`🚫 ${f} JAMAIS stocké (règle sécu)`,{duration:8e3})}a.failed>0&&a.stored.length===0&&m.warn("Format inconnu — ouvre 🔐 Coffre pour coller manuellement",{duration:6e3})})()}));const u=t.querySelector("#ax-chat-mic");let h=null,v=!1;u?.addEventListener("click",()=>{y.tap();const n=window.SpeechRecognition??window.webkitSpeechRecognition;if(!n){m.warn("Dictée vocale non supportée par ton navigateur");return}if(v&&h){h.stop(),v=!1,u.style.background="";return}try{if(h=new n,!h)return;h.continuous=!1,h.interimResults=!0,h.lang="fr-FR";let s="",i=null;const r=1500;h.onresult=l=>{const a=l;let f="",b=!1;for(let S=a.resultIndex;S<a.results.length;S++){const E=a.results[S];E?.[0]&&(f+=E[0].transcript,E.isFinal&&(b=!0))}const $=t.querySelector("#ax-chat-text");$&&($.value=f),b&&(s=f,i&&clearTimeout(i),i=setTimeout(()=>{if(s.trim().length>0&&v){try{h?.stop()}catch{}t.querySelector("#ax-chat-form")?.requestSubmit()}},r))},h.onend=()=>{v=!1,u&&(u.style.background=""),i&&(clearTimeout(i),i=null);const l=t.querySelector("#ax-chat-text");s.trim().length>0&&l&&l.value.trim()===s.trim()&&t.querySelector("#ax-chat-form")?.requestSubmit()},h.onerror=l=>{const a=l;m.warn(`Dictée erreur : ${a.error??"inconnu"}`),v=!1,u&&(u.style.background="")},h.start(),v=!0,u.style.background="linear-gradient(135deg,#ff4444,#cc2222)",y.medium(),m.success("🎙 Parle maintenant — re-tap 🎙 pour arrêter")}catch(s){const i=s instanceof Error?s.message:"erreur";m.warn(`Dictée fail : ${i}`)}});const g=t.querySelector("#ax-chat-wake");g?.addEventListener("click",()=>{y.tap(),(async()=>{try{const{voicePrint:n}=await k(async()=>{const{voicePrint:i}=await import("./voice-Dr7NkkAT.js").then(r=>r.v);return{voicePrint:i}},__vite__mapDeps([1,2]),import.meta.url);if(!n.isSupported()){m.warn("Wake word non supporté par ton navigateur");return}if(n.isListening()){n.stopWakeWord(),g&&(g.style.background=""),m.success("Wake word arrêté");return}const s=n.startWakeWord(i=>{const r=t.querySelector("#ax-chat-text");r&&(r.value=i,t.querySelector("#ax-chat-form")?.requestSubmit())});s.ok&&g?(g.style.background="linear-gradient(135deg,#22cc77,#1a9a5a)",m.success('👂 "Dis Apex" actif — parle quand tu veux')):m.warn(`Wake word fail : ${s.reason??"inconnu"}`)}catch(n){const s=n instanceof Error?n.message:"erreur";m.warn(`Wake word erreur : ${s}`)}})()});const w=t.querySelector("#ax-chat-attach"),C=t.querySelector("#ax-chat-file-input"),L=t.querySelector("#ax-chat-attachments");w?.addEventListener("click",()=>{y.tap(),C?.click()});const A=n=>{if(!L)return;L.style.display="block";const s=(n.size/1024/1024).toFixed(2),i=n.type.startsWith("image/")?"🖼️":n.type.startsWith("video/")?"🎬":n.type.startsWith("audio/")?"🎵":n.type.includes("pdf")?"📄":n.type.includes("zip")||n.type.includes("rar")||n.type.includes("7z")?"📦":"📎",r=document.createElement("div");r.style.cssText="display:inline-flex;align-items:center;gap:6px;padding:6px 10px;background:rgba(201,162,39,0.1);border:1px solid rgba(201,162,39,0.3);border-radius:6px;margin-right:6px;font-size:12px;color:#c9a227",r.textContent=`${i} ${n.name.slice(0,30)}${n.name.length>30?"...":""} (${s} MB)`,L.appendChild(r)},G=n=>{const s=t.querySelector(".ax-chat-scroll");if(!s||n.length===0)return;const i=document.createElement("div");i.className="ax-msg ax-msg-user ax-slide-up-fade",i.innerHTML=`<div class="ax-msg-body">${Z(n)}</div>`,s.appendChild(i),s.scrollTo({top:s.scrollHeight,behavior:"smooth"}),i.querySelectorAll(".ax-album-item").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.imgIdx??"0",a=parseInt(l,10),f=n[a];f&&tt(t,f)})})};C?.addEventListener("change",()=>{const n=Array.from(C.files??[]);if(n.length===0)return;y.success();const s=[];for(const i of n){if(A(i),i.type.startsWith("image/"))try{const r=URL.createObjectURL(i);s.push({url:r,filename:i.name})}catch{}(async()=>{try{const{fileConverter:r}=await k(async()=>{const{fileConverter:a}=await import("./file-converter-C4bAF1pZ.js");return{fileConverter:a}},__vite__mapDeps([7,1,2]),import.meta.url),l=await r.ingest(i,"admin");l.ok?m.success(`✅ ${i.name} ingéré`):m.warn(`Ingest fail : ${l.reason??i.name}`)}catch(r){const l=r instanceof Error?r.message:"erreur";m.warn(`File error : ${l}`)}})()}s.length>0&&G(s),C.value=""});const T=t.querySelector(".ax-chat-body, #ax-chat-form");T&&(T.addEventListener("dragover",n=>{n.preventDefault(),T.style.background="rgba(201,162,39,0.1)"}),T.addEventListener("dragleave",()=>{T.style.background=""}),T.addEventListener("drop",n=>{n.preventDefault(),T.style.background="";const i=Array.from(n.dataTransfer?.files??[]);for(const r of i)A(r),(async()=>{try{const{fileConverter:l}=await k(async()=>{const{fileConverter:a}=await import("./file-converter-C4bAF1pZ.js");return{fileConverter:a}},__vite__mapDeps([7,1,2]),import.meta.url);await l.ingest(r,"admin"),m.success(`📎 ${r.name} ajouté`)}catch{}})()})),t.querySelector("#ax-chat-text")?.addEventListener("paste",n=>{const s=n.clipboardData?.items??[];for(let i=0;i<s.length;i++){const r=s[i];if(r&&r.kind==="file"){const l=r.getAsFile();l&&(A(l),(async()=>{try{const{fileConverter:a}=await k(async()=>{const{fileConverter:f}=await import("./file-converter-C4bAF1pZ.js");return{fileConverter:f}},__vite__mapDeps([7,1,2]),import.meta.url);await a.ingest(l,"admin"),m.success(`📋 ${l.name||"media collé"} ajouté`)}catch{}})())}}}),t.querySelector("#ax-chat-camera")?.addEventListener("click",()=>{y.tap(),(async()=>{try{const{smartCamera:n}=await k(async()=>{const{smartCamera:r}=await import("./smart-camera-D_59mrUx.js");return{smartCamera:r}},__vite__mapDeps([1,2]),import.meta.url),{adminPrompt:s}=await k(async()=>{const{adminPrompt:r}=await import("./admin-prompt-Cn2qIm5W.js");return{adminPrompt:r}},__vite__mapDeps([8,6,9,5,2,1,0,3]),import.meta.url),i=await s.askChoice("📷 Caméra","Choisis le mode :",[{id:"single",label:"Photo simple",emoji:"📷",variant:"primary"},{id:"burst",label:"Rafale (5 photos)",emoji:"⚡",variant:"ghost"},{id:"qr_live",label:"Scanner QR/Code-barre",emoji:"⬛",variant:"ghost"},{id:"video_record",label:"Enregistrer vidéo (30s)",emoji:"🎬",variant:"ghost"}]);if(!i)return;if(i==="single"){const r=await n.captureSingle();if(!r.ok){m.error(r.reason??"Capture échouée");return}const l=r.dataUrls?.[0];if(l){const a=t.querySelector(".ax-chat-scroll");if(a){const f=document.createElement("div");f.className="ax-msg ax-msg-user ax-slide-up-fade";const b=document.createElement("img");b.alt="Capture caméra",b.style.maxWidth="100%",b.style.borderRadius="8px",(typeof l=="string"&&/^data:image\/[a-z+]+;base64,/i.test(l)||typeof l=="string"&&/^https?:/.test(l))&&(b.src=l),f.appendChild(b),a.appendChild(f),a.scrollTo({top:a.scrollHeight,behavior:"smooth"})}m.success("Photo capturée")}}else if(i==="burst"){const r=await n.captureBurst(5,200);m.info(r.ok?`${r.count} photos capturées`:r.reason??"Échec")}else if(i==="qr_live")await n.scanQrLive(r=>{for(const l of r)m.success(`📦 ${l.format}: ${l.rawValue.slice(0,80)}`)},{durationMs:15e3});else if(i==="video_record"){const r=await n.startVideoRecord(3e4);if(!r.ok){m.error(r.reason??"Recording impossible");return}m.info("🔴 Enregistrement 30s..."),setTimeout(()=>{n.stopVideoRecord().then(l=>{l.ok&&m.success(`Vidéo ${Math.round((l.blob?.size??0)/1024)}KB`)})},3e4)}}catch(n){m.error(n instanceof Error?n.message:"Erreur caméra")}})()}),t.querySelector("#ax-chat-menu")?.addEventListener("click",()=>{y.tap();const n=P.get("isAdmin"),s=z.open({title:"☰ Menu",content:`
      ...
      `,actions:[{label:"Fermer",variant:"ghost",onClick:()=>s.close()}]});setTimeout(()=>{document.querySelectorAll("[data-menu-nav]").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.menuNav??"";y.tap(),s.close(),r&&(location.hash=`#${r}`)})}),document.querySelectorAll("[data-menu-action]").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.menuAction??"";y.tap(),s.close(),r==="paste-key"?t.querySelector("#ax-paste-key-nav")?.click():r==="logout"&&t.querySelector("#ax-logout-nav")?.click()})})},50)});const B=t.querySelector("#ax-chat-settings");B||t.addEventListener("click",n=>{n.target.closest("#ax-chat-settings")&&(location.hash="#settings")}),B?.addEventListener("click",()=>{y.tap(),(async()=>{try{const{aiRoutingPolicy:n}=await k(async()=>{const{aiRoutingPolicy:a}=await import("./ai-routing-policy-CCS8bVx9.js");return{aiRoutingPolicy:a}},__vite__mapDeps([10,1,11,0,2,3,12,13,14,15,16,17,18]),import.meta.url),s=n.getStatus(),i=n.recommendActions(),r=i.length?i.map(a=>`
            ...
            `).join(""):'<li style="color:#22cc77">✅ Tout est configuré au mieux</li>',l=z.open({title:"⚙️ Paramètres",content:`
          ...
          `,actions:[{label:"Fermer",variant:"ghost",onClick:()=>l.close()}]});setTimeout(()=>{const a=document.getElementById("ax-settings-mode");a?.addEventListener("change",()=>{const b=a.value;n.setMode(b),m.success(`Mode routing : ${b}`),y.medium()}),document.getElementById("ax-settings-paste-key")?.addEventListener("click",()=>{l.close(),t.querySelector("#ax-paste-key-nav")?.click()})},50)}catch(n){const s=n instanceof Error?n.message:"erreur";m.error(`Paramètres indisponibles : ${s}`)}})()});const V=n=>{t.querySelector(n)?.addEventListener("click",()=>{y.tap();const i=z.open({title:"🔑 Coller ta clé API",content:`
        ...
        `,actions:[{label:"Annuler",variant:"ghost",onClick:()=>{y.tap(),i.close()}},{label:"Coller + ranger",variant:"primary",onClick:()=>{const l=document.getElementById("ax-paste-input")?.value.trim()??"";if(!l){m.warn('⚠️ Textarea vide — utilise "📋 Coller automatiquement" ou long press dans le rectangle blanc');return}i.close(),(async()=>{const a=await Y.autoStore(l);if(a.forbidden){y.error(),m.error(`${a.pattern?.name} : Apex ne stocke jamais ce type de donnée pour ta sécurité.`,{duration:6e3});return}if(!a.ok){y.warning(),m.warn("Format non reconnu : "+(a.reason??"inconnu")+` (taille ${l.length} chars, début: "${l.slice(0,12)}...")`,{duration:8e3});return}y.success();const f=a.valid===!0?" ✅ validée":a.valid===!1?" ⚠️ ping échoué":"";m.success(`${a.pattern?.name} rangée${f}`),mt(t)})()}}]});setTimeout(()=>{const r=document.getElementById("ax-paste-clipboard-btn"),l=document.getElementById("ax-paste-input"),a=document.getElementById("ax-paste-preview"),f=document.getElementById("ax-paste-detection");r?.addEventListener("click",async()=>{y.tap();try{if(!navigator.clipboard?.readText){m.warn("Clipboard API non supportée. Long press dans le textarea → Coller manuellement.");return}const $=(await navigator.clipboard.readText()).trim();if(!$){m.warn("Presse-papiers vide. Copie d'abord ta clé puis tap ce bouton.");return}l&&(l.value=$);const{detectCredential:S}=await k(async()=>{const{detectCredential:K}=await import("./credential-patterns-DqicUg9o.js");return{detectCredential:K}},[],import.meta.url),E=S($);a&&f&&(E?(f.textContent=`✅ Détecté : ${E.name} (${$.length} chars)`,a.style.display="block",a.style.background="rgba(34,204,119,0.1)",a.style.color="#22cc77"):(f.textContent=`⚠️ Format inconnu (${$.length} chars, début "${$.slice(0,15)}...")`,a.style.display="block",a.style.background="rgba(255,170,0,0.1)",a.style.color="#ffaa00")),m.success('Clé collée — vérifie + tap "Coller + ranger"'),y.medium()}catch(b){const $=b instanceof Error?b.message:"erreur";m.warn(`Permission presse-papiers refusée. Long press dans le textarea blanc → Coller. (${$})`)}}),l?.addEventListener("input",async()=>{const b=l.value.trim();if(!b||!a||!f){a&&(a.style.display="none");return}const{detectCredential:$}=await k(async()=>{const{detectCredential:E}=await import("./credential-patterns-DqicUg9o.js");return{detectCredential:E}},[],import.meta.url),S=$(b);S?(f.textContent=`✅ Détecté : ${S.name} (${b.length} chars)`,a.style.display="block",a.style.background="rgba(34,204,119,0.1)",a.style.color="#22cc77"):(f.textContent=`⚠️ Format inconnu (${b.length} chars)`,a.style.display="block",a.style.background="rgba(255,170,0,0.1)",a.style.color="#ffaa00")})},100)})};V("#ax-paste-key"),V("#ax-paste-key-nav"),t.addEventListener("click",n=>{const i=n.target.closest("[data-nav-route]");if(i){const r=i.dataset.navRoute;r&&(y.tap(),location.hash="#"+r)}}),t.addEventListener("click",n=>{const i=n.target.closest("[data-action]");if(!i)return;const r=i.getAttribute("data-action"),l=i.getAttribute("data-msg-id");if(!r||!l||r!=="speak"&&r!=="copy"&&r!=="export-pdf")return;const a=D.find(f=>f.id===l);if(a){if(r==="speak"){lt(i,a);return}if(r==="copy"){dt(a);return}if(r==="export-pdf"){ut(a);return}}}),t.querySelector("#ax-logout-nav")?.addEventListener("click",()=>{y.tap();const n=z.open({title:"Déconnexion ?",content:"<p>Tes données restent sauvegardées (Coffre, conversations, profil).</p>",actions:[{label:"Annuler",variant:"ghost",onClick:()=>n.close()},{label:"Déconnecter",variant:"danger",onClick:()=>{y.medium(),n.close(),k(()=>import("./auth-DfBiOs-y.js"),__vite__mapDeps([19,0,1,2,3,12,18]),import.meta.url).then(s=>{s.auth.logout(),m.info("Déconnecté"),location.hash="#landing"})}}]})}),D.length&&I(t),j.info("chat","Chat view rendered")}export{_ as escapeHtml,et as handleLightboxAction,ct as isAutoReadEnabled,pt as maybeAutoReadAssistant,tt as openImageLightbox,at as pushTransformResult,mt as render,Z as renderImageAlbum,H as renderMarkdownLight,F as renderMessageActions,N as renderToolPills,Lt as setAutoReadEnabled};
//# sourceMappingURL=index-Bix1C3Hg.js.map
