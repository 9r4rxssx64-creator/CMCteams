import{e as r}from"./monitoring-BpRt9lbD.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DSjSNYUe.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-CM2wq0Ph.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CVooyODQ.js";import"./kevin-alerts-CPAqCn70.js";import"./whatsapp-B62K_uFw.js";import"./auth-gate-CHOTR15z.js";import"./auth-C4RzI05x.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
