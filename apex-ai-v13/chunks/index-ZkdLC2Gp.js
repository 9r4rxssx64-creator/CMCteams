import{e as g}from"./escape-html-BlQj2yEF.js";import{c as q}from"./listener-cleanup-Y2rGGxxX.js";import{l,a as $,s as H}from"./monitoring-IylaM7fC.js";import{r as j}from"../core/main-DlcG_zKO.js";import{aiRouter as k}from"./ai-router-DSnDr42P.js";import{_ as z}from"./apex-kb-CSQ6lrzQ.js";import{haptic as C}from"./haptic-CQFg2PXZ.js";import{modalSheet as v}from"./modal-sheet-oR7SW-wv.js";import{toast as y}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-EZnZFDrm.js";import"./credential-patterns-CLzI061R.js";import"./chat-fallback-C5CS4zjP.js";import"./apex-tools-dispatch-core-CrIin2T7.js";import"./apex-tools-dispatch-skills-BIR2EZr6.js";import"./apex-tools-dispatch-data-_yBit20W.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-BaXkVqrC.js";import"./apex-tools-misc-rxIglcY4.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./economy-mode-BN9VLOeq.js";const T="apex_v13_agent_browser_history",N=20;class J{async analyze(t,e){const r=(t||"").trim(),a=(e||"").trim();if(!r)throw new Error("URL vide");if(!a)throw new Error("Objectif vide");if(!/^https?:\/\//i.test(r))throw new Error("URL doit commencer par http(s)://");const c=Date.now(),o=`agent_${Date.now()}_${Math.random().toString(36).slice(2,6)}`;let n="",m=!1;try{const s=await fetch(r,{method:"GET",mode:"cors",credentials:"omit"});s.ok&&(n=await s.text(),m=!0)}catch(s){l.info("agent-browser","fetch CORS blocked, fallback skeleton",{err:s})}const h=this.extractRelevantDom(n).slice(0,3e4),d=`Tu es un agent pilote browser. L'utilisateur te donne une URL et un objectif.
