import{e as r}from"./monitoring-DRVTXjnb.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DU4TAkxa.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-oyVqpynn.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-HfCuLlw7.js";import"./kevin-alerts-Cc-DfUIx.js";import"./whatsapp-8Jsxpb8s.js";import"./auth-gate-a434ldwy.js";import"./auth-BD6B4xzE.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
