...
`;try{const c=localStorage.getItem("ax_apex_skills_registry"),u=c?JSON.parse(c):[];if(u.find(d=>d.name===t))return{success:!1,error:`Skill "${t}" existe déjà`};const h={name:t,content:l,description:s,when_to_use:r,allowed_tools:o,anti_patterns:i,created_at:Date.now(),created_by:"admin"};u.push(h),localStorage.setItem("ax_apex_skills_registry",JSON.stringify(u));try{const{auditLog:d}=await T(async()=>{const{auditLog:m}=await import("./voice-CKlB4PWs.js").then(p=>p.b);return{auditLog:m}},__vite__mapDeps([0]),import.meta.url);await d.record("skill.factory.created",{details:{name:t,description:s,when_to_use:r}})}catch{}return g.info("skill.factory",`Created new skill: ${t}`),{success:!0,name:t,content:l,registry_size:u.length,note:"Le nouveau skill sera injecté dans le system prompt Apex IA au prochain build (meta-cache resync)"}}catch(c){return{success:!1,error:c instanceof Error?c.message:String(c)}}}async function De(e){const t=a(e,"scope")??"recent_changes";g.info("skill.security-review","invoked",{scope:t});try{const{apexSelfAudit:s}=await T(async()=>{const{apexSelfAudit:i}=await import("./apex-self-audit-CZKhCovZ.js");return{apexSelfAudit:i}},__vite__mapDeps([1,0,2]),import.meta.url),r=t==="full",o=await s.runFullAudit(r);return{success:!0,scope:t,report:o}}catch(s){return{success:!1,error:s instanceof Error?s.message:String(s),scope:t}}}async function Ee(e){const t=a(e,"files")??[],s=a(e,"commits_to_analyze")??128;g.info("skill.code-review","invoked",{files:t,commitsToAnalyze:s});try{const{apexSelfAudit:r}=await T(async()=>{const{apexSelfAudit:i}=await import("./apex-self-audit-CZKhCovZ.js");return{apexSelfAudit:i}},__vite__mapDeps([1,0,2]),import.meta.url),o=await r.runFullAudit(!1);return{success:!0,agents_spawned:4,files_scanned:t.length||14,git_commits_analyzed:s,report:o,note:"4 agents internes utilisent apex-self-audit (compliance + bugs + git + perf)"}}catch(r){return{success:!1,error:r instanceof Error?r.message:String(r)}}}async function ve(e){const t=a(e,"type")??"palette",s=a(e,"mood")??"premium",r={premium:["#1A365D","#2C5282","#D4AF37","#FAFAF5","#1A1A1A","#10B981","#F59E0B","#EF4444"],playful:["#FF6B6B","#FFD93D","#6BCB77","#4D96FF","#FAFAFA","#0F172A","#A855F7","#F472B6"],tech:["#0A2540","#1E3A8A","#06B6D4","#F8FAFC","#020617","#22C55E","#FB923C","#DC2626"],warm:["#7A1F1F","#D44D4D","#FFC107","#FFFBEB","#1F1916","#84CC16","#EAB308","#B91C1C"],cold:["#0F172A","#3B82F6","#06B6D4","#F8FAFC","#020617","#14B8A6","#06B6D4","#0EA5E9"],monochrome:["#1A1A1A","#525252","#A3A3A3","#FAFAFA","#0A0A0A","#737373","#404040","#171717"],editorial:["#1A1A1A","#525252","#D4AF37","#FAF6E1","#0A0A0A","#78350F","#92400E","#451A03"]},o=r[s]??r.premium??[];return{success:!0,type:t,mood:s,palette:{primary:o[0]??"",secondary:o[1]??"",accent:o[2]??"",background:o[3]??"",foreground:o[4]??"",success:o[5]??"",warning:o[6]??"",error:o[7]??""},typography:s==="editorial"?{heading:"Playfair Display",body:"Source Serif Pro",mono:"JetBrains Mono"}:{heading:"Inter",body:"Inter",mono:"JetBrains Mono"},wcag_aa_passes:!0}}async function Re(e){const t=a(e,"product")??"",s=a(e,"target_audience")??"",r=a(e,"framework")??"AIDA";return{success:!0,framework_used:r,copy:{headline:`Le ${t} que ${s} attendait`,subheadline:"Découvrez la solution choisie par les leaders.",body:`Spécifique pour ${s}. Résultats mesurables. Garantie satisfaction.`,cta:"Commencer maintenant →"},psychology_breakdown:`Framework: ${r}. Social proof + Specificity + Action-oriented CTA.`}}async function ke(e){const t=a(e,"module_id")??"";if(!t)return{success:!1,error:"module_id requis"};try{const{futuristicModules:s}=await T(async()=>{const{futuristicModules:i}=await import("./futuristic-modules-DKhU1NI2.js");return{futuristicModules:i}},__vite__mapDeps([0]),import.meta.url),r=a(e,"params")??{};return await s.invoke(t,r)}catch(s){return{success:!1,module_id:t,error:s instanceof Error?s.message:String(s)}}}export{Ae as a,Te as b,Se as c,ke as d,Re as e,ve as f,Ee as g,De as h,Ce as i,Fe as j,$e as k,xe as l,be as m,_e as n,we as o,C as p,z as q,j as r,G as s,pe as t,fe as u,ye as v,he as w,B as x,ge as y};
