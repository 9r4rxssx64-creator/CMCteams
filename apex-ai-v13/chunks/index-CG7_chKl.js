import{b as x,e as s,l as m}from"./monitoring-CvP9ulCW.js";import{r as f}from"./apex-tools-dispatch-skills-B8js_8h_.js";import{mcpRegistry as c}from"./mcp-registry-5NWPpsu3.js";import{skillsWatch as g}from"./skills-watch-DWioyTN4.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-0p_vlsjK.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-Ds3uJQ4I.js";import"./haptic-CQFg2PXZ.js";function b(t){const l={alive:{color:"#10b981",emoji:"🟢"},dead:{color:"#ef4444",emoji:"🔴"},unknown:{color:"#94a3b8",emoji:"⚪"}},a=l[t]??l.unknown;return`<span style="color:${a.color};font-weight:600">${a.emoji} ${s(t)}</span>`}function p(t){if(!(x.get("isAdmin")===!0)){t.innerHTML='<div class="ax-gs-37">🔒 Réservé admin Kevin</div>';return}c.init();const a=c.list(),d=g.getLastReport("mcp-health-watch"),u=a.map(e=>{const r=e.toolsExposed?.length??0,i=e.lastCheck?new Date(e.lastCheck).toLocaleString("fr-FR"):"jamais";return`
