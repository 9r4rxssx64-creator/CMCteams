import{e as r}from"./monitoring-eS3mQsuP.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CD5PwIbu.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DRC5_BGP.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DXirSuC2.js";import"./kevin-alerts-DEC08hl6.js";import"./whatsapp-DUkUO5lq.js";import"./auth-gate-n680mZxm.js";import"./auth-DBGLzjph.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
