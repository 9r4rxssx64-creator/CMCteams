import{b as x,e as s,l as m}from"./monitoring-BQbiUTkF.js";import{r as f}from"./apex-tools-dispatch-skills-DNSJiRP8.js";import{mcpRegistry as c}from"./mcp-registry-DLeiu9XX.js";import{skillsWatch as g}from"./skills-watch-DWfG_BY-.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-JCoCFUdV.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-D6z-UVRr.js";import"./haptic-CQFg2PXZ.js";function b(t){const l={alive:{color:"#10b981",emoji:"🟢"},dead:{color:"#ef4444",emoji:"🔴"},unknown:{color:"#94a3b8",emoji:"⚪"}},a=l[t]??l.unknown;return`<span style="color:${a.color};font-weight:600">${a.emoji} ${s(t)}</span>`}function p(t){if(!(x.get("isAdmin")===!0)){t.innerHTML='<div class="ax-gs-37">🔒 Réservé admin Kevin</div>';return}c.init();const a=c.list(),d=g.getLastReport("mcp-health-watch"),u=a.map(e=>{const r=e.toolsExposed?.length??0,i=e.lastCheck?new Date(e.lastCheck).toLocaleString("fr-FR"):"jamais";return`
