import{m as n,s as d}from"./monitoring-qYECZG6L.js";import"./multi-source-analyze-DI0tATGY.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-C1B0uCd_.js";const u={ai:"🧠 Intelligence Artificielle",saas:"💼 SaaS",comms:"✉️ Communications",infra:"☁️ Infrastructure",finance:"💳 Finance & Paiements",other:"🔧 Autres"};function f(a){if(a.length<2)return'<span class="ax-spark-empty">—</span>';const s=Math.max(...a.map(i=>i.eur),1),e=120,t=32,r=e/(a.length-1),o=a.map((i,l)=>`${l===0?"M":"L"}${(l*r).toFixed(1)} ${(t-i.eur/s*t).toFixed(1)}`).join(" ");return`
