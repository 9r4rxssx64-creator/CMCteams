import{o as n}from"./monitoring-BkJ_WZbY.js";import"./multi-source-analyze-DCjiC-qU.js";import"./apex-kb-C132uqD8.js";import"./credential-patterns-CLzI061R.js";const d={ai:"🧠 Intelligence Artificielle",saas:"💼 SaaS",comms:"✉️ Communications",infra:"☁️ Infrastructure",finance:"💳 Finance & Paiements",other:"🔧 Autres"};function u(a){if(a.length<2)return'<span class="ax-spark-empty">—</span>';const s=Math.max(...a.map(i=>i.eur),1),e=120,r=32,t=e/(a.length-1),o=a.map((i,l)=>`${l===0?"M":"L"}${(l*t).toFixed(1)} ${(r-i.eur/s*r).toFixed(1)}`).join(" ");return`
