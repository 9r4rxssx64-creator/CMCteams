import{b as k,l as f,e as n}from"./monitoring-Bg0Oiujo.js";import{c as w}from"./listener-cleanup-Y2rGGxxX.js";import{apexAutonomousMode as d}from"./apex-autonomous-mode-BEC0C6ep.js";import{autonomousWatch as h}from"./autonomous-watch-wHqokhOv.js";import{haptic as A}from"./haptic-CQFg2PXZ.js";import{toast as i}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-B6It-ijz.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-z0aUEZIG.js";import"./ai-router-BL4McLpX.js";import"../core/main-DFq-1Qsm.js";import"./economy-mode-DXUWpRi1.js";import"./chat-fallback-DOvDj7Eb.js";import"./apex-tools-dispatch-core-wfid_LJg.js";import"./apex-tools-dispatch-skills-DCkJeZGy.js";import"./apex-tools-dispatch-data-CMpu6xmY.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-Bqrh0fEh.js";import"./apex-tools-misc-YmKNsxq_.js";import"./apex-tools-registry-core-B4u4pCoL.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./firebase-queue-Bm1KGSa0.js";let c=null,r=null;function X(){r&&(clearInterval(r),r=null),c?.cleanup(),c=null}function v(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function z(t){if(!t)return`
