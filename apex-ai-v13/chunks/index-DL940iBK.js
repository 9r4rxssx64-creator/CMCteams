import{l as b}from"./monitoring-3uBGKGRH.js";import{s as y}from"../core/main-FGs0Cy95.js";import{c as h}from"./csp-style-helper-BisGRi53.js";import{iotRegistry as d}from"./iot-providers-registry-azCPac71.js";import{toast as r}from"./toast-ClsF1KRZ.js";import"./apex-kb-vEgxDV-A.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-DUow5a1T.js";import"./broadlink-bridge-BULp0SBO.js";import"./haptic-CQFg2PXZ.js";const v="kdmc_admin";function n(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function $(){return y.get("user")?.id===v}async function g(e){if(e){if(!$()){e.innerHTML=`
