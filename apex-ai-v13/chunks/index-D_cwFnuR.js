import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-CHdxRYqH.js";import{broadlinkBridge as t}from"./broadlink-bridge-BcEGPAkW.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-BbuqZtIN.js";import"./credential-patterns-qcw7Brjr.js";import"./multi-source-analyze-BNltq3UP.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
