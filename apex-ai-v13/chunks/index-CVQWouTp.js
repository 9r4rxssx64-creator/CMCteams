import{e as r}from"./monitoring-Dwmx5tS-.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-C8AZIMOz.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-BwmGob6O.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-D-RQMX7f.js";import"./kevin-alerts-M3cCwAx5.js";import"./whatsapp-Do_wpHf6.js";import"./auth-gate-D33Jb9iN.js";import"./auth-CjfLdIaC.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
