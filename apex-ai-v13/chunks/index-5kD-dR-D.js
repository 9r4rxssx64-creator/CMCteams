import{b as x,e as s,l as m}from"./monitoring-DKvm4AF3.js";import{r as f}from"./apex-tools-dispatch-skills-DRfHCn10.js";import{mcpRegistry as c}from"./mcp-registry-Bp0_eI7m.js";import{skillsWatch as g}from"./skills-watch-Bv2NfseX.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-4KwHUxnT.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-D5AC3Kxi.js";import"./haptic-CQFg2PXZ.js";function b(t){const l={alive:{color:"#10b981",emoji:"🟢"},dead:{color:"#ef4444",emoji:"🔴"},unknown:{color:"#94a3b8",emoji:"⚪"}},a=l[t]??l.unknown;return`<span style="color:${a.color};font-weight:600">${a.emoji} ${s(t)}</span>`}function p(t){if(!(x.get("isAdmin")===!0)){t.innerHTML='<div class="ax-gs-37">🔒 Réservé admin Kevin</div>';return}c.init();const a=c.list(),d=g.getLastReport("mcp-health-watch"),u=a.map(e=>{const r=e.toolsExposed?.length??0,i=e.lastCheck?new Date(e.lastCheck).toLocaleString("fr-FR"):"jamais";return`
