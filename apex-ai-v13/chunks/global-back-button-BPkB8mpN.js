import{l as n}from"./monitoring-BoEKyGkX.js";import"./multi-source-analyze-QSHSuVVp.js";import"./apex-kb-BedjWJA9.js";import"./credential-patterns-CLzI061R.js";const i="apex-global-back-btn",a="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(a))return;const t=`
      #${i} {
        position: fixed;
