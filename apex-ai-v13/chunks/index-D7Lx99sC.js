const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-3uBGKGRH.js","./apex-kb-D6gjJiDN.js","./credential-patterns-CLzI061R.js","./multi-source-analyze-8fXmK5FN.js","./auth-CbQBxw6M.js","../assets/css/main-BUIq5pfg.css"])))=>i.map(i=>d[i]);
import{_ as u}from"./apex-kb-D6gjJiDN.js";import{e as y}from"./escape-html-B4YFbUXM.js";import{c as P}from"./listener-cleanup-Y2rGGxxX.js";import{l as A}from"./monitoring-3uBGKGRH.js";import{s as L}from"../core/main-DBiCqUwg.js";import{c as E}from"./csp-style-helper-BisGRi53.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-8fXmK5FN.js";let i=null;function F(){i?.cleanup(),i=null}const I="apex_v13_chat_auto_read";function O(){try{return localStorage.getItem(I)==="1"}catch{return!1}}function D(n){try{localStorage.setItem(I,n?"1":"0")}catch{}}async function V(n){try{const $=await u(()=>import("./voice-pOsZW5qo.js").then(l=>l.c),__vite__mapDeps([0,1,2]),import.meta.url),{listVoices:k,getActiveVoice:x,setActiveVoice:f,speak:m,stopAll:b}=$,h=n.querySelector("#ax-settings-auto-read"),S=n.querySelector("#ax-voice-current"),_=n.querySelector("#ax-voice-list"),T=n.querySelectorAll(".ax-voice-cat-btn");if(!_)return;h&&(h.checked=O(),i.bind(h,"change",()=>{D(h.checked),(async()=>{const{toast:l}=await u(async()=>{const{toast:d}=await import("./toast-ClsF1KRZ.js");return{toast:d}},[],import.meta.url);l.success(h.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const z=()=>{if(!S)return;const l=x(),g=k().find(v=>v.id===l);S.textContent=g?`Voix active : ${g.emoji??"🔊"} ${g.name} (${g.category})`:`Voix active : ${l}`};z();const w=l=>{const d=k(),g=l==="all"?d:d.filter(e=>e.category===l),v=x();_.innerHTML=g.map(e=>{const a=e.id===v,o=e.emoji??(e.category==="pro"?"🎙️":e.category==="fun"?"🎉":"🎨"),t=e.description?y(e.description):"",r=a?"background:rgba(232,184,48,0.15);border-color:rgba(232,184,48,0.45)":"background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.06)";return`
