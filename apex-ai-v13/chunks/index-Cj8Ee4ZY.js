const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-CK0rcZmH.js","./monitoring-CrUxUkKj.js","./multi-source-analyze-Bkqb1WVC.js","./credential-patterns-CLzI061R.js","./auth-DwYzny07.js"])))=>i.map(i=>d[i]);
import{_ as v}from"./apex-kb-CK0rcZmH.js";import{b,r as g}from"../core/main-PEGkDzx1.js";import{a as x}from"./escape-html-DGIYNPKb.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{auth as _}from"./auth-DwYzny07.js";import{i as h}from"./apex-tools-dispatch-core-CKMQkgVw.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import{toast as m}from"./toast-CRdbcLoc.js";import"./monitoring-CrUxUkKj.js";import"./multi-source-analyze-Bkqb1WVC.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-CbmWJN4W.js";import"./apex-tools-dispatch-data-BP3L9kyZ.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-a0Ewo8gG.js";import"./apex-tools-misc-B5RxC7rp.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let l=null;function J(){l?.cleanup(),l=null}function S(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}async function I(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),p=localStorage.getItem("apex_v13_last_known_name"),o=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!p||!o)return!1;const{deviceContext:n}=await v(async()=>{const{deviceContext:c}=await import("./device-context-CQLo4mM7.js");return{deviceContext:c}},__vite__mapDeps([0,1,2,3]),import.meta.url);if((await n.getFingerprint()).device_id!==o)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:t}=await v(async()=>{const{auth:c}=await import("./auth-DwYzny07.js");return{auth:c}},__vite__mapDeps([4,0,1,2,3]),import.meta.url);if((await t.loginTrusted(e,p)).ok)return g.navigate("chat"),!0}catch{}return!1}function O(e){if(l?.cleanup(),l=y("landing"),!h("module.landing")){e.innerHTML=`
