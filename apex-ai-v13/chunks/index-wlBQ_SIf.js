import{e as r}from"./monitoring-B_mTQJ5f.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CTHuiWkF.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-ajv1lZKz.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-Bbc5CKue.js";import"./kevin-alerts-C-3Filwl.js";import"./whatsapp-DZyK3cr3.js";import"./auth-gate-Ct-ezY1s.js";import"./auth-B94C5_WZ.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
