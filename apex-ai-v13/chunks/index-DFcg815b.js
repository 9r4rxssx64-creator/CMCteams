import{e as r}from"./monitoring-BAfbao5s.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CF0pSlj3.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DXfBT6z8.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CN_a2NJH.js";import"./kevin-alerts-D8Q9tKzE.js";import"./whatsapp-TrwnwCsV.js";import"./auth-gate-gSLKWoAn.js";import"./auth-BgWS2ZWn.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
