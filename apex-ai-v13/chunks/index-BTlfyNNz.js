const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./memory-bridge-B7dJPtge.js","../core/main-CVBVMToZ.js","../assets/css/main-Bng3LWQS.css","./audit-log-CtaoMSI4.js","./observability-CvvuAVzU.js","./persistent-memory-store-C_ZdZOtn.js","./toast-BkOpdP-z.js","./haptic-BUEqXK0N.js","./auth-Dg-haRDc.js"])))=>i.map(i=>d[i]);
import{s as p,_ as r,l}from"../core/main-CVBVMToZ.js";function m(o){const u=p.get("user"),g=p.get("isAdmin")??!1;o.innerHTML=`
