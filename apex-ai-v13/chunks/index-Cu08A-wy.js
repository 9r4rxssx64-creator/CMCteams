...
import{_ as u}from"./apex-kb-BRFYnqla.js";import{a as o}from"./escape-html-DGIYNPKb.js";import{c as M}from"./listener-cleanup-Y2rGGxxX.js";import{q as D}from"./monitoring-DGsdmyG7.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-BxcrFYSE.js";let i=null;function E(){i?.cleanup(),i=null}async function g(n){i?.cleanup(),i=M("sentinels");const{sentinels:x}=await u(async()=>{const{sentinels:t}=await import("./sentinels-tOYZUjlt.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),{sentinelsRegistry:m,bootstrapSentinelsRegistry:b}=await u(async()=>{const{sentinelsRegistry:t,bootstrapSentinelsRegistry:a}=await import("./sentinels-registry-BiH36dj9.js");return{sentinelsRegistry:t,bootstrapSentinelsRegistry:a}},__vite__mapDeps([0,1,2,3]),import.meta.url);b();const e=x.list(),y=m.getStatus(),p=m.getMetrics(),v=e.filter(t=>t.lastResult?.ok).length,$=e.filter(t=>t.lastResult&&!t.lastResult.ok).length,R=e.filter(t=>!t.lastResult).length;n.innerHTML=`
