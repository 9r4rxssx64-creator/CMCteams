import{b as k,l as f,e as n}from"./monitoring-eS3mQsuP.js";import{c as w}from"./listener-cleanup-Y2rGGxxX.js";import{apexAutonomousMode as d}from"./apex-autonomous-mode-C28JLusp.js";import{autonomousWatch as h}from"./autonomous-watch-D-mvozR0.js";import{haptic as A}from"./haptic-CQFg2PXZ.js";import{toast as i}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DRC5_BGP.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DXirSuC2.js";import"./ai-router-fsKyzqmM.js";import"../core/main-Cvm2bldz.js";import"./economy-mode-BS2R6oxR.js";import"./chat-fallback-C69eC_2Z.js";import"./apex-tools-dispatch-core-DpLATz68.js";import"./apex-tools-dispatch-skills-DIn_62CE.js";import"./apex-tools-dispatch-data-BUaL_mf4.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-DrFAAeH4.js";import"./apex-tools-misc-Z1KCGGIq.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./firebase-queue-BHvCI7ea.js";let c=null,r=null;function X(){r&&(clearInterval(r),r=null),c?.cleanup(),c=null}function v(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function z(t){if(!t)return`
