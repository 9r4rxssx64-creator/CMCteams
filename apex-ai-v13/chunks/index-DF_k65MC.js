...
import{_ as g}from"./apex-kb-BTjMfcEM.js";import{l as M}from"./monitoring-3uBGKGRH.js";import{m as b}from"../core/main-C8f0ioof.js";import{g as L}from"./apex-tools-dispatch-core-Byp69UIC.js";import{toast as p}from"./toast-ClsF1KRZ.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-D5mviugG.js";import"./apex-tools-dispatch-skills-hKWaecbw.js";import"./apex-tools-dispatch-data-C85pNwXu.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-aOZ9T32r.js";import"./apex-tools-registry-DAP-5MYm.js";import"./voice-CmXxr4Jw.js";import"./haptic-CQFg2PXZ.js";const S="kdmc_admin";function c(r){return r.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function T(){try{const r=localStorage.getItem("apex_v13_user");return r?JSON.parse(r):null}catch{return null}}function x(r){if(!r)return"—";try{return new Date(r).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function h(r){if(!r)return"jamais";const t=Date.now()-r,e=t/36e5;return e<1?`${Math.floor(t/6e4)}min`:e<24?`${Math.floor(e)}h`:`${Math.floor(e/24)}j`}function B(r){const t=T(),e=t?.id===S,o=t?.name??"Anonyme";L("admin.kb",r,t?.id)&&(r.innerHTML=`
