import{e as a}from"./escape-html-BlQj2yEF.js";import{c as h}from"./listener-cleanup-Y2rGGxxX.js";import{s as y,l as v}from"./monitoring-BkJ7GkQd.js";import{m,s as f}from"./multi-source-analyze-B5GxSoZr.js";import{haptic as l}from"./haptic-CQFg2PXZ.js";import{toast as n}from"./toast-CRdbcLoc.js";import"./apex-kb-D6Tnu3RN.js";import"./credential-patterns-CLzI061R.js";let p=null;function L(){p?.cleanup(),p=null}async function u(e){if(!(y.get("isAdmin")===!0)){e.innerHTML=`
      <div class="ax-gs-21">
        <h2 class="ax-gs-266">Accès admin uniquement</h2>
        <p>Multi-Source History — Kevin admin.</p>
      </div>
    `;return}p?.cleanup(),p=h("multi-source-history");const r=m.getHistory(),o=m.getStats(),c=f.listKnown();e.innerHTML=b(r,o,c.length),S(e,r),v.info("multi-source-history",`Render ${r.length} sources, ${o.items_total} items`)}function b(e,t,r){const o=t.items_total>0?Math.round(t.items_configured/t.items_total*100):0,c=t.items_configured>0?Math.round(t.items_tested_ok/t.items_configured*100):0;return`
