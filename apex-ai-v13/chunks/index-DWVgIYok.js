import{e as r}from"./monitoring-DYX6bdmc.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DP1lsG-b.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-CRio0pH7.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-WuvlUkP-.js";import"./kevin-alerts-BT_9Oe7j.js";import"./whatsapp-B4iKIkQS.js";import"./auth-gate-DW95y2Jg.js";import"./auth-1gwvG6Ic.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
