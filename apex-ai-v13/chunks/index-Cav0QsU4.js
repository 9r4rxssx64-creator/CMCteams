import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-B81OMBNP.js";import{broadlinkBridge as t}from"./broadlink-bridge-t7xsrjOn.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-CTF0Ti0W.js";import"./credential-patterns-z3lBBSNT.js";import"./multi-source-analyze-CDoC_lMn.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
