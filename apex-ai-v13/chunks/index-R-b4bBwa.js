import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-DZyO3m1v.js";import{broadlinkBridge as t}from"./broadlink-bridge-Bx3fgJsv.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-SSNoHAZM.js";import"./credential-patterns-CXLwp4oz.js";import"./multi-source-analyze-CCuoLf0d.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
