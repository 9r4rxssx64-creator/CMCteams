const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-IylaM7fC.js","./multi-source-analyze-EZnZFDrm.js","./apex-kb-CSQ6lrzQ.js","./credential-patterns-CLzI061R.js"])))=>i.map(i=>d[i]);
import{a as f,_ as k}from"./apex-kb-CSQ6lrzQ.js";import{e as s}from"./escape-html-BlQj2yEF.js";import{c as H}from"./listener-cleanup-Y2rGGxxX.js";import{s as M,d as _,l as g}from"./monitoring-IylaM7fC.js";import{apexExecute as y}from"./apex-execute-BSg1PK7_.js";import{auth as P}from"./auth-DqrZiin7.js";import{c as D}from"./csp-style-helper-BisGRi53.js";import{i as T,r as R}from"./apex-tools-dispatch-core-CrIin2T7.js";import{kdmcProjectsRegistry as A}from"./kdmc-projects-registry-DR1qGCLT.js";import{w as j}from"./whatsapp-BUYfkt2K.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{s as E}from"../core/main-DlcG_zKO.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-EZnZFDrm.js";import"./apex-tools-dispatch-skills-BIR2EZr6.js";import"./apex-tools-dispatch-data-_yBit20W.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-BaXkVqrC.js";import"./apex-tools-misc-rxIglcY4.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let v="commerce";const I={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function z(){const t=_.isEnabled();return`
  ...
  `}function G(){const t=I[v];if(t&&!T(t))return`<div class="ax-admin-section">${R(t)}</div>`;switch(v){case"commerce":return z();case"users":return V();case"pending":return B();case"health":return F();case"projects":return N();case"executions":return O();case"knowledge":return K();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>';case"audit-log":return'<div id="ax-admin-mount-audit-log" class="ax-admin-section"><p class="ax-muted">Chargement audit log immuable…</p></div>'}}async function q(t){const o=t.querySelector("#ax-admin-audits-summary");if(o)try{const{reportsHistory:n}=await k(async()=>{const{reportsHistory:b}=await import("./apex-reports-history-B_u6ppd4.js");return{reportsHistory:b}},__vite__mapDeps([0,1,2,3]),import.meta.url),e=n.getStats(),a=e.lastLayoutTs?new Date(e.lastLayoutTs).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"jamais",i=e.lastFunctionalTs?new Date(e.lastFunctionalTs).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"jamais",u=e.recentBugs>0?"var(--ax-error)":"var(--ax-green)",x=e.recentEscalations>0?"var(--ax-sev-high)":"var(--ax-green)";o.innerHTML=`
      ...
      `}catch(n){g.warn("admin","audits summary render failed",{err:n})}const c=t.querySelector("#ax-admin-mount-bilan");if(c)try{(await k(()=>import("./financial-bilan-CFIwpOkA.js"),__vite__mapDeps([0,1,2,3]),import.meta.url)).render(c)}catch(n){g.warn("admin","financial-bilan render failed",{err:n}),c.innerHTML='<p class="ax-muted">Bilan indisponible (module ko)</p>'}const r=t.querySelector("#ax-admin-mount-consumption");if(r)try{(await k(()=>import("./consumption-dashboard-BD_dyWCS.js"),__vite__mapDeps([0,1,2,3]),import.meta.url)).render(r)}catch(n){g.warn("admin","consumption-dashboard render failed",{err:n}),r.innerHTML='<p class="ax-muted">Consommation indisponible (module ko)</p>'}const l=t.querySelector("#ax-admin-mount-audit-log");if(l){if(!T("admin.audit-log")){l.innerHTML=R("admin.audit-log");return}try{const{auditLog:n}=await k(async()=>{const{auditLog:i}=await import("./monitoring-IylaM7fC.js").then(u=>u.q);return{auditLog:i}},__vite__mapDeps([0,1,2,3]),import.meta.url);n.init();const e=n.getEntries().slice(-100).reverse(),a=e.map(i=>`<li><code>${s(new Date(i.ts).toLocaleString())}</code> · <strong>${s(i.action)}</strong> · ${s(i.actor||"system")}</li>`).join("");l.innerHTML=`
