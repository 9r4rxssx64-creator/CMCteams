import{e as r}from"./monitoring-cgUxWU4N.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BnaxZ_Fm.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DhRsjedI.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-08BL-j6z.js";import"./kevin-alerts-Dhw2BKZm.js";import"./whatsapp-CL61Z22Y.js";import"./auth-gate-C9El9TRS.js";import"./auth-DIZFYLQ0.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
