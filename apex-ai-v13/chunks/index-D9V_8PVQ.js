import{b as u,l as p,e as a,a as x}from"./monitoring-BQ-Irvy-.js";import{c as v}from"./listener-cleanup-Y2rGGxxX.js";import{rgpd as g}from"./rgpd-ClihmxhF.js";import{haptic as o}from"./haptic-CQFg2PXZ.js";import{toast as l}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-Dhd8Ospz.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-lVmzRuTO.js";let s=null;function S(){s?.cleanup(),s=null}function f(i){if(!i)return"—";try{return new Date(i).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function m(i){const e=i.scopes.includes("*")?'<span style="color:#ff6b6b;font-weight:600">Globale (tous scopes)</span>':i.scopes.map(n=>`<code style="background:rgba(255,255,255,0.05);padding:2px 6px;border-radius:4px;font-size:11px;margin-right:4px">${a(n)}</code>`).join("");return`
