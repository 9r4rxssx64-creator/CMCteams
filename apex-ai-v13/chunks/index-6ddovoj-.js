import{e as r}from"./monitoring-CwxJ9cqV.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BXdfBVCD.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-BIU-yOf5.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-B0G8l0r5.js";import"./kevin-alerts-F5KFZQco.js";import"./whatsapp-DGVvtnAj.js";import"./auth-gate-BxFmtiK5.js";import"./auth-BA3n4lrz.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
