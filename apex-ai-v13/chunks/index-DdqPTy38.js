import{c as u}from"./listener-cleanup-Y2rGGxxX.js";import{l as d}from"./monitoring-3uBGKGRH.js";import{s as b}from"../core/main-DU4EptiZ.js";import{autoRestoreCredentials as l}from"./auto-restore-credentials-Cbi-c9LQ.js";import{haptic as g}from"./haptic-CQFg2PXZ.js";import{toast as n}from"./toast-ClsF1KRZ.js";import"./apex-kb-C1dS-h6I.js";import"./credential-patterns-qcw7Brjr.js";import"./multi-source-analyze-D8ut3-WE.js";let i=null,s=null;function H(){i?.cleanup(),i=null,s=null}function a(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}const f={localStorage:{icon:"💾",label:"Local",color:"#22cc77"},idb_shadow:{icon:"🗄️",label:"IDB shadow",color:"#22cc77"},firebase_backup:{icon:"☁️",label:"Firebase backup",color:"#4d9eff"},alias:{icon:"🔗",label:"Alias localStorage",color:"#c9a227"},pattern_match:{icon:"🔍",label:"Pattern match",color:"#ff9d3f"}};function m(e){const t=e.recoverable_from?f[e.recoverable_from]:{icon:"❓",label:"—",color:"#aaa"};return`
