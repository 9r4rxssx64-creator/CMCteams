import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-DE9ruDiu.js";import{h as d}from"./haptic-BUEqXK0N.js";import{toast as s}from"./toast-Dgg9rcIP.js";import"./monitoring-BAiQJoxJ.js";import"./apex-tools-registry-DqA3gZXO.js";import"./apex-kb-BFHUv3jX.js";import"./credential-patterns-Dy6Wjk7e.js";import"./auth-gate-DfqUjrr1.js";import"../core/main-BNLrwE3Y.js";import"./multi-source-analyze-DAvdcAQw.js";import"./commerce-DQ1kl4cy.js";import"./kevin-alerts-CDvGabxb.js";import"./whatsapp-BIW5kwXA.js";let r=null;function C(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function m(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function D(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
