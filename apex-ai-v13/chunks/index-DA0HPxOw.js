import{e as r}from"./monitoring-CaG9JFsT.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-Csxdpt5Q.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-CLACKbxV.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DaSSqxRG.js";import"./kevin-alerts-Byrq_SOE.js";import"./whatsapp-BFZNtDoQ.js";import"./auth-gate-Bn2VJWMG.js";import"./auth-BrAQOjcs.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
