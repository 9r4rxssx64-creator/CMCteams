import{auth as r}from"./auth-EhoW4C6U.js";import{r as a}from"../core/main-CAfKhyyq.js";function l(n){return n.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e)}function s(){const n=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!n||!n[1])return null;try{const e=atob(n[1]),[t,i,o]=e.split(":");if(t)return{uid:t}}catch{}return null}function u(n){const e=s();n.innerHTML=`
...
//# sourceMappingURL=index-lJgPIQ1X.js.map
