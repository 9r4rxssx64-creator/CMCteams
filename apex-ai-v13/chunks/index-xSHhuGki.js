import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-BLLQX--H.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-ClsF1KRZ.js";import"./monitoring-3uBGKGRH.js";import"./apex-kb-Cd0L1a6w.js";import"./credential-patterns-z3lBBSNT.js";import"./auth-gate-8e2HJZJo.js";import"../core/main-BxEfEyDl.js";import"./multi-source-analyze-BRdpAG2S.js";import"./commerce-DQHCQeuq.js";import"./kevin-alerts-Bg4-R0-k.js";import"./whatsapp-Bp5uuwlt.js";let r=null;function P(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function f(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function C(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
