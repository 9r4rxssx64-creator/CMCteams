import{q as n}from"./monitoring-BEF8D60L.js";import"./multi-source-analyze-GHL4EzEF.js";import"./apex-kb-CYEMVHK9.js";import"./credential-patterns-DNv8q-dc.js";const i="apex-global-back-btn",a="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(a))return;const t=`
      #${i} {
        position: fixed;
