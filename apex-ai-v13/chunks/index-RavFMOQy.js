...
import{_ as m}from"./apex-kb-Bv3UHTHR.js";import{e as c}from"./escape-html-BlQj2yEF.js";import{c as C}from"./listener-cleanup-Y2rGGxxX.js";import{l as A}from"./monitoring-3uBGKGRH.js";import{A as b,s as S}from"./auto-improvement-core-Dt7OknT2.js";import"./credential-patterns-CLzI061R.js";let u=null;function W(){u?.cleanup(),u=null}const P={critical:'<span style="color:#ff5b5b">🔥 CRITICAL</span>',high:'<span style="color:#22cc77">⭐ HIGH</span>',medium:'<span style="color:#f0c020">○ MEDIUM</span>',low:'<span style="color:#888">— LOW</span>'},k={installed:'<span style="color:#22cc77">🟢 Installé</span>',available:'<span style="color:#9aa">⚪ Disponible</span>',"unsupported-pwa":'<span style="color:#ff5b5b">🔴 Non-PWA</span>',planned:'<span style="color:#aa8">🟡 Planifié</span>'},z={"dev-tools":"🛠 Dev Tools",lsp:"📝 LSP (langage)",database:"🗄 Database",cloud:"☁ Cloud",deployment:"🚀 Deployment",monitoring:"📊 Monitoring",security:"🛡 Security",productivity:"✨ Productivity",design:"🎨 Design",api:"🔌 API",search:"🔍 Search","vector-rag":"🧠 Vector RAG",payment:"💳 Payment",messaging:"💬 Messaging",social:"📱 Social",auth:"🔐 Auth","ai-ml":"🤖 AI/ML",analytics:"📈 Analytics",mobile:"📱 Mobile",browser:"🌐 Browser",content:"📁 Content",data:"💾 Data",memory:"🧬 Memory",voice:"🎙 Voice",workflow:"⚙ Workflow",observability:"👁 Observability",testing:"🧪 Testing",location:"📍 Location",finance:"💰 Finance",creator:"🎬 Creator",learning:"📚 Learning"},t={search:"",categoryFilter:"all",statusFilter:"all",pwaOnly:!0,view:"marketplace",extendedTypeFilter:"all",extendedCompatFilter:"all",extendedValueFilter:"all",extendedSortBy:"value"},h={"mcp-server":"🧩 MCP Server","mcp-aggregator":"🌐 MCP Aggregator","claude-skill":"🎯 Claude Skill","claude-hook":"🪝 Claude Hook","claude-command":"⌨ Claude Command","claude-subagent-orchestrator":"🤖 Subagent Orchestrator","agent-framework":"🏗 Agent Framework","browser-api":"🌍 Browser API","web-tool":"🛠 Web Tool","github-action":"⚙ GitHub Action","tooling-cli":"⌨ CLI Tooling","status-line":"📊 Status Line","pwa-capability":"📱 PWA Capability"},$={"pwa-direct":"🟢 PWA Direct","cloudflare-worker":"🟡 CF Worker","node-required":"🔴 Node Only","native-only":"⛔ Native Only"},T={high:'<span style="color:#22cc77">⭐ HIGH</span>',medium:'<span style="color:#f0c020">○ MEDIUM</span>',low:'<span style="color:#888">— LOW</span>'};async function s(e){if(u?.cleanup(),u=C("plugins"),t.view==="extended"){await L(e);return}const{apexPluginsMarketplace:n}=await m(async()=>{const{apexPluginsMarketplace:i}=await import("./apex-plugins-marketplace-Cx_fueDw.js");return{apexPluginsMarketplace:i}},__vite__mapDeps([0,1,2]),import.meta.url),d=n.getStats(),f=n.getCategories();let r;t.search.trim()?r=n.search(t.search,100):r=n.list({...t.categoryFilter!=="all"&&{category:t.categoryFilter},...t.statusFilter!=="all"&&{status:t.statusFilter},pwaOnly:t.pwaOnly});const x=n.recommendForUser({minValue:"high",max:6});e.innerHTML=`
  ...
  `}export{W as dispose,s as render};
