import{e as r}from"./monitoring-BQF7kI2q.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-zGyDrEwI.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-BU9bN8Ej.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-klwbQ2l3.js";import"./kevin-alerts-eoIT3c3Y.js";import"./whatsapp-SYKUlKVu.js";import"./auth-gate-CB_n1B0y.js";import"./auth-2t_rrHNS.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
