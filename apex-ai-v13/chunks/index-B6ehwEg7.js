const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-DiTKTVji.js","../core/main-DJD0WOrQ.js","../assets/css/main-Bng3LWQS.css","./observability-yhdBsfdO.js"])))=>i.map(i=>d[i]);
import{_ as l,l as r}from"../core/main-DJD0WOrQ.js";async function n(a){const{sentinels:s}=await l(async()=>{const{sentinels:t}=await import("./sentinels-DiTKTVji.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),e=s.list();a.innerHTML=`
...
//# sourceMappingURL=index-B6ehwEg7.js.map
