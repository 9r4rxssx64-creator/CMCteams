import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-92IJDxUj.js";import{broadlinkBridge as t}from"./broadlink-bridge-BKlR9zcu.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-w4GZZqG7.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-CAKfMbD9.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
