const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./voice-C12Hv_B9.js","./monitoring-B17vNBOa.js","./apex-tools-registry-eSveblul.js","./toast-Dgg9rcIP.js","./haptic-BUEqXK0N.js","./memory-bridge-DGKXsF4A.js","./apex-tools-dispatch-Dr5skY9s.js","./persistent-memory-store-BqtvXdVv.js","./consumption-anomaly-detector-CRHqopEP.js","./consumption-monitor-BFjBBpm8.js","./links-registry-CxAYZBb7.js","./push-notifications-CinypRT4.js","./tokens-dashboard-C5ZzZyK6.js","./auth-D6SKVOTl.js","../core/main-CcYrGU7Q.js","../assets/css/main-rhfGvOFL.css"])))=>i.map(i=>d[i]);
import{_ as l}from"./apex-tools-dispatch-Dr5skY9s.js";import{l as k}from"./monitoring-B17vNBOa.js";import{s as z}from"../core/main-CcYrGU7Q.js";import"./apex-tools-registry-eSveblul.js";function b(i){return i.replace(/[&<>"']/g,m=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[m]??m)}const S="apex_v13_chat_auto_read";function E(){try{return localStorage.getItem(S)==="1"}catch{return!1}}function L(i){try{localStorage.setItem(S,i?"1":"0")}catch{}}async function T(i){try{const m=await l(()=>import("./voice-C12Hv_B9.js").then(o=>o.a),__vite__mapDeps([0,1,2]),import.meta.url),{listVoices:v,getActiveVoice:p,setActiveVoice:u,speak:x,stopAll:f}=m,t=i.querySelector("#ax-settings-auto-read"),r=i.querySelector("#ax-voice-current"),c=i.querySelector("#ax-voice-list"),a=i.querySelectorAll(".ax-voice-cat-btn");if(!c)return;t&&(t.checked=E(),t.addEventListener("change",()=>{L(t.checked),(async()=>{const{toast:o}=await l(async()=>{const{toast:n}=await import("./toast-Dgg9rcIP.js");return{toast:n}},__vite__mapDeps([3,4]),import.meta.url);o.success(t.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const s=()=>{if(!r)return;const o=p(),g=v().find(h=>h.id===o);r.textContent=g?`Voix active : ${g.emoji??"🔊"} ${g.name} (${g.category})`:`Voix active : ${o}`};s();const d=o=>{const n=v(),g=o==="all"?n:n.filter(e=>e.category===o),h=p();c.innerHTML=g.map(e=>{const y=e.id===h,w=e.emoji??(e.category==="pro"?"🎙️":e.category==="fun"?"🎉":"🎨"),_=e.description?b(e.description):"",$=y?"background:rgba(232,184,48,0.15);border-color:rgba(232,184,48,0.45)":"background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.06)";return`
  ...
  `,(async()=>{try{const{memoryBridge:t}=await l(async()=>{const{memoryBridge:s}=await import("./memory-bridge-DGKXsF4A.js");return{memoryBridge:s}},__vite__mapDeps([5,6,1,2,7]),import.meta.url),r=i.querySelector("#ax-memory-bridge-status"),c=i.querySelector("#ax-memory-bridge-sync"),a=()=>{if(!r)return;const s=t.getHealth(),d=t.getStatus(),o=d.filter(n=>n.last_success).length;r.textContent=`${s.backends_configured} backends configurés · ${o}/${d.length} dernier sync OK`};a(),c?.addEventListener("click",()=>{(async()=>{c&&(c.disabled=!0);const s=await t.runAutoSync(),d=s.filter(n=>n.ok).length,{toast:o}=await l(async()=>{const{toast:n}=await import("./toast-Dgg9rcIP.js");return{toast:n}},__vite__mapDeps([3,4]),import.meta.url);s.length===0?o.warn("Aucun backend configuré"):d===s.length?o.success(`Sync OK (${d}/${s.length})`):o.warn(`Sync partielle (${d}/${s.length})`),a(),c&&(c.disabled=!1)})()})}catch(t){k.warn("feature-settings","memory-bridge wire failed",{err:t})}})(),i.querySelector("#ax-conso-scan")?.addEventListener("click",()=>{(async()=>{try{const{consumptionAnomalyDetector:t}=await l(async()=>{const{consumptionAnomalyDetector:a}=await import("./consumption-anomaly-detector-CRHqopEP.js");return{consumptionAnomalyDetector:a}},__vite__mapDeps([8,1,2,9,10,6,11,12]),import.meta.url),r=t.scanAllVerbose(),c=i.querySelector("#ax-conso-results");if(!c)return;c.innerHTML=r.map(a=>{const s=a.severity==="critical"?"#ff4444":a.severity==="high"?"#ff8844":a.severity==="medium"?"#ffaa00":a.severity==="low"?"#88aaff":"#22cc77",d=a.severity==="critical"?"🚨":a.severity==="high"?"⚠️":a.severity==="medium"?"🟡":a.severity==="low"?"🔵":"✅";return`<div style="background:rgba(255,255,255,0.03);border-left:3px solid ${s};padding:8px 12px;margin-top:6px;border-radius:4px">
          ...
          </div>`}).join("")}catch(t){k.warn("feature-settings","conso scan failed",{err:t})}})()}),i.querySelectorAll("[data-nav-route]").forEach(t=>{t.addEventListener("click",()=>{const r=t.getAttribute("data-nav-route");r&&(location.hash="#"+r)})}),i.querySelector("#ax-settings-logout")?.addEventListener("click",()=>{(async()=>{const{auth:t}=await l(async()=>{const{auth:r}=await import("./auth-D6SKVOTl.js");return{auth:r}},__vite__mapDeps([13,6,1,2,14,15]),import.meta.url);t.logout(),location.hash="#login"})()}),T(i),i.querySelector("#ax-settings-notif-test")?.addEventListener("click",()=>{(async()=>{try{if("Notification"in window&&Notification.permission==="granted")new Notification("Test Apex",{body:"Si tu vois ça, push notif fonctionne ✅"});else if("Notification"in window)if(await Notification.requestPermission()==="granted")new Notification("Test Apex",{body:"Push activé ✅"});else{const{toast:r}=await l(async()=>{const{toast:c}=await import("./toast-Dgg9rcIP.js");return{toast:c}},__vite__mapDeps([3,4]),import.meta.url);r.warn("Permission notifications refusée")}else{const{toast:t}=await l(async()=>{const{toast:r}=await import("./toast-Dgg9rcIP.js");return{toast:r}},__vite__mapDeps([3,4]),import.meta.url);t.warn("Notifications non supportées par ce navigateur")}}catch{const{toast:t}=await l(async()=>{const{toast:r}=await import("./toast-Dgg9rcIP.js");return{toast:r}},__vite__mapDeps([3,4]),import.meta.url);t.warn("Test notification échoué")}})()}),k.info("feature-settings","rendered")}export{O as render,T as wireVoiceSection};
//# sourceMappingURL=index-DR4Hg3bj.js.map
