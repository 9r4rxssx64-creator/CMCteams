...
import{_ as g}from"./apex-kb-D1VtWFD9.js";import{e as c}from"./escape-html-BlQj2yEF.js";import{l as M}from"./monitoring-D2lWYrYo.js";import{m as b}from"../core/main-B4DExc5S.js";import{g as L}from"./apex-tools-dispatch-core-C_k5h2yM.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-Bg1HHfSC.js";import"./apex-tools-dispatch-skills-DOw4cI4G.js";import"./apex-tools-dispatch-data-DHUpGBCD.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-fNevKu6E.js";import"./apex-tools-misc-DBbScgMK.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./haptic-CQFg2PXZ.js";const S="kdmc_admin";function T(){try{const s=localStorage.getItem("apex_v13_user");return s?JSON.parse(s):null}catch{return null}}function x(s){if(!s)return"—";try{return new Date(s).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function h(s){if(!s)return"jamais";const t=Date.now()-s,e=t/36e5;return e<1?`${Math.floor(t/6e4)}min`:e<24?`${Math.floor(e)}h`:`${Math.floor(e/24)}j`}function K(s){const t=T(),e=t?.id===S,o=t?.name??"Anonyme";L("admin.kb",s,t?.id)&&(s.innerHTML=`
  ...
  `,w(s,t,e),H(s,t,e))}async function w(s,t,e){await Promise.all([v(s,t),e?C(s):Promise.resolve(),D(s),_(s),E(s)])}async function v(s,t){const e=s.querySelector("#my-facts-content");if(e){if(!t){e.innerHTML="<em>Pas de user connecté.</em>";return}try{const{persistentMemory:o}=await g(async()=>{const{persistentMemory:r}=await import("./persistent-memory-store-C-NQCZJQ.js");return{persistentMemory:r}},__vite__mapDeps([0,1,2,3]),import.meta.url),d=(await o.list()).filter(r=>r.scope===t.id).sort((r,n)=>n.importance-r.importance);if(d.length===0){e.innerHTML="<em>Aucun fact mémorisé pour ton compte. Les facts seront extraits automatiquement de tes messages chat.</em>";return}const l=d.slice(0,100).map((r,n)=>`
