import{auditLog as i}from"./audit-log-BZPO3aag.js";import{permissions as g}from"./permissions-Dg_kFHGi.js";import"../core/main-C0K6Dkgn.js";const r=["linear-gradient(135deg, #ffd6e8 0%, #c9a4ff 50%, #a4c8ff 100%)","linear-gradient(135deg, #ffe4ec 0%, #ffb3d9 50%, #d4a5ff 100%)","linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%)","linear-gradient(135deg, #f6d365 0%, #fda085 100%)","linear-gradient(135deg, #d4fc79 0%, #96e6a1 100%)"];function h(){const e=new Date().getHours();return e<5?"Bonne nuit":e<12?"Bonjour":e<18?"Bon après-midi":e<22?"Bonsoir":"Bonne soirée"}function x(){const t=Math.floor(Date.now()/864e5)%r.length;return r[t]??r[0]??"#ffd6e8"}function n(e,t,o){return`
...
//# sourceMappingURL=index-znhhdcw2.js.map
