import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-BL52Rrgn.js";import{broadlinkBridge as t}from"./broadlink-bridge-DA2KpTPN.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-SbzLITEn.js";import"./credential-patterns-z3lBBSNT.js";import"./multi-source-analyze-B4XFhN97.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
