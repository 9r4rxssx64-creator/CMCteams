import{l as b}from"./monitoring-3uBGKGRH.js";import{s as y}from"../core/main-COVVZXkx.js";import{c as h}from"./csp-style-helper-BisGRi53.js";import{iotRegistry as d}from"./iot-providers-registry-BS0ff32z.js";import{toast as r}from"./toast-ClsF1KRZ.js";import"./apex-kb-C57_4Py8.js";import"./credential-patterns-D-srKehy.js";import"./multi-source-analyze-DVXRcPw0.js";import"./broadlink-bridge-D7N1la9c.js";import"./haptic-CQFg2PXZ.js";const v="kdmc_admin";function n(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function $(){return y.get("user")?.id===v}async function g(e){if(e){if(!$()){e.innerHTML=`
