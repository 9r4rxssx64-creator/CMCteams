import{b as v,e as o,l as y}from"./monitoring-Bbobua-m.js";import{c as h}from"./listener-cleanup-Y2rGGxxX.js";import{p as c}from"./projects-BFwIeYiO.js";import{g as $}from"./apex-tools-dispatch-core-kKhf8nyr.js";import{toast as u}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-D3nCkIzq.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-B-lkJuA5.js";import"./apex-tools-dispatch-skills-DDzIKbmQ.js";import"./apex-tools-dispatch-data-CF_mCGAI.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-BJDIWIYT.js";import"./apex-tools-misc-D64oF_zW.js";import"./apex-tools-registry-core-48oOK-KS.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./haptic-CQFg2PXZ.js";let m=null,l=null,b=null;function R(){m?.cleanup(),m=null,l=null,b=null}function d(t){m?.cleanup(),m=h("projects");const p=v.get("user")?.id??"anon";if(!$("module.projects",t,p))return;const r=c.list(p),n=c.getActiveId(p),s=l?c.get(l,p):null,a=n?(()=>{const e=c.get(n,p);return e?`<div class="ax-gs-400" style="border:1px solid rgba(232,184,48,.5);border-radius:10px;padding:12px;margin-bottom:12px;background:rgba(232,184,48,.06)">
