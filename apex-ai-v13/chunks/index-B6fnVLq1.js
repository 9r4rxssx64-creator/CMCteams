import{a as s}from"./escape-html-DGIYNPKb.js";import{c as $}from"./listener-cleanup-Y2rGGxxX.js";import{l as f}from"./monitoring-DMtdadhB.js";import{i as w}from"../core/main-B1tqK_pJ.js";import{apexAutonomousMode as p}from"./apex-autonomous-mode-DzaNczwy.js";import{autonomousWatch as h}from"./autonomous-watch-B0AhBN8T.js";import{haptic as z}from"./haptic-CQFg2PXZ.js";import{toast as n}from"./toast-CRdbcLoc.js";import"./apex-kb-WlLpLTss.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-C8YgDmlx.js";import"./ai-router-DdAP84qp.js";import"./chat-fallback-DLKL321m.js";import"./voice-Bwo3pzNd.js";import"./economy-mode-BvFiYfEM.js";import"./tokens-dashboard-C5ZzZyK6.js";import"./firebase-queue-B-2Lipsg.js";let l=null,i=null;function _(){i&&(clearInterval(i),i=null),l?.cleanup(),l=null}function y(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function A(t){if(!t)return`
