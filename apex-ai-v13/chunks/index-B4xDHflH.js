import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-DnnLji0j.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-ClsF1KRZ.js";import"./monitoring-3uBGKGRH.js";import"./apex-kb-CRGOnMny.js";import"./credential-patterns-qcw7Brjr.js";import"./auth-gate-Bsp_h4A3.js";import"../core/main-DyxG2k-A.js";import"./multi-source-analyze-DUcUkJiD.js";import"./commerce-rTnua-7-.js";import"./kevin-alerts-Di7wC2ud.js";import"./whatsapp-giV9yuhu.js";let r=null;function P(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function f(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function C(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
