import{b as k,l as f,e as n}from"./monitoring-CpfNzZiS.js";import{c as w}from"./listener-cleanup-Y2rGGxxX.js";import{apexAutonomousMode as d}from"./apex-autonomous-mode-4NJIBLnk.js";import{autonomousWatch as h}from"./autonomous-watch-BnwdpF7F.js";import{haptic as A}from"./haptic-CQFg2PXZ.js";import{toast as i}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-Z1RdILhm.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-Dfn3GKur.js";import"./ai-router-DPoiGla5.js";import"../core/main-Bu39t4iI.js";import"./memory-VhlYwAM_.js";import"./economy-mode-C7HagSHm.js";import"./chat-fallback-CW7MIUI_.js";import"./apex-tools-dispatch-core-CCPmdq1z.js";import"./apex-tools-dispatch-skills-DgwfTaXZ.js";import"./apex-tools-dispatch-data-5is4fvHz.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-qVzbmluq.js";import"./apex-tools-misc-BF9DHqvU.js";import"./apex-tools-registry-core-48oOK-KS.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./firebase-queue-LDbiFwi9.js";let c=null,o=null;function Y(){o&&(clearInterval(o),o=null),c?.cleanup(),c=null}function v(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function z(t){if(!t)return`
    ...
    `;const s=t.tasksCompleted.filter(a=>a.status==="done").length,e=t.tasksCompleted.filter(a=>a.status==="failed").length,r=Math.round((Date.now()-t.startedAt)/6e4),l=t.maxIterations??50,u=t.quotaLimit??5e4,g=Math.min(100,Math.round(t.tokensConsumed/u*100)),y=Math.min(100,Math.round(t.iterations/l*100));return`
    <div class="ax-card" data-session-id="${n(t.id)}" style="padding:18px;border-radius:16px;background:linear-gradient(135deg,rgba(232,184,48,0.08),rgba(60,200,80,0.04));border:1px solid rgba(232,184,48,0.18)">
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(120px,1fr));gap:10px;margin-bottom:14px">
        <div class="ax-gs-38">
          ...
          <p style="margin:4px 0 0;font-size:18px;font-weight:700;color:#e8b830">${r} min</p>
        </div>
        <div class="ax-gs-38">
  ...
  `}function j(){const t=d.getHistory(10);if(t.length===0)return"";const s=t.map(e=>{const r=Math.round((Date.now()-e.startedAt)/36e5),l=e.endedAt?Math.round((e.endedAt-e.startedAt)/6e4):null,u=e.tasksCompleted.filter(g=>g.status==="done").length;return`<tr>
        ...
        <td style="padding:8px 6px;font-size:11px;color:rgba(255,255,255,0.6)">il y a ${r}h</td>
