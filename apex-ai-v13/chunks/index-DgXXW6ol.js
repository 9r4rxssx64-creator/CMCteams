import{e as r}from"./monitoring-B_33l2zx.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-D37CbJYY.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DkfkG7ED.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-viWGArzc.js";import"./kevin-alerts-CIgsgbmb.js";import"./whatsapp-C8hfWdfC.js";import"./auth-gate-Ct9AmY5h.js";import"./auth-D9n6v62n.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
