import{b as k,l as f,e as n}from"./monitoring-BYU-00Ll.js";import{c as w}from"./listener-cleanup-Y2rGGxxX.js";import{apexAutonomousMode as d}from"./apex-autonomous-mode-BaWr0eY7.js";import{autonomousWatch as h}from"./autonomous-watch-BY4qEsRk.js";import{haptic as A}from"./haptic-CQFg2PXZ.js";import{toast as i}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-Cu2z58R_.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BCMNRUTk.js";import"./ai-router-Cg_VE8qX.js";import"../core/main-CpiOZFny.js";import"./economy-mode-DBmdBjji.js";import"./chat-fallback-B8OBiRZd.js";import"./apex-tools-dispatch-core-D6iHTlg5.js";import"./apex-tools-dispatch-skills-380K2kQA.js";import"./apex-tools-dispatch-data-X3FfZBSG.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-BxaJjjsa.js";import"./apex-tools-misc-CzmsAPJC.js";import"./apex-tools-registry-core-B4u4pCoL.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./firebase-queue-DiakVXxs.js";let c=null,o=null;function X(){o&&(clearInterval(o),o=null),c?.cleanup(),c=null}function v(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function z(t){if(!t)return`
  ...
  `}function b(t){t.querySelectorAll("[data-action]").forEach(s=>{c.bind(s,"click",async()=>{A.tap();const e=s.dataset.action??"";try{if(e==="back")window.location.hash="#admin";else if(e==="refresh")p(t),i.info("Rafraîchi");else if(e==="stop"){if(!confirm("Arrêter le mode autonome ?"))return;d.stop(void 0,"admin-ui-stop"),i.success("🛑 Session arrêtée"),p(t)}else e==="pause"?(d.pause(),i.info("⏸ Session pausée"),p(t)):e==="resume"?(d.resume(),i.success("▶️ Session reprise"),p(t)):e==="force-tick"&&(i.info("⚡ Tick forcé…"),await h.forceTick(),p(t))}catch(r){f.warn("admin-autonomous",`action ${e} failed`,{err:r}),i.error(`Erreur : ${r instanceof Error?r.message:String(r)}`)}})})}function p(t){if(c?.cleanup(),c=w("admin-autonomous"),!k.get("isAdmin")){t.innerHTML=`
    ...
    `;return}t.innerHTML=m(),b(t),o&&(clearInterval(o),o=null);const e=d.getActiveSession();e&&(e.status==="running"||e.status==="paused")&&(o=setInterval(()=>{try{t.innerHTML=m(),b(t)}catch(r){f.warn("admin-autonomous","auto-refresh failed",{err:r})}},5e3))}export{X as dispose,p as render};
