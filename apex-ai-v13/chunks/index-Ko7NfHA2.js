const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-DzbR7ldU.js","../core/main-CoftA83U.js","../assets/css/main-rhfGvOFL.css","./observability-B22w3nVm.js","./sentinels-registry-C0jVMHa2.js","./toast-Dgg9rcIP.js","./haptic-BUEqXK0N.js"])))=>i.map(i=>d[i]);
import{_ as i,l as f}from"../core/main-CoftA83U.js";async function c(a){const{sentinels:s}=await i(async()=>{const{sentinels:t}=await import("./sentinels-DzbR7ldU.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),{sentinelsRegistry:u,bootstrapSentinelsRegistry:m}=await i(async()=>{const{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}=await import("./sentinels-registry-C0jVMHa2.js");return{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}},__vite__mapDeps([4,1,2,0,3]),import.meta.url);m();const n=s.list(),y=u.getStatus(),r=u.getMetrics(),x=n.filter(t=>t.lastResult?.ok).length,g=n.filter(t=>t.lastResult&&!t.lastResult.ok).length,b=n.filter(t=>!t.lastResult).length;a.innerHTML=`
...
//# sourceMappingURL=index-Ko7NfHA2.js.map
