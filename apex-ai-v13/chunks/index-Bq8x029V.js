const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-tools-dispatch-Lv32_re3.js","../core/main-CRl1sxCr.js","../assets/css/main-GfJ7qlqs.css","./apex-tools-fLE6-Ei6.js","./audit-log-QQT00jVg.js","./firebase-vTtSZvKp.js","./orchestrator-BbAvXsMa.js","./smart-tools-suggester-DiLBe8aP.js","./toast-BkOpdP-z.js","./haptic-BUEqXK0N.js","./vault-oB6u8pD5.js","./credential-patterns-Ct__OCbr.js","./voice-print-QTSUCjUv.js","./file-converter-DmGFT_dZ.js","./smart-camera-BVkKOKHM.js","./admin-prompt-beSav1OH.js","./modal-sheet-CHe4PF78.js","./ai-routing-policy-CBsoSyCx.js","./ai-router-B9gH_PC5.js","./chat-fallback-DLIHY4f9.js","./pii-redaction-BenraFWG.js","./tokens-dashboard-C5ZzZyK6.js","./consumption-monitor-VmekUZme.js","./links-registry-DY2gzFXC.js","./push-notifications-CN37Xl-R.js","./auth-CSkXiGBE.js"])))=>i.map(i=>d[i]);
import{s as $,_ as g,l as O,e as W,m as K}from"../core/main-CRl1sxCr.js";import{aiRouter as z}from"./ai-router-B9gH_PC5.js";import{commerce as G}from"./commerce-B0Uyg0e6.js";import{vault as N}from"./vault-oB6u8pD5.js";import{h as p}from"./haptic-BUEqXK0N.js";import{modalSheet as D}from"./modal-sheet-CHe4PF78.js";import{toast as c}from"./toast-BkOpdP-z.js";import"./audit-log-QQT00jVg.js";import"./chat-fallback-DLIHY4f9.js";import"./pii-redaction-BenraFWG.js";import"./tokens-dashboard-C5ZzZyK6.js";import"./credential-patterns-Ct__OCbr.js";const L=[],q=[];let T=!1;function C(n){return n.replace(/[&<>"']/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[s]??s)}function j(n){let s=C(n);return s=s.replace(/```([\s\S]*?)```/g,(m,d)=>`<pre class="ax-code"><code>${d}</code></pre>`),s=s.replace(/`([^`\n]+)`/g,'<code class="ax-code-inline">$1</code>'),s=s.replace(/\*\*([^*\n]+)\*\*/g,"<strong>$1</strong>"),s=s.replace(/\*([^*\n]+)\*/g,"<em>$1</em>"),s=s.replace(/\n/g,"<br>"),s}function U(){const n=$.get("user");return K.buildSystemPromptContext(n)}async function Q(n,s){try{const{apexToolsDispatch:m}=await g(async()=>{const{apexToolsDispatch:h}=await import("./apex-tools-dispatch-Lv32_re3.js");return{apexToolsDispatch:h}},__vite__mapDeps([0,1,2,3,4,5,6]),import.meta.url),d=await m.execute("detect_intent",{text:n},"admin");if(!d.ok||!d.result)return;const y=d.result.intent,b=d.result.confidence??0;if(!y||y==="unknown"||b<.7)return;if(y==="open_url"||y==="open_browser"){const h=n.match(/(https?:\/\/[^\s]+)/i),I=n.match(/\b([a-z0-9-]+\.(com|fr|io|net|org|app|dev|ai|co))\b/i),E=h?.[1]??I?.[1]??"https://www.google.com";m.execute("open_url",{url:E},"admin");return}const{smartToolsSuggester:x}=await g(async()=>{const{smartToolsSuggester:h}=await import("./smart-tools-suggester-DiLBe8aP.js");return{smartToolsSuggester:h}},__vite__mapDeps([7,1,2,4]),import.meta.url),l=x.suggestForIntent(y);if(!l)return;const{toast:f}=await g(async()=>{const{toast:h}=await import("./toast-BkOpdP-z.js");return{toast:h}},__vite__mapDeps([8,9]),import.meta.url);f.info(`${l.emoji} ${l.name} disponible — tape pour ouvrir`,{duration:5e3});const _=$.get("user");_?.id&&x.recordUsage(l.id,_.id),X(s,l)}catch(m){O.warn("chat","detectAndSuggestTool failed",{err:m})}}function X(n,s){const m=n.querySelector(".ax-chat-scroll");if(!m)return;const d=document.createElement("div");d.className="ax-msg ax-msg-tool ax-slide-up-fade",d.innerHTML=`
