const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../core/main-BQ6JhBsC.js","./push-notifications-CR6ug6q_.js","../assets/css/main-DLXksLe1.css","./consumption-dashboard-a2ZxjPlV.js"])))=>i.map(i=>d[i]);
import{b as g,_ as A}from"./apex-kb-BrxoW6ip.js";import{l as $}from"./monitoring-BAiQJoxJ.js";import{c as j}from"./listener-cleanup-Y2rGGxxX.js";import{s as T}from"../core/main-BQ6JhBsC.js";import{apexExecute as h}from"./apex-execute-D1dScyVb.js";import{auth as _}from"./auth-Dh_vg4w8.js";import{commerce as w}from"./commerce-DFqzgEm3.js";import{kdmcProjectsRegistry as k}from"./kdmc-projects-registry-sRmoyobO.js";import{w as S}from"./whatsapp-Da9lMcEi.js";import{h as l}from"./haptic-BUEqXK0N.js";import{s as q}from"./skeleton-Dr8sni_Y.js";import{toast as d}from"./toast-Dgg9rcIP.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-BefgB4O2.js";import"./claude-bridge-BDGYcmLV.js";let y="commerce";function n(t){return t.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a]??a)}function P(){const t=w.isEnabled();return`
  ...
  `}function z(){return[["commerce","💳 Commerce"],["users","👥 Comptes"],["pending","📨 Attente"],["health","🩺 Santé"],["projects","📦 Projets"],["executions","⚙️ Exec"],["knowledge","📚 KB"],["bilan","📊 Bilan"],["consumption","💰 Conso"]].map(([a,o])=>{const i=y===a;return`
      ...
      `}).join("")}function M(){const t=h.listPendingExecutions({limit:30}),a=h.getStats(),o=h.listAllowedTasks(),i=h.listForbiddenTasks(),m={pending:"pending",dispatched:"wip",running:"wip",completed:"ok",failed:"error",cancelled:"archived",timeout:"error"},r=t.map(e=>{const s=m[e.status]??"archived",c=new Date(e.ts_created).toLocaleString(),u=e.duration_ms?`${Math.round(e.duration_ms/1e3)}s`:"—",b=e.workflow_run_url?`<a href="${n(e.workflow_run_url)}" target="_blank" rel="noopener">🔗 Workflow</a>`:'<span class="ax-muted">—</span>',f=e.status==="pending"||e.status==="dispatched";return`
  ...
  `}function D(){switch(y){case"commerce":return P();case"users":return L();case"pending":return R();case"health":return H();case"projects":return I();case"executions":return M();case"knowledge":return U();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>'}}async function C(t){const a=t.querySelector("#ax-admin-mount-bilan");if(a)try{(await A(()=>import("./financial-bilan-11SOzD6p.js"),__vite__mapDeps([0,1,2]),import.meta.url)).render(a)}catch(i){$.warn("admin","financial-bilan render failed",{err:i}),a.innerHTML='<p class="ax-muted">Bilan indisponible (module ko)</p>'}const o=t.querySelector("#ax-admin-mount-consumption");if(o)try{(await A(()=>import("./consumption-dashboard-a2ZxjPlV.js"),__vite__mapDeps([3,1]),import.meta.url)).render(o)}catch(i){$.warn("admin","consumption-dashboard render failed",{err:i}),o.innerHTML='<p class="ax-muted">Consommation indisponible (module ko)</p>'}}function U(){const t=g.listRepos(),a=g.getStats(),o=t.map(i=>`
  ...
  `,x(t)}let p=null;function ne(){p?.cleanup(),p=null}function x(t){if(p?.cleanup(),p=j("admin"),!T.get("isAdmin")){t.innerHTML=`
      <div class="ax-empty">
        <h2>Accès réservé</h2>
  ...
  `,B(t),y==="bilan"||y==="consumption"){const o=t.querySelector(".ax-admin-content");if(o){const i=q(o,"admin-table");C(t).finally(()=>{i()})}else C(t)}}export{ne as dispose,x as render};
