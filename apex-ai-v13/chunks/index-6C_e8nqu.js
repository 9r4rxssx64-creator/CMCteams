import{c as k,e as u}from"./monitoring-CdKapu3A.js";import{c as w}from"./listener-cleanup-Y2rGGxxX.js";import{scheduledTasks as x}from"./scheduled-tasks-_O0HvKDe.js";import{g as $}from"./apex-tools-dispatch-core-DdIikP2I.js";import{toast as m}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-i0SrWIqV.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-C9cr8uzA.js";import"./apex-tools-dispatch-skills-BYmpLTiJ.js";import"./apex-tools-dispatch-data-5TGwuBD7.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-BFBfrGw2.js";import"./apex-tools-misc-BZp_ZxEV.js";import"./apex-tools-registry-core-48oOK-KS.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./haptic-CQFg2PXZ.js";let s=null;function K(){s?.cleanup(),s=null}const b=["Dim","Lun","Mar","Mer","Jeu","Ven","Sam"];function S(e){const o=t=>`${String(Math.floor(t/60)).padStart(2,"0")}h${String(t%60).padStart(2,"0")}`;switch(e.kind){case"once":return`Une fois — ${new Date(e.at??e.nextRun).toLocaleString("fr-FR")}`;case"daily":return`Chaque jour à ${o(e.timeMin??540)}`;case"weekly":return`Chaque ${b[e.weekday??1]} à ${o(e.timeMin??540)}`;case"interval":return`Toutes les ${e.everyMin??15} min`;default:return""}}function h(e){s?.cleanup(),s=w("scheduled");const t=k.get("user")?.id??"anon";if(!$("module.scheduled",e,t))return;const i=x.list(t),p=i.length?i.map(a=>`
    ...
    <div class="ax-page ax-gs-332">
      ...
      <div id="ax-sched-list" style="margin-top:14px">${p}</div>
      <p class="ax-gs-212"><a href="#chat" class="ax-gs-198">← Retour chat</a></p>
    </div>
  `,q(e,t)}function q(e,o){const t=e.querySelector("#ax-sched-kind"),i=e.querySelector("#ax-sched-time"),p=e.querySelector("#ax-sched-weekday"),a=e.querySelector("#ax-sched-every"),d=()=>{const n=t?.value;i&&(i.style.display=n==="daily"||n==="weekly"?"":"none"),p&&(p.style.display=n==="weekly"?"":"none"),a&&(a.style.display=n==="interval"?"":"none")};t&&(s.bind(t,"change",d),d());const g=e.querySelector("#ax-sched-form");g&&s.bind(g,"submit",n=>{n.preventDefault();const l=e.querySelector("#ax-sched-prompt")?.value??"",r=t?.value??"daily",[f,v]=(i?.value??"09:00").split(":").map(Number),y=(f??9)*60+(v??0),c={prompt:l,kind:r};if(r==="daily"?c.timeMin=y:r==="weekly"?(c.timeMin=y,c.weekday=Number(p?.value??1)):r==="interval"?c.everyMin=Math.max(15,Number(a?.value??60)):r==="once"&&(c.at=Date.now()+1440*60*1e3),!x.create(c)){m.warn("Prompt requis (ou limite atteinte)");return}m.success("⏰ Tâche programmée"),h(e)}),s.bind(e,"click",n=>{const l=n.target?.closest("[data-action]");if(!l)return;const r=l.dataset.taskId;if(r)if(l.dataset.action==="toggle"){const f=x.toggle(r,o);m.info(f?"▶️ Tâche activée":"⏸ Tâche désactivée"),h(e)}else l.dataset.action==="delete"&&x.remove(r,o)&&(m.info("Tâche supprimée"),h(e))})}export{K as dispose,u as escapeHtml,h as render};
