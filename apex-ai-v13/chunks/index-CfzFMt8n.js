import{e as n}from"./html-safe-CCp1QaJu.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{l as h}from"./monitoring-WiO5ZBU9.js";import{s as b}from"../core/main-DTyRp2Or.js";import{multiSourceAnalyze as x}from"./multi-source-analyze-BViKOd95.js";import{studyService as g}from"./study-service-CV7Az764.js";import{h as c}from"./haptic-BUEqXK0N.js";import{toast as o}from"./toast-Dgg9rcIP.js";import"./apex-kb-CEQketf_.js";import"./apex-tools-registry-ByCfEB3e.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-DIDRO4PS.js";import"./links-registry-M7mrW14i.js";let u=null;function T(){u?.cleanup(),u=null}async function p(e){if(!(b.get("isAdmin")===!0)){e.innerHTML=`
      <div style="padding:40px;text-align:center;color:#999">
        <h2 style="color:#c9a227">Accès admin uniquement</h2>
        <p>Multi-Source History — Kevin admin.</p>
      </div>
    `;return}u?.cleanup(),u=y("multi-source-history");const s=x.getHistory(),a=x.getStats(),d=g.listKnown();e.innerHTML=v(s,a,d.length),S(e,s),h.info("multi-source-history",`Render ${s.length} sources, ${a.items_total} items`)}function v(e,t,s){const a=t.items_total>0?Math.round(t.items_configured/t.items_total*100):0,d=t.items_configured>0?Math.round(t.items_tested_ok/t.items_configured*100):0;return`
