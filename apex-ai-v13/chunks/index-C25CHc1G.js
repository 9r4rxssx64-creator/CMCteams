import{l as d}from"./monitoring-WiO5ZBU9.js";import{s as l}from"../core/main-3fOQAofu.js";import{broadlinkBridge as a}from"./broadlink-bridge-sPaCxayY.js";import{toast as i}from"./toast-Dgg9rcIP.js";import"./apex-kb-By2L93Xh.js";import"./apex-tools-registry-CVvnzBqX.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-Cn-bcah1.js";import"./haptic-BUEqXK0N.js";const x="kdmc_admin";function t(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
