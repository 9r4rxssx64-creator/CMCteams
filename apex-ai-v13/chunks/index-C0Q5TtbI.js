const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./multi-source-analyze-TER8_hce.js","./apex-kb-CjNuJy7Q.js","./monitoring-3uBGKGRH.js","./credential-patterns-Dy6Wjk7e.js","../assets/css/main-BlPIY2te.css"])))=>i.map(i=>d[i]);
import{b as h,_ as k}from"./apex-kb-CjNuJy7Q.js";import{l as $}from"./monitoring-3uBGKGRH.js";import{c as L}from"./listener-cleanup-Y2rGGxxX.js";import{s as P,a as H}from"../core/main-CUm3-Q03.js";import{apexExecute as v}from"./apex-execute-D8au-hcL.js";import{auth as T}from"./auth-CvGJWHpT.js";import{commerce as S}from"./commerce-BTvLLCu8.js";import{c as I}from"./csp-style-helper-BisGRi53.js";import{i as A,r as j}from"./voice-BGJIfQhy.js";import{kdmcProjectsRegistry as w}from"./kdmc-projects-registry-DdTqW2gy.js";import{w as _}from"./whatsapp-BoQQXXwO.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as u}from"./toast-ClsF1KRZ.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-TER8_hce.js";import"./claude-bridge-CQmQ5NFe.js";let f="commerce";const q={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function n(e){return e.replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i]??i)}function R(){const e=S.isEnabled();return`
