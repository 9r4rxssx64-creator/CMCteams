import{a as o}from"./escape-html-DGIYNPKb.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{l}from"./monitoring-DMtdadhB.js";import{i as f}from"../core/main-B1tqK_pJ.js";import{c as u}from"./apex-kb-WlLpLTss.js";import{rgpd as x}from"./rgpd-K9kQAvND.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as c}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-C8YgDmlx.js";import"./credential-patterns-CLzI061R.js";let t=null;function S(){t?.cleanup(),t=null}function m(e){if(!e)return"—";try{return new Date(e).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function b(e){const i=e.scopes.includes("*")?'<span style="color:#ff6b6b;font-weight:600">Globale (tous scopes)</span>':e.scopes.map(s=>`<code style="background:rgba(255,255,255,0.05);padding:2px 6px;border-radius:4px;font-size:11px;margin-right:4px">${o(s)}</code>`).join("");return`
