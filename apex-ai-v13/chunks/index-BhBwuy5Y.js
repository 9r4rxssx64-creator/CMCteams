import{e as r}from"./monitoring-CWQm8S_w.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-C0-K1P1W.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-BLdnngVZ.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-Bf_SPpoW.js";import"./kevin-alerts-BG6LT9Nw.js";import"./whatsapp-DjapZf-R.js";import"./auth-gate-CPW-Uho5.js";import"./auth-LV5jA9Wp.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
