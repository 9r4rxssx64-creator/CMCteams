import{e as r}from"./monitoring-BKvSFH8Q.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-Bx7NUZp-.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-BDEvlG2G.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CdIpTWpq.js";import"./kevin-alerts-ufywgnFI.js";import"./whatsapp-DSn4WyiZ.js";import"./auth-gate--INgDwTV.js";import"./auth-C70Km22Y.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
