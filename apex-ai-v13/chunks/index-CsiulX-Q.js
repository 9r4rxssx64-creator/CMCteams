import{a as o,_ as x}from"./apex-kb-Bnm9PKww.js";import{s as v}from"../core/main-DJG6Q3RZ.js";import{g as b}from"./apex-tools-dispatch-Vr2zafOB.js";import{permissions as w}from"./permissions-BGrCGkf0.js";import"./monitoring-3uBGKGRH.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-D15Z0Ibq.js";import"./apex-tools-registry-QrqBtw0n.js";import"./voice-Digjkztq.js";const r=["linear-gradient(135deg, #ffd6e8 0%, #c9a4ff 50%, #a4c8ff 100%)","linear-gradient(135deg, #ffe4ec 0%, #ffb3d9 50%, #d4a5ff 100%)","linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%)","linear-gradient(135deg, #f6d365 0%, #fda085 100%)","linear-gradient(135deg, #d4fc79 0%, #96e6a1 100%)"];function _(){const e=new Date().getHours();return e<5?"Bonne nuit":e<12?"Bonjour":e<18?"Bon après-midi":e<22?"Bonsoir":"Bonne soirée"}function y(){const n=Math.floor(Date.now()/864e5)%r.length;return r[n]??r[0]??"#ffd6e8"}function t(e,n,s){return`
