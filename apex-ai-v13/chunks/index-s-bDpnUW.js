const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./device-context-Cyv6GeOK.js","../core/main-BEHfRhW_.js","../assets/css/main-Bng3LWQS.css","./audit-log-BEm-6fW7.js","./auth-DnKZ9diS.js"])))=>i.map(i=>d[i]);
import{_ as m,r as v}from"../core/main-BEHfRhW_.js";import{auth as g}from"./auth-DnKZ9diS.js";import{t as p,h as d}from"./toast-DbVEuO4x.js";function f(e){return e.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]??o)}function x(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const l=atob(e[1]??"").split(":")[0];if(l)return{uid:l}}catch{}return null}async function _(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),o=localStorage.getItem("apex_v13_last_known_name"),l=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!o||!l)return!1;const{deviceContext:n}=await m(async()=>{const{deviceContext:s}=await import("./device-context-Cyv6GeOK.js");return{deviceContext:s}},__vite__mapDeps([0,1,2,3]),import.meta.url);if((await n.getFingerprint()).device_id!==l)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:a}=await m(async()=>{const{auth:s}=await import("./auth-DnKZ9diS.js");return{auth:s}},__vite__mapDeps([4,1,2]),import.meta.url);if((await a.loginTrusted(e,o)).ok)return v.navigate("chat"),!0}catch{}return!1}function I(e){_().then(t=>{t&&p.success("🔐 Reconnu automatiquement (device trusted)")});const o=x();e.innerHTML=`
