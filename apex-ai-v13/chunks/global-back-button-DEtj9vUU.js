import{l as n}from"./monitoring-CwxJ9cqV.js";import"./multi-source-analyze-BIU-yOf5.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-B0G8l0r5.js";const i="apex-global-back-btn",a="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(a))return;const t=`
      #${i} {
        position: fixed;
