const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-8FXW6jDe.js","./monitoring-gJBPZdzr.js","./multi-source-analyze-CxbUoEQT.js","./credential-patterns-K-vGUK9F.js","./auth-CAqxTnHk.js"])))=>i.map(i=>d[i]);
import{_ as v}from"./apex-kb-8FXW6jDe.js";import{A as b,r as g}from"../core/main-ReifuZ6f.js";import{e as x}from"./escape-html-BlQj2yEF.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{auth as _}from"./auth-CAqxTnHk.js";import{i as h}from"./apex-tools-dispatch-core-DBBjuMet.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import{toast as m}from"./toast-CRdbcLoc.js";import"./monitoring-gJBPZdzr.js";import"./multi-source-analyze-CxbUoEQT.js";import"./credential-patterns-K-vGUK9F.js";import"./apex-tools-dispatch-skills-DPp14-i2.js";import"./apex-tools-dispatch-data-C2rS_slH.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-DxqeMa-2.js";import"./apex-tools-misc-C_-CfxAx.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let l=null;function J(){l?.cleanup(),l=null}function S(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}async function I(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),p=localStorage.getItem("apex_v13_last_known_name"),o=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!p||!o)return!1;const{deviceContext:n}=await v(async()=>{const{deviceContext:c}=await import("./device-context-kYpmyJqG.js");return{deviceContext:c}},__vite__mapDeps([0,1,2,3]),import.meta.url);if((await n.getFingerprint()).device_id!==o)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:t}=await v(async()=>{const{auth:c}=await import("./auth-CAqxTnHk.js");return{auth:c}},__vite__mapDeps([4,0,1,2,3]),import.meta.url);if((await t.loginTrusted(e,p)).ok)return g.navigate("chat"),!0}catch{}return!1}function O(e){if(l?.cleanup(),l=y("landing"),!h("module.landing")){e.innerHTML=`
...
Continuer ?`))return;try{localStorage.removeItem("apex_v13_pin"),localStorage.removeItem("apex_v13_pin_kdmc_admin");const a=[];for(let i=0;i<localStorage.length;i++){const f=localStorage.key(i);f?.startsWith("apex_v13_pin_fails_")&&a.push(f)}for(const i of a)localStorage.removeItem(i)}catch{}const c=e.querySelector("#login-error");c&&(c.innerHTML='<div class="ax-alert ax-alert-success">✅ PIN réinitialisé. Tape ton nouveau code PIN puis Se connecter.</div>');const d=e.querySelector("#login-pin");d&&(d.value="",d.focus())});const r=e.querySelector("#login-go-signup");r&&l&&l.bind(r,"click",()=>{u.tap(),g.navigate("signup")}),typeof window<"u"&&window.matchMedia("(pointer: fine)").matches&&e.querySelector("#login-name")?.focus()}async function T(e){const p=e.querySelector("#login-name"),o=e.querySelector("#login-pin"),n=e.querySelector("#login-submit"),r=e.querySelector("#login-error"),t=n?.querySelector(".ax-btn-label"),s=n?.querySelector(".ax-spinner"),c=p?.value.trim()??"",d=o?.value??"";if(c.length<2||d.length<4){u.warning(),r&&(r.innerHTML='<div class="ax-error">Nom et PIN obligatoires (min 4 chiffres)</div>');return}n&&(n.disabled=!0),t&&(t.textContent="Vérification..."),s&&(s.style.display="inline-block");try{const a=await _.login(c,d);if(!a.ok){u.error();const i=a.reason??"Connexion impossible";r&&(r.innerHTML=`<div class="ax-error">${x(i)}</div>`),m.error(i),n&&(n.disabled=!1),t&&(t.textContent="Se connecter"),s&&(s.style.display="none");return}u.success(),m.success("Bienvenue !"),setTimeout(()=>{g.navigate("chat")},200)}catch(a){u.error();const i=a instanceof Error?a.message:"Erreur inattendue";r&&(r.innerHTML=`<div class="ax-error">${x(i)}</div>`),m.error(i),n&&(n.disabled=!1),t&&(t.textContent="Se connecter"),s&&(s.style.display="none")}}export{J as dispose,O as render};
