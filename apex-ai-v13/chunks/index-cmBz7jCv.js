import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-BbFSegEP.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-ClsF1KRZ.js";import"./monitoring-3uBGKGRH.js";import"./apex-kb-g4zH13MT.js";import"./credential-patterns-guxfirLX.js";import"./auth-gate-DQ8_IwBQ.js";import"../core/main-COsUWeuM.js";import"./multi-source-analyze-Bq2b3Za8.js";import"./commerce-B-nH0xSd.js";import"./kevin-alerts-H8Rjr5Z9.js";import"./whatsapp-DI8qVhx9.js";let r=null;function P(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function f(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function C(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
