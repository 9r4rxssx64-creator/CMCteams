import{q as n}from"./monitoring-Bj7krNVC.js";import"./multi-source-analyze-DKS_jL8s.js";import"./apex-kb-BHBYXtTa.js";import"./credential-patterns-CLzI061R.js";const i="apex-global-back-btn",a="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(a))return;const t=`
      #${i} {
        position: fixed;
