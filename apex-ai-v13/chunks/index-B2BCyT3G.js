import{l as d}from"./monitoring-WiO5ZBU9.js";import{s as l}from"../core/main-DTyRp2Or.js";import{broadlinkBridge as a}from"./broadlink-bridge-DOAfAW5C.js";import{toast as i}from"./toast-Dgg9rcIP.js";import"./apex-kb-CEQketf_.js";import"./apex-tools-registry-ByCfEB3e.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-DIDRO4PS.js";import"./haptic-BUEqXK0N.js";const x="kdmc_admin";function t(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
