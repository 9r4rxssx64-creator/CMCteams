import{r as f}from"../core/main-DYH39Bqz.js";import{auth as g}from"./auth-BP_4cKma.js";import{h as u,t as p}from"./toast-DbVEuO4x.js";function m(e){return e.replace(/[&<>"']/g,l=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[l]??l)}function v(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const d=atob(e[1]??"").split(":")[0];if(d)return{uid:d}}catch{}return null}function S(e){const l=v();e.innerHTML=`
...
//# sourceMappingURL=index-DlK3Wep7.js.map
