import{e as r}from"./monitoring-bDZQK4Aa.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-MqDfZC6Q.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-VHlHLF-q.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CxyBPYZO.js";import"./kevin-alerts--PswT-MA.js";import"./whatsapp-CSBhYSdx.js";import"./auth-gate-BBjk1tEE.js";import"./auth-C764OpM9.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
