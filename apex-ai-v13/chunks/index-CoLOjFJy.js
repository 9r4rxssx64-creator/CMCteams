import{l as b}from"./monitoring-3uBGKGRH.js";import{s as y}from"../core/main-B_MALIn8.js";import{c as h}from"./csp-style-helper-BisGRi53.js";import{iotRegistry as d}from"./iot-providers-registry-D0G5C6OR.js";import{toast as r}from"./toast-ClsF1KRZ.js";import"./apex-kb-BzZGdAjE.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-DhpYozSQ.js";import"./broadlink-bridge-CIR00wk5.js";import"./haptic-CQFg2PXZ.js";const v="kdmc_admin";function n(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function $(){return y.get("user")?.id===v}async function g(e){if(e){if(!$()){e.innerHTML=`
