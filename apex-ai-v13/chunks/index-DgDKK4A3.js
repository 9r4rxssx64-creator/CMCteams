import{l as b}from"./monitoring-BAiQJoxJ.js";import{c as h}from"./listener-cleanup-Y2rGGxxX.js";import{s as v}from"../core/main-BqtLFpxm.js";import{autoBackup as s}from"./auto-backup-AkeAkKbG.js";import{h as c}from"./haptic-BUEqXK0N.js";import{toast as n}from"./toast-Dgg9rcIP.js";import"./apex-kb-DEV0ns6l.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-Cjv0lJFa.js";let i=null;function D(){i?.cleanup(),i=null}function d(t){return t.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function f(t){return t<1024?t+" B":t<1024*1024?(t/1024).toFixed(1)+" KB":(t/(1024*1024)).toFixed(2)+" MB"}function m(t){const r=new Date(t),e=o=>o.toString().padStart(2,"0");return`${e(r.getDate())}/${e(r.getMonth()+1)}/${r.getFullYear()} ${e(r.getHours())}:${e(r.getMinutes())}`}const k={manual:"💾 Manuel",daily:"📅 Quotidien",weekly:"🌐 Hebdo","pre-rollback":"↩ Pre-rollback"};function w(t){const r=k[t]??t;return`<span style="padding:2px 6px;border-radius:4px;background:rgba(201,162,39,0.15);color:#c9a227;font-size:11px;font-weight:600">${d(r)}</span>`}function U(){}function _(t){const r=t.last_backup_age_h<0?"Jamais":t.last_backup_age_h===0?"< 1h":`${t.last_backup_age_h}h`,e=t.last_backup_age_h<0||t.last_backup_age_h>48?"#ff6666":t.last_backup_age_h>26?"#ffa500":"#22c55e",o=t.integrity_ok?"#22c55e":"#ff6666",a=t.integrity_ok?"✓ OK":"⚠ Cassée",p=s.isQuotaCritical()?'<span style="margin-left:10px;padding:3px 8px;background:rgba(255,165,0,0.15);color:#ffa500;border-radius:4px;font-size:11px">⚠ Quota localStorage > 4 MB</span>':"";return`
