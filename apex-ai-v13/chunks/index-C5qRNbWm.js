import{e as r}from"./monitoring-ChxUqN9b.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CTTEA1zg.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-B32nDlUt.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DHHNHNCs.js";import"./kevin-alerts-lfBXplCR.js";import"./whatsapp-D28agpZI.js";import"./auth-gate-DDlWSm1H.js";import"./auth-DTacvS4h.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
