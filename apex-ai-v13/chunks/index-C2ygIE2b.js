...
import{_ as v}from"./apex-kb-D3OZMspj.js";import{e as i}from"./html-safe-CCp1QaJu.js";import{c as S}from"./listener-cleanup-Y2rGGxxX.js";import{l as _}from"./monitoring-3uBGKGRH.js";import{s as z}from"../core/main-D6LPyU12.js";import{credentialsAudit as w}from"./credentials-audit-CAoHTJtQ.js";import{haptic as f}from"./haptic-CQFg2PXZ.js";import{toast as p}from"./toast-ClsF1KRZ.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-IO1VLhJg.js";let x=null,y=null,m="all";function P(){x?.cleanup(),x=null}const h={ok:{color:"#22cc77",icon:"🟢",label:"OK"},missing:{color:"#888",icon:"⚪",label:"Non config"},corrupted:{color:"#ff6b6b",icon:"🔴",label:"Corrompu"},expired:{color:"#ffaa00",icon:"🟠",label:"Expiré"},unknown:{color:"#aaa",icon:"❓",label:"Inconnu"},decrypt_failed:{color:"#ff6b6b",icon:"🔒",label:"Illisible"}},$={all:"Tous",ai:"🤖 IA",banking:"🏦 Banque",payment:"💳 Paiement",social:"📱 Social",email:"📧 Email",crypto:"₿ Crypto",hosting:"☁️ Hosting",productivity:"📋 Productivité",forbidden:"⚠️ Forbidden"};async function k(e){if(!(z.get("isAdmin")===!0)){e.innerHTML=`
