const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-DZS3Ey0Z.js","./apex-kb-Cv9YYzZr.js","./monitoring-B17vNBOa.js","./apex-tools-registry-DloDnFZi.js","./credential-patterns-BybElwOv.js","./sentinels-registry-Dm-DCy0C.js","./toast-Dgg9rcIP.js","./haptic-BUEqXK0N.js"])))=>i.map(i=>d[i]);
import{_ as c}from"./apex-kb-Cv9YYzZr.js";import{l as $}from"./monitoring-B17vNBOa.js";import{c as R}from"./listener-cleanup-Y2rGGxxX.js";import"./apex-tools-registry-DloDnFZi.js";import"./credential-patterns-BybElwOv.js";let s=null;function k(){s?.cleanup(),s=null}async function d(n){s?.cleanup(),s=R("sentinels");const{sentinels:o}=await c(async()=>{const{sentinels:t}=await import("./sentinels-DZS3Ey0Z.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3,4]),import.meta.url),{sentinelsRegistry:x,bootstrapSentinelsRegistry:f}=await c(async()=>{const{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}=await import("./sentinels-registry-Dm-DCy0C.js");return{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}},__vite__mapDeps([5,1,2,3,4,0]),import.meta.url);f();const a=o.list(),h=x.getStatus(),l=x.getMetrics(),g=a.filter(t=>t.lastResult?.ok).length,m=a.filter(t=>t.lastResult&&!t.lastResult.ok).length,v=a.filter(t=>!t.lastResult).length;n.innerHTML=`
...
//# sourceMappingURL=index-CBS1nM7M.js.map
