...
import{_ as g}from"./apex-kb-BSd1hSd3.js";import{e as c}from"./escape-html-B4YFbUXM.js";import{l as M}from"./monitoring-3uBGKGRH.js";import{m as b}from"../core/main-BYwFk6vy.js";import{g as L}from"./apex-tools-dispatch-core-HBEQ1OWw.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-BnCU6An4.js";import"./apex-tools-dispatch-skills-DKFyNY9N.js";import"./apex-tools-dispatch-data-CAKD0bBr.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-CQCjJpUc.js";import"./apex-tools-misc-BxDDF1lb.js";import"./apex-tools-registry-core-CTDAtJ18.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";import"./voice-t_RqTDYR.js";import"./haptic-CQFg2PXZ.js";const S="kdmc_admin";function T(){try{const s=localStorage.getItem("apex_v13_user");return s?JSON.parse(s):null}catch{return null}}function x(s){if(!s)return"—";try{return new Date(s).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function h(s){if(!s)return"jamais";const t=Date.now()-s,e=t/36e5;return e<1?`${Math.floor(t/6e4)}min`:e<24?`${Math.floor(e)}h`:`${Math.floor(e/24)}j`}function W(s){const t=T(),e=t?.id===S,o=t?.name??"Anonyme";L("admin.kb",s,t?.id)&&(s.innerHTML=`
