import{e as i}from"./escape-html-BlQj2yEF.js";import{l as f}from"./monitoring-3uBGKGRH.js";import{s as m}from"./apex-tools-dispatch-skills-CE_nvnLN.js";import{toast as a}from"./toast-CRdbcLoc.js";import"./apex-kb-BUdkXo7X.js";import"./voice-CKlB4PWs.js";import"./credential-patterns-CLzI061R.js";import"./haptic-CQFg2PXZ.js";const x=[{id:"invoice",label:"Facture",emoji:"💰"},{id:"quote",label:"Devis",emoji:"📋"},{id:"contract-signed",label:"Contrat à signer",emoji:"✍️"},{id:"report-standard",label:"Rapport",emoji:"📊"},{id:"certificate",label:"Certificat",emoji:"🏆"},{id:"receipt",label:"Reçu",emoji:"🧾"},{id:"custom",label:"Texte libre",emoji:"📝"}];function $(t){t.innerHTML=`
...
`).map(e=>e.trim()).filter(Boolean).map(e=>{const o=e.split("|").map(b=>b.trim());return{description:o[0]??"",quantity:parseFloat(o[1]??"1")||1,unit_price:parseFloat(o[2]??"0")||0}});a.info("Génération en cours...");try{const e=await m.generate({template:r,data:{number:p,client_name:n,client_address:d,items:c,date:new Date().toLocaleDateString("fr-FR")},...l?{options:{watermark:l}}:{}}),o=t.querySelector("#pdf-result");if(!o)return;e.success?(o.innerHTML=`
          ...
          </div>`,a.success(`✅ ${e.filename}`)):(o.innerHTML=`<p style="color:#ef4444">❌ ${i(e.error??"Erreur")}</p>`,a.error(`❌ ${e.error??"Erreur"}`))}catch(e){f.warn("studio-pdf","failed",{err:e}),a.error(`❌ ${e instanceof Error?e.message:"Erreur"}`)}})}export{$ as render};
