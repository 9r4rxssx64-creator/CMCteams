const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-D1VtWFD9.js","./monitoring-D2lWYrYo.js","./multi-source-analyze-Bg1HHfSC.js","./credential-patterns-CLzI061R.js","./auth-B3RTUO4E.js"])))=>i.map(i=>d[i]);
import{_ as v}from"./apex-kb-D1VtWFD9.js";import{A as b,r as f}from"../core/main-B4DExc5S.js";import{e as x}from"./escape-html-BlQj2yEF.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{auth as _}from"./auth-B3RTUO4E.js";import{i as h}from"./apex-tools-dispatch-core-C_k5h2yM.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import{toast as m}from"./toast-CRdbcLoc.js";import"./monitoring-D2lWYrYo.js";import"./multi-source-analyze-Bg1HHfSC.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-DOw4cI4G.js";import"./apex-tools-dispatch-data-DHUpGBCD.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-fNevKu6E.js";import"./apex-tools-misc-DBbScgMK.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let l=null;function J(){l?.cleanup(),l=null}function S(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}async function I(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),p=localStorage.getItem("apex_v13_last_known_name"),o=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!p||!o)return!1;const{deviceContext:n}=await v(async()=>{const{deviceContext:c}=await import("./device-context-DdThItzt.js");return{deviceContext:c}},__vite__mapDeps([0,1,2,3]),import.meta.url);if((await n.getFingerprint()).device_id!==o)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:t}=await v(async()=>{const{auth:c}=await import("./auth-B3RTUO4E.js");return{auth:c}},__vite__mapDeps([4,0,1,2,3]),import.meta.url);if((await t.loginTrusted(e,p)).ok)return f.navigate("chat"),!0}catch{}return!1}function O(e){if(l?.cleanup(),l=y("landing"),!h("module.landing")){e.innerHTML=`
  ...
  `;const o=e.querySelector("#login-form");o&&l&&l.bind(o,"submit",t=>{t.preventDefault(),u.tap(),T(e)});const n=e.querySelector("#login-reset-pin");n&&l&&l.bind(n,"click",()=>{u.medium();const s=e.querySelector("#login-name")?.value.trim()??"";if(!s){const i=e.querySelector("#login-error");i&&(i.innerHTML=`<div class="ax-alert ax-alert-warn">Tape ton nom et prénom d'abord, puis tap "🔑 J'ai oublié mon code PIN"</div>`);return}if(!confirm(`Réinitialiser le code PIN pour "${s}" ?
...
Continuer ?`))return;try{localStorage.removeItem("apex_v13_pin"),localStorage.removeItem("apex_v13_pin_kdmc_admin");const i=[];for(let a=0;a<localStorage.length;a++){const g=localStorage.key(a);g?.startsWith("apex_v13_pin_fails_")&&i.push(g)}for(const a of i)localStorage.removeItem(a)}catch{}const c=e.querySelector("#login-error");c&&(c.innerHTML='<div class="ax-alert ax-alert-success">✅ PIN réinitialisé. Tape ton nouveau code PIN puis Se connecter.</div>');const d=e.querySelector("#login-pin");d&&(d.value="",d.focus())});const r=e.querySelector("#login-go-signup");r&&l&&l.bind(r,"click",()=>{u.tap(),f.navigate("signup")}),typeof window<"u"&&window.matchMedia("(pointer: fine)").matches&&e.querySelector("#login-name")?.focus()}async function T(e){const p=e.querySelector("#login-name"),o=e.querySelector("#login-pin"),n=e.querySelector("#login-submit"),r=e.querySelector("#login-error"),t=n?.querySelector(".ax-btn-label"),s=n?.querySelector(".ax-spinner"),c=p?.value.trim()??"",d=o?.value??"";if(c.length<2||d.length<4){u.warning(),r&&(r.innerHTML='<div class="ax-error">Nom et PIN obligatoires (min 4 chiffres)</div>');return}n&&(n.disabled=!0),t&&(t.textContent="Vérification..."),s&&(s.style.display="inline-block");try{const i=await _.login(c,d);if(!i.ok){u.error();const a=i.reason??"Connexion impossible";r&&(r.innerHTML=`<div class="ax-error">${x(a)}</div>`),m.error(a),n&&(n.disabled=!1),t&&(t.textContent="Se connecter"),s&&(s.style.display="none");return}u.success(),m.success("Bienvenue !"),setTimeout(()=>{f.navigate("chat")},200)}catch(i){u.error();const a=i instanceof Error?i.message:"Erreur inattendue";r&&(r.innerHTML=`<div class="ax-error">${x(a)}</div>`),m.error(a),n&&(n.disabled=!1),t&&(t.textContent="Se connecter"),s&&(s.style.display="none")}}export{J as dispose,O as render};
