import{c as z}from"./listener-cleanup-Y2rGGxxX.js";import{l as $}from"./monitoring-BAiQJoxJ.js";import{s as A}from"../core/main-BQ6JhBsC.js";import{v as d}from"./voice-CpX0ed6p.js";import{h as M}from"./haptic-BUEqXK0N.js";import{toast as f}from"./toast-Dgg9rcIP.js";import"./apex-kb-BrxoW6ip.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-BefgB4O2.js";const k="kdmc_admin";let m=null;function V(){m?.cleanup(),m=null}function w(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function h(e){if(!e||e===0)return"—";const t=new Date(e),i=a=>a.toString().padStart(2,"0");return`${i(t.getDate())}/${i(t.getMonth()+1)}/${t.getFullYear()} ${i(t.getHours())}:${i(t.getMinutes())}`}function b(e){return Math.round(e*100)+"%"}function S(){const e=A.get("user");return!e||!e.id?null:{id:e.id,name:e.name??"",isAdmin:e.id===k}}function u(e,t,i,a){t&&e.bind(t,i,a)}function C(e){const t=Math.max(0,Math.min(1,e))*100,i=t>=85?"#22c55e":t>=50?"#ffa500":"#ff6666";return`
