const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-Ck3wIn9l.js","../core/main-CfXHe9JO.js","../assets/css/main-Bng3LWQS.css","./observability-txxP2bNR.js","./toast-BkOpdP-z.js","./haptic-BUEqXK0N.js"])))=>i.map(i=>d[i]);
import{_ as i,l as g}from"../core/main-CfXHe9JO.js";async function d(e){const{sentinels:s}=await i(async()=>{const{sentinels:t}=await import("./sentinels-Ck3wIn9l.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),n=s.list(),p=n.filter(t=>t.lastResult?.ok).length,x=n.filter(t=>t.lastResult&&!t.lastResult.ok).length,u=n.filter(t=>!t.lastResult).length;e.innerHTML=`
...
//# sourceMappingURL=index-Dr6V6W4_.js.map
