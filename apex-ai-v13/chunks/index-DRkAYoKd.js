const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-s9o8kKp9.js","./multi-source-analyze-Dfkr7KXP.js","./apex-kb-BEvG-Zs7.js","./credential-patterns-DNv8q-dc.js"])))=>i.map(i=>d[i]);
import{a as f,_ as k}from"./apex-kb-BEvG-Zs7.js";import{a as i}from"./escape-html-DGIYNPKb.js";import{c as H}from"./listener-cleanup-Y2rGGxxX.js";import{C as M,h as _,q as g}from"./monitoring-s9o8kKp9.js";import{apexExecute as y}from"./apex-execute-D_gXIsZH.js";import{kdmcProjectsRegistry as A}from"./kdmc-projects-registry-sMLNjcsy.js";import{auth as q}from"./auth-DX9tR4vY.js";import{i as T,r as R}from"./apex-tools-dispatch-core-sbw7vHmK.js";import{c as D}from"./csp-style-helper-BisGRi53.js";import{w as j}from"./whatsapp-CV-hw5Hz.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{s as E}from"../core/main-0bQNZ9fp.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./credential-patterns-DNv8q-dc.js";import"./multi-source-analyze-Dfkr7KXP.js";import"./apex-tools-dispatch-skills-30PLOlC_.js";import"./apex-tools-dispatch-data-ChDjwwF9.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-DmySP1I7.js";import"./apex-tools-misc-6oFZsUN4.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let v="commerce";const I={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function z(){const t=_.isEnabled();return`
  ...
  `),W(t),v==="bilan"||v==="consumption"){const c=v==="bilan"?"ax-admin-mount-bilan":"ax-admin-mount-consumption",r=t.querySelector(`#${c}`);if(r){const l=r.querySelector("p.ax-muted"),n=l?E(l,"admin-table"):()=>{};P(t).finally(()=>{n()})}else P(t)}}export{ve as dispose,h as render};
