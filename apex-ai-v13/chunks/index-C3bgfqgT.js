import{c as $}from"./listener-cleanup-Y2rGGxxX.js";import{l as f}from"./monitoring-3uBGKGRH.js";import{s as w}from"../core/main-DrVBXkSy.js";import{apexAutonomousMode as p}from"./apex-autonomous-mode-BtyfNeki.js";import{autonomousWatch as h}from"./autonomous-watch-Cm-jTW5S.js";import{haptic as z}from"./haptic-CQFg2PXZ.js";import{toast as n}from"./toast-ClsF1KRZ.js";import"./apex-kb-i9Iqlsh3.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-C1ueNZzl.js";import"./ai-router-h0KMy-mC.js";import"./chat-fallback-C1WZxrAT.js";import"./voice-CsoO0HQZ.js";import"./economy-mode-BkvrYZaX.js";import"./tokens-dashboard-C5ZzZyK6.js";import"./firebase-queue-Dc_pTFFc.js";let l=null,i=null;function N(){i&&(clearInterval(i),i=null),l?.cleanup(),l=null}function s(t){return t.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]??o)}function y(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function A(t){if(!t)return`
