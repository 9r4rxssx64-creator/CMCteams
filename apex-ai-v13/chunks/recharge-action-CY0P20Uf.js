import{e as t}from"./monitoring-D_1f5IX4.js";function x(n){const{rechargeUrl:e,rotateUrl:a,variant:o="inline",label:r="Recharge"}=n;if(!e&&!a)return"";if(o==="button"){const c=e?t(e):"",s=a?t(a):"";return`<div class="ax-recharge-action ax-recharge-action-button" style="display:flex;gap:6px;flex-wrap:wrap;margin-top:6px">
