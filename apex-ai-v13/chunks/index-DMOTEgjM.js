...
import{_ as u}from"./apex-kb-rRvA5n0g.js";import{e as o}from"./escape-html-BlQj2yEF.js";import{c as M}from"./listener-cleanup-Y2rGGxxX.js";import{l as D}from"./monitoring-C5xZgfP5.js";import"./credential-patterns-ClK5OHi0.js";import"./multi-source-analyze-D2V8qF5I.js";let i=null;function E(){i?.cleanup(),i=null}async function g(n){i?.cleanup(),i=M("sentinels");const{sentinels:x}=await u(async()=>{const{sentinels:t}=await import("./sentinels-BKTW8ZnG.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),{sentinelsRegistry:m,bootstrapSentinelsRegistry:b}=await u(async()=>{const{sentinelsRegistry:t,bootstrapSentinelsRegistry:a}=await import("./sentinels-registry-_GHZsJ7j.js");return{sentinelsRegistry:t,bootstrapSentinelsRegistry:a}},__vite__mapDeps([0,1,2,3]),import.meta.url);b();const e=x.list(),y=m.getStatus(),p=m.getMetrics(),v=e.filter(t=>t.lastResult?.ok).length,$=e.filter(t=>t.lastResult&&!t.lastResult.ok).length,R=e.filter(t=>!t.lastResult).length;n.innerHTML=`
