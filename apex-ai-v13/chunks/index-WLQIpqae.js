import{e as r}from"./monitoring-Bg0Oiujo.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DrybJuNu.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-B6It-ijz.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-z0aUEZIG.js";import"./kevin-alerts-BuCE8ABZ.js";import"./whatsapp-Becs01Jm.js";import"./auth-gate-2OYF1XnY.js";import"./auth-DzRI0SKl.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
