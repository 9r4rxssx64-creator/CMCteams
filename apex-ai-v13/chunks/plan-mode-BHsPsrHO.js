import{l as c}from"./monitoring-3uBGKGRH.js";import{aiRouter as g}from"./ai-router-Ck1HVcgK.js";import{a as d}from"./apex-kb-DUIOVBSL.js";import"../core/main-DTgauA5H.js";import"./multi-source-analyze-D9C_OxTF.js";import"./credential-patterns-qcw7Brjr.js";import"./chat-fallback-I0JJlHU0.js";import"./voice-CUTaj1G9.js";import"./tokens-dashboard-C5ZzZyK6.js";const u="apex_v13_plan_active",f="apex_v13_plan_history",y=20;class w{async generate(t){const e=(t||"").trim();if(!e)throw new Error("Objectif vide");const r=Date.now(),i=`plan_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,n=`Tu es Apex en MODE PLAN. L'utilisateur te donne un objectif. Tu DOIS retourner STRICTEMENT un JSON :
{
