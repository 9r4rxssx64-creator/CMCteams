import{e as r}from"./monitoring-gwUaDUms.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BBEkoKSl.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-1eA_tl5V.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-uwxpjP18.js";import"./kevin-alerts-eeo0xXnw.js";import"./whatsapp-jDkCFBsa.js";import"./auth-gate-DWido0Y0.js";import"./auth-Dczr_dgF.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
