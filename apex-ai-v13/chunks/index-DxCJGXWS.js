import{c as v,e as o,l as y}from"./monitoring-CdKapu3A.js";import{c as h}from"./listener-cleanup-Y2rGGxxX.js";import{p as c}from"./projects-Dlil9XH0.js";import{g as $}from"./apex-tools-dispatch-core-DdIikP2I.js";import{toast as u}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-i0SrWIqV.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-C9cr8uzA.js";import"./apex-tools-dispatch-skills-BYmpLTiJ.js";import"./apex-tools-dispatch-data-5TGwuBD7.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-BFBfrGw2.js";import"./apex-tools-misc-BZp_ZxEV.js";import"./apex-tools-registry-core-48oOK-KS.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./haptic-CQFg2PXZ.js";let m=null,l=null,g=null;function R(){m?.cleanup(),m=null,l=null,g=null}function d(t){m?.cleanup(),m=h("projects");const p=v.get("user")?.id??"anon";if(!$("module.projects",t,p))return;const r=c.list(p),n=c.getActiveId(p),s=l?c.get(l,p):null,a=n?(()=>{const e=c.get(n,p);return e?`<div class="ax-gs-400" style="border:1px solid rgba(232,184,48,.5);border-radius:10px;padding:12px;margin-bottom:12px;background:rgba(232,184,48,.06)">
             ...
             </div>`:""})():'<p style="color:var(--ax-text-dim);font-size:13px;margin-bottom:12px">Aucun projet actif — le chat répond sans cadre projet.</p>',i=r.length?r.map(e=>{const f=g===e.id?`<div style="margin-top:10px;border-top:1px solid #2a2a3a;padding-top:10px">
                 ${e.knowledge.map((b,j)=>`<div style="display:flex;gap:8px;align-items:start;margin-bottom:6px">
                       <div style="flex:1"><strong style="font-size:12px">${o(b.title)}</strong>
                         <div style="color:var(--ax-text-dim);font-size:12px;white-space:pre-wrap">${o(b.content.slice(0,160))}${b.content.length>160?"…":""}</div></div>
