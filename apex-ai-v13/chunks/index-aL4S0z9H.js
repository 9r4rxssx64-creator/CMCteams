const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-6-EY2ka6.js","../core/main-BEHfRhW_.js","../assets/css/main-Bng3LWQS.css","./observability-DGUXOW-n.js"])))=>i.map(i=>d[i]);
import{_ as l,l as r}from"../core/main-BEHfRhW_.js";async function n(a){const{sentinels:s}=await l(async()=>{const{sentinels:t}=await import("./sentinels-6-EY2ka6.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),e=s.list();a.innerHTML=`
...
//# sourceMappingURL=index-aL4S0z9H.js.map
