import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-pGo9stcP.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-ClsF1KRZ.js";import"./monitoring-3uBGKGRH.js";import"./apex-kb-Dy6vCGT-.js";import"./credential-patterns-guxfirLX.js";import"./auth-gate-lf4fRBdH.js";import"../core/main-D3lWW8n9.js";import"./multi-source-analyze-C4hRQtOU.js";import"./commerce-CyiAOcl4.js";import"./kevin-alerts-FNNSDkq7.js";import"./whatsapp-L2A4QKhs.js";let r=null;function P(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function f(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function C(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
