import{l as c}from"./monitoring-DMtdadhB.js";import{aiRouter as g}from"./ai-router-CvD1scvT.js";import{c as d}from"./apex-kb-DEL_sHoX.js";import"../core/main-myvRjsi6.js";import"./multi-source-analyze-CB5VpFNy.js";import"./credential-patterns-CLzI061R.js";import"./chat-fallback-Dw-F-MpW.js";import"./voice-BhcyBU8i.js";import"./economy-mode-BvFiYfEM.js";import"./tokens-dashboard-C5ZzZyK6.js";const u="apex_v13_plan_active",f="apex_v13_plan_history",y=20;class w{async generate(t){const e=(t||"").trim();if(!e)throw new Error("Objectif vide");const r=Date.now(),i=`plan_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,n=`Tu es Apex en MODE PLAN. L'utilisateur te donne un objectif. Tu DOIS retourner STRICTEMENT un JSON :
{
