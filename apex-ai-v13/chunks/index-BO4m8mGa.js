import{e as r}from"./monitoring-FVZXdgCC.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CzK0s9Tj.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-ORaraTFl.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-D6LOeL9m.js";import"./kevin-alerts-DuhY632q.js";import"./whatsapp-CtULyIJd.js";import"./auth-gate-DJGgbIx9.js";import"./auth-DCJOt04d.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
