import{e as r}from"./monitoring-BflFP8Zd.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-Csjacd-8.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-C3fzIm5i.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-Cdi4zCRf.js";import"./kevin-alerts-DoNCfIK8.js";import"./whatsapp-DQBKY3He.js";import"./auth-gate-m3uwVqWN.js";import"./auth-Bk2g9XMF.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
