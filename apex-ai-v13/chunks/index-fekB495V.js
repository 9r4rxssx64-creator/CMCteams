import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-BD3e2KjQ.js";import{broadlinkBridge as t}from"./broadlink-bridge-B-wn3mQX.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-D58JHve5.js";import"./credential-patterns-D-srKehy.js";import"./multi-source-analyze-qLL1n6a4.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
