const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-Dx00IPob.js","./monitoring-3uBGKGRH.js","./credential-patterns-CLzI061R.js"])))=>i.map(i=>d[i]);
import{_ as g}from"./apex-kb-Dx00IPob.js";import{l as M}from"./monitoring-3uBGKGRH.js";import{m as b}from"../core/main-BdyYp559.js";import{g as L}from"./apex-tools-dispatch-core-DbuM0bVv.js";import{toast as p}from"./toast-ClsF1KRZ.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-Dai8QiTQ.js";import"./apex-tools-dispatch-skills-BV9-W1kV.js";import"./apex-tools-dispatch-data-BsbZmmLK.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-CVk2QLb4.js";import"./apex-tools-registry-DX8rxGJt.js";import"./voice-8szRM3YO.js";import"./haptic-CQFg2PXZ.js";const S="kdmc_admin";function c(r){return r.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function T(){try{const r=localStorage.getItem("apex_v13_user");return r?JSON.parse(r):null}catch{return null}}function x(r){if(!r)return"—";try{return new Date(r).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function h(r){if(!r)return"jamais";const t=Date.now()-r,e=t/36e5;return e<1?`${Math.floor(t/6e4)}min`:e<24?`${Math.floor(e)}h`:`${Math.floor(e/24)}j`}function B(r){const t=T(),e=t?.id===S,o=t?.name??"Anonyme";L("admin.kb",r,t?.id)&&(r.innerHTML=`
