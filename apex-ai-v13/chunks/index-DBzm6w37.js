import{p as r}from"./monitoring-Cq_vIOf8.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-fYkNSql_.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-CgbS5D-d.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DY2-6tey.js";import"./kevin-alerts-Q23XD9Dp.js";import"./whatsapp-B8P56fVl.js";import"./auth-gate-MZY5mJ1i.js";import"./auth-5l3Yi1sP.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
