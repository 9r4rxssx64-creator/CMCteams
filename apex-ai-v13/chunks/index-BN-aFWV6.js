import{e as o}from"./escape-html-BlQj2yEF.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{l as c}from"./monitoring-3uBGKGRH.js";import{s as f}from"../core/main-CxoKTJ9r.js";import{a as u}from"./apex-kb-DRERxXuJ.js";import{rgpd as x}from"./rgpd-nvx_dbpc.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as l}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-Bfq2osax.js";import"./credential-patterns-CLzI061R.js";let i=null;function S(){i?.cleanup(),i=null}function m(e){if(!e)return"—";try{return new Date(e).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function b(e){const t=e.scopes.includes("*")?'<span style="color:#ff6b6b;font-weight:600">Globale (tous scopes)</span>':e.scopes.map(s=>`<code style="background:rgba(255,255,255,0.05);padding:2px 6px;border-radius:4px;font-size:11px;margin-right:4px">${o(s)}</code>`).join("");return`
