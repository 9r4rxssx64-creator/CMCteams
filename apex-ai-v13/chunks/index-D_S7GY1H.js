...
Bien cordialement,
${i} ${r}`}class D{load(e){if(!e)return null;try{const t=localStorage.getItem(f(e));if(!t)return null;const i=JSON.parse(t);return!i||typeof i!="object"?null:i}catch(t){return p.warn("studio-cv","load failed",{err:t}),null}}save(e,t){if(!e)return!1;try{return localStorage.setItem(f(e),JSON.stringify(t)),!0}catch(i){return p.warn("studio-cv","save failed (quota?)",{err:i}),!1}}setTemplate(e,t){const i=this.load(e)??b(t);return i.template=t,this.save(e,i),i}setLang(e,t){const i=this.load(e);return i?(i.lang=t,this.save(e,i)):!1}addExperience(e){const t=this.load(e);return t?(t.experiences.length>=x||(t.experiences.push($()),this.save(e,t)),t):null}addFormation(e){const t=this.load(e);return t?(t.formations.length>=v||(t.formations.push(k()),this.save(e,t)),t):null}addCertification(e){const t=this.load(e);return t?(t.certifications.length>=A||(t.certifications.push(w()),this.save(e,t)),t):null}addProject(e){const t=this.load(e);return t?(t.projets.length>=j||(t.projets.push(T()),this.save(e,t)),t):null}addReference(e){const t=this.load(e);return t?(t.references.length>=M||(t.references.push(R()),this.save(e,t)),t):null}removeExperience(e,t){const i=this.load(e);return i?(i.experiences=i.experiences.filter(r=>r.id!==t),this.save(e,i)):!1}removeFormation(e,t){const i=this.load(e);return i?(i.formations=i.formations.filter(r=>r.id!==t),this.save(e,i)):!1}setIdentite(e,t){const i=this.load(e);return i?(i.identite={...i.identite,...t},this.save(e,i)):!1}setResume(e,t){const i=this.load(e);return i?(i.resume=t.slice(0,600),this.save(e,i)):!1}setCompetences(e,t){const i=this.load(e);return i?(i.competences=t.slice(0,P),this.save(e,i)):!1}clear(e){return e?(localStorage.removeItem(f(e)),!0):!1}}const d=new D;function m(n){const e=C.get("user"),t=e?.id??"anon";let i=d.load(t);if(!i){const o={};e?.firstName&&(o.prenom=e.firstName),e?.lastName&&(o.nom=e.lastName),i=b("classique",o),d.save(t,i)}const r=F(i),a=_(i),c=h.map(o=>`
  ...
  `,I(n,t)}function I(n,e){n.querySelectorAll(".ax-cv-template").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.template;r&&(d.setTemplate(e,r),m(n))})});const t=(i,r)=>{const a=n.querySelector(`#${i}`);a?.addEventListener("change",()=>{d.setIdentite(e,{[r]:a.value})})};t("ax-cv-prenom","prenom"),t("ax-cv-nom","nom"),t("ax-cv-titre","titre"),t("ax-cv-email","email"),t("ax-cv-tel","telephone"),t("ax-cv-linkedin","linkedin"),n.querySelector("#ax-cv-add-exp")?.addEventListener("click",()=>{d.addExperience(e),m(n)}),n.querySelector("#ax-cv-add-form")?.addEventListener("click",()=>{d.addFormation(e),m(n)}),n.querySelector("#ax-cv-clear")?.addEventListener("click",()=>{d.clear(e),m(n)}),n.querySelectorAll("[data-export]").forEach(i=>{i.addEventListener("click",()=>{const r=i.dataset.export;p.info("studio-cv","export requested",{format:r}),(async()=>{try{const{toast:a}=await q(async()=>{const{toast:c}=await import("./toast-Dgg9rcIP.js");return{toast:c}},__vite__mapDeps([0,1]),import.meta.url).catch(()=>({toast:null}));a?.info(`Export ${r.toUpperCase()} en cours…`)}catch(a){p.warn("studio-cv","export failed",{err:a})}})()})}),n.querySelector("#ax-cv-cover-letter")?.addEventListener("click",()=>{p.info("studio-cv","cover letter requested")}),n.querySelector("#ax-cv-match-offer")?.addEventListener("click",()=>{p.info("studio-cv","match offer requested")}),n.querySelector("#ax-cv-interview")?.addEventListener("click",()=>{p.info("studio-cv","interview simulator requested")})}export{J as ATS_REQUIRED_KEYWORDS_FR,B as ATS_REQUIRED_SECTIONS,G as COMPETENCES_PAR_DOMAINE,H as COVER_LETTER_TEMPLATES,V as INTERVIEW_QUESTIONS_FR,A as MAX_CERTIFICATIONS,P as MAX_COMPETENCES,x as MAX_EXPERIENCES,v as MAX_FORMATIONS,j as MAX_PROJECTS,M as MAX_REFERENCES,Q as NIVEAUX_CECRL,E as STORAGE_PREFIX,h as TEMPLATES,_ as calcATSScore,F as calcCompleteness,w as createCertification,$ as createExperience,k as createFormation,T as createProject,R as createReference,d as cvStudioStore,l as escapeHtml,W as extractGitHubUsername,K as extractLinkedInSlug,Z as generateCoverLetterTemplate,f as getStorageKey,b as initCV,y as isValidEmail,Y as matchOffer,m as render};
//# sourceMappingURL=index-D_S7GY1H.js.map
