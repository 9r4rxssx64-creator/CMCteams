const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-Bpf2mYw2.js","./monitoring-3uBGKGRH.js","./credential-patterns-guxfirLX.js","./auth-DPJD-Yk4.js","./multi-source-analyze-pnf_r8ld.js","../assets/css/main-DkJDY-ZY.css"])))=>i.map(i=>d[i]);
import{_ as v}from"./apex-kb-Bpf2mYw2.js";import{A as b,r as f}from"../core/main-DElitp4e.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{auth as _}from"./auth-DPJD-Yk4.js";import{i as h}from"./voice-DvmhwLRC.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import{toast as m}from"./toast-ClsF1KRZ.js";import"./monitoring-3uBGKGRH.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-pnf_r8ld.js";let c=null;function R(){c?.cleanup(),c=null}function x(e){return e.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]??o)}function S(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const r=atob(e[1]??"").split(":")[0];if(r)return{uid:r}}catch{}return null}async function I(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),o=localStorage.getItem("apex_v13_last_known_name"),r=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!o||!r)return!1;const{deviceContext:n}=await v(async()=>{const{deviceContext:p}=await import("./device-context-DaSdTdsE.js");return{deviceContext:p}},__vite__mapDeps([0,1,2]),import.meta.url);if((await n.getFingerprint()).device_id!==r)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:t}=await v(async()=>{const{auth:p}=await import("./auth-DPJD-Yk4.js");return{auth:p}},__vite__mapDeps([3,0,1,2,4,5]),import.meta.url);if((await t.loginTrusted(e,o)).ok)return f.navigate("chat"),!0}catch{}return!1}function z(e){if(c?.cleanup(),c=y("landing"),!h("module.landing")){e.innerHTML=`
