import{l as c}from"./monitoring-3uBGKGRH.js";import{aiRouter as g}from"./ai-router-CzL6T0q7.js";import{a as d}from"./apex-kb-CmLg4l85.js";import"../core/main-DFnpHCqE.js";import"./multi-source-analyze-DzV9YvuY.js";import"./credential-patterns-D-srKehy.js";import"./chat-fallback-HJL95bTd.js";import"./voice-CtW6d5IW.js";import"./tokens-dashboard-C5ZzZyK6.js";const u="apex_v13_plan_active",f="apex_v13_plan_history",y=20;class w{async generate(t){const e=(t||"").trim();if(!e)throw new Error("Objectif vide");const r=Date.now(),i=`plan_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,n=`Tu es Apex en MODE PLAN. L'utilisateur te donne un objectif. Tu DOIS retourner STRICTEMENT un JSON :
{
