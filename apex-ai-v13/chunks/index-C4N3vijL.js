import{l as b}from"./monitoring-3uBGKGRH.js";import{s as y}from"../core/main-BOqWmV_-.js";import{c as h}from"./csp-style-helper-BisGRi53.js";import{iotRegistry as d}from"./iot-providers-registry-CnEnur95.js";import{toast as r}from"./toast-ClsF1KRZ.js";import"./apex-kb-K_ZPpd3E.js";import"./credential-patterns-CXLwp4oz.js";import"./multi-source-analyze-BsOCsqij.js";import"./broadlink-bridge-CkbMQJ28.js";import"./haptic-CQFg2PXZ.js";const v="kdmc_admin";function n(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function $(){return y.get("user")?.id===v}async function g(e){if(e){if(!$()){e.innerHTML=`
