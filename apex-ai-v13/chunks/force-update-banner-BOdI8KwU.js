const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-DbAgUIbF.js","./monitoring-3uBGKGRH.js","./credential-patterns-D-srKehy.js"])))=>i.map(i=>d[i]);
import{_ as d}from"./apex-kb-DbAgUIbF.js";import{A as c}from"../core/main-BKhWVufO.js";import{l as a}from"./monitoring-3uBGKGRH.js";import{s as u}from"./style-injector-C0qr4r8-.js";import"./credential-patterns-D-srKehy.js";import"./multi-source-analyze-DitVJkMM.js";const s="apex-force-update-banner",f="apex-force-update-banner",x="./index.html",v=600*1e3,h="apex_v13_last_version_check_ts",l="apex_v13_force_update_in_progress",m=3e4;class g{installed=!1;intervalHandle=null;visibilityListener=null;install(){this.installed||typeof document>"u"||(this.installed=!0,setTimeout(()=>void this.checkAndMaybeShow(),3e3),this.intervalHandle=setInterval(()=>void this.checkAndMaybeShow(),v),typeof document<"u"&&typeof window<"u"&&(this.visibilityListener=()=>{if(document.visibilityState!=="visible")return;const e=parseInt(localStorage.getItem("apex_v13_last_visibility_update_check")??"0",10);if(!(Date.now()-e<1800*1e3)){try{localStorage.setItem("apex_v13_last_visibility_update_check",String(Date.now()))}catch{}this.checkAndMaybeShow()}},document.addEventListener("visibilitychange",this.visibilityListener)),a.info("force-update","banner installed (sole owner force-update flow)"))}isUpdateInProgress(){try{const e=parseInt(sessionStorage.getItem(l)??"0",10);return e?Date.now()-e>m?(sessionStorage.removeItem(l),!1):!0:!1}catch{return!1}}markUpdateInProgress(){try{sessionStorage.setItem(l,String(Date.now()))}catch{}}uninstall(){this.intervalHandle&&clearInterval(this.intervalHandle),this.intervalHandle=null,this.visibilityListener&&typeof document<"u"&&document.removeEventListener("visibilitychange",this.visibilityListener),this.visibilityListener=null,this.removeBanner(),this.installed=!1}async checkVersion(){try{const e=await fetch(`${x}?_v=${Date.now()}`,{cache:"no-store",headers:{"Cache-Control":"no-cache"}});if(!e.ok)return a.warn("force-update",`version check fetch failed: ${e.status}`),{remote_ver:null,local_ver:c,is_stale:!1};const n=(await e.text()).match(/data-app-ver="([^"]+)"/)?.[1]??null,i=n!==null&&n!==c;try{localStorage.setItem(h,String(Date.now()))}catch{}return{remote_ver:n,local_ver:c,is_stale:i}}catch(e){return a.warn("force-update","version check failed",{err:e}),{remote_ver:null,local_ver:c,is_stale:!1}}}async checkAndMaybeShow(){if(this.isUpdateInProgress()){a.debug("force-update","check skipped — update already in progress");return}const e=await this.checkVersion();if(e.is_stale&&e.remote_ver){const t=parseInt(localStorage.getItem("apex_v13_auto_maj_last")??"0",10),r=Date.now()-t>3600*1e3,n=document.visibilityState==="hidden"||this.isUserIdle(),i=!this.hasActiveFetch()&&!this.hasUserTyping();if(r&&n&&i){a.info("force-update",`AUTO-MAJ silencieuse (${e.local_ver} → ${e.remote_ver})`),localStorage.setItem("apex_v13_auto_maj_last",String(Date.now()));try{const{toast:o}=await d(async()=>{const{toast:_}=await import("./toast-ClsF1KRZ.js");return{toast:_}},[],import.meta.url);o.info(`🔄 Mise à jour ${e.remote_ver} en cours…`)}catch{}await this.forceUpdate()}else this.showBanner(e.remote_ver)}else this.removeBanner()}hasUserTyping(){const e=document.activeElement;if(!e)return!1;const t=e.tagName?.toLowerCase();return t==="textarea"||t==="input"||e.getAttribute("contenteditable")==="true"}hasActiveFetch(){try{return window.__apexActiveStream===!0}catch{return!1}}isUserIdle(){try{const e=parseInt(localStorage.getItem("apex_v13_last_interaction")??"0",10);return e?Date.now()-e>3e4:!0}catch{return!0}}showBanner(e){if(document.getElementById(s))return;this.injectStyle();const t=document.createElement("div");t.id=s,t.setAttribute("role","alert"),t.setAttribute("aria-live","assertive"),t.innerHTML=`
