import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-CSQ0n1Vx.js";import{broadlinkBridge as t}from"./broadlink-bridge-xH6-TMX0.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-BNk1cX4A.js";import"./credential-patterns-D-srKehy.js";import"./multi-source-analyze-CGK5HgrY.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
