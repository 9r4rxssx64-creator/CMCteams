...
import{_ as y}from"./apex-kb-c-P5-RTX.js";import{a as s}from"./escape-html-DGIYNPKb.js";import{c as S}from"./listener-cleanup-Y2rGGxxX.js";import{C as T,q as _}from"./monitoring-BfbB6e37.js";import{credentialsAudit as k}from"./credentials-audit-DfzVm_3x.js";import{haptic as f}from"./haptic-CQFg2PXZ.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-BBMN1Ak3.js";let u=null,m=null,v="all";function H(){u?.cleanup(),u=null}const $={ok:{color:"#22cc77",icon:"🟢",label:"OK"},missing:{color:"#888",icon:"⚪",label:"Non config"},corrupted:{color:"#ff6b6b",icon:"🔴",label:"Corrompu"},expired:{color:"#ffaa00",icon:"🟠",label:"Expiré"},unknown:{color:"#aaa",icon:"❓",label:"Inconnu"},decrypt_failed:{color:"#ff6b6b",icon:"🔒",label:"Illisible"}},h={all:"Tous",ai:"🤖 IA",banking:"🏦 Banque",payment:"💳 Paiement",social:"📱 Social",email:"📧 Email",crypto:"₿ Crypto",hosting:"☁️ Hosting",productivity:"📋 Productivité",forbidden:"⚠️ Forbidden"};async function w(e){if(!(T.get("isAdmin")===!0)){e.innerHTML=`
      <div class="ax-gs-21">
