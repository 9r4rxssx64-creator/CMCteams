import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{l as c}from"./monitoring-3uBGKGRH.js";import{s as u}from"../core/main-BnQtkoVJ.js";import{a as f}from"./apex-kb-D1zljU5q.js";import{rgpd as g}from"./rgpd-DL4Vmxr2.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as l}from"./toast-ClsF1KRZ.js";import"./multi-source-analyze-BIfTUL_2.js";import"./credential-patterns-CLzI061R.js";let i=null;function k(){i?.cleanup(),i=null}function o(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function m(e){if(!e)return"—";try{return new Date(e).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}}function b(e){const t=e.scopes.includes("*")?'<span style="color:#ff6b6b;font-weight:600">Globale (tous scopes)</span>':e.scopes.map(a=>`<code style="background:rgba(255,255,255,0.05);padding:2px 6px;border-radius:4px;font-size:11px;margin-right:4px">${o(a)}</code>`).join("");return`
