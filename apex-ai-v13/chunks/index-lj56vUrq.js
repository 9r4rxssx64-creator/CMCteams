const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-Cyq4GAw3.js","../core/main-D1U8bEzg.js","../assets/css/main-Bng3LWQS.css","./observability-D3rlP0JZ.js","./toast-BkOpdP-z.js","./haptic-BUEqXK0N.js"])))=>i.map(i=>d[i]);
import{_ as i,l as g}from"../core/main-D1U8bEzg.js";async function d(e){const{sentinels:s}=await i(async()=>{const{sentinels:t}=await import("./sentinels-Cyq4GAw3.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3]),import.meta.url),n=s.list(),p=n.filter(t=>t.lastResult?.ok).length,x=n.filter(t=>t.lastResult&&!t.lastResult.ok).length,u=n.filter(t=>!t.lastResult).length;e.innerHTML=`
...
//# sourceMappingURL=index-lj56vUrq.js.map
