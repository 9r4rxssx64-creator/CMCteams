import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-BS-z-sug.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-ClsF1KRZ.js";import"./monitoring-3uBGKGRH.js";import"./apex-kb-c4_AErjY.js";import"./credential-patterns-guxfirLX.js";import"./auth-gate-St-GG_i_.js";import"../core/main-t0_JzSDB.js";import"./multi-source-analyze-NuVDv5dF.js";import"./commerce-Bu39cp_v.js";import"./kevin-alerts-D4RLmxma.js";import"./whatsapp-D7zm_R9R.js";let r=null;function P(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function f(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function C(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
