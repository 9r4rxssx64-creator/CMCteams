const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-D5vzxqdJ.js","./multi-source-analyze-DdqCfc-V.js","./credential-patterns-DUMYZEMu.js","./apex-kb-BTbqxy9i.js","./auth-DW1N10g8.js"])))=>i.map(i=>d[i]);
import{b as I,e as x,_ as l,l as z}from"./monitoring-D5vzxqdJ.js";import{c as P}from"./listener-cleanup-Y2rGGxxX.js";import{c as O}from"./csp-style-helper-BEHhIhzj.js";import{r as D}from"./recharge-action-DmZiHX--.js";import"./multi-source-analyze-DdqCfc-V.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BTbqxy9i.js";let i=null;function K(){i?.cleanup(),i=null}const L="apex_v13_chat_auto_read";function R(){try{return localStorage.getItem(L)==="1"}catch{return!1}}function V(o){try{localStorage.setItem(L,o?"1":"0")}catch{}}async function q(o){try{const A=await l(()=>import("./voice-Dc3Qytlp.js"),__vite__mapDeps([0,1,2,3]),import.meta.url),{listVoices:S,getActiveVoice:g,setActiveVoice:b,speak:v,stopAll:m}=A,h=o.querySelector("#ax-settings-auto-read"),T=o.querySelector("#ax-voice-current"),k=o.querySelector("#ax-voice-list"),E=o.querySelectorAll(".ax-voice-cat-btn"),_=o.querySelector("#ax-settings-rag");_&&(l(async()=>{const{apexMemoryRag:n}=await import("./apex-memory-rag-Cms0u6mw.js");return{apexMemoryRag:n}},__vite__mapDeps([0,1,2,3]),import.meta.url).then(({apexMemoryRag:n})=>{_.checked=n.isEnabled()}),i.bind(_,"change",()=>{(async()=>{const{apexMemoryRag:n}=await l(async()=>{const{apexMemoryRag:a}=await import("./apex-memory-rag-Cms0u6mw.js");return{apexMemoryRag:a}},__vite__mapDeps([0,1,2,3]),import.meta.url);n.enable(_.checked);const{toast:p}=await l(async()=>{const{toast:a}=await import("./toast-BCPNzfMv.js");return{toast:a}},[],import.meta.url);p.success(_.checked?"🧠 Mémoire long terme activée":"Mémoire long terme désactivée")})()}));const w=o.querySelector("#ax-settings-cmem");if(w&&(l(async()=>{const{compactMemory:n}=await import("./compact-memory-AGkINt_q.js");return{compactMemory:n}},[],import.meta.url).then(({compactMemory:n})=>{w.checked=n.isEnabled()}),i.bind(w,"change",()=>{(async()=>{const{compactMemory:n}=await l(async()=>{const{compactMemory:a}=await import("./compact-memory-AGkINt_q.js");return{compactMemory:a}},[],import.meta.url);n.enable(w.checked);const{toast:p}=await l(async()=>{const{toast:a}=await import("./toast-BCPNzfMv.js");return{toast:a}},[],import.meta.url);p.success(w.checked?"⚡ Mémoire compacte activée":"Mémoire compacte désactivée")})()})),!k)return;h&&(h.checked=R(),i.bind(h,"change",()=>{V(h.checked),(async()=>{const{toast:n}=await l(async()=>{const{toast:p}=await import("./toast-BCPNzfMv.js");return{toast:p}},[],import.meta.url);n.success(h.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const $=()=>{if(!T)return;const n=g(),a=S().find(s=>s.id===n);T.textContent=a?`Voix active : ${a.emoji??"🔊"} ${a.name} (${a.category})`:`Voix active : ${n}`};$();const f=n=>{const p=S(),a=n==="all"?p:p.filter(t=>t.category===n),s=g();k.setAttribute("aria-busy","false"),k.innerHTML=a.map(t=>{const e=t.id===s,r=t.emoji??(t.category==="pro"?"🎙️":t.category==="fun"?"🎉":"🎨"),d=t.description?x(t.description):"";return`
