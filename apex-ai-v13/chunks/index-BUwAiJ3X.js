const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-3uBGKGRH.js","./multi-source-analyze-D8khlpoL.js","./apex-kb-BQ7RvhPe.js","./credential-patterns-CLzI061R.js","../assets/css/main-DHnkOnRu.css"])))=>i.map(i=>d[i]);
import{b as f,_ as k}from"./apex-kb-BQ7RvhPe.js";import{e as i}from"./escape-html-BlQj2yEF.js";import{c as H}from"./listener-cleanup-Y2rGGxxX.js";import{l as h}from"./monitoring-3uBGKGRH.js";import{s as M,a as z}from"../core/main-D2R-lkuF.js";import{apexExecute as y}from"./apex-execute-DJ5qyxVB.js";import{auth as P}from"./auth-oxe3_xHI.js";import{commerce as _}from"./commerce-DgJRAh9z.js";import{c as D}from"./csp-style-helper-BisGRi53.js";import{i as T,r as R}from"./voice-B6k0RIEV.js";import{kdmcProjectsRegistry as S}from"./kdmc-projects-registry-DdTqW2gy.js";import{w as j}from"./whatsapp-PsXbhRwV.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-D8khlpoL.js";import"./claude-bridge-B9vhApr8.js";let v="commerce";const I={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function E(){const t=_.isEnabled();return`
  ...
  `}function N(){const t=S.list(),o=S.count(),c=S.countActive(),r=["active","wip","archived"],l=t.map(n=>{const e=r.includes(n.status)?n.status:"archived",a=n.tech_stack.slice(0,4).map(s=>i(s)).join(", ");return`
  ...
  `}function G(){const t=I[v];if(t&&!T(t))return`<div class="ax-admin-section">${R(t)}</div>`;switch(v){case"commerce":return E();case"users":return V();case"pending":return B();case"health":return F();case"projects":return N();case"executions":return O();case"knowledge":return K();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>';case"audit-log":return'<div id="ax-admin-mount-audit-log" class="ax-admin-section"><p class="ax-muted">Chargement audit log immuable…</p></div>'}}async function q(t){const o=t.querySelector("#ax-admin-audits-summary");if(o)try{const{reportsHistory:n}=await k(async()=>{const{reportsHistory:b}=await import("./apex-reports-history-Cv_X_jWe.js");return{reportsHistory:b}},__vite__mapDeps([0]),import.meta.url),e=n.getStats(),a=e.lastLayoutTs?new Date(e.lastLayoutTs).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"jamais",s=e.lastFunctionalTs?new Date(e.lastFunctionalTs).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"jamais",u=e.recentBugs>0?"var(--ax-error)":"var(--ax-green)",x=e.recentEscalations>0?"var(--ax-sev-high)":"var(--ax-green)";o.innerHTML=`
      ...
      `}catch(n){h.warn("admin","audit-log render failed",{err:n}),l.innerHTML='<p class="ax-muted">Audit log indisponible (module ko)</p>'}}}function K(){const t=f.listRepos(),o=f.getStats(),c=t.map(r=>`
  ...
  `,g(t)}let m=null;function me(){m?.cleanup(),m=null}function g(t){if(m?.cleanup(),m=H("admin"),!M.get("isAdmin")){t.innerHTML=`
      <div class="ax-empty">
        <h2>Accès réservé</h2>
  ...
  `),W(t),v==="bilan"||v==="consumption"){const c=v==="bilan"?"ax-admin-mount-bilan":"ax-admin-mount-consumption",r=t.querySelector(`#${c}`);if(r){const l=r.querySelector("p.ax-muted"),n=l?z(l,"admin-table"):()=>{};q(t).finally(()=>{n()})}else q(t)}}export{me as dispose,g as render};
