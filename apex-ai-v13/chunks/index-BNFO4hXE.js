const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./multi-source-analyze-NuVDv5dF.js","./apex-kb-c4_AErjY.js","./monitoring-3uBGKGRH.js","./credential-patterns-guxfirLX.js","../assets/css/main-CLN-rjKG.css"])))=>i.map(i=>d[i]);
import{b as f,_ as $}from"./apex-kb-c4_AErjY.js";import{c as q}from"./listener-cleanup-Y2rGGxxX.js";import{l as y}from"./monitoring-3uBGKGRH.js";import{s as P,a as z}from"../core/main-t0_JzSDB.js";import{apexExecute as v}from"./apex-execute-BoZErM1G.js";import{auth as T}from"./auth-PxkCDcTL.js";import{commerce as S}from"./commerce-Bu39cp_v.js";import{c as M}from"./csp-style-helper-BisGRi53.js";import{i as A,r as j}from"./voice-BNebb1g_.js";import{kdmcProjectsRegistry as w}from"./kdmc-projects-registry-DdTqW2gy.js";import{w as C}from"./whatsapp-D7zm_R9R.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as u}from"./toast-ClsF1KRZ.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-NuVDv5dF.js";import"./claude-bridge-DWR6g67y.js";let h="commerce";const L={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function n(e){return e.replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i]??i)}function H(){const e=S.isEnabled();return`
  ...
  `}function N(){const e=L[h];if(e&&!A(e))return`<div class="ax-admin-section">${j(e)}</div>`;switch(h){case"commerce":return H();case"users":return R();case"pending":return I();case"health":return D();case"projects":return U();case"executions":return B();case"knowledge":return G();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>';case"audit-log":return'<div id="ax-admin-mount-audit-log" class="ax-admin-section"><p class="ax-muted">Chargement audit log immuable…</p></div>'}}async function _(e){const i=e.querySelector("#ax-admin-mount-bilan");if(i)try{(await $(()=>import("./financial-bilan-Biu3SutE.js"),__vite__mapDeps([0,1,2,3,4]),import.meta.url)).render(i)}catch(o){y.warn("admin","financial-bilan render failed",{err:o}),i.innerHTML='<p class="ax-muted">Bilan indisponible (module ko)</p>'}const c=e.querySelector("#ax-admin-mount-consumption");if(c)try{(await $(()=>import("./consumption-dashboard-Bw89knit.js"),__vite__mapDeps([1,2,3,0,4]),import.meta.url)).render(c)}catch(o){y.warn("admin","consumption-dashboard render failed",{err:o}),c.innerHTML='<p class="ax-muted">Consommation indisponible (module ko)</p>'}const s=e.querySelector("#ax-admin-mount-audit-log");if(s){if(!A("admin.audit-log")){s.innerHTML=j("admin.audit-log");return}try{const{auditLog:o}=await $(async()=>{const{auditLog:a}=await import("./apex-kb-c4_AErjY.js").then(l=>l.d);return{auditLog:a}},__vite__mapDeps([1,2,3]),import.meta.url);o.init();const r=o.getEntries().slice(-100).reverse(),t=r.map(a=>`<li><code>${n(new Date(a.ts).toLocaleString())}</code> · <strong>${n(a.action)}</strong> · ${n(a.actor||"system")}</li>`).join("");s.innerHTML=`
