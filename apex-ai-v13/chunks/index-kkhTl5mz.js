import{a as n}from"./escape-html-DGIYNPKb.js";import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-0c3arqvs.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-CRdbcLoc.js";import"./monitoring-DMtdadhB.js";import"./apex-kb-CXZzCgLq.js";import"./credential-patterns-CLzI061R.js";import"./auth-gate-D_4s9rpH.js";import"../core/main-CaohDm0d.js";import"./multi-source-analyze-C8fcBWGF.js";import"./commerce-DPMB60eZ.js";import"./kevin-alerts-C7f95NnT.js";import"./whatsapp-dKt-chmL.js";let r=null;function C(){r?.cleanup(),r=null}function m(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function D(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const i=o.listPending(),t=o.listProcessed().slice(0,20);e.innerHTML=`
