import{e as $}from"./escape-html-BlQj2yEF.js";import{c as M}from"./listener-cleanup-Y2rGGxxX.js";import{l as k}from"./monitoring-3uBGKGRH.js";import{s as z}from"../core/main-CrKyVDzG.js";import{g as S}from"./apex-tools-dispatch-core-BG6l0LRJ.js";import{v as l}from"./voice-BfnpejMA.js";import{haptic as C}from"./haptic-CQFg2PXZ.js";import{toast as u}from"./toast-CRdbcLoc.js";import"./apex-kb-B_r9SrFa.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze--ebg0Fay.js";import"./apex-tools-dispatch-skills-CtgVRZtQ.js";import"./apex-tools-dispatch-data-DECe4lR4.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-BrjwcdXI.js";import"./apex-tools-misc-k_ORVE_G.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";const A="kdmc_admin";let v=null;function Z(){v?.cleanup(),v=null}function y(e){if(!e||e===0)return"—";const t=new Date(e),r=i=>i.toString().padStart(2,"0");return`${r(t.getDate())}/${r(t.getMonth()+1)}/${t.getFullYear()} ${r(t.getHours())}:${r(t.getMinutes())}`}function b(e){return Math.round(e*100)+"%"}function _(){const e=z.get("user");return!e||!e.id?null:{id:e.id,name:e.name??"",isAdmin:e.id===A}}function x(e,t,r,i){t&&e.bind(t,r,i)}function D(e){const t=Math.max(0,Math.min(1,e))*100,r=t>=85?"#22c55e":t>=50?"#ffa500":"#ff6666";return`
