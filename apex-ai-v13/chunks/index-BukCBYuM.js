import{e as r}from"./monitoring-D1PZH0XM.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-kGzljYp4.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DpM3Rj_4.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CwGmaUpO.js";import"./kevin-alerts-CM3I6apM.js";import"./whatsapp-BuqkMrxb.js";import"./auth-gate--imKk2VT.js";import"./auth-u_Oijmvl.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
