import{c as E}from"./listener-cleanup-Y2rGGxxX.js";import{l}from"./monitoring-3uBGKGRH.js";import{s as q,r as H}from"../core/main-COiIpq5N.js";import{aiRouter as k}from"./ai-router-DmcqO5b8.js";import{a as $,_ as j}from"./apex-kb-yVGyFwpN.js";import{haptic as C}from"./haptic-CQFg2PXZ.js";import{modalSheet as x}from"./modal-sheet-oR7SW-wv.js";import{toast as y}from"./toast-ClsF1KRZ.js";import"./multi-source-analyze-DzynTqKL.js";import"./credential-patterns-qcw7Brjr.js";import"./chat-fallback-BZEKtDL9.js";import"./voice-YAmti4kn.js";import"./tokens-dashboard-C5ZzZyK6.js";const T="apex_v13_agent_browser_history",N=20;class J{async analyze(e,t){const r=(e||"").trim(),a=(t||"").trim();if(!r)throw new Error("URL vide");if(!a)throw new Error("Objectif vide");if(!/^https?:\/\//i.test(r))throw new Error("URL doit commencer par http(s)://");const c=Date.now(),s=`agent_${Date.now()}_${Math.random().toString(36).slice(2,6)}`;let n="",m=!1;try{const o=await fetch(r,{method:"GET",mode:"cors",credentials:"omit"});o.ok&&(n=await o.text(),m=!0)}catch(o){l.info("agent-browser","fetch CORS blocked, fallback skeleton",{err:o})}const h=this.extractRelevantDom(n).slice(0,3e4),d=`Tu es un agent pilote browser. L'utilisateur te donne une URL et un objectif.
