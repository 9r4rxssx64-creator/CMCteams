const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./commerce-BTNM23W_.js","./multi-source-analyze-DAvdcAQw.js","../core/main-CfzzJEKO.js","./push-notifications-Con0RoNe.js","./tokens-dashboard-C5ZzZyK6.js","../assets/css/main-CYtYG7GU.css","./consumption-dashboard-DlhFWy3V.js"])))=>i.map(i=>d[i]);
import{a as g,_ as A}from"./apex-kb-BFHUv3jX.js";import{l as $}from"./monitoring-BAiQJoxJ.js";import{c as _}from"./listener-cleanup-Y2rGGxxX.js";import{s as j}from"../core/main-CfzzJEKO.js";import{apexExecute as h}from"./apex-execute-DSTKhaMX.js";import{auth as C}from"./auth-BnBFaMo1.js";import{commerce as w}from"./commerce-BTNM23W_.js";import{kdmcProjectsRegistry as k}from"./kdmc-projects-registry-sRmoyobO.js";import{w as S}from"./whatsapp-BIW5kwXA.js";import{h as l}from"./haptic-BUEqXK0N.js";import{toast as d}from"./toast-Dgg9rcIP.js";import"./apex-tools-registry-DqA3gZXO.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-DAvdcAQw.js";import"./claude-bridge-Bhr-N3vi.js";let y="commerce";function n(t){return t.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a]??a)}function T(){const t=w.isEnabled();return`
  ...
  `}function z(){switch(y){case"commerce":return T();case"users":return q();case"pending":return P();case"health":return L();case"projects":return R();case"executions":return I();case"knowledge":return D();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>'}}async function M(t){const a=t.querySelector("#ax-admin-mount-bilan");if(a)try{(await A(()=>import("./financial-bilan-CIJznR4F.js"),__vite__mapDeps([0,1,2,3,4,5]),import.meta.url)).render(a)}catch(i){$.warn("admin","financial-bilan render failed",{err:i}),a.innerHTML='<p class="ax-muted">Bilan indisponible (module ko)</p>'}const r=t.querySelector("#ax-admin-mount-consumption");if(r)try{(await A(()=>import("./consumption-dashboard-DlhFWy3V.js"),__vite__mapDeps([6,1,3,4]),import.meta.url)).render(r)}catch(i){$.warn("admin","consumption-dashboard render failed",{err:i}),r.innerHTML='<p class="ax-muted">Consommation indisponible (module ko)</p>'}}function D(){const t=g.listRepos(),a=g.getStats(),r=t.map(i=>`
