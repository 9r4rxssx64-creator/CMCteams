import{e as r}from"./monitoring-D464VzTN.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-ByzHALk4.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DQ6ZtyiG.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DEnZH7Q6.js";import"./kevin-alerts-DtT7qicK.js";import"./whatsapp-BOWEgJEL.js";import"./auth-gate-CK_FbH2u.js";import"./auth-pThgpO48.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
