const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-B17vNBOa.js","./apex-tools-registry-DloDnFZi.js","./toast-Dgg9rcIP.js","./haptic-BUEqXK0N.js","./memory-bridge-CePlAxqi.js","./apex-kb-CoczroTx.js","./credential-patterns-DqicUg9o.js","./persistent-memory-store-Ct_hiSgO.js","./consumption-anomaly-detector-C_h_USOH.js","./consumption-monitor-BQjdu0lr.js","./links-registry-c2tuS2l8.js","./push-notifications-BXt8XeLt.js","./tokens-dashboard-C5ZzZyK6.js","./auth-B0Nj-Vdm.js","../core/main-Bc4jV-85.js","../assets/css/main-rhfGvOFL.css"])))=>i.map(i=>d[i]);
import{_ as l}from"./apex-kb-CoczroTx.js";import{l as k}from"./monitoring-B17vNBOa.js";import{s as z}from"../core/main-Bc4jV-85.js";import"./apex-tools-registry-DloDnFZi.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-DmNwGTAD.js";function b(i){return i.replace(/[&<>"']/g,m=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[m]??m)}const S="apex_v13_chat_auto_read";function E(){try{return localStorage.getItem(S)==="1"}catch{return!1}}function L(i){try{localStorage.setItem(S,i?"1":"0")}catch{}}async function T(i){try{const m=await l(()=>import("./voice-Dr7NkkAT.js").then(o=>o.a),__vite__mapDeps([0,1]),import.meta.url),{listVoices:v,getActiveVoice:p,setActiveVoice:u,speak:x,stopAll:f}=m,t=i.querySelector("#ax-settings-auto-read"),r=i.querySelector("#ax-voice-current"),c=i.querySelector("#ax-voice-list"),a=i.querySelectorAll(".ax-voice-cat-btn");if(!c)return;t&&(t.checked=E(),t.addEventListener("change",()=>{L(t.checked),(async()=>{const{toast:o}=await l(async()=>{const{toast:n}=await import("./toast-Dgg9rcIP.js");return{toast:n}},__vite__mapDeps([2,3]),import.meta.url);o.success(t.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const s=()=>{if(!r)return;const o=p(),g=v().find(h=>h.id===o);r.textContent=g?`Voix active : ${g.emoji??"🔊"} ${g.name} (${g.category})`:`Voix active : ${o}`};s();const d=o=>{const n=v(),g=o==="all"?n:n.filter(e=>e.category===o),h=p();c.innerHTML=g.map(e=>{const y=e.id===h,w=e.emoji??(e.category==="pro"?"🎙️":e.category==="fun"?"🎉":"🎨"),_=e.description?b(e.description):"",$=y?"background:rgba(232,184,48,0.15);border-color:rgba(232,184,48,0.45)":"background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.06)";return`
