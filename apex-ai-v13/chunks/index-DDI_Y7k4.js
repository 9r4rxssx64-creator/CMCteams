import{e as r}from"./monitoring-BgtktgjF.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DIWreqPh.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-KxZooCJ8.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CniVxJrc.js";import"./kevin-alerts-0E5Zwoyw.js";import"./whatsapp-CyI-tG3a.js";import"./auth-gate-M7CIijDx.js";import"./auth-2129xGFS.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
