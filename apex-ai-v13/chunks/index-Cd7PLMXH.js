const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./multi-source-analyze-D6iNtPSu.js","./apex-kb-EcrpBPpX.js","./monitoring-3uBGKGRH.js","./credential-patterns-qcw7Brjr.js","../assets/css/main-fW-M94Lx.css"])))=>i.map(i=>d[i]);
import{b as f,_ as k}from"./apex-kb-EcrpBPpX.js";import{l as y}from"./monitoring-3uBGKGRH.js";import{c as q}from"./listener-cleanup-Y2rGGxxX.js";import{s as P,a as H}from"../core/main-DzzOcgY6.js";import{apexExecute as v}from"./apex-execute-D1zEfafV.js";import{auth as T}from"./auth-DpufRvlL.js";import{commerce as S}from"./commerce-BPINS2HQ.js";import{c as M}from"./csp-style-helper-BisGRi53.js";import{i as A,r as j}from"./voice-DoLYwyuH.js";import{kdmcProjectsRegistry as $}from"./kdmc-projects-registry-DdTqW2gy.js";import{w as C}from"./whatsapp-D7cJ6uAq.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as u}from"./toast-ClsF1KRZ.js";import"./credential-patterns-qcw7Brjr.js";import"./multi-source-analyze-D6iNtPSu.js";import"./claude-bridge-f16kGE0w.js";let h="commerce";const L={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function n(e){return e.replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i]??i)}function R(){const e=S.isEnabled();return`
  ...
  `}function U(){const e=L[h];if(e&&!A(e))return`<div class="ax-admin-section">${j(e)}</div>`;switch(h){case"commerce":return R();case"users":return z();case"pending":return I();case"health":return D();case"projects":return V();case"executions":return N();case"knowledge":return G();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>';case"audit-log":return'<div id="ax-admin-mount-audit-log" class="ax-admin-section"><p class="ax-muted">Chargement audit log immuable…</p></div>'}}async function _(e){const i=e.querySelector("#ax-admin-mount-bilan");if(i)try{(await k(()=>import("./financial-bilan-B7YSBbzo.js"),__vite__mapDeps([0,1,2,3,4]),import.meta.url)).render(i)}catch(r){y.warn("admin","financial-bilan render failed",{err:r}),i.innerHTML='<p class="ax-muted">Bilan indisponible (module ko)</p>'}const c=e.querySelector("#ax-admin-mount-consumption");if(c)try{(await k(()=>import("./consumption-dashboard-B7fHR55V.js"),__vite__mapDeps([1,2,3,0,4]),import.meta.url)).render(c)}catch(r){y.warn("admin","consumption-dashboard render failed",{err:r}),c.innerHTML='<p class="ax-muted">Consommation indisponible (module ko)</p>'}const s=e.querySelector("#ax-admin-mount-audit-log");if(s){if(!A("admin.audit-log")){s.innerHTML=j("admin.audit-log");return}try{const{auditLog:r}=await k(async()=>{const{auditLog:a}=await import("./apex-kb-EcrpBPpX.js").then(l=>l.d);return{auditLog:a}},__vite__mapDeps([1,2,3]),import.meta.url);r.init();const o=r.getEntries().slice(-100).reverse(),t=o.map(a=>`<li><code>${n(new Date(a.ts).toLocaleString())}</code> · <strong>${n(a.action)}</strong> · ${n(a.actor||"system")}</li>`).join("");s.innerHTML=`
