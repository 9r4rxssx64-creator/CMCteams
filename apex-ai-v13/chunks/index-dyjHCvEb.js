import{l as b}from"./monitoring-BAiQJoxJ.js";import{c as v}from"./listener-cleanup-Y2rGGxxX.js";import{s as m,r as y}from"../core/main-BRJyZFXI.js";import{h as d}from"./haptic-BUEqXK0N.js";import{toast as c}from"./toast-Dgg9rcIP.js";import"./apex-kb-0vuBuWYy.js";import"./apex-tools-registry-DFaDwWZQ.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-DzTKkB_U.js";let r=null,i=1;const x=5,a={name:"",permissionsRequested:!1,capabilities:new Set(["chat","voice","studios"]),mode:"both",done:!1},h=[{id:"chat",label:"💬 Chat IA",desc:"Conversation Claude"},{id:"voice",label:"🎙 Voix",desc:"Dictée + lecture"},{id:"studios",label:"🎨 Studios",desc:"Music/Video/Logo"},{id:"browser",label:"🌐 Browser",desc:"Navigation embed"},{id:"pro",label:"💼 Pro modules",desc:"Cuisine/Médical/Légal"},{id:"crypto",label:"🪙 Crypto",desc:"Wallets + tracking"},{id:"domotique",label:"🏠 Domotique",desc:"Maison connectée"},{id:"remote",label:"📺 Remote TV",desc:"Télécommande univ."}];function l(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function L(){r?.cleanup(),r=null}function N(e){if(!e||e==="kdmc_admin")return!1;try{return localStorage.getItem(`apex_v13_onboarding_done_${e}`)!=="true"}catch{return!1}}function z(e){try{localStorage.setItem(`apex_v13_onboarding_done_${e}`,"true"),a.done=!0,b.info("onboarding",`Marked done for uid=${e}`)}catch{}}async function O(e){r?.cleanup(),r=v("onboarding");const t=m.get("user");t?.name&&(a.name=t.name),p(e)}function p(e){const t=`
