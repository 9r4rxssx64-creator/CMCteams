import{e as o}from"./monitoring-COuO8_T4.js";import{c as b}from"./listener-cleanup-Y2rGGxxX.js";import{r as l}from"../core/main-jPEEMaa4.js";import{haptic as x}from"./haptic-CQFg2PXZ.js";import{toast as g}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DXDFY8kk.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-D5Xt67ca.js";import"./memory-BOf-utw6.js";import"./apex-tools-dispatch-misc-Cfx9cGNq.js";let n=null,i=null;function A(){n?.cleanup(),n=null,i&&(clearInterval(i),i=null)}function p(){try{const t=localStorage.getItem("apex_v13_signup_pending_id");return t?JSON.parse(localStorage.getItem("apex_v13_signup_requests")??"[]").find(a=>a.id===t)??null:null}catch{return null}}function I(t){n?.cleanup(),n=b("waiting-approval"),s(t),i&&clearInterval(i),i=setInterval(()=>{const e=p();if(e)if(e.status==="approved"){g.success("🎉 Compte approuvé ! Tu peux te connecter.");try{localStorage.removeItem("apex_v13_signup_pending_id")}catch{}setTimeout(()=>l.navigate("landing"),1500)}else(e.status==="rejected"||e.status==="expired")&&s(t)},3e4)}function s(t){const e=p(),a=(()=>{try{return localStorage.getItem("apex_v13_signup_invite_link")??""}catch{return""}})();if(!e){t.innerHTML=`
