import{l as u}from"./monitoring-3uBGKGRH.js";import{p as x}from"./apex-tools-dispatch-Mkgd23qg.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-kmSFKZ1D.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-DQRNajlN.js";import"./apex-tools-registry-DMB4dlzN.js";import"./voice-DmRe8mWa.js";import"./haptic-CQFg2PXZ.js";function l(t){return t.replace(/[&<>"']/g,p=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[p]??p)}const f=[{id:"pitch-startup",label:"Pitch startup",emoji:"🚀"},{id:"business-quarterly",label:"Review trimestrielle",emoji:"📊"},{id:"lecture-academic",label:"Cours académique",emoji:"🎓"},{id:"wedding-anniversary",label:"Mariage / Anniv",emoji:"💍"},{id:"birthday-party",label:"Anniversaire fun",emoji:"🎂"},{id:"casino-training",label:"Formation casino",emoji:"🎰"},{id:"product-launch",label:"Lancement produit",emoji:"📢"}];let i=[{title:"Slide 1",content:`• Point 1
• Point 2
