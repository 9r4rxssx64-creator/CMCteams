import{e as r}from"./monitoring-doXWC0hm.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BIKV-8_I.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-CnMHmDQ7.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DMtOJcIx.js";import"./kevin-alerts-CpETJECg.js";import"./whatsapp-BaJScvwu.js";import"./auth-gate-DnAlVMUG.js";import"./auth-DNnhedU8.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
