import{l as d}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-BmbDabbw.js";import{broadlinkBridge as a}from"./broadlink-bridge-CgSUK_0_.js";import{toast as i}from"./toast-Dgg9rcIP.js";import"./apex-kb-D-Wwv6M3.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-Bai9IpOh.js";import"./haptic-BUEqXK0N.js";const x="kdmc_admin";function t(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
