import{r as f}from"../core/main-8qn3Zw_v.js";import{auth as g}from"./auth-BSyP2m3P.js";import{h as c,t as d}from"./toast-DbVEuO4x.js";function m(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function v(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}function q(e){const t=v();e.innerHTML=`
...
//# sourceMappingURL=index-BbgxwgRX.js.map
