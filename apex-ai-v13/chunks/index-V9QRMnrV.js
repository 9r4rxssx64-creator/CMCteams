import{e as r}from"./monitoring-DL2volVB.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DLz3_WTV.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DVkDsaua.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-Dy57KTxG.js";import"./kevin-alerts-Cg380V1l.js";import"./whatsapp-CmqZJbuO.js";import"./auth-gate-NVCdlN0v.js";import"./auth-CRlLm2fd.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
