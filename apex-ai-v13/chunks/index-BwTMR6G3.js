const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-3uBGKGRH.js","./apex-kb-BtZF0S4E.js","./credential-patterns-CLzI061R.js","./multi-source-analyze-DZ5Krcf9.js","./auth-CSUZu_Hg.js","../assets/css/main-DBQtIeVv.css"])))=>i.map(i=>d[i]);
import{_ as l}from"./apex-kb-BtZF0S4E.js";import{c as I}from"./listener-cleanup-Y2rGGxxX.js";import{l as S}from"./monitoring-3uBGKGRH.js";import{s as A}from"../core/main-DyLGSF1f.js";import{c as R}from"./csp-style-helper-BisGRi53.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DZ5Krcf9.js";let r=null;function M(){r?.cleanup(),r=null}function f(i){return i.replace(/[&<>"']/g,y=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[y]??y)}const T="apex_v13_chat_auto_read";function P(){try{return localStorage.getItem(T)==="1"}catch{return!1}}function V(i){try{localStorage.setItem(T,i?"1":"0")}catch{}}async function O(i){try{const y=await l(()=>import("./voice-CrbWlieZ.js").then(s=>s.c),__vite__mapDeps([0,1,2]),import.meta.url),{listVoices:k,getActiveVoice:d,setActiveVoice:p,speak:u,stopAll:b}=y,h=i.querySelector("#ax-settings-auto-read"),$=i.querySelector("#ax-voice-current"),w=i.querySelector("#ax-voice-list"),v=i.querySelectorAll(".ax-voice-cat-btn");if(!w)return;h&&(h.checked=P(),r.bind(h,"change",()=>{V(h.checked),(async()=>{const{toast:s}=await l(async()=>{const{toast:t}=await import("./toast-ClsF1KRZ.js");return{toast:t}},[],import.meta.url);s.success(h.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const m=()=>{if(!$)return;const s=d(),a=k().find(o=>o.id===s);$.textContent=a?`Voix active : ${a.emoji??"🔊"} ${a.name} (${a.category})`:`Voix active : ${s}`};m();const _=s=>{const t=k(),a=s==="all"?t:t.filter(e=>e.category===s),o=d();w.innerHTML=a.map(e=>{const n=e.id===o,c=e.emoji??(e.category==="pro"?"🎙️":e.category==="fun"?"🎉":"🎨"),g=e.description?f(e.description):"",x=n?"background:rgba(232,184,48,0.15);border-color:rgba(232,184,48,0.45)":"background:rgba(255,255,255,0.03);border-color:rgba(255,255,255,0.06)";return`
