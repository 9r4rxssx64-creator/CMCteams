import{l as b,b as h,e as n}from"./monitoring-Bbobua-m.js";import{c as y}from"./csp-style-helper-BEHhIhzj.js";import{iotRegistry as d}from"./iot-providers-registry-ehnTIBJP.js";import{toast as s}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-D3nCkIzq.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-B-lkJuA5.js";import"./broadlink-bridge-DfoKJHnc.js";import"./haptic-CQFg2PXZ.js";const v="kdmc_admin";function $(){return h.get("user")?.id===v}async function g(e){if(e){if(!$()){e.innerHTML=`
      <div class="ax-gs-62">
  ...
  `;try{const t=await d.statusAll(),a=await d.listAllDevices().catch(()=>[]);e.innerHTML=y.withNonce(k(t,a)),q(e)}catch(t){b.warn("iot-providers-view","render fail",{err:String(t)}),e.innerHTML=`
    ...
    `,e.querySelector("#ax-iot-reload")?.addEventListener("click",()=>location.reload())}}}function k(e,t){const a=e.filter(i=>i.status.ok).length,o=e.length;return`
  ...
  `}function q(e){e.addEventListener("click",t=>{const a=t.target;if(!a)return;const o=a.closest("[data-action]");if(!o)return;const i=o.dataset.action??"",r=o.dataset.providerId??"",c=o.dataset.deviceId??"";i==="install"?T(r,e):i==="test"?L(r):i==="refresh-all"?z(e):i==="show-proxy"?S():i==="open-broadlink"?location.hash="#broadlink-setup":i==="device-on"&&r&&c&&I(r,c)})}async function T(e,t){const a=d.get(e);if(!a){s.error(`Provider ${e} inconnu`);return}const o=t.querySelector("#iot-modal-host");if(!o)return;const i=A(a);o.innerHTML=`
