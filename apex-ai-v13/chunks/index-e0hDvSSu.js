import{e as r}from"./monitoring-CXcraAs2.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CzQPOJva.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-umEgTQRh.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BpE4KfvW.js";import"./kevin-alerts-BMQfML32.js";import"./whatsapp-CBAt1PS4.js";import"./auth-gate-hr6OxXFG.js";import"./auth-CRxxVxvy.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
