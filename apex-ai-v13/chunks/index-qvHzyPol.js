import{a as w}from"./escape-html-DGIYNPKb.js";import{c as S}from"./listener-cleanup-Y2rGGxxX.js";import{q as k,C as A}from"./monitoring-DGsdmyG7.js";import{voicePrint as c}from"./voice-print-BVAu_4TI.js";import{g as C}from"./apex-tools-dispatch-core-CvZ21wjU.js";import{haptic as z}from"./haptic-CQFg2PXZ.js";import{toast as u}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-BxcrFYSE.js";import"./apex-kb-BRFYnqla.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-BkaZs8wZ.js";import"./apex-tools-dispatch-data-p_35KUhq.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-BXiXoWIa.js";import"./apex-tools-misc-BYYBLwJX.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";const M="kdmc_admin";let m=null;function X(){m?.cleanup(),m=null}function y(e){if(!e||e===0)return"—";const i=new Date(e),a=t=>t.toString().padStart(2,"0");return`${a(i.getDate())}/${a(i.getMonth()+1)}/${i.getFullYear()} ${a(i.getHours())}:${a(i.getMinutes())}`}function b(e){return Math.round(e*100)+"%"}function _(){const e=A.get("user");return!e||!e.id?null:{id:e.id,name:e.name??"",isAdmin:e.id===M}}function x(e,i,a,t){i&&e.bind(i,a,t)}function q(e){const i=Math.max(0,Math.min(1,e))*100,a=i>=85?"#22c55e":i>=50?"#ffa500":"#ff6666";return`
  ...
  `}function D(e){const i=c.getPrintFor(e.id),a=c.needsCalibration(e.id),t=c.isExclusiveMode(),s=c.getPhaseDetails(e.id),l=c.isExclusiveAnticipated();if(!i)return`
      <div class="ax-gs-81">
