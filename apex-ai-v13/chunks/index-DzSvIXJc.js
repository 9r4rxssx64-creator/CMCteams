import{a as r}from"./escape-html-DGIYNPKb.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CRpnzxuf.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-BlYjOulu.js";import"./apex-kb-DkXWMstU.js";import"./monitoring-CjXQKsP-.js";import"./credential-patterns-CLzI061R.js";import"./kevin-alerts-864pgAT0.js";import"./whatsapp-B4mPzve4.js";import"./auth-gate-BqQZvSUR.js";import"./auth-DaFk2Tly.js";let n=null;function P(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function C(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
