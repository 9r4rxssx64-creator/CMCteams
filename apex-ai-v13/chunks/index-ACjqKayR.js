import{a as c}from"./escape-html-DGIYNPKb.js";import{c as f}from"./listener-cleanup-Y2rGGxxX.js";import{C as x,q as v}from"./monitoring-DVGzzCJW.js";import{g as _}from"./apex-tools-dispatch-core-KxHx7-85.js";import{haptic as m}from"./haptic-CQFg2PXZ.js";import"./multi-source-analyze-D7DsYaNG.js";import"./apex-kb-Bq_cTbkB.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-CXpvPpKm.js";import"./apex-tools-dispatch-data-ULrE8DVR.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-BKGNzV0s.js";import"./apex-tools-misc-C_eddp0Y.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let o=null;function z(){o?.cleanup(),o=null}const l=[{id:"chien",name:"Chien",emoji:"🐕",weight_range_kg:{min:1,max:80},kcal_per_kg_normal:70,vaccinations:["CHPPiL (carré, hépatite, parvo, parainfluenza, leptospirose)","Rage","Toux du chenil","Maladie de Lyme (zone à risque)"],red_flags:["Vomissements répétés > 24h","Diarrhée sanglante","Léthargie soudaine","Refus de manger > 24h","Difficulté à respirer","Convulsions"],age_coefficient:5,base_year_offset:16},{id:"chat",name:"Chat",emoji:"🐈",weight_range_kg:{min:2,max:12},kcal_per_kg_normal:60,vaccinations:["Typhus, coryza, leucose","Rage","Chlamydiose"],red_flags:["Léthargie","Refus de boire/manger > 24h","Vomissements répétés","Mictions difficiles ou absentes","Boiterie soudaine","Respiration rapide au repos"],age_coefficient:4,base_year_offset:15},{id:"lapin",name:"Lapin",emoji:"🐇",weight_range_kg:{min:1,max:6},kcal_per_kg_normal:55,vaccinations:["Myxomatose","VHD (maladie hémorragique virale)"],red_flags:["Arrêt total alimentation > 12h (URGENT)","Pas de selles > 12h","Tête inclinée","Boiterie","Difficulté respiratoire"],age_coefficient:7,base_year_offset:0},{id:"hamster",name:"Hamster",emoji:"🐹",weight_range_kg:{min:.05,max:.2},kcal_per_kg_normal:100,vaccinations:[],red_flags:["Léthargie inhabituelle","Diarrhée (mortelle rapide)","Boiterie","Croûtes / perte poils","Difficulté respiratoire"],age_coefficient:25,base_year_offset:0},{id:"oiseau",name:"Oiseau (perroquet, canari)",emoji:"🦜",weight_range_kg:{min:.01,max:1.5},kcal_per_kg_normal:120,vaccinations:["Polyomavirus (perroquets élevage)","Maladie de Pacheco"],red_flags:["Plumes ébouriffées au repos","Fientes anormales","Respiration bouche ouverte","Repli au fond cage","Refus chant"],age_coefficient:6,base_year_offset:0},{id:"poisson",name:"Poisson (aquarium)",emoji:"🐟",weight_range_kg:{min:.001,max:.5},kcal_per_kg_normal:30,vaccinations:[],red_flags:["Nage de travers","Plaies / champignons visibles","Ouïes pâles ou rouges","Refus alimentation","Reste isolé en surface"],age_coefficient:3,base_year_offset:0}],h={sedentaire:.85,normal:1,actif:1.2,"tres-actif":1.5};function b(e,i,t){const s=l.find(r=>r.id===e);if(!s||!isFinite(i)||i<=0||i<s.weight_range_kg.min||i>s.weight_range_kg.max)return null;const a=70*Math.pow(i,.75),n=h[t];return Math.round(a*n)}function y(e,i){const t=l.find(s=>s.id===e);return!t||!isFinite(i)||i<0?null:Math.round(t.base_year_offset+i*t.age_coefficient)}function B(e){o?.cleanup(),o=f("studios-pet");const i=x.get("user")?.id??"anon";if(!_("studio.pet",e,i))return;const t=l.map(a=>`<option value="${a.id}">${a.emoji} ${c(a.name)}</option>`).join(""),s=l.map(a=>`
  ...
  `,k(e)}function k(e){const i=e.querySelector("#ax-pet-calc"),t=e.querySelector("#ax-pet-out");i&&t&&o&&o.bind(i,"click",()=>{m.tap();const n=e.querySelector("#ax-pet-species")?.value??"",r=parseFloat(e.querySelector("#ax-pet-weight")?.value??""),p=e.querySelector("#ax-pet-activity")?.value??"normal",u=b(n,r,p);if(u===null){t.textContent="Poids hors plage pour cette espèce.";return}const g=l.find(d=>d.id===n);t.innerHTML=`Ration journalière estimée : <strong>${u} kcal</strong> ${g?`(${g.emoji} ${c(g.name)} · ${r} kg · ${c(p)})`:""}<br><span class="ax-gs-5">Diviser en 2-3 repas. Adapter selon avis véto.</span>`});const s=e.querySelector("#ax-pet-age-btn"),a=e.querySelector("#ax-pet-age-out");s&&a&&o&&o.bind(s,"click",()=>{m.tap();const n=e.querySelector("#ax-pet-species")?.value??"",r=parseFloat(e.querySelector("#ax-pet-age")?.value??""),p=y(n,r);if(p===null){a.textContent="Âge invalide.";return}a.textContent="",a.append("Équivalent humain : ");const u=document.createElement("strong");u.textContent=`≈ ${p} ans`,a.append(u)}),v.info("studios-pet","rendered")}export{l as PET_SPECIES,y as animalToHumanAge,b as calcDailyCalories,z as dispose,B as render};
