import{c as x}from"./listener-cleanup-Y2rGGxxX.js";import{s as o}from"./signup-CB64k-hK.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-ClsF1KRZ.js";import"./monitoring-3uBGKGRH.js";import"./apex-kb-tqPfp7BJ.js";import"./credential-patterns-z3lBBSNT.js";import"./auth-gate-h4JtymYL.js";import"../core/main-Czk-K14s.js";import"./multi-source-analyze-CHsQcwb6.js";import"./commerce-jbsJt3Yf.js";import"./kevin-alerts-Cpyz5y2k.js";import"./whatsapp-CfSThF5C.js";let r=null;function P(){r?.cleanup(),r=null}function n(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function f(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function C(e){r?.cleanup(),r=x("signup-approval"),l(e)}function l(e){const t=o.listPending(),i=o.listProcessed().slice(0,20);e.innerHTML=`
