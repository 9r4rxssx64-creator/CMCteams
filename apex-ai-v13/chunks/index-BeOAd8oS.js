const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["../core/main-BqtLFpxm.js","./push-notifications-DrbO5gc0.js","../assets/css/main-DLXksLe1.css","./consumption-dashboard-CFsWfNxa.js"])))=>i.map(i=>d[i]);
import{b as g,_ as A}from"./apex-kb-DEV0ns6l.js";import{l as $}from"./monitoring-BAiQJoxJ.js";import{c as _}from"./listener-cleanup-Y2rGGxxX.js";import{s as j}from"../core/main-BqtLFpxm.js";import{apexExecute as h}from"./apex-execute-D8MyPm0R.js";import{auth as C}from"./auth-C3T0_Nu9.js";import{commerce as w}from"./commerce-CN85uT0g.js";import{kdmcProjectsRegistry as k}from"./kdmc-projects-registry-sRmoyobO.js";import{w as S}from"./whatsapp-CtgSkElE.js";import{h as l}from"./haptic-BUEqXK0N.js";import{toast as d}from"./toast-Dgg9rcIP.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-Cjv0lJFa.js";import"./claude-bridge--Hs6SCja.js";let y="commerce";function n(t){return t.replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a]??a)}function T(){const t=w.isEnabled();return`
  ...
  `}function H(){return[["commerce","💳 Commerce"],["users","👥 Comptes"],["pending","📨 Attente"],["health","🩺 Santé"],["projects","📦 Projets"],["executions","⚙️ Exec"],["knowledge","📚 KB"],["bilan","📊 Bilan"],["consumption","💰 Conso"]].map(([a,r])=>{const i=y===a;return`
      ...
      `}).join("")}function I(){const t=h.listPendingExecutions({limit:30}),a=h.getStats(),r=h.listAllowedTasks(),i=h.listForbiddenTasks(),m={pending:"pending",dispatched:"wip",running:"wip",completed:"ok",failed:"error",cancelled:"archived",timeout:"error"},o=t.map(e=>{const s=m[e.status]??"archived",c=new Date(e.ts_created).toLocaleString(),p=e.duration_ms?`${Math.round(e.duration_ms/1e3)}s`:"—",b=e.workflow_run_url?`<a href="${n(e.workflow_run_url)}" target="_blank" rel="noopener">🔗 Workflow</a>`:'<span class="ax-muted">—</span>',f=e.status==="pending"||e.status==="dispatched";return`
  ...
  `}function z(){switch(y){case"commerce":return T();case"users":return q();case"pending":return P();case"health":return L();case"projects":return R();case"executions":return I();case"knowledge":return D();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>'}}async function M(t){const a=t.querySelector("#ax-admin-mount-bilan");if(a)try{(await A(()=>import("./financial-bilan-BXGyhq09.js"),__vite__mapDeps([0,1,2]),import.meta.url)).render(a)}catch(i){$.warn("admin","financial-bilan render failed",{err:i}),a.innerHTML='<p class="ax-muted">Bilan indisponible (module ko)</p>'}const r=t.querySelector("#ax-admin-mount-consumption");if(r)try{(await A(()=>import("./consumption-dashboard-CFsWfNxa.js"),__vite__mapDeps([3,1]),import.meta.url)).render(r)}catch(i){$.warn("admin","consumption-dashboard render failed",{err:i}),r.innerHTML='<p class="ax-muted">Consommation indisponible (module ko)</p>'}}function D(){const t=g.listRepos(),a=g.getStats(),r=t.map(i=>`
  ...
  `,x(t)}let u=null;function te(){u?.cleanup(),u=null}function x(t){if(u?.cleanup(),u=_("admin"),!j.get("isAdmin")){t.innerHTML=`
      <div class="ax-empty">
        <h2>Accès réservé</h2>
  ...
  `,U(t),(y==="bilan"||y==="consumption")&&M(t)}export{te as dispose,x as render};
