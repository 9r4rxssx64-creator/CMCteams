const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./device-context-i6kb04UC.js","./auth-Dh_vg4w8.js","../core/main-BQ6JhBsC.js","../assets/css/main-DLXksLe1.css"])))=>i.map(i=>d[i]);
import{_ as v}from"./apex-kb-BrxoW6ip.js";import{A as b,r as f}from"../core/main-BQ6JhBsC.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{auth as _}from"./auth-Dh_vg4w8.js";import{h as p}from"./haptic-BUEqXK0N.js";import{toast as m}from"./toast-Dgg9rcIP.js";import"./monitoring-BAiQJoxJ.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-BefgB4O2.js";let c=null;function H(){c?.cleanup(),c=null}function x(e){return e.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]??o)}function h(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const r=atob(e[1]??"").split(":")[0];if(r)return{uid:r}}catch{}return null}async function S(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),o=localStorage.getItem("apex_v13_last_known_name"),r=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!o||!r)return!1;const{deviceContext:n}=await v(async()=>{const{deviceContext:u}=await import("./device-context-i6kb04UC.js");return{deviceContext:u}},__vite__mapDeps([0]),import.meta.url);if((await n.getFingerprint()).device_id!==r)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:t}=await v(async()=>{const{auth:u}=await import("./auth-Dh_vg4w8.js");return{auth:u}},__vite__mapDeps([1,2,3]),import.meta.url);if((await t.loginTrusted(e,o)).ok)return f.navigate("chat"),!0}catch{}return!1}function M(e){c?.cleanup(),c=y("landing"),S().then(t=>{t&&m.success("🔐 Reconnu automatiquement (device trusted)")});const o=h();e.innerHTML=`
