const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-BAfbao5s.js","./multi-source-analyze-DXfBT6z8.js","./credential-patterns-DUMYZEMu.js","./apex-kb-CN_a2NJH.js"])))=>i.map(i=>d[i]);
import{c as H,f as _,l as h,e as s,_ as k}from"./monitoring-BAfbao5s.js";import{c as M}from"./listener-cleanup-Y2rGGxxX.js";import{apexExecute as f}from"./apex-execute-BFfw2GYE.js";import{a as y}from"./apex-kb-CN_a2NJH.js";import{kdmcProjectsRegistry as A}from"./kdmc-projects-registry-C4EwoUDZ.js";import{auth as q}from"./auth-BgWS2ZWn.js";import{i as T,r as R}from"./apex-tools-dispatch-core-Cqi1qFbp.js";import{c as D}from"./csp-style-helper-BEHhIhzj.js";import{w as j}from"./whatsapp-TrwnwCsV.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{s as z}from"./router-BGlvK6ui.js";import{toast as p}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DXfBT6z8.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-tools-dispatch-skills-Biot7Cxr.js";import"./apex-tools-dispatch-data-DopNoEbE.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-Co4zxZ4I.js";import"./apex-tools-misc-DHErf_wU.js";import"./apex-tools-registry-core-48oOK-KS.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./errors-D9XvOMOX.js";let v="commerce";const I={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function E(){const t=_.isEnabled();return`
  ...
  `}function O(){const t=I[v];if(t&&!T(t))return`<div class="ax-admin-section">${R(t)}</div>`;switch(v){case"commerce":return E();case"users":return V();case"pending":return B();case"health":return F();case"projects":return N();case"executions":return K();case"knowledge":return G();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>';case"audit-log":return'<div id="ax-admin-mount-audit-log" class="ax-admin-section"><p class="ax-muted">Chargement audit log immuable…</p></div>'}}async function P(t){const o=t.querySelector("#ax-admin-audits-summary");if(o)try{const{reportsHistory:n}=await k(async()=>{const{reportsHistory:b}=await import("./apex-reports-history-Dv7Js1f4.js");return{reportsHistory:b}},__vite__mapDeps([0,1,2,3]),import.meta.url),e=n.getStats(),a=e.lastLayoutTs?new Date(e.lastLayoutTs).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"jamais",i=e.lastFunctionalTs?new Date(e.lastFunctionalTs).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"jamais",u=e.recentBugs>0?"var(--ax-error)":"var(--ax-green)",x=e.recentEscalations>0?"var(--ax-sev-high)":"var(--ax-green)";o.innerHTML=`
      ...
      `}catch(n){h.warn("admin","audits summary render failed",{err:n})}const c=t.querySelector("#ax-admin-mount-bilan");if(c)try{(await k(()=>import("./financial-bilan-CUWA4ORF.js"),__vite__mapDeps([0,1,2,3]),import.meta.url)).render(c)}catch(n){h.warn("admin","financial-bilan render failed",{err:n}),c.innerHTML='<p class="ax-muted">Bilan indisponible (module ko)</p>'}const r=t.querySelector("#ax-admin-mount-consumption");if(r)try{(await k(()=>import("./consumption-dashboard-TK_uwGcv.js"),__vite__mapDeps([0,1,2,3]),import.meta.url)).render(r)}catch(n){h.warn("admin","consumption-dashboard render failed",{err:n}),r.innerHTML='<p class="ax-muted">Consommation indisponible (module ko)</p>'}const l=t.querySelector("#ax-admin-mount-audit-log");if(l){if(!T("admin.audit-log")){l.innerHTML=R("admin.audit-log");return}try{const{auditLog:n}=await k(async()=>{const{auditLog:i}=await import("./monitoring-BAfbao5s.js").then(u=>u.x);return{auditLog:i}},__vite__mapDeps([0,1,2,3]),import.meta.url);n.init();const e=n.getEntries().slice(-100).reverse(),a=e.map(i=>`<li><code>${s(new Date(i.ts).toLocaleString())}</code> · <strong>${s(i.action)}</strong> · ${s(i.actor||"system")}</li>`).join("");l.innerHTML=`
