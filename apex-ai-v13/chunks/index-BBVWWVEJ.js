import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-DyLGSF1f.js";import{broadlinkBridge as t}from"./broadlink-bridge-Pgs8UY8Z.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-BtZF0S4E.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DZ5Krcf9.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
