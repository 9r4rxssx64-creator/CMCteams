import{l as c}from"./monitoring-3uBGKGRH.js";import{aiRouter as g}from"./ai-router-DUqd2iQL.js";import{a as d}from"./apex-kb-CvTWOkmJ.js";import"../core/main-BG5A3meL.js";import"./multi-source-analyze-BQrgAPat.js";import"./credential-patterns-qcw7Brjr.js";import"./chat-fallback-VRdtQwv9.js";import"./voice-DCrB8Pzx.js";import"./tokens-dashboard-C5ZzZyK6.js";const u="apex_v13_plan_active",f="apex_v13_plan_history",y=20;class w{async generate(t){const e=(t||"").trim();if(!e)throw new Error("Objectif vide");const r=Date.now(),i=`plan_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,n=`Tu es Apex en MODE PLAN. L'utilisateur te donne un objectif. Tu DOIS retourner STRICTEMENT un JSON :
{
