import{b as v,e as o,l as y}from"./monitoring-2FCqkW9t.js";import{c as h}from"./listener-cleanup-Y2rGGxxX.js";import{p as c}from"./projects-CTTHl-1R.js";import{g as $}from"./apex-tools-dispatch-core-DR9aQ5dM.js";import{toast as u}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-BrlABFhg.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CdaJuSzX.js";import"./apex-tools-dispatch-skills--sYxvWbI.js";import"./apex-tools-dispatch-data-B3fBuKjN.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-4mxUSkio.js";import"./apex-tools-misc-Cu8ZM4Qe.js";import"./apex-tools-registry-core-48oOK-KS.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./haptic-CQFg2PXZ.js";let m=null,l=null,b=null;function R(){m?.cleanup(),m=null,l=null,b=null}function d(t){m?.cleanup(),m=h("projects");const p=v.get("user")?.id??"anon";if(!$("module.projects",t,p))return;const r=c.list(p),n=c.getActiveId(p),s=l?c.get(l,p):null,a=n?(()=>{const e=c.get(n,p);return e?`<div class="ax-gs-400" style="border:1px solid rgba(232,184,48,.5);border-radius:10px;padding:12px;margin-bottom:12px;background:rgba(232,184,48,.06)">
