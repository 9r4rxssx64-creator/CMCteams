import{e as r}from"./monitoring-Y05Yy1vf.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BAGD_AUN.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-DrrMJiQC.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BQfklJRf.js";import"./kevin-alerts-ztEJtS__.js";import"./whatsapp-BNgxfDUW.js";import"./auth-gate-BTUozmuz.js";import"./auth-Bvuh5z4b.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
