import{a as o,_ as x}from"./apex-kb-CgZLFOP-.js";import{s as v}from"../core/main-CLEjO6OH.js";import{g as b}from"./apex-tools-dispatch-CXiA4S9h.js";import{permissions as w}from"./permissions-Di_IOF0P.js";import"./monitoring-3uBGKGRH.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-B5tXX8YT.js";import"./apex-tools-registry-BnZ6yLIe.js";import"./voice-DuTQ7srs.js";const r=["linear-gradient(135deg, #ffd6e8 0%, #c9a4ff 50%, #a4c8ff 100%)","linear-gradient(135deg, #ffe4ec 0%, #ffb3d9 50%, #d4a5ff 100%)","linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%)","linear-gradient(135deg, #f6d365 0%, #fda085 100%)","linear-gradient(135deg, #d4fc79 0%, #96e6a1 100%)"];function _(){const e=new Date().getHours();return e<5?"Bonne nuit":e<12?"Bonjour":e<18?"Bon après-midi":e<22?"Bonsoir":"Bonne soirée"}function y(){const n=Math.floor(Date.now()/864e5)%r.length;return r[n]??r[0]??"#ffd6e8"}function t(e,n,s){return`
