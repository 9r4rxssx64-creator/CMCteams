import{b as g,l as d,e as r}from"./monitoring-HDbaNYsD.js";import{c as p}from"./listener-cleanup-Y2rGGxxX.js";import{autoRestoreCredentials as n}from"./auto-restore-credentials-DPXaRfuL.js";import{haptic as x}from"./haptic-CQFg2PXZ.js";import{toast as l}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-BNEeNaWZ.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BSt8ypjU.js";let c=null,o=null;function H(){c?.cleanup(),c=null,o=null}const v={localStorage:{icon:"💾",label:"Local",color:"#22cc77"},idb_shadow:{icon:"🗄️",label:"IDB shadow",color:"#22cc77"},firebase_backup:{icon:"☁️",label:"Firebase backup",color:"#4d9eff"},alias:{icon:"🔗",label:"Alias localStorage",color:"#c9a227"},pattern_match:{icon:"🔍",label:"Pattern match",color:"#ff9d3f"}};function f(e){const s=e.recoverable_from?v[e.recoverable_from]:{icon:"❓",label:"—",color:"#aaa"};return`
