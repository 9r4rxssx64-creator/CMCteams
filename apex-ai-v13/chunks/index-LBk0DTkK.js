const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-BSt8ypjU.js","./monitoring-HDbaNYsD.js","./multi-source-analyze-BNEeNaWZ.js","./credential-patterns-DUMYZEMu.js"])))=>i.map(i=>d[i]);
import{b as S,l as _,e as s,_ as y}from"./monitoring-HDbaNYsD.js";import{c as T}from"./listener-cleanup-Y2rGGxxX.js";import{credentialsAudit as k}from"./credentials-audit-D4V-8vLk.js";import{haptic as f}from"./haptic-CQFg2PXZ.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-BNEeNaWZ.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BSt8ypjU.js";let u=null,m=null,v="all";function j(){u?.cleanup(),u=null}const $={ok:{color:"#22cc77",icon:"🟢",label:"OK"},missing:{color:"#888",icon:"⚪",label:"Non config"},corrupted:{color:"#ff6b6b",icon:"🔴",label:"Corrompu"},expired:{color:"#ffaa00",icon:"🟠",label:"Expiré"},unknown:{color:"#aaa",icon:"❓",label:"Inconnu"},decrypt_failed:{color:"#ff6b6b",icon:"🔒",label:"Illisible"}},h={all:"Tous",ai:"🤖 IA",banking:"🏦 Banque",payment:"💳 Paiement",social:"📱 Social",email:"📧 Email",crypto:"₿ Crypto",hosting:"☁️ Hosting",productivity:"📋 Productivité",forbidden:"⚠️ Forbidden"};async function w(e){if(!(S.get("isAdmin")===!0)){e.innerHTML=`
      <div class="ax-gs-21">
