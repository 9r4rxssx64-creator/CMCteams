import{e as r,l as m}from"./monitoring-BbFVg0DV.js";import{u as g}from"./apex-tools-dispatch-skills-isS2N-xT.js";import{toast as l}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-BEXlXrQF.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CBwQgbdH.js";import"./haptic-CQFg2PXZ.js";const x=[{id:"invoice",label:"Facture",emoji:"💰"},{id:"quote",label:"Devis",emoji:"📋"},{id:"contract-signed",label:"Contrat à signer",emoji:"✍️"},{id:"report-standard",label:"Rapport",emoji:"📊"},{id:"certificate",label:"Certificat",emoji:"🏆"},{id:"receipt",label:"Reçu",emoji:"🧾"},{id:"custom",label:"Texte libre",emoji:"📝"}];function T(a){a.innerHTML=`
    <div class="ax-gs-169">
