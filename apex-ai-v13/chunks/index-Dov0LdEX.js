import{e as r}from"./monitoring-BYU-00Ll.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-B1-A1shv.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-Cu2z58R_.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BCMNRUTk.js";import"./kevin-alerts-DGTkWjYL.js";import"./whatsapp-t2_VmD3x.js";import"./auth-gate-CYkftQdh.js";import"./auth-BvNkGFNm.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
