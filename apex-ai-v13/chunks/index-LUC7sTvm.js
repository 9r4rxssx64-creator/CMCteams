const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-3uBGKGRH.js","./multi-source-analyze-DfTeMbTC.js","./apex-kb-BUdkXo7X.js","./credential-patterns-CLzI061R.js","../assets/css/main-Bmb5ACYM.css"])))=>i.map(i=>d[i]);
import{a as f,_ as k}from"./apex-kb-BUdkXo7X.js";import{e as i}from"./escape-html-BlQj2yEF.js";import{c as H}from"./listener-cleanup-Y2rGGxxX.js";import{l as g}from"./monitoring-3uBGKGRH.js";import{s as M,a as z}from"../core/main-BHBzMEgW.js";import{apexExecute as y}from"./apex-execute-Dp-Ua9HM.js";import{auth as P}from"./auth-BK9K-HVi.js";import{commerce as _}from"./commerce-D-3VwLol.js";import{c as D}from"./csp-style-helper-BisGRi53.js";import{i as T,r as R}from"./voice-CKlB4PWs.js";import{kdmcProjectsRegistry as A}from"./kdmc-projects-registry-DdTqW2gy.js";import{w as j}from"./whatsapp-B4V4yTXn.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DfTeMbTC.js";import"./claude-bridge-B1YAtmqL.js";let v="commerce";const I={commerce:"admin.commerce",users:"admin.users",pending:"admin.users",health:null,projects:null,executions:"admin.executions",knowledge:"admin.kb",bilan:"admin.bilan",consumption:"admin.consumption","audit-log":"admin.audit-log"};function E(){const t=_.isEnabled();return`
  ...
  `}function G(){const t=I[v];if(t&&!T(t))return`<div class="ax-admin-section">${R(t)}</div>`;switch(v){case"commerce":return E();case"users":return V();case"pending":return B();case"health":return F();case"projects":return N();case"executions":return O();case"knowledge":return K();case"bilan":return'<div id="ax-admin-mount-bilan" class="ax-admin-section"><p class="ax-muted">Chargement du bilan financier…</p></div>';case"consumption":return'<div id="ax-admin-mount-consumption" class="ax-admin-section"><p class="ax-muted">Chargement consommation IA…</p></div>';case"audit-log":return'<div id="ax-admin-mount-audit-log" class="ax-admin-section"><p class="ax-muted">Chargement audit log immuable…</p></div>'}}async function q(t){const o=t.querySelector("#ax-admin-audits-summary");if(o)try{const{reportsHistory:n}=await k(async()=>{const{reportsHistory:b}=await import("./apex-reports-history-Cv_X_jWe.js");return{reportsHistory:b}},__vite__mapDeps([0]),import.meta.url),e=n.getStats(),a=e.lastLayoutTs?new Date(e.lastLayoutTs).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"jamais",s=e.lastFunctionalTs?new Date(e.lastFunctionalTs).toLocaleString("fr-FR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}):"jamais",u=e.recentBugs>0?"var(--ax-error)":"var(--ax-green)",x=e.recentEscalations>0?"var(--ax-sev-high)":"var(--ax-green)";o.innerHTML=`
      ...
      `}catch(n){g.warn("admin","audits summary render failed",{err:n})}const c=t.querySelector("#ax-admin-mount-bilan");if(c)try{(await k(()=>import("./financial-bilan-DC_lzN-f.js"),__vite__mapDeps([1,2,0,3,4]),import.meta.url)).render(c)}catch(n){g.warn("admin","financial-bilan render failed",{err:n}),c.innerHTML='<p class="ax-muted">Bilan indisponible (module ko)</p>'}const r=t.querySelector("#ax-admin-mount-consumption");if(r)try{(await k(()=>import("./consumption-dashboard-BWvz27oG.js"),__vite__mapDeps([2,0,3,1,4]),import.meta.url)).render(r)}catch(n){g.warn("admin","consumption-dashboard render failed",{err:n}),r.innerHTML='<p class="ax-muted">Consommation indisponible (module ko)</p>'}const l=t.querySelector("#ax-admin-mount-audit-log");if(l){if(!T("admin.audit-log")){l.innerHTML=R("admin.audit-log");return}try{const{auditLog:n}=await k(async()=>{const{auditLog:s}=await import("./voice-CKlB4PWs.js").then(u=>u.b);return{auditLog:s}},__vite__mapDeps([0]),import.meta.url);n.init();const e=n.getEntries().slice(-100).reverse(),a=e.map(s=>`<li><code>${i(new Date(s.ts).toLocaleString())}</code> · <strong>${i(s.action)}</strong> · ${i(s.actor||"system")}</li>`).join("");l.innerHTML=`
  ...
  `,h(t)}let m=null;function me(){m?.cleanup(),m=null}function h(t){if(m?.cleanup(),m=H("admin"),!M.get("isAdmin")){t.innerHTML=`
      <div class="ax-empty">
        <h2>Accès réservé</h2>
  ...
  `),W(t),v==="bilan"||v==="consumption"){const c=v==="bilan"?"ax-admin-mount-bilan":"ax-admin-mount-consumption",r=t.querySelector(`#${c}`);if(r){const l=r.querySelector("p.ax-muted"),n=l?z(l,"admin-table"):()=>{};q(t).finally(()=>{n()})}else q(t)}}export{me as dispose,h as render};
