import{l as f}from"./monitoring-B17vNBOa.js";import{s as h}from"../core/main-1B0Upg3F.js";import"./apex-kb-BtBDNOCA.js";import"./apex-tools-registry-DloDnFZi.js";import"./credential-patterns-BybElwOv.js";import"./apex-tools-dispatch-B3xQ6s_d.js";const b="ax_notes_";function x(n){return`${b}${n}`}function l(n){return n.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}class v{load(t){if(!t)return[];try{const e=localStorage.getItem(x(t));if(!e)return[];const r=JSON.parse(e);return Array.isArray(r)?r.filter(this.isValidNote):[]}catch(e){return f.warn("notes","load failed",{err:e}),[]}}isValidNote(t){if(!t||typeof t!="object")return!1;const e=t;return typeof e.id=="string"&&typeof e.title=="string"&&typeof e.content=="string"&&Array.isArray(e.tags)&&typeof e.favorite=="boolean"&&typeof e.ts_created=="number"&&typeof e.ts_updated=="number"}save(t,e){if(!t)return!1;try{return localStorage.setItem(x(t),JSON.stringify(e)),!0}catch(r){return f.warn("notes","save failed (quota?)",{err:r}),!1}}add(t,e){if(!t||!e.title.trim())return null;const r=this.load(t),o={id:`note_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,title:e.title.trim().slice(0,200),content:e.content.slice(0,5e4),tags:(e.tags??[]).slice(0,10).map(a=>a.toLowerCase().trim()).filter(Boolean),favorite:!1,ts_created:Date.now(),ts_updated:Date.now()};return r.unshift(o),r.length>500&&(r.length=500),this.save(t,r)?o:null}update(t,e,r){if(!t)return!1;const o=this.load(t),a=o.findIndex(c=>c.id===e);if(a===-1)return!1;const i=o[a];if(!i)return!1;const s={...i,...r.title!==void 0&&{title:r.title.trim().slice(0,200)},...r.content!==void 0&&{content:r.content.slice(0,5e4)},...r.tags!==void 0&&{tags:r.tags.slice(0,10)},...r.favorite!==void 0&&{favorite:r.favorite},ts_updated:Date.now()};return o[a]=s,this.save(t,o)}remove(t,e){if(!t)return!1;const r=this.load(t).filter(o=>o.id!==e);return this.save(t,r)}search(t,e){if(!t||!e.trim())return this.load(t);const r=e.toLowerCase().trim();return this.load(t).filter(o=>o.title.toLowerCase().includes(r)||o.content.toLowerCase().includes(r)||o.tags.some(a=>a.includes(r)))}toggleFavorite(t,e){const o=this.load(t).find(a=>a.id===e);return o?this.update(t,e,{favorite:!o.favorite}):!1}exportJson(t){return JSON.stringify(this.load(t),null,2)}count(t){return this.load(t).length}}const d=new v;function p(n){const e=h.get("user")?.id??"anon",r=d.load(e),o=r.length>0?r.map(a=>`
  ...
  `,w(n,e)}function w(n,t){const e=n.querySelector("#ax-notes-form");e&&e.addEventListener("submit",o=>{o.preventDefault();const a=n.querySelector("#ax-notes-title"),i=n.querySelector("#ax-notes-content"),s=n.querySelector("#ax-notes-tags"),c=a?.value.trim()??"",g=i?.value??"",m=(s?.value??"").split(",").map(y=>y.trim()).filter(Boolean);if(!c)return;const u=d.add(t,{title:c,content:g,tags:m});u&&(f.info("notes","created",{id:u.id}),a&&(a.value=""),i&&(i.value=""),s&&(s.value=""),p(n))});const r=n.querySelector("#ax-notes-search");r&&r.addEventListener("input",()=>{const o=r.value.trim(),a=o?d.search(t,o):d.load(t),i=n.querySelector("#ax-notes-list");i&&(i.innerHTML=a.length>0?a.map(s=>`
...
//# sourceMappingURL=index-rIL9QDfY.js.map
