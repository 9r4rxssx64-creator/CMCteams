import{b as k,l as f,e as n}from"./monitoring-CXcraAs2.js";import{c as w}from"./listener-cleanup-Y2rGGxxX.js";import{apexAutonomousMode as d}from"./apex-autonomous-mode-DYJBAtja.js";import{autonomousWatch as h}from"./autonomous-watch-CoaOLBRp.js";import{haptic as A}from"./haptic-CQFg2PXZ.js";import{toast as i}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-umEgTQRh.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BpE4KfvW.js";import"./ai-router-C69aD3R4.js";import"../core/main-DghvCCHX.js";import"./economy-mode-D0xg78db.js";import"./chat-fallback-Bi-ze-DK.js";import"./apex-tools-dispatch-core-CwMTWuYm.js";import"./apex-tools-dispatch-skills-B4h2Veyt.js";import"./apex-tools-dispatch-data-Cpple_wG.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-r20J7_hD.js";import"./apex-tools-misc-BcE0xlEt.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./firebase-queue-C25NTk8_.js";let c=null,r=null;function X(){r&&(clearInterval(r),r=null),c?.cleanup(),c=null}function v(t){const e={running:{color:"#0a0",bg:"rgba(60,200,80,0.18)",emoji:"🟢"},paused:{color:"#cc9000",bg:"rgba(255,200,60,0.15)",emoji:"⏸"},stopped:{color:"#aaa",bg:"rgba(255,255,255,0.08)",emoji:"🛑"},quota_exhausted:{color:"#c50",bg:"rgba(220,90,30,0.15)",emoji:"🪫"},completed:{color:"#08c",bg:"rgba(70,140,210,0.15)",emoji:"🏁"},failed:{color:"#c33",bg:"rgba(220,60,60,0.15)",emoji:"❌"}}[t];return`<span class="ax-badge" style="display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:14px;background:${e.bg};color:${e.color};font-weight:600;font-size:12px">${e.emoji} ${t}</span>`}function z(t){if(!t)return`
