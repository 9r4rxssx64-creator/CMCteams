import{e as r}from"./monitoring-5A14HoVE.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BlOjQkyO.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-D-oFkvyV.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-FdDZ5-BX.js";import"./kevin-alerts-xjxrYypy.js";import"./whatsapp-D4EsCddq.js";import"./auth-gate-BtGyy8BM.js";import"./auth-B6npmx1r.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
