const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./sentinels-xlJSTnjm.js","./apex-kb-BtA0z5Zk.js","./monitoring-B17vNBOa.js","./apex-tools-registry-Duck4KzY.js","./credential-patterns-BybElwOv.js","./sentinels-registry-DE8mMa-j.js","./toast-Dgg9rcIP.js","./haptic-BUEqXK0N.js"])))=>i.map(i=>d[i]);
import{_ as l}from"./apex-kb-BtA0z5Zk.js";import{l as f}from"./monitoring-B17vNBOa.js";import"./apex-tools-registry-Duck4KzY.js";import"./credential-patterns-BybElwOv.js";async function c(a){const{sentinels:s}=await l(async()=>{const{sentinels:t}=await import("./sentinels-xlJSTnjm.js");return{sentinels:t}},__vite__mapDeps([0,1,2,3,4]),import.meta.url),{sentinelsRegistry:u,bootstrapSentinelsRegistry:m}=await l(async()=>{const{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}=await import("./sentinels-registry-DE8mMa-j.js");return{sentinelsRegistry:t,bootstrapSentinelsRegistry:e}},__vite__mapDeps([5,1,2,3,4,0]),import.meta.url);m();const n=s.list(),y=u.getStatus(),r=u.getMetrics(),x=n.filter(t=>t.lastResult?.ok).length,g=n.filter(t=>t.lastResult&&!t.lastResult.ok).length,b=n.filter(t=>!t.lastResult).length;a.innerHTML=`
  ...
  `,a.querySelector("#ax-sent-run-all")?.addEventListener("click",()=>{(async()=>{const{toast:t}=await l(async()=>{const{toast:e}=await import("./toast-Dgg9rcIP.js");return{toast:e}},__vite__mapDeps([6,7]),import.meta.url);t.info(`Exécution de ${n.length} sentinelles...`),await Promise.all(n.map(e=>s.runOne(e.id))),t.success("✅ Tous les sentinelles re-exécutés"),await c(a)})()}),a.querySelector("#ax-sent-refresh")?.addEventListener("click",()=>{c(a)}),a.querySelectorAll(".ax-sent-run").forEach(t=>{t.addEventListener("click",()=>{(async()=>{const e=t.dataset.sentId;if(!e)return;const{toast:d}=await l(async()=>{const{toast:i}=await import("./toast-Dgg9rcIP.js");return{toast:i}},__vite__mapDeps([6,7]),import.meta.url),o=await s.runOne(e);d[o?.ok?"success":"warn"](`${e}: ${o?.msg??"KO"}`),await c(a)})()})}),f.info("feature-sentinels",`rendered ${n.length} sentinels (${x}OK / ${g}WARN)`)}function p(a){return a.replace(/[&<>"']/g,s=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[s]??s)}export{c as render};
//# sourceMappingURL=index-DL4rvj1g.js.map
