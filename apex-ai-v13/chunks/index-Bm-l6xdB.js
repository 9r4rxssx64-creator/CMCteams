import{a as l}from"./escape-html-DGIYNPKb.js";import{c as f}from"./listener-cleanup-Y2rGGxxX.js";import{q as v,C as m}from"./monitoring-DeGQqZ0u.js";import{r as h}from"../core/main-COfZEon1.js";import{haptic as d}from"./haptic-CQFg2PXZ.js";import{toast as p}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-DYoNDC9E.js";import"./apex-kb-50Vb9VEO.js";import"./credential-patterns-CLzI061R.js";let o=null,s=1;const g=5,a={name:"",permissionsRequested:!1,capabilities:new Set(["chat","voice","studios"]),mode:"both",done:!1},y=[{id:"chat",label:"💬 Chat IA",desc:"Conversation Claude"},{id:"voice",label:"🎙 Voix",desc:"Dictée + lecture"},{id:"studios",label:"🎨 Studios",desc:"Music/Video/Logo"},{id:"browser",label:"🌐 Browser",desc:"Navigation embed"},{id:"pro",label:"💼 Pro modules",desc:"Cuisine/Médical/Légal"},{id:"crypto",label:"🪙 Crypto",desc:"Wallets + tracking"},{id:"domotique",label:"🏠 Domotique",desc:"Maison connectée"},{id:"remote",label:"📺 Remote TV",desc:"Télécommande univ."}];function L(){o?.cleanup(),o=null}function N(e){if(!e||e==="kdmc_admin")return!1;try{return localStorage.getItem(`apex_v13_onboarding_done_${e}`)!=="true"}catch{return!1}}function S(e){try{localStorage.setItem(`apex_v13_onboarding_done_${e}`,"true"),a.done=!0,v.info("onboarding",`Marked done for uid=${e}`)}catch{}}async function O(e){o?.cleanup(),o=f("onboarding");const t=m.get("user");t?.name&&(a.name=t.name),c(e)}function c(e){const t=`
