import{l as n}from"./monitoring-wGSiuzVT.js";import"./multi-source-analyze-CHQB7-97.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BhTyGVYB.js";const a="apex-global-back-btn",i="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(i))return;const t=`
      #${a} {
        position: fixed;
