import{e as r}from"./monitoring-2FCqkW9t.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BpehzmSi.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-BrlABFhg.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CdaJuSzX.js";import"./kevin-alerts-zrpfW9Ho.js";import"./whatsapp-CD-IbunZ.js";import"./auth-gate-IfgDg7Oe.js";import"./auth-DvkXU-p9.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
