import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-oTtOzuzI.js";import{broadlinkBridge as t}from"./broadlink-bridge-BkjibJTu.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-J2BE6WV_.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-B6Ty0Khb.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
