import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-D95VLWPH.js";import{broadlinkBridge as t}from"./broadlink-bridge-n564QL5Q.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-C9-smOZf.js";import"./credential-patterns-Dy6Wjk7e.js";import"./multi-source-analyze-BoPGCW63.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
