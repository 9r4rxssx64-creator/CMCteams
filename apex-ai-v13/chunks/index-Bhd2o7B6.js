import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-C6T1GSWs.js";import{broadlinkBridge as t}from"./broadlink-bridge-B6FufcPQ.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-D55-ywCE.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-7S2YpsYM.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
