const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./monitoring-3uBGKGRH.js","./apex-kb-B_r9SrFa.js","./credential-patterns-CLzI061R.js","./multi-source-analyze--ebg0Fay.js","./auth-CKBPpqD3.js","../assets/css/main-CyCMK6kQ.css"])))=>i.map(i=>d[i]);
import{_ as p}from"./apex-kb-B_r9SrFa.js";import{e as u}from"./escape-html-BlQj2yEF.js";import{c as E}from"./listener-cleanup-Y2rGGxxX.js";import{l as T}from"./monitoring-3uBGKGRH.js";import{s as I}from"../core/main-CrKyVDzG.js";import{c as O}from"./csp-style-helper-BisGRi53.js";import{r as D}from"./recharge-action-C73aOkPx.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze--ebg0Fay.js";let i=null;function U(){i?.cleanup(),i=null}const P="apex_v13_chat_auto_read";function V(){try{return localStorage.getItem(P)==="1"}catch{return!1}}function q(n){try{localStorage.setItem(P,n?"1":"0")}catch{}}async function R(n){try{const k=await p(()=>import("./voice-BfnpejMA.js").then(l=>l.e),__vite__mapDeps([0,1,2]),import.meta.url),{listVoices:S,getActiveVoice:x,setActiveVoice:b,speak:v,stopAll:g}=k,_=n.querySelector("#ax-settings-auto-read"),A=n.querySelector("#ax-voice-current"),w=n.querySelector("#ax-voice-list"),L=n.querySelectorAll(".ax-voice-cat-btn");if(!w)return;_&&(_.checked=V(),i.bind(_,"change",()=>{q(_.checked),(async()=>{const{toast:l}=await p(async()=>{const{toast:d}=await import("./toast-CRdbcLoc.js");return{toast:d}},[],import.meta.url);l.success(_.checked?"Lecture auto activée":"Lecture auto désactivée")})()}));const z=()=>{if(!A)return;const l=x(),m=S().find(h=>h.id===l);A.textContent=m?`Voix active : ${m.emoji??"🔊"} ${m.name} (${m.category})`:`Voix active : ${l}`};z();const $=l=>{const d=S(),m=l==="all"?d:d.filter(t=>t.category===l),h=x();w.setAttribute("aria-busy","false"),w.innerHTML=m.map(t=>{const o=t.id===h,a=t.emoji??(t.category==="pro"?"🎙️":t.category==="fun"?"🎉":"🎨"),e=t.description?u(t.description):"";return`
