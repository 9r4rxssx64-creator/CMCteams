import{e as s}from"./escape-html-BlQj2yEF.js";import{s as x,l as m}from"./monitoring-wizczV_1.js";import{p as f}from"./apex-tools-dispatch-skills-0u_03RSE.js";import{mcpRegistry as c}from"./mcp-registry-BDgR2Ole.js";import{skillsWatch as g}from"./skills-watch-O3Jbit2M.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-CeV_AU5U.js";import"./apex-kb-DffZdqkV.js";import"./credential-patterns-ClK5OHi0.js";import"./haptic-CQFg2PXZ.js";function b(t){const l={alive:{color:"#10b981",emoji:"🟢"},dead:{color:"#ef4444",emoji:"🔴"},unknown:{color:"#94a3b8",emoji:"⚪"}},a=l[t]??l.unknown;return`<span style="color:${a.color};font-weight:600">${a.emoji} ${s(t)}</span>`}function p(t){if(!(x.get("isAdmin")===!0)){t.innerHTML='<div class="ax-gs-37">🔒 Réservé admin Kevin</div>';return}c.init();const a=c.list(),d=g.getLastReport("mcp-health-watch"),u=a.map(e=>{const r=e.toolsExposed?.length??0,i=e.lastCheck?new Date(e.lastCheck).toLocaleString("fr-FR"):"jamais";return`
