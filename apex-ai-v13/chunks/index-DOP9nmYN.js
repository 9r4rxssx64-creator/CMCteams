import{e as p}from"./escape-html-B4YFbUXM.js";import{c as k}from"./listener-cleanup-Y2rGGxxX.js";import{l as m}from"./monitoring-3uBGKGRH.js";import{s as S}from"../core/main-DKjmWbkB.js";import{g as $}from"./apex-tools-dispatch-core-BnLPPrJR.js";import{haptic as f}from"./haptic-CQFg2PXZ.js";import{toast as x}from"./toast-CRdbcLoc.js";import"./apex-kb-Dda8AO_3.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-G4jmaoyD.js";import"./apex-tools-dispatch-skills-CCS_KttI.js";import"./apex-tools-dispatch-data-C7q6dayh.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-r-zBM_mX.js";import"./apex-tools-registry-DdGsF0Ap.js";import"./voice-BcuF8p-Q.js";let c=null;function P(){c?.cleanup(),c=null}const b="ax_scan_history",g=20,d={email:/^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$/i,phone:/^(\+?\d{1,3}[\s.-]?)?(\(?\d{1,4}\)?[\s.-]?){2,5}\d{2,4}$/,url:/^https?:\/\/[^\s]+$/i,iban:/^[A-Z]{2}\d{2}[A-Z0-9]{10,30}$/,api_key_anthropic:/^sk-ant-api\d{2}-[A-Za-z0-9_-]{40,}$/,api_key_openai:/^sk-[A-Za-z0-9]{40,}$/,api_key_github_pat:/^ghp_[A-Za-z0-9]{36}$/,btc_addr:/^(bc1|[13])[a-zA-HJ-NP-Z0-9]{25,62}$/,eth_addr:/^0x[a-fA-F0-9]{40}$/};function v(t){return d.email.test(t)?"email":d.api_key_anthropic.test(t)||d.api_key_openai.test(t)||d.api_key_github_pat.test(t)?"api_key":d.iban.test(t.replace(/\s/g,""))?"iban":d.url.test(t)?"url":d.btc_addr.test(t)?"btc_addr":d.eth_addr.test(t)?"eth_addr":d.phone.test(t)&&t.replace(/\D/g,"").length>=10?"phone":"plain"}function z(t){if(!t)return[];const e=[],i=t.split(/\r?\n/).map(n=>n.trim()).filter(Boolean),a=new Set;for(const n of i){const s=v(n);if(s!=="plain"&&!a.has(n)){e.push({kind:s,value:n}),a.add(n);continue}const u=n.split(/[\s,;]+/).filter(r=>r.length>=5);for(const r of u){const o=v(r);o!=="plain"&&!a.has(r)&&(e.push({kind:o,value:r}),a.add(r))}}return e}async function C(t){const e=window;if(!e.BarcodeDetector)return m.warn("studios-scan","BarcodeDetector API not supported"),null;try{const i=new e.BarcodeDetector({formats:["qr_code","code_128","code_39","ean_13","ean_8","upc_a","upc_e","data_matrix"]}),a=t instanceof Blob?await createImageBitmap(t):t;return(await i.detect(a)).map(s=>({value:s.rawValue,format:s.format}))}catch(i){return m.warn("studios-scan","BarcodeDetector failed",{err:i}),null}}function y(){try{const t=localStorage.getItem(b);if(!t)return[];const e=JSON.parse(t);return Array.isArray(e)?e:[]}catch{return[]}}function q(t){try{const e=[...y(),t],i=e.length>g?e.slice(e.length-g):e;localStorage.setItem(b,JSON.stringify(i))}catch(e){m.warn("studios-scan","history save failed",{err:e})}}function A(){localStorage.removeItem(b)}function Q(t){c?.cleanup(),c=k("studios-scan");const e=S.get("user")?.id??"anon";if(!$("studio.scan",t,e))return;const a=typeof window.BarcodeDetector<"u";t.innerHTML=`
