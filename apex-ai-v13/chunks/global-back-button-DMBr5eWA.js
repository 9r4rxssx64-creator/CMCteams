import{l as n}from"./monitoring-BhKOVk_R.js";import"./multi-source-analyze-DT0Pl3Vf.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BpUeje3j.js";const a="apex-global-back-btn",i="apex-global-back-style";class o{installed=!1;install(){this.installed||typeof document>"u"||(this.installed=!0,this.injectStyle(),this.mountButton(),this.attachRouterHook(),n.info("global-back-button","installed"))}injectStyle(){if(document.getElementById(i))return;const t=`
      #${a} {
        position: fixed;
