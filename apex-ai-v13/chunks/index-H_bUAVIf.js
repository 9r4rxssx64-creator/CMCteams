import{r as f}from"../core/main-BP34xyZA.js";import{auth as g}from"./auth-CeVUb59y.js";import{h as c,t as d}from"./toast-BuJ8GQaZ.js";function m(e){return e.replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function v(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}function q(e){const t=v();e.innerHTML=`
...
//# sourceMappingURL=index-H_bUAVIf.js.map
