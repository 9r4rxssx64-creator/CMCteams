const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-KUpdSyu5.js","./monitoring-glbGSPAY.js","./multi-source-analyze-BKtnCZaJ.js","./credential-patterns-CLzI061R.js","./auth-BQOuiNJp.js"])))=>i.map(i=>d[i]);
import{_ as v}from"./apex-kb-KUpdSyu5.js";import{A as b,r as g}from"../core/main-BMAiz5b2.js";import{e as x}from"./escape-html-BlQj2yEF.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{auth as _}from"./auth-BQOuiNJp.js";import{i as h}from"./apex-tools-dispatch-core-CJJ5MHF9.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import{toast as m}from"./toast-CRdbcLoc.js";import"./monitoring-glbGSPAY.js";import"./multi-source-analyze-BKtnCZaJ.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-DGxLIlGa.js";import"./apex-tools-dispatch-data-Da70baUH.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-BGB-0TZN.js";import"./apex-tools-misc-BVQgO3kF.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let l=null;function J(){l?.cleanup(),l=null}function S(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}async function I(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),p=localStorage.getItem("apex_v13_last_known_name"),o=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!p||!o)return!1;const{deviceContext:n}=await v(async()=>{const{deviceContext:c}=await import("./device-context-Hna9T8x4.js");return{deviceContext:c}},__vite__mapDeps([0,1,2,3]),import.meta.url);if((await n.getFingerprint()).device_id!==o)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:t}=await v(async()=>{const{auth:c}=await import("./auth-BQOuiNJp.js");return{auth:c}},__vite__mapDeps([4,0,1,2,3]),import.meta.url);if((await t.loginTrusted(e,p)).ok)return g.navigate("chat"),!0}catch{}return!1}function O(e){if(l?.cleanup(),l=y("landing"),!h("module.landing")){e.innerHTML=`
