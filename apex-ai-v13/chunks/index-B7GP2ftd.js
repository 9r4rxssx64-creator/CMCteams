import{b as y,e as i,l as g}from"./monitoring-gdN37KLL.js";import{c as $}from"./listener-cleanup-Y2rGGxxX.js";import{c,A as v}from"./custom-assistants-B7Pz2Rx1.js";import{g as h}from"./apex-tools-dispatch-core-EjdZmZ0g.js";import{toast as x}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-_RAvLX0s.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DEigeGWI.js";import"./apex-tools-dispatch-skills-C5auUtcD.js";import"./apex-tools-dispatch-data-DdzIHTNU.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-D7bEN-_u.js";import"./apex-tools-misc-CXoCnKBK.js";import"./apex-tools-registry-core-48oOK-KS.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./haptic-CQFg2PXZ.js";let f=null,l=null;function F(){f?.cleanup(),f=null,l=null}function u(s){f?.cleanup(),f=$("assistants");const d=y.get("user")?.id??"anon";if(!h("module.assistants",s,d))return;const m=c.list(d),r=c.getActiveId(d),n=l?c.get(l,d):null,o=r?(()=>{const t=c.get(r,d);return t?`<div class="ax-gs-400" style="border:1px solid rgba(232,184,48,.5);border-radius:10px;padding:12px;margin-bottom:12px;background:rgba(232,184,48,.06)">
