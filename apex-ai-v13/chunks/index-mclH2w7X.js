import{l as b}from"./monitoring-3uBGKGRH.js";import{s as y}from"../core/main-CLF8H3Xc.js";import{c as h}from"./csp-style-helper-BisGRi53.js";import{iotRegistry as d}from"./iot-providers-registry-BA3oPX2S.js";import{toast as r}from"./toast-ClsF1KRZ.js";import"./apex-kb-CEkJt-I0.js";import"./credential-patterns-guxfirLX.js";import"./multi-source-analyze-C1m_WZ_G.js";import"./broadlink-bridge-14Y-8XAz.js";import"./haptic-CQFg2PXZ.js";const v="kdmc_admin";function n(e){return String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]??t)}function $(){return y.get("user")?.id===v}async function g(e){if(e){if(!$()){e.innerHTML=`
