const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-BoJKlzXO.js","./monitoring-3uBGKGRH.js","./credential-patterns-CLzI061R.js","./auth-C5a1ra4u.js","./multi-source-analyze-CD3qyri_.js","../assets/css/main-BjtUc25U.css"])))=>i.map(i=>d[i]);
import{_ as v}from"./apex-kb-BoJKlzXO.js";import{A as b,r as f}from"../core/main-D3ZvsLUN.js";import{e as x}from"./escape-html-BlQj2yEF.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{auth as _}from"./auth-C5a1ra4u.js";import{i as h}from"./voice-BWS80WA2.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import{toast as m}from"./toast-CRdbcLoc.js";import"./monitoring-3uBGKGRH.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-CD3qyri_.js";let l=null;function z(){l?.cleanup(),l=null}function S(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}async function I(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),p=localStorage.getItem("apex_v13_last_known_name"),o=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!p||!o)return!1;const{deviceContext:n}=await v(async()=>{const{deviceContext:c}=await import("./device-context-Cu79EX3n.js");return{deviceContext:c}},__vite__mapDeps([0,1,2]),import.meta.url);if((await n.getFingerprint()).device_id!==o)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:t}=await v(async()=>{const{auth:c}=await import("./auth-C5a1ra4u.js");return{auth:c}},__vite__mapDeps([3,0,1,2,4,5]),import.meta.url);if((await t.loginTrusted(e,p)).ok)return f.navigate("chat"),!0}catch{}return!1}function E(e){if(l?.cleanup(),l=y("landing"),!h("module.landing")){e.innerHTML=`
