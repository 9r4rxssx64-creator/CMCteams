import{e as r}from"./monitoring-qi89B_xw.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BRHMUhVm.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-Dn6AXpjc.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BBVmNfcm.js";import"./kevin-alerts-CZd34Xsr.js";import"./whatsapp-C1bpu-89.js";import"./auth-gate-Blz_10GX.js";import"./auth-CBc2rhlA.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
