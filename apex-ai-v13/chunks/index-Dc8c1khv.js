import{e as r}from"./monitoring-DrYio7_k.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-BsnkV7Cc.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-ZZ2u9mng.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CxlqDgaN.js";import"./kevin-alerts-CGY5ocTn.js";import"./whatsapp-DXJ0dcWr.js";import"./auth-gate-DGkpf5HL.js";import"./auth-Dr3xYQ5L.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
