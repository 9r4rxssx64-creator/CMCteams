const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./device-context-DTK5GbSH.js","./apex-kb-CoczroTx.js","./monitoring-B17vNBOa.js","./apex-tools-registry-DloDnFZi.js","./credential-patterns-DqicUg9o.js","./auth-B0Nj-Vdm.js","../core/main-Bc4jV-85.js","../assets/css/main-rhfGvOFL.css"])))=>i.map(i=>d[i]);
import{_ as m}from"./apex-kb-CoczroTx.js";import{A as g,r as v}from"../core/main-Bc4jV-85.js";import{auth as x}from"./auth-B0Nj-Vdm.js";import{h as d}from"./haptic-BUEqXK0N.js";import{toast as p}from"./toast-Dgg9rcIP.js";import"./monitoring-B17vNBOa.js";import"./apex-tools-registry-DloDnFZi.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-DmNwGTAD.js";function f(e){return e.replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o]??o)}function _(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const l=atob(e[1]??"").split(":")[0];if(l)return{uid:l}}catch{}return null}async function b(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),o=localStorage.getItem("apex_v13_last_known_name"),l=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!o||!l)return!1;const{deviceContext:n}=await m(async()=>{const{deviceContext:s}=await import("./device-context-DTK5GbSH.js");return{deviceContext:s}},__vite__mapDeps([0,1,2,3,4]),import.meta.url);if((await n.getFingerprint()).device_id!==l)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:a}=await m(async()=>{const{auth:s}=await import("./auth-B0Nj-Vdm.js");return{auth:s}},__vite__mapDeps([5,1,2,3,4,6,7]),import.meta.url);if((await a.loginTrusted(e,o)).ok)return v.navigate("chat"),!0}catch{}return!1}function N(e){b().then(t=>{t&&p.success("🔐 Reconnu automatiquement (device trusted)")});const o=_();e.innerHTML=`
...
//# sourceMappingURL=index-BRLaYp0j.js.map
