import{l as c}from"./monitoring-3uBGKGRH.js";import{aiRouter as g}from"./ai-router-C1ZpNikd.js";import{a as d}from"./apex-kb-BNk1cX4A.js";import"../core/main-CSQ0n1Vx.js";import"./multi-source-analyze-CGK5HgrY.js";import"./credential-patterns-D-srKehy.js";import"./chat-fallback-Dj7lH6O4.js";import"./voice-CzoCc7cL.js";import"./tokens-dashboard-C5ZzZyK6.js";const u="apex_v13_plan_active",f="apex_v13_plan_history",y=20;class w{async generate(t){const e=(t||"").trim();if(!e)throw new Error("Objectif vide");const r=Date.now(),i=`plan_${Date.now()}_${Math.random().toString(36).slice(2,8)}`,n=`Tu es Apex en MODE PLAN. L'utilisateur te donne un objectif. Tu DOIS retourner STRICTEMENT un JSON :
{
