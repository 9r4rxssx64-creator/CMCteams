import{e as r}from"./monitoring-C12QRqw5.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DHYRyZLn.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-CQSM2O-1.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-CtLXl_GD.js";import"./kevin-alerts-CborAoC6.js";import"./whatsapp-BuBkNQJc.js";import"./auth-gate-CD6V6TdM.js";import"./auth-Cai_Xp1F.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
