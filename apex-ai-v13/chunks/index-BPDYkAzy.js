import{e as o}from"./escape-html-BlQj2yEF.js";import{c as b}from"./listener-cleanup-Y2rGGxxX.js";import{r as l}from"../core/main-BHBzMEgW.js";import{haptic as x}from"./haptic-CQFg2PXZ.js";import{toast as g}from"./toast-CRdbcLoc.js";import"./apex-kb-BUdkXo7X.js";import"./monitoring-3uBGKGRH.js";import"./voice-CKlB4PWs.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DfTeMbTC.js";let n=null,a=null;function A(){n?.cleanup(),n=null,a&&(clearInterval(a),a=null)}function c(){try{const t=localStorage.getItem("apex_v13_signup_pending_id");return t?JSON.parse(localStorage.getItem("apex_v13_signup_requests")??"[]").find(i=>i.id===t)??null:null}catch{return null}}function I(t){n?.cleanup(),n=b("waiting-approval"),s(t),a&&clearInterval(a),a=setInterval(()=>{const e=c();if(e)if(e.status==="approved"){g.success("🎉 Compte approuvé ! Tu peux te connecter.");try{localStorage.removeItem("apex_v13_signup_pending_id")}catch{}setTimeout(()=>l.navigate("landing"),1500)}else(e.status==="rejected"||e.status==="expired")&&s(t)},3e4)}function s(t){const e=c(),i=(()=>{try{return localStorage.getItem("apex_v13_signup_invite_link")??""}catch{return""}})();if(!e){t.innerHTML=`
      ...
      <div style="max-width:560px;width:100%;background:rgba(20,20,35,0.92);backdrop-filter:blur(20px);border:1px solid rgba(201,162,39,0.3);border-radius:20px;padding:32px;box-shadow:0 20px 60px rgba(0,0,0,0.5)">
        ...
        ${e.status==="awaiting_kevin"?`
          <div style="background:rgba(201,162,39,0.08);border:1px solid rgba(201,162,39,0.2);border-radius:12px;padding:16px;margin-bottom:16px">
            ...
            <a href="${o(i||"#")}" target="_blank" rel="noopener" id="wa-open-link"
  ...
  `,f(t)}function f(t){if(!n)return;const e=t.querySelector("#wa-check");e&&n.bind(e,"click",()=>{x.tap(),s(t),c()?.status==="awaiting_kevin"&&g.info("Toujours en attente Kevin")});const i=t.querySelector("#wa-cancel");i&&n.bind(i,"click",()=>{x.medium();try{localStorage.removeItem("apex_v13_signup_pending_id"),localStorage.removeItem("apex_v13_signup_invite_link")}catch{}l.navigate("signup")});const r=t.querySelector("#wa-back");r&&n.bind(r,"click",()=>l.navigate("landing"))}export{A as dispose,I as render};
