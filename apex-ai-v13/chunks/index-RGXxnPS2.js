import{e as n}from"./escape-html-BlQj2yEF.js";import{l as b,s as h}from"./monitoring-gJBPZdzr.js";import{c as y}from"./csp-style-helper-BisGRi53.js";import{iotRegistry as d}from"./iot-providers-registry-DYG_9CL2.js";import{toast as s}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-CxbUoEQT.js";import"./apex-kb-8FXW6jDe.js";import"./credential-patterns-K-vGUK9F.js";import"./broadlink-bridge-BXZYck_e.js";import"./haptic-CQFg2PXZ.js";const v="kdmc_admin";function $(){return h.get("user")?.id===v}async function g(e){if(e){if(!$()){e.innerHTML=`
      <div class="ax-gs-62">
  ...
  `;try{const t=await d.statusAll(),o=await d.listAllDevices().catch(()=>[]);e.innerHTML=y.withNonce(k(t,o)),q(e)}catch(t){b.warn("iot-providers-view","render fail",{err:String(t)}),e.innerHTML=`
  ...
  `}function w(e){const{provider:t,status:o}=e;let a="iot-status-no",i="⚪ Non configuré";o.ok?(a="iot-status-ok",i=`🟢 OK · ${o.devices_count??0} devices`):o.reason&&o.reason!=="no_credentials"&&(a="iot-status-ko",i=`🔴 ${n(o.reason)}`);const r=o.ok;return`
  ...
  `}function q(e){e.addEventListener("click",t=>{const o=t.target;if(!o)return;const a=o.closest("[data-action]");if(!a)return;const i=a.dataset.action??"",r=a.dataset.providerId??"",c=a.dataset.deviceId??"";i==="install"?T(r,e):i==="test"?L(r):i==="refresh-all"?z(e):i==="show-proxy"?I():i==="open-broadlink"?location.hash="#broadlink-setup":i==="device-on"&&r&&c&&S(r,c)})}async function T(e,t){const o=d.get(e);if(!o){s.error(`Provider ${e} inconnu`);return}const a=t.querySelector("#iot-modal-host");if(!a)return;const i=A(o);a.innerHTML=`
    <div class="iot-modal-bg" data-modal-bg="1">
      <div class="iot-modal">
        ...
        <p style="color:#888;font-size:12px">Console : <a href="${n(o.console_url)}" target="_blank" rel="noopener" class="ax-gs-198">${n(o.console_url)}</a></p>
