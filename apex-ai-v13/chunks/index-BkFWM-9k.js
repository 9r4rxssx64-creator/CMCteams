import{c as f}from"./listener-cleanup-Y2rGGxxX.js";import{l as x}from"./monitoring-3uBGKGRH.js";import{s as b}from"../core/main-C6XVEYVZ.js";import{g as h}from"./apex-tools-dispatch-core-3gkwsLsM.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import"./apex-kb-Dut8ppfy.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-DcWgsAAp.js";import"./apex-tools-dispatch-skills-C_1JIg7T.js";import"./apex-tools-dispatch-data-DvNGL6xI.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-rTkkZmBV.js";import"./apex-tools-registry-CCpvWT7v.js";import"./voice-CCivQYdU.js";let r=null;function A(){r?.cleanup(),r=null}function p(e){return e.replace(/[&<>"']/g,i=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[i]??i)}const l=[{id:"chien",name:"Chien",emoji:"🐕",weight_range_kg:{min:1,max:80},kcal_per_kg_normal:70,vaccinations:["CHPPiL (carré, hépatite, parvo, parainfluenza, leptospirose)","Rage","Toux du chenil","Maladie de Lyme (zone à risque)"],red_flags:["Vomissements répétés > 24h","Diarrhée sanglante","Léthargie soudaine","Refus de manger > 24h","Difficulté à respirer","Convulsions"],age_coefficient:5,base_year_offset:16},{id:"chat",name:"Chat",emoji:"🐈",weight_range_kg:{min:2,max:12},kcal_per_kg_normal:60,vaccinations:["Typhus, coryza, leucose","Rage","Chlamydiose"],red_flags:["Léthargie","Refus de boire/manger > 24h","Vomissements répétés","Mictions difficiles ou absentes","Boiterie soudaine","Respiration rapide au repos"],age_coefficient:4,base_year_offset:15},{id:"lapin",name:"Lapin",emoji:"🐇",weight_range_kg:{min:1,max:6},kcal_per_kg_normal:55,vaccinations:["Myxomatose","VHD (maladie hémorragique virale)"],red_flags:["Arrêt total alimentation > 12h (URGENT)","Pas de selles > 12h","Tête inclinée","Boiterie","Difficulté respiratoire"],age_coefficient:7,base_year_offset:0},{id:"hamster",name:"Hamster",emoji:"🐹",weight_range_kg:{min:.05,max:.2},kcal_per_kg_normal:100,vaccinations:[],red_flags:["Léthargie inhabituelle","Diarrhée (mortelle rapide)","Boiterie","Croûtes / perte poils","Difficulté respiratoire"],age_coefficient:25,base_year_offset:0},{id:"oiseau",name:"Oiseau (perroquet, canari)",emoji:"🦜",weight_range_kg:{min:.01,max:1.5},kcal_per_kg_normal:120,vaccinations:["Polyomavirus (perroquets élevage)","Maladie de Pacheco"],red_flags:["Plumes ébouriffées au repos","Fientes anormales","Respiration bouche ouverte","Repli au fond cage","Refus chant"],age_coefficient:6,base_year_offset:0},{id:"poisson",name:"Poisson (aquarium)",emoji:"🐟",weight_range_kg:{min:.001,max:.5},kcal_per_kg_normal:30,vaccinations:[],red_flags:["Nage de travers","Plaies / champignons visibles","Ouïes pâles ou rouges","Refus alimentation","Reste isolé en surface"],age_coefficient:3,base_year_offset:0}],v={sedentaire:.85,normal:1,actif:1.2,"tres-actif":1.5};function y(e,i,t){const n=l.find(s=>s.id===e);if(!n||!isFinite(i)||i<=0||i<n.weight_range_kg.min||i>n.weight_range_kg.max)return null;const a=70*Math.pow(i,.75),o=v[t];return Math.round(a*o)}function _(e,i){const t=l.find(n=>n.id===e);return!t||!isFinite(i)||i<0?null:Math.round(t.base_year_offset+i*t.age_coefficient)}function F(e){r?.cleanup(),r=f("studios-pet");const i=b.get("user")?.id??"anon";if(!h("studio.pet",e,i))return;const t=l.map(a=>`<option value="${a.id}">${a.emoji} ${p(a.name)}</option>`).join(""),n=l.map(a=>`
  ...
  `,k(e)}function k(e){const i=e.querySelector("#ax-pet-calc"),t=e.querySelector("#ax-pet-out");i&&t&&r&&r.bind(i,"click",()=>{u.tap();const o=e.querySelector("#ax-pet-species")?.value??"",s=parseFloat(e.querySelector("#ax-pet-weight")?.value??""),c=e.querySelector("#ax-pet-activity")?.value??"normal",d=y(o,s,c);if(d===null){t.textContent="Poids hors plage pour cette espèce.";return}const m=l.find(g=>g.id===o);t.innerHTML=`Ration journalière estimée : <strong>${d} kcal</strong> ${m?`(${m.emoji} ${p(m.name)} · ${s} kg · ${p(c)})`:""}<br><span style="font-size:12px;color:var(--ax-text-dim)">Diviser en 2-3 repas. Adapter selon avis véto.</span>`});const n=e.querySelector("#ax-pet-age-btn"),a=e.querySelector("#ax-pet-age-out");n&&a&&r&&r.bind(n,"click",()=>{u.tap();const o=e.querySelector("#ax-pet-species")?.value??"",s=parseFloat(e.querySelector("#ax-pet-age")?.value??""),c=_(o,s);if(c===null){a.textContent="Âge invalide.";return}a.textContent="",a.append("Équivalent humain : ");const d=document.createElement("strong");d.textContent=`≈ ${c} ans`,a.append(d)}),x.info("studios-pet","rendered")}export{l as PET_SPECIES,_ as animalToHumanAge,y as calcDailyCalories,A as dispose,p as escapeHtml,F as render};
