import{e as a}from"./escape-html-B4YFbUXM.js";import{c as u}from"./listener-cleanup-Y2rGGxxX.js";import{l as d}from"./monitoring-3uBGKGRH.js";import{s as b}from"../core/main-DKjmWbkB.js";import{autoRestoreCredentials as l}from"./auto-restore-credentials-BsWsdwyK.js";import{haptic as g}from"./haptic-CQFg2PXZ.js";import{toast as s}from"./toast-CRdbcLoc.js";import"./apex-kb-Dda8AO_3.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-G4jmaoyD.js";let i=null,n=null;function L(){i?.cleanup(),i=null,n=null}const f={localStorage:{icon:"💾",label:"Local",color:"#22cc77"},idb_shadow:{icon:"🗄️",label:"IDB shadow",color:"#22cc77"},firebase_backup:{icon:"☁️",label:"Firebase backup",color:"#4d9eff"},alias:{icon:"🔗",label:"Alias localStorage",color:"#c9a227"},pattern_match:{icon:"🔍",label:"Pattern match",color:"#ff9d3f"}};function m(e){const t=e.recoverable_from?f[e.recoverable_from]:{icon:"❓",label:"—",color:"#aaa"};return`
