import{e as p}from"./escape-html-BlQj2yEF.js";import{c as h}from"./listener-cleanup-Y2rGGxxX.js";import{s as _,l as f}from"./monitoring-D2lWYrYo.js";import{g as y}from"./apex-tools-dispatch-core-C_k5h2yM.js";import{haptic as x}from"./haptic-CQFg2PXZ.js";import"./multi-source-analyze-Bg1HHfSC.js";import"./apex-kb-D1VtWFD9.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-DOw4cI4G.js";import"./apex-tools-dispatch-data-DHUpGBCD.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-fNevKu6E.js";import"./apex-tools-misc-DBbScgMK.js";import"./apex-tools-registry-core-BMhHY4vU.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let c=null;function G(){c?.cleanup(),c=null}const b=[{zone:"H1a",bbio_max:72,cep_max:75,description:"Nord-Est (Strasbourg, Reims)"},{zone:"H1b",bbio_max:65,cep_max:70,description:"Centre (Paris, Tours)"},{zone:"H1c",bbio_max:60,cep_max:65,description:"Centre-Est (Lyon, Grenoble)"},{zone:"H2a",bbio_max:65,cep_max:65,description:"Bretagne, Pays de Loire"},{zone:"H2b",bbio_max:60,cep_max:60,description:"Sud-Ouest Atlantique (Bordeaux)"},{zone:"H2c",bbio_max:55,cep_max:55,description:"Sud (Toulouse, Montpellier)"},{zone:"H2d",bbio_max:55,cep_max:50,description:"Méditerranée (Marseille, Nice, Monaco)"},{zone:"H3",bbio_max:50,cep_max:50,description:"Côte méditerranéenne très chaude"}],g=[{type:"Béton de propreté",ciment_kg_m3:150,sable_kg_m3:800,gravier_kg_m3:1100,eau_l_m3:100,usage:"Couche sous fondations"},{type:"Béton dosage 250",ciment_kg_m3:250,sable_kg_m3:750,gravier_kg_m3:1100,eau_l_m3:130,usage:"Dalle non porteuse, terrasse"},{type:"Béton dosage 300",ciment_kg_m3:300,sable_kg_m3:720,gravier_kg_m3:1080,eau_l_m3:150,usage:"Dalle porteuse, fondation maison"},{type:"Béton dosage 350",ciment_kg_m3:350,sable_kg_m3:700,gravier_kg_m3:1050,eau_l_m3:175,usage:"Béton armé, poteau, poutre"},{type:"Béton dosage 400",ciment_kg_m3:400,sable_kg_m3:680,gravier_kg_m3:1020,eau_l_m3:200,usage:"Béton structurel résistant"}],v=[{id:"door_width",label:"Largeur porte d'entrée",min_value_cm:83,description:"Loi 2005-102. Passage utile ≥ 83 cm."},{id:"corridor_width",label:"Largeur couloir",min_value_cm:90,description:"Largeur libre ≥ 90 cm."},{id:"shower_size",label:"Douche italienne",min_value_cm:120,description:"Espace minimum 120×90 cm."},{id:"turn_circle",label:"Aire de rotation",min_value_cm:150,description:"Diamètre Ø1.50 m libre."},{id:"wc_clearance",label:"Espace latéral WC",min_value_cm:80,description:"Latéral ≥ 80 cm pour transfert."},{id:"ramp_slope_pct",label:"Pente rampe (%)",min_value_cm:5,description:"Max 5% (sinon palier + main courante)."}],I=240,Z=230,k=60,S=64;function z(e){return!isFinite(e)||e<=0?0:Math.round(e*.95*100)/100}function M(e,i){if(!isFinite(e)||e<=0)return null;const t=g.find(a=>a.type===i);if(!t)return null;const o=Math.round(e*t.ciment_kg_m3);return{volume_m3:e,ciment_kg:o,sable_kg:Math.round(e*t.sable_kg_m3),gravier_kg:Math.round(e*t.gravier_kg_m3),eau_l:Math.round(e*t.eau_l_m3),sacs_ciment_35kg:Math.ceil(o/35)}}function $(e,i,t,o=2){if(!isFinite(e)||e<=0||!isFinite(i)||i<=0||!isFinite(t)||t<=0||o<1||o>5)return null;const a=2*(e+i)*t,m=e*i,u=(a+m)*o,r=Math.ceil(u/10),s=Math.floor(r/5),l=Math.ceil((r-s*5)/2.5);return{surface_a_peindre_m2:Math.round(u*100)/100,litres_total:r,pots_5l:s,pots_2_5l:l<0?0:l}}function W(e,i,t=10){if(!isFinite(e)||e<=0||!isFinite(i)||i<=0)return null;const o=e*i,a=o*(1+t/100);return{surface_m2:Math.round(o*100)/100,surface_avec_chutes_m2:Math.round(a*100)/100}}function X(e,i){const t=2*e+i;return t<k?{ok:!1,valeur:t,recommandation:"Marches trop basses ou giron trop court (escalier raide à monter)."}:t>S?{ok:!1,valeur:t,recommandation:"Marches trop hautes ou giron trop long (escalier difficile)."}:{ok:!0,valeur:t,recommandation:"Escalier conforme à l'échelle Blondel."}}function E(e){c?.cleanup(),c=h("studios-architecture");const i=_.get("user")?.id??"anon";if(!y("studio.architecture",e,i))return;const t=g.map(a=>`<option value="${p(a.type)}">${p(a.type)} — ${p(a.usage)}</option>`).join(""),o=b.map(a=>`<option value="${p(a.zone)}">${p(a.zone)} — ${p(a.description)}</option>`).join("");e.innerHTML=`
  ...
  `,B(e)}function B(e){const i=e.querySelector("#ax-archi-surface-btn");i&&c&&c.bind(i,"click",()=>{x.tap();const r=e.querySelector("#ax-archi-surface"),s=e.querySelector("#ax-archi-surface-out");if(!r||!s)return;const l=parseFloat(r.value),n=z(l);s.textContent=n>0?`Surface habitable estimée : ${n} m²`:"Saisis une surface valide."});const t=e.querySelector("#ax-archi-beton-btn");t&&c&&c.bind(t,"click",()=>{x.tap();const r=parseFloat(e.querySelector("#ax-archi-vol")?.value??""),s=e.querySelector("#ax-archi-dosage")?.value??"",l=e.querySelector("#ax-archi-beton-out");if(!l)return;const n=M(r,s);if(!n){l.textContent="Volume invalide.";return}l.textContent=`Volume : ${n.volume_m3} m³
Ciment : ${n.ciment_kg} kg (${n.sacs_ciment_35kg} sacs de 35 kg)
Sable : ${n.sable_kg} kg
Gravier : ${n.gravier_kg} kg
Eau : ${n.eau_l} L`});const o=e.querySelector("#ax-archi-paint-btn");o&&c&&c.bind(o,"click",()=>{x.tap();const r=parseFloat(e.querySelector("#ax-archi-l")?.value??""),s=parseFloat(e.querySelector("#ax-archi-w")?.value??""),l=parseFloat(e.querySelector("#ax-archi-h")?.value??""),n=e.querySelector("#ax-archi-paint-out");if(!n)return;const d=$(r,s,l,2);if(!d){n.textContent="Dimensions invalides.";return}n.textContent=`Surface peinte (2 couches) : ${d.surface_a_peindre_m2} m²
Total : ${d.litres_total} litres
≈ ${d.pots_5l} pots de 5L + ${d.pots_2_5l} pots de 2.5L`});const a=e.querySelector("#ax-archi-zone"),m=e.querySelector("#ax-archi-zone-out"),u=()=>{if(!a||!m)return;const r=b.find(s=>s.zone===a.value);r&&(m.textContent=`${r.zone} — ${r.description}. Bbio max ${r.bbio_max} pts · Cep max ${r.cep_max} kWh/m²/an.`)};a&&c&&(c.bind(a,"change",u),u()),f.info("studios-architecture","rendered")}export{g as BETON_DOSAGES,S as BLONDEL_MAX,k as BLONDEL_MIN,I as HSP_MIN_FR,Z as HSP_MIN_MONACO,v as PMR_NORMS,b as RE2020_ZONES,M as calcBeton,$ as calcPeinture,W as calcRevetement,z as calcSurfaceHabitable,X as checkBlondel,G as dispose,p as escapeHtml,E as render};
