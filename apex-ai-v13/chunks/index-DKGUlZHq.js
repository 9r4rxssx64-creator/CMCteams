import{b as y,e as i,l as g}from"./monitoring-BQF7kI2q.js";import{c as $}from"./listener-cleanup-Y2rGGxxX.js";import{c,A as v}from"./custom-assistants-D9SyrZ-E.js";import{g as h}from"./apex-tools-dispatch-core-DTmE7UHw.js";import{toast as x}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-BU9bN8Ej.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-klwbQ2l3.js";import"./apex-tools-dispatch-skills-IWCe79Os.js";import"./apex-tools-dispatch-data-DJa6Jmm0.js";import"./apex-tools-dispatch-finance-D84Ce07W.js";import"./apex-tools-dispatch-misc-CJuusfOA.js";import"./apex-tools-misc-CcMueUq3.js";import"./apex-tools-registry-core-48oOK-KS.js";import"./apex-tools-registry-skills-x-mAWYry.js";import"./haptic-CQFg2PXZ.js";let f=null,l=null;function F(){f?.cleanup(),f=null,l=null}function u(s){f?.cleanup(),f=$("assistants");const d=y.get("user")?.id??"anon";if(!h("module.assistants",s,d))return;const m=c.list(d),r=c.getActiveId(d),n=l?c.get(l,d):null,o=r?(()=>{const t=c.get(r,d);return t?`<div class="ax-gs-400" style="border:1px solid rgba(232,184,48,.5);border-radius:10px;padding:12px;margin-bottom:12px;background:rgba(232,184,48,.06)">
