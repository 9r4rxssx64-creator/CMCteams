import{a as s}from"./escape-html-DGIYNPKb.js";import{l as m}from"./monitoring-DMtdadhB.js";import{i as f}from"../core/main-CUO2jjmv.js";import{r as x}from"./apex-tools-dispatch-skills-CpR1_932.js";import{mcpRegistry as d}from"./mcp-registry-C2HAo2sX.js";import{skillsWatch as b}from"./skills-watch-DfopoXXu.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./apex-kb-BdO9xyva.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-oYazAI5o.js";import"./haptic-CQFg2PXZ.js";function g(t){const l={alive:{color:"#10b981",emoji:"🟢"},dead:{color:"#ef4444",emoji:"🔴"},unknown:{color:"#94a3b8",emoji:"⚪"}},n=l[t]??l.unknown;return`<span style="color:${n.color};font-weight:600">${n.emoji} ${s(t)}</span>`}function c(t){if(!(f.get("isAdmin")===!0)){t.innerHTML='<div style="padding:24px;text-align:center;color:#94a3b8">🔒 Réservé admin Kevin</div>';return}d.init();const n=d.list(),p=b.getLastReport("mcp-health-watch"),u=n.map(e=>{const r=e.toolsExposed?.length??0,i=e.lastCheck?new Date(e.lastCheck).toLocaleString("fr-FR"):"jamais";return`
