import{e as r}from"./monitoring-CvP9ulCW.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-b6tOY-FU.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-0p_vlsjK.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-Ds3uJQ4I.js";import"./kevin-alerts-C9rxuPxI.js";import"./whatsapp-ChzSdQEl.js";import"./auth-gate-D1SHrMkZ.js";import"./auth-BGe163JD.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
