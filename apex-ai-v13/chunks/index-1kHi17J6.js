import{e as r}from"./monitoring-CNcu4wnT.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-HxqaVXWP.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-B4ohZUbk.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-Cf7LoMt2.js";import"./kevin-alerts-Cp1srWwA.js";import"./whatsapp-BMNK1Tdh.js";import"./auth-gate-BxxnxUMc.js";import"./auth-CoQ3Xh14.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
