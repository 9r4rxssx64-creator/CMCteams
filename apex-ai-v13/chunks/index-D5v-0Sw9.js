...
Bien cordialement,
${i} ${r}`}class I{load(e){if(!e)return null;try{const t=localStorage.getItem(f(e));if(!t)return null;const i=JSON.parse(t);return!i||typeof i!="object"?null:i}catch(t){return d.warn("studio-cv","load failed",{err:t}),null}}save(e,t){if(!e)return!1;try{return localStorage.setItem(f(e),JSON.stringify(t)),!0}catch(i){return d.warn("studio-cv","save failed (quota?)",{err:i}),!1}}setTemplate(e,t){const i=this.load(e)??b(t);return i.template=t,this.save(e,i),i}setLang(e,t){const i=this.load(e);return i?(i.lang=t,this.save(e,i)):!1}addExperience(e){const t=this.load(e);return t?(t.experiences.length>=x||(t.experiences.push(w()),this.save(e,t)),t):null}addFormation(e){const t=this.load(e);return t?(t.formations.length>=v||(t.formations.push(T()),this.save(e,t)),t):null}addCertification(e){const t=this.load(e);return t?(t.certifications.length>=j||(t.certifications.push(R()),this.save(e,t)),t):null}addProject(e){const t=this.load(e);return t?(t.projets.length>=M||(t.projets.push(k()),this.save(e,t)),t):null}addReference(e){const t=this.load(e);return t?(t.references.length>=P||(t.references.push(_()),this.save(e,t)),t):null}removeExperience(e,t){const i=this.load(e);return i?(i.experiences=i.experiences.filter(r=>r.id!==t),this.save(e,i)):!1}removeFormation(e,t){const i=this.load(e);return i?(i.formations=i.formations.filter(r=>r.id!==t),this.save(e,i)):!1}setIdentite(e,t){const i=this.load(e);return i?(i.identite={...i.identite,...t},this.save(e,i)):!1}setResume(e,t){const i=this.load(e);return i?(i.resume=t.slice(0,600),this.save(e,i)):!1}setCompetences(e,t){const i=this.load(e);return i?(i.competences=t.slice(0,E),this.save(e,i)):!1}clear(e){return e?(localStorage.removeItem(f(e)),!0):!1}}const m=new I;function z(n){p?.cleanup(),p=C("studios-cv");const e=A.get("user"),t=e?.id??"anon";let i=m.load(t);if(!i){const o={};e?.firstName&&(o.prenom=e.firstName),e?.lastName&&(o.nom=e.lastName),i=b("classique",o),m.save(t,i)}const r=D(i),a=F(i),c=h.map(o=>`
  ...
  `,O(n,t)}function O(n,e){n.querySelectorAll(".ax-cv-template").forEach(i=>{p.bind(i,"click",()=>{const r=i.dataset.template;r&&(m.setTemplate(e,r),z(n))})});const t=(i,r)=>{const a=n.querySelector(`#${i}`);a&&p.bind(a,"change",()=>{m.setIdentite(e,{[r]:a.value})})};t("ax-cv-prenom","prenom"),t("ax-cv-nom","nom"),t("ax-cv-titre","titre"),t("ax-cv-email","email"),t("ax-cv-tel","telephone"),t("ax-cv-linkedin","linkedin"),n.querySelectorAll("[data-export]").forEach(i=>{p.bind(i,"click",()=>{const r=i.dataset.export;d.info("studio-cv","export requested",{format:r}),(async()=>{try{const{toast:a}=await q(async()=>{const{toast:c}=await import("./toast-Dgg9rcIP.js");return{toast:c}},__vite__mapDeps([0,1]),import.meta.url).catch(()=>({toast:null}));a?.info(`Export ${r.toUpperCase()} en cours…`)}catch(a){d.warn("studio-cv","export failed",{err:a})}})()})})}export{Q as ATS_REQUIRED_KEYWORDS_FR,G as ATS_REQUIRED_SECTIONS,Z as COMPETENCES_PAR_DOMAINE,W as COVER_LETTER_TEMPLATES,K as INTERVIEW_QUESTIONS_FR,j as MAX_CERTIFICATIONS,E as MAX_COMPETENCES,x as MAX_EXPERIENCES,v as MAX_FORMATIONS,M as MAX_PROJECTS,P as MAX_REFERENCES,Y as NIVEAUX_CECRL,$ as STORAGE_PREFIX,h as TEMPLATES,F as calcATSScore,D as calcCompleteness,R as createCertification,w as createExperience,T as createFormation,k as createProject,_ as createReference,m as cvStudioStore,H as dispose,l as escapeHtml,te as extractGitHubUsername,ee as extractLinkedInSlug,ne as generateCoverLetterTemplate,f as getStorageKey,b as initCV,y as isValidEmail,ie as matchOffer,z as render};
//# sourceMappingURL=index-D5v-0Sw9.js.map
