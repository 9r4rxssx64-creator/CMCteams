import{e as r}from"./monitoring-BizumX9y.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DJCA-I-d.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-8iCBXc7y.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-ComPBpsj.js";import"./kevin-alerts-BO5ZVLnv.js";import"./whatsapp-M0wt6YTC.js";import"./auth-gate-B0dvQWer.js";import"./auth-BoEUBaQk.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
