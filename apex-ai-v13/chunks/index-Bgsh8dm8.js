import{e as r}from"./monitoring-YocS_xEr.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-DBgsGuLt.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-CMMfqOLC.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-Df3o73Xo.js";import"./kevin-alerts-DSCTaaCm.js";import"./whatsapp-o8_RoxRm.js";import"./auth-gate-D2YYCd0D.js";import"./auth-BvqL_K2i.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
