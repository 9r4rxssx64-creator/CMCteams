const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-BFpEt2rP.js","./monitoring-C21_YuBN.js","./multi-source-analyze-BF2gxnOB.js","./credential-patterns-CLzI061R.js","./auth-DU-9rI8i.js"])))=>i.map(i=>d[i]);
import{_ as v}from"./apex-kb-BFpEt2rP.js";import{b,r as g}from"../core/main-BkJZWZ8N.js";import{a as x}from"./escape-html-DGIYNPKb.js";import{c as y}from"./listener-cleanup-Y2rGGxxX.js";import{auth as _}from"./auth-DU-9rI8i.js";import{i as h}from"./apex-tools-dispatch-core-557kGaQU.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import{toast as m}from"./toast-CRdbcLoc.js";import"./monitoring-C21_YuBN.js";import"./multi-source-analyze-BF2gxnOB.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-Byr7emR5.js";import"./apex-tools-dispatch-data-BQqTb4_N.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-yz2wqpwm.js";import"./apex-tools-misc-Da9XyAYd.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let l=null;function J(){l?.cleanup(),l=null}function S(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}async function I(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),p=localStorage.getItem("apex_v13_last_known_name"),o=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!p||!o)return!1;const{deviceContext:n}=await v(async()=>{const{deviceContext:c}=await import("./device-context-BoOvPg3p.js");return{deviceContext:c}},__vite__mapDeps([0,1,2,3]),import.meta.url);if((await n.getFingerprint()).device_id!==o)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:t}=await v(async()=>{const{auth:c}=await import("./auth-DU-9rI8i.js");return{auth:c}},__vite__mapDeps([4,0,1,2,3]),import.meta.url);if((await t.loginTrusted(e,p)).ok)return g.navigate("chat"),!0}catch{}return!1}function O(e){if(l?.cleanup(),l=y("landing"),!h("module.landing")){e.innerHTML=`
