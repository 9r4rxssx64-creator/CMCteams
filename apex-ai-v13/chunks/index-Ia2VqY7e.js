const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./apex-kb-CbzVLcxA.js","./monitoring-BqodRReZ.js","./multi-source-analyze-CKhc2o3F.js","./credential-patterns-CLzI061R.js","./auth-Cg0RgLHT.js"])))=>i.map(i=>d[i]);
import{_ as g}from"./apex-kb-CbzVLcxA.js";import{b as _,r as f}from"../core/main-p_I-F7Er.js";import{a as x}from"./escape-html-DGIYNPKb.js";import{c as b}from"./listener-cleanup-Y2rGGxxX.js";import{auth as y}from"./auth-Cg0RgLHT.js";import{i as h}from"./apex-tools-dispatch-core-BuiZzNhM.js";import{haptic as u}from"./haptic-CQFg2PXZ.js";import{toast as m}from"./toast-CRdbcLoc.js";import"./monitoring-BqodRReZ.js";import"./multi-source-analyze-CKhc2o3F.js";import"./credential-patterns-CLzI061R.js";import"./apex-tools-dispatch-skills-DHiF9xYO.js";import"./apex-tools-dispatch-data-CSnt5vyw.js";import"./apex-tools-dispatch-finance-DoRAfEZC.js";import"./apex-tools-dispatch-misc-BU6yQDTo.js";import"./apex-tools-misc-CnSibEsP.js";import"./apex-tools-registry-core-CQvgkOQw.js";import"./apex-tools-registry-skills-DRX4PPQ_.js";let c=null;function O(){c?.cleanup(),c=null}function S(){const e=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!e||!e[1])return null;try{const o=atob(e[1]??"").split(":")[0];if(o)return{uid:o}}catch{}return null}async function I(){try{const e=localStorage.getItem("apex_v13_last_known_uid"),d=localStorage.getItem("apex_v13_last_known_name");let o=localStorage.getItem("apex_v13_device_trusted_v1");if(!e||!d)return!1;if(!o&&(localStorage.getItem("apex_v13_pin")!==null||localStorage.getItem(`apex_v13_pin_${e}`)!==null))try{const{deviceContext:p}=await g(async()=>{const{deviceContext:i}=await import("./device-context-BTD9J-GG.js");return{deviceContext:i}},__vite__mapDeps([0,1,2,3]),import.meta.url),t=await p.getFingerprint();localStorage.setItem("apex_v13_device_trusted_v1",t.device_id),o=t.device_id}catch{}if(!o)return!1;const{deviceContext:n}=await g(async()=>{const{deviceContext:l}=await import("./device-context-BTD9J-GG.js");return{deviceContext:l}},__vite__mapDeps([0,1,2,3]),import.meta.url);if((await n.getFingerprint()).device_id!==o)return localStorage.removeItem("apex_v13_device_trusted_v1"),!1;const{auth:a}=await g(async()=>{const{auth:l}=await import("./auth-Cg0RgLHT.js");return{auth:l}},__vite__mapDeps([4,0,1,2,3]),import.meta.url);if((await a.loginTrusted(e,d)).ok)return f.navigate("chat"),!0}catch{}return!1}function J(e){if(c?.cleanup(),c=b("landing"),!h("module.landing")){e.innerHTML=`
