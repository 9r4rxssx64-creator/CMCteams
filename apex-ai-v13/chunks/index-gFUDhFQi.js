const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./kevin-alerts-D-8nqvP3.js"])))=>i.map(i=>d[i]);
import{_ as h}from"./apex-kb-Co9TqiFL.js";import{l as $}from"./monitoring-WiO5ZBU9.js";import{c as z}from"./listener-cleanup-Y2rGGxxX.js";import{e as o}from"./html-safe-CCp1QaJu.js";import{s as C}from"../core/main-CHCbNonX.js";import{credentialsAudit as _}from"./credentials-audit-CnRdEHwE.js";import{h as p}from"./haptic-BUEqXK0N.js";import{toast as l}from"./toast-Dgg9rcIP.js";import"./apex-tools-registry-_6Box58P.js";import"./credential-patterns-DqicUg9o.js";import"./apex-tools-dispatch-BOHQloZe.js";let d=null,y=null,m="all";function K(){d?.cleanup(),d=null}const S={ok:{color:"#22cc77",icon:"🟢",label:"OK"},missing:{color:"#888",icon:"⚪",label:"Non config"},corrupted:{color:"#ff6b6b",icon:"🔴",label:"Corrompu"},expired:{color:"#ffaa00",icon:"🟠",label:"Expiré"},unknown:{color:"#aaa",icon:"❓",label:"Inconnu"},decrypt_failed:{color:"#ff6b6b",icon:"🔒",label:"Illisible"}},v={all:"Tous",ai:"🤖 IA",banking:"🏦 Banque",payment:"💳 Paiement",social:"📱 Social",email:"📧 Email",crypto:"₿ Crypto",hosting:"☁️ Hosting",productivity:"📋 Productivité",forbidden:"⚠️ Forbidden"};async function w(e){if(!(C.get("isAdmin")===!0)){e.innerHTML=`
