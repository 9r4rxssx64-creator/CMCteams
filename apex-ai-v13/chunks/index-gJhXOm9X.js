import{a as s}from"./escape-html-DGIYNPKb.js";import{l as m}from"./monitoring-DMtdadhB.js";import{i as f}from"../core/main-BNvOFLLb.js";import{r as x}from"./apex-tools-dispatch-skills-07jwPyLv.js";import{mcpRegistry as d}from"./mcp-registry-Bj9HvdPj.js";import{skillsWatch as b}from"./skills-watch-Fj0_IR8p.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./apex-kb-OPrvxVPi.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-D2F3mBsQ.js";import"./haptic-CQFg2PXZ.js";function g(t){const l={alive:{color:"#10b981",emoji:"🟢"},dead:{color:"#ef4444",emoji:"🔴"},unknown:{color:"#94a3b8",emoji:"⚪"}},n=l[t]??l.unknown;return`<span style="color:${n.color};font-weight:600">${n.emoji} ${s(t)}</span>`}function c(t){if(!(f.get("isAdmin")===!0)){t.innerHTML='<div style="padding:24px;text-align:center;color:#94a3b8">🔒 Réservé admin Kevin</div>';return}d.init();const n=d.list(),p=b.getLastReport("mcp-health-watch"),u=n.map(e=>{const r=e.toolsExposed?.length??0,i=e.lastCheck?new Date(e.lastCheck).toLocaleString("fr-FR"):"jamais";return`
