import{e as r}from"./monitoring-CpAzCFTb.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CNGY1nQo.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-CABQFfu3.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DvSa-GZo.js";import"./kevin-alerts-C-cjlZoQ.js";import"./whatsapp-D3ftGT08.js";import"./auth-gate-D6qnKpd_.js";import"./auth-DfuMTtv2.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
