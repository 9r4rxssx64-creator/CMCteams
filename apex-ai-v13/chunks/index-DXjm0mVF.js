import{e as r}from"./monitoring-gdN37KLL.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-Dg7ERhD7.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-BCPNzfMv.js";import"./multi-source-analyze-_RAvLX0s.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-DEigeGWI.js";import"./kevin-alerts-LHgovbn2.js";import"./whatsapp-B_hP3mXE.js";import"./auth-gate-1I4cGOmr.js";import"./auth-OsJOepWc.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
