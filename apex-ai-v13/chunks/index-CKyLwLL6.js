import{l as c}from"./monitoring-3uBGKGRH.js";import{s as l}from"../core/main-D1gdyM8d.js";import{broadlinkBridge as t}from"./broadlink-bridge-VES697oY.js";import{toast as a}from"./toast-ClsF1KRZ.js";import"./apex-kb-4Yru_caL.js";import"./credential-patterns-CLzI061R.js";import"./multi-source-analyze-9ZhG_xKV.js";import"./haptic-CQFg2PXZ.js";const x="kdmc_admin";function i(e){return e.replace(/[&<>"']/g,r=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[r]??r)}function u(){return l.get("user")?.id===x}async function p(e){if(!e)return;if(!u()){e.innerHTML=`
