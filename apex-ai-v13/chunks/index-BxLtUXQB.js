import{r}from"../core/main-BkGEiZqP.js";import{auth as a}from"./auth-9DHLN_kt.js";function l(n){return n.replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]??e)}function c(){const n=location.hash.match(/invite=([A-Za-z0-9+/=]+)/);if(!n||!n[1])return null;try{const t=atob(n[1]??"").split(":")[0];if(t)return{uid:t}}catch{}return null}function u(n){const e=c();n.innerHTML=`
...
//# sourceMappingURL=index-BxLtUXQB.js.map
