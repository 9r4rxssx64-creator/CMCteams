import{e as r}from"./monitoring-Bpme0qaR.js";import{c as g}from"./listener-cleanup-Y2rGGxxX.js";import{s}from"./signup-CccGEzrw.js";import{haptic as p}from"./haptic-CQFg2PXZ.js";import{toast as o}from"./toast-CRdbcLoc.js";import"./multi-source-analyze-Dqa1M_v7.js";import"./credential-patterns-DUMYZEMu.js";import"./apex-kb-BY-X14Fv.js";import"./kevin-alerts-CQXXfWjC.js";import"./whatsapp-CGLP6tlC.js";import"./auth-gate-Do7t4sC8.js";import"./auth-CENQ1O4a.js";let n=null;function q(){n?.cleanup(),n=null}function x(e){return e.length<=4?e:e.slice(0,4)+"***"+e.slice(-2)}function P(e){n?.cleanup(),n=g("signup-approval"),l(e)}function l(e){const i=s.listPending(),t=s.listProcessed().slice(0,20);e.innerHTML=`
    <div class="ax-gs-364">
