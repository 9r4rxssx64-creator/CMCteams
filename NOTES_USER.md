...
### 🚨 PRÉCISION CRITIQUE — Chefs BJ (Kevin 2026-05-19)

**LARINI H et SOLIMEIS F NE SONT PAS dans la même équipe.**
**Ils n'ont PAS les mêmes jours de repos.**

Donc dans la section "Chefs black Jack" du PDF :
- Chaque COLONNE du PDF = une équipe distincte (pas chaque ligne)
- Les 6 emps listés sur la première ligne du header sont chacun dans une équipe DIFFÉRENTE
- Exemples mai V2 :
  - LARINI H : son équipe (sig 6:offset_X:20/5c) + autres emps starting 20/5c → groupés par sig
